...
(function($, window, document) {
  ...
  var Timepicker = function(element, options) {
    var self = this;
    $(element).parent().siblings('button.btn-set-now').click(function() {
    ...
    this.defaultTime = this.$element.val();
  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.showWidgetOnAddonClick && (this.$element.parent().hasClass('input-group') && this.$element.parent().hasClass('bootstrap-timepicker'))) {
        this.$element.parent('.input-group.bootstrap-timepicker').find('.input-group-addon').bind({
    ...
    getTemplate: function() {
      ...
      case 'modal':
        template = '<div style="overflow:hidden; z-index:9999;" class="bootstrap-timepicker-widget modal hide fade in" data-backdrop="'+ (this.modalBackdrop ? 'true' : 'false') +'">'+
        ...
        break;
      case 'dropdown':
        template = '<div class="bootstrap-timepicker-widget dropdown-menu" style="overflow:hidden; z-index:9999;">'+ templateContent +'</div>';
        break;
      }
    ...
    hideWidget: function() {
      ...
      this.$widget.detach();
      $('.timepickerAnchor').removeClass('changed');
      this.$element.addClass('changed');
      this.$element.parent().siblings('button.btn-set-time').trigger('click');
    },
    ...
    showWidget: function() {
      ...
      var timer = this.$element.attr('value');

      // widget shouldn't be empty on open
      if (this.hour === '') {
        if (timer) {
          this.setDefaultTime(timer);
        } else {
          this.setTime('0:0:0');
        }
      }
