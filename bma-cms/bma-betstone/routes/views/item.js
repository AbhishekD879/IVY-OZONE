...
exports = module.exports = function(req, res) {
	...
	global.time_zone = parseInt(req.cookies.time_zone, 10);
	global.time_zone_name = req.cookies.time_zone_name;
      ...
      item.brand = req.user.brandCode;
		...
		if (req.method === 'POST' && req.body.action === 'updateItem' && !req.list.get('noedit')) {
			...
			if (!keystone.security.csrf.validate(req)) {
				Logger.error('CSRF', 'CSRF failure', req.method, req.body);
