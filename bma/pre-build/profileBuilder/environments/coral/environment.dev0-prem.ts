...
export default merge(prodConfig, {
  ...
  FEATURED_SPORTS: 'wss://featured-publisher.internal.dev.coral.co.uk',
  INPLAYMS: 'wss://inplay-publisher.internal.dev.coral.co.uk',
  LIVESERVEMS: 'wss://liveserve-publisher.internal.dev.coral.co.uk',
  REMOTEBETSLIPMS: 'wss://remotebetslip-dev0.coralsports.dev.cloud.ladbrokescoral.com',
  EDPMS: 'https://edp.internal.dev.coral.co.uk',
  BIG_COMPETITION_MS: 'https://bigcompetition.internal.dev.coral.co.uk/competition',
  ...
  TIME_ENDPOINT:'https://hydra.internal.dev.coral.co.uk',
  ...
  BYB_CONFIG: {
    ...
    uri: 'https://buildyourbet.internal.dev.coral.co.uk/api'
  },
