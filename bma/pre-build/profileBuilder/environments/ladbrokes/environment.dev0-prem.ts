...
export default merge(prodConfig, {
  ...
  FEATURED_SPORTS: 'wss://featured-publisher.internal.dev.ladbrokes.com',
  INPLAYMS: 'wss://inplay-publisher.internal.dev.ladbrokes.com',
  CASHOUT_MS: 'https://cashout-dev0.ladbrokesoxygen.dev.cloud.ladbrokescoral.com',
  LIVESERVEMS: 'wss://liveserve-publisher.internal.dev.ladbrokes.com',
  REMOTEBETSLIPMS: 'wss://remotebetslip-dev0.ladbrokesoxygen.dev.cloud.ladbrokescoral.com',
  EDPMS: 'https://edp.internal.dev.ladbrokes.com',
  BIG_COMPETITION_MS: 'https://bigcompetition.internal.dev.ladbrokes.com/competition',
  AEM_CONFIG: {
  ...
  TIME_ENDPOINT: 'https://hydra.internal.dev.ladbrokes.com',
  ...
  BYB_CONFIG: {
    ...
    uri: 'https://buildyourbet.internal.dev.ladbrokes.com/api'
  },
