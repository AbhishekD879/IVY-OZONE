...
export default {
  ...
  IMAGES_RACE_ENDPOINT: 'https://aggregation.ladbrokes.com/silks/racingpost',
  ...
  OPT_IN_ENDPOINT: 'https://optin-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  ...
  IG_MEDIA_TOTE_ENDPOINT: 'https://optin-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com/api/igamemedia',
  IG_MEDIA_ENDPOINT: 'https://optin-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com/api/video/igame',
  ...
  NOTIFICATION_CENTER_ENDPOINT: 'https://notification-center-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  LIVESERV: {
    DOMAIN: 'ladbrokes.com',
  ...
  desktopWidth: 1025,
  FEATURED_SPORTS: 'wss://featured-sports-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  INPLAYMS: 'wss://inplay-publisher-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  CASHOUT_MS: 'https://cashout-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  LIVESERVEMS: 'wss://liveserve-publisher-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  REMOTEBETSLIPMS: 'wss://remotebetslip-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  EDPMS: 'https://edp-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com',
  BIG_COMPETITION_MS: 'https://bigcompetition-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com/competition',
  ...
  BYB_CONFIG: {
    ...
    uri: 'https://buildyourbet.ladbrokes.com/api'
  },
  ...
  QUESTION_ENGINE_ENDPOINT: 'https://question-engine-prd0.ladbrokesoxygen.prod.cloud.ladbrokescoral.com/api',
  TIMELINE_MS: 'wss://timeline-api-prd0.coralsports.prod.cloud.ladbrokescoral.com',
  OXYMS: '',
  SHOWDOWN_MS: 'https://showdown.prod.ladbrokes.com/showdown/api',
