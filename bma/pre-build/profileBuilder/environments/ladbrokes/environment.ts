...
export default merge(prodConfig, {
  ...
  PROMO_LB_ENDPOINT:'https://promo-sandbox.internal.dev.coral.co.uk/promosandbox/api/userRank',
  ...
  TRENDING_BETS_API_ENDPOINT: 'https://trending-bets.internal.tst.ladbrokes.com/api',
