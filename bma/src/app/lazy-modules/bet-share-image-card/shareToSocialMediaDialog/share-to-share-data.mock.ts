...
SHARE_DATA['sortType'] = 'test horserace';
...
export const REGULAR_BET_DATA1 = {
    eventSource: EVENT_SOURCE,
    id: '12345',
    bets: {id:'123'},
}
...
export const REGULAR_SHARE_DATA = {
  ...
  export const REGULAR_SHARE_5ASIDE_CATEGORY = {
    betData:{
      eventSource: {    
        ...
        leg: [{
          backupEventEntity: { id: '123' },
          part: [{ outcome: [{eventCategory:{id:'55555',name:'Football'}}]}],
          cashoutId: '12345'
        }],
        id: '123',
        totalStatus: 'won',
  ...
  export const REGULAR_SHARE_FOOTBALL_CATEGORY = {
    betData:{
      bybType:'',
      eventSource: {    
        bybType: 'SGL',
        leg: [{
          backupEventEntity: { id: '123' },
          part: [{ outcome: [{ eventCategory:{id: '123',name:'Football'}}]}],
          cashoutId: '12345'
        }],
        id: '123',
        totalStatus: 'won',
      ...
      bets: [{eventSource:{    
        ...
        leg: [{
          backupEventEntity: { id: '123' },
          part: [{ outcome: [{eventCategory:{id:'666',name:'Football'}}] }],
          cashoutId: '12345'
        }],
        id: '123',
        raceNumberTitle: 'race1',
...
export const BUILD_BET_SHARE_IMG_DATA = [{line1:'test',line2:'test data',
line3:'test line',eventName:'test event',selectionName:['test selection, test'],selectionOutcomes:['test slection outcomes']
,marketName:'BUILD YOUR BET',selectionHeaderName:'jackPot',lotteryDrawResults: [{drawLineName:'test line'}]}];

BUILD_BET_SHARE_IMG_DATA['betFullDate'] = '12-11-2023';
BUILD_BET_SHARE_IMG_DATA['betFullDateTime'] = '1-2-13';
BUILD_BET_SHARE_IMG_DATA['stake'] = '$22';
BUILD_BET_SHARE_IMG_DATA['returns'] = '$33';
BUILD_BET_SHARE_IMG_DATA['betType'] = 'Bet Builder';
BUILD_BET_SHARE_IMG_DATA['imageObj'] = imgObject;
BUILD_BET_SHARE_IMG_DATA['betId'] = '12345';
BUILD_BET_SHARE_IMG_DATA['msg1'] = 'its my bet';

export const lottoImgObject = new Image();
lottoImgObject.crossOrigin="anonymous";
lottoImgObject.src ="https://scmedia.itsfogo.com/$-$/5539b5e8d1cc4b6595ea27657d46ce3f.jpg";

export const LOTTO_BET_SHARE_IMG_DATA = [{line1:'test',line2:'test data',
line3:'test line',eventName:'test event',selectionName:'test selection',selectionOutcomes:['test slection outcomes']
,marketName:'lotto 1',selectionHeaderName:'lotto',lotteryDrawResults: [{drawLineName:'test line4'},{drawLineName:'test line1'},{drawLineName:'test line2'},{drawLineName:'test line2'}]}];

LOTTO_BET_SHARE_IMG_DATA['betFullDate'] = '12-11-2023';
LOTTO_BET_SHARE_IMG_DATA['betFullDateTime'] = '1-2-13';
LOTTO_BET_SHARE_IMG_DATA['stake'] = '$22';
LOTTO_BET_SHARE_IMG_DATA['returns'] = '$33';
LOTTO_BET_SHARE_IMG_DATA['betType'] = 'lotto';
LOTTO_BET_SHARE_IMG_DATA['imageObj'] = lottoImgObject;
LOTTO_BET_SHARE_IMG_DATA['betId'] = '67910';
LOTTO_BET_SHARE_IMG_DATA['msg1'] = 'its lotto msg';
...
export const USER_PREFERENCES = [
  {"name":"Total Returns","isSelected":false},
