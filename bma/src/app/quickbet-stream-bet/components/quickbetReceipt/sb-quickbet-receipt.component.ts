...
// import { QuickbetReceiptComponent } from '../quickbetReceipt/quickbet-receipt.component';
...
@Component({
  ...
  templateUrl: 'sb-quickbet-receipt.component.html',
  styleUrls: ['sb-quickbet-receipt.component.scss']
})
export class SbQuickbetReceiptComponent extends QuickbetReceiptComponent {
  ...
  constructor(
    ...
    super(user, filtersService, quickbetService, nativeBridge, window, pubSubService, http,
       ...
       fiveASideContestSelectionService, freeBetsService, gtmService, maxPayOutErrorService, locale, 
