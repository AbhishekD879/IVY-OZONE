export const SPORT_INPLAY = [
  {
    ...
    MARKETS_NAMES: {
      ...
      'Total Goals Over/Under 4.5': 'Total Goals Over/Under 4.5',
  ...
  },
  {
    ...
    MARKETS_NAME_ORDER: [
      ...
      'Next Game Winner', 'Current Set Games Total', 'Current Game Winner', 'Games Handicap', 'Correct Score'
    ],
    MARKETS_NAMES: {
      'Main Market': 'Main Markets',
      'Match Result': 'Match Result',
  ...
  },
  {
    ...
    MARKETS_NAME_ORDER: [
      'Money Line', 'Total Points', 'Spread', 'Half Total Points', 'Quarter Total Points', 'Money Line,Total Points,Spread'
    ],
    MARKETS_NAMES: {
      'Main Market': 'Main Markets',
