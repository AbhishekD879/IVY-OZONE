...
describe('OddsCardSportComponent', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('it should set correct header: true, true, true', () => {
    ...
    it('it should set correct header: false, false, false', () => {
    ...
    it('it should set correct header: false, true, false', () => {
      marketTypeService.isMatchResultType.and.returnValue(false);
      marketTypeService.isHomeDrawAwayType.and.returnValue(true);
      marketTypeService.isHeader2Columns.and.returnValue(false);
      component.ngOnInit();
    ...
    it('should set isSnooker as true', () => {
      component.event.categoryName = 'Snooker';
      component.ngOnInit();
      expect(component.isSnooker).toBeTrue();
    })
    ...
    it('should match the expression and push the matches names to eventList', () => {
      component.sportConfig = undefined;
      component.event = {
        name:"(12)/(23)",
        oddsCardHeaderType: 'homeDrawAwayType',
  ...
  describe('@watchHandler', () => {
    ...
    it('it should hide duplicate markets in events', () => {
      component.sportConfig = {
        config: {
          oddsCardHeaderType: '',
  ...
  describe('ngOnChanges', () => {
    ...
    it('should call watchHandler and calculateScores but not isShowMarketsCount ', () => {
      const changes = {
    ...
    it('should call watchHandler and isShowMarketsCount but not calculateScores', () => {
      const changes = {
        selectedMarketObject: {
  ...
  describe('getCorrectedOutcomes', () => {
    ...
    it('should subscribe on selectedMarketObject outcomes updates for odds sport', () => {
    ...
    it('should subscribe on event.markets first outcome updates for non odds sport', () => {
      ...
      component.event.markets = [
        {outcomes: [{id: 800}, {id: 801}, {id: 802}]},
        {outcomes: [undefined, {id: 901}, {id: 902}]}
      ] as any;
      component['getCorrectedOutcomes']();
  ...
  describe('subscribeOutcomeChanges', () => {
    ...
    describe('REMOVE_FROM_QUICKBET', () => {
      ...
      it('should change active to false', () => {
        selections = { outcomes: [{ id: 100 }], isAddToBetslip: false };
        component['subscribeOutcomeChanges'](outcomesLst);
      ...
      it('should not change active to false', () => {
        selections = { outcomes: [{ id: 200 }], isAddToBetslip: true };
        component['subscribeOutcomeChanges'](outcomesLst);
  ...
  describe('#showTemplate', () => {
   ...
   describe('goToSeo', () => {
     it('should create seo ', () => {
      ...
      component.goToSeo();
      expect(routingHelper.formEdpUrl).toHaveBeenCalledWith({});
      expect(seoDataService.eventPageSeo).toHaveBeenCalledWith({},'url');
      expect(router.navigateByUrl).toHaveBeenCalledWith('url');
    });
   });

  it('ga tracking for quick switch', () => {
    component.event = { name: 'Greuther Furth v Liverpool' } as any;
    component.eventQuickSwitch = true;
    component.gaTracking();
    const data = {
      ...
      'component.EventDetails': 'Greuther Furth v Liverpool'
    }
...
// TODO#################################################################################################################
// TODO#################################################################################################################
describe('LMOddsCardSportComponent', () => {
  let component: OddsCardSportComponent;
  ...
  let
    ...
    pubSubService, router, smartBoostsService, userService, commandService,
    windowRef, betSlipSelectionsData, priceOddsButtonService, routingState, gtmTrackingService, gtmService,
    favouritesService, sportsConfigService, scoreParserService, sportEventHelperService;
