...
describe('TableWidgetComponent', () => {
  ...
  beforeEach(() => {
    ...
    component = new TableWidgetComponent(commandService, pubSubService);
    component.params = {
      sportId: 16,
      typeId: 'string',
      classId: 'string'
  ...
  it('#ngOnInit', fakeAsync(() => {
    component['setSeasonIndex'] = jasmine.createSpy('setSeasonIndex').and.returnValue(0);
    component.ngOnInit();
    tick();
