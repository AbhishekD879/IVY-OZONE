...
import { SCOREBOARD_CONFIG, SCOREBOARDS_LOAD_ORDER } from '@coralDesktop/edp/components/sportEventMain/sport-event-main.constant';
...
export class DesktopSportEventMainComponent extends SportEventMainComponent implements OnInit {
  ...
  constructor(
    ...
    super(deviceService, activatedRoute, visEventService, visDataHandler,
      ...
      changeDetectorRef, scoreParserService, sportsConfigService, updateEventService, cashOutMapService, 
      cashoutWsConnectorService, storageService, sportEventHelperService);
  }
