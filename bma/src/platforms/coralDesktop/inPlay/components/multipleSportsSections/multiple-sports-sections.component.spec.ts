...
} from '@coralDesktop/inPlay/components/multipleSportsSections/multiple-sports-sections.component';
...
describe('MultipleSportsSectionsComponent', () => {
  ...
  let pubsubService, inPlayMainService, inPlayConnectionService, awsService, changeDetectorRef;
