...
@Component({
  ...
  templateUrl: '../../../../../app/lazy-modules/raceCard/raceCardContent/race-card-content.component.html',
...
export class CoralDesktopRaceCardContentComponent extends RaceCardContentComponent {}
