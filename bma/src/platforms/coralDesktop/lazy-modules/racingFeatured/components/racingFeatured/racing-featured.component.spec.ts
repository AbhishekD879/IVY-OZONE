...
describe('CDRacingFeaturedComponent', () => {
  let component;
  let locale;
  let filtersService;
  let windowRef;
  ...
  beforeEach(() => {
    ...
    component = new RacingFeaturedComponent(
      ...
      horseRacingService, greyhoundService, routingState, buildUtilityService, timeService,deviceService, bonusSuppressionService,vEPService
    );
  });
