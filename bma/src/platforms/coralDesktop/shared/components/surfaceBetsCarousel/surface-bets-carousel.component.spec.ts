...
import { SurfaceBetsCarouselComponent as
    AppSurfaceBetsCarouselComponent } from '@shared/components/surfaceBetsCarousel/surface-bets-carousel.component';
...
describe('DesktopSurfaceBetsCarouselComponent', () => {
  ...
  it('#ngOnInit should set initial values', () => {
    const superNgOnInitSpy = spyOn<any>(AppSurfaceBetsCarouselComponent.prototype, 'ngOnInit');
  ...
  it('#ngOnDestroy should call resizeListener', () => {
    const superNgOnDestroySpy = spyOn<any>(AppSurfaceBetsCarouselComponent.prototype, 'ngOnDestroy');
