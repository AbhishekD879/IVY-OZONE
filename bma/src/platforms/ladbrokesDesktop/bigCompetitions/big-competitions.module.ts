...
import { DesktopBigCompetitionComponent } from '@ladbrokesDesktop/bigCompetitions/components/big-competition.component';
import { BigCompetitionsRoutingModule } from '@ladbrokesDesktop/bigCompetitions/big-competitions-routing.module';
...
@NgModule({
  declarations: [
    // Overridden app components
    DesktopBigCompetitionComponent,
