...
export class FanzoneHomeDesktopComponent extends FanzoneAppHomeComponent {
  constructor(
    ...
    super(
      cms, navigationService, dynamicComponentLoader, routingState, fanzoneModuleService,
      pubsub, changeDetectorRef, wsUpdateEventService, templateService, commentsService, router, route, fanzoneStorageService,
      fanzoneHelperService, fanzoneSharedService, gtmService, device, user, bonusSuppression, dialogService, componentFactoryResolver, fanzoneGamesService, windowRefService, storageService);
  }
}
