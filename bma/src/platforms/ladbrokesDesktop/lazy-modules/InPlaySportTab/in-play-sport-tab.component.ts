...
export class InPlaySportTabComponent implements OnInit, OnDestroy, OnChanges {
  ...
  private processInitialData(): void {
    this.eventsBySports && this.eventsBySports.forEach((competitionSection: ISportSegment, competitionIndex: number) => {
   ...
   * @param {ISportSegment} competitionSection
   * @param {Number} index
   */
