...
describe('RetailPageComponent', () => {
  ...
  describe('configUpgradeButton', () => {
    ...
    it('for inShopUser', () => {
      ...
      cmsService.getSystemConfig.and.returnValue(observableOf({ Connect: { upgrade: true } }));
      component['configUpgradeButton']();
      expect(component['getUpgradeButtonStaticBlock']).toHaveBeenCalledWith(UPGRADE_ACCOUNT_DIALOG.inshopUpgrade.inshopGrid);
    });
    ...
    it('for online users', () => {
      ...
      cmsService.getSystemConfig.and.returnValue(observableOf({ Connect: { upgrade: true } }));
      component['configUpgradeButton']();
      expect(component['getUpgradeButtonStaticBlock']).toHaveBeenCalledWith(UPGRADE_ACCOUNT_DIALOG.onlineUpgrade.onlineGrid);
    });
  });

  describe('getUpgradeButtonStaticBlock', () => {
    it('should call cmsService.getStaticBlock', () => {
      component['getUpgradeButtonStaticBlock']('inshop-upgrade-grid');
