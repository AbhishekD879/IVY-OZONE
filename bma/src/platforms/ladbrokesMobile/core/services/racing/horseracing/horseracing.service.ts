...
import { ladbrokesHorseracingConfig } from '../config/horseracing.config';
...
@Injectable()
export class HorseracingService extends RacingService {
  constructor(
    ...
    super.setConfig(ladbrokesHorseracingConfig);
  }
}
