...
@Component({
  ...
  templateUrl: '../../../../../app/quickbet-stream-bet/components/quickbetPanel/sb-quickbet-panel.component.html',
  styleUrls: ['../../../../../app/quickbet-stream-bet/components/quickbetPanel/sb-quickbet-panel.component.scss'],
  // eslint-disable-next-line
  encapsulation: ViewEncapsulation.None
})
export class SbQuickbetPanelComponent extends LadbrokesQuickbetPanelComponent {
