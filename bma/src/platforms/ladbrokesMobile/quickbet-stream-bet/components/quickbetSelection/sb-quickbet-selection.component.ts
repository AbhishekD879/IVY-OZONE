...
@Component({
  ...
  templateUrl: '../../../../../app/quickbet-stream-bet/components/quickbetSelection/sb-quickbet-selection.component.html',
  styleUrls: ['../../../../../app/quickbet-stream-bet/components/quickbetSelection/sb-quickbet-selection.component.scss']
})

export class SbQuickbetSelectionComponent extends LadbrokesQuickbetSelectionComponent {
