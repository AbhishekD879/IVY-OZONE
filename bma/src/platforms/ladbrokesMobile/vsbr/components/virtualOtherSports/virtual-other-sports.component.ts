...
@Component({
    ...
    templateUrl: './../../../../../app/vsbr/components/virtualOtherSports/virtual-other-sports.component.html',
    styleUrls: ['./virtual-other-sports.component.scss']
})

export class MobileVirtualOtherSports extends VirtualOtherSports{
    constructor(
