...
class MatchHandicapMarket(BaseMarketEntity):

    def __init__(self, **kwargs):
        super(MatchHandicapMarket, self).__init__(**kwargs)
        ...
        self.market_display_sort_code = 'MH'
    ...
    def _generate_params(self):
        return ((f'name_{self.market_template_id}_{self.market_display_sort_code}', self.market_name),
                ...
                (f'hc_{self.market_template_id}_{self.market_display_sort_code}', self.handicap),
