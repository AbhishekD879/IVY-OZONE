...
class AuthenticationApi(object):
    ...
    def login(self, body, **kwargs):  # noqa: E501
        ...
        Allow users to log in, and to receive a JWT   # noqa: E501
        ...
        :param Login body: username/password (required)
    ...
    def refresh_token(self, body, **kwargs):  # noqa: E501
        ...
        Generate new token with the help of the refreshToken if the previous jwt token has been expired   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param TokenRequest body: refreshToken value (required)
    ...
    def refresh_token_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TokenResponse2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
