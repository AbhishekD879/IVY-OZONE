...
@vtest
class Test_C34181747_Header_bar_stick_to_top_if_user_added_some_selection_after_scrolling(Common):
    """
    TR_ID: C34181747
    NAME: Header bar stick to top if user added some selection after scrolling
    ...
    def test_001_start_the_app_scroll_down_and_add_some_selection_to_betslip(self):
        """
        DESCRIPTION: Start the app scroll down and add some selection to betslip
        EXPECTED: App main screen appears with scrolled header bar
        """
        pass
    ...
    def test_008_unset_selection_and_scroll_to_the_top(self):
        """
        DESCRIPTION: Unset selection and scroll to the top
        EXPECTED: Initial Header bar is shown
        """
        pass
