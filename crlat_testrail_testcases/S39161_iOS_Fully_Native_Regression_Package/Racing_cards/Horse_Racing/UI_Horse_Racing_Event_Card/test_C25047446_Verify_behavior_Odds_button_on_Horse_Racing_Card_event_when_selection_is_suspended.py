...
@pytest.mark.races
@vtest
class Test_C25047446_Verify_behavior_Odds_button_on_Horse_Racing_Card_event_when_selection_is_suspended(Common):
    """
    TR_ID: C25047446
    NAME: Verify behavior Odds button on Horse Racing Card event when selection is  suspended
    ...
    def test_001_the_selection_case_was_emulated_for_the_horse_racing_event(self):
        """
        DESCRIPTION: The selection case was emulated for the Horse Racing Event
        EXPECTED: * selection on the Horse Racing Event card is suspended
