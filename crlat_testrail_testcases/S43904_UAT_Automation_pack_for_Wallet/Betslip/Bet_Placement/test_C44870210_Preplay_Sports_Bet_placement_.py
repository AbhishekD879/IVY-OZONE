...
@pytest.mark.betslip
@vtest
class Test_C44870210_Preplay_Sports_Bet_placement_(Common):
    """
    TR_ID: C44870210
    ...
    def test_004_go_to_football_preplay_event_make_a_selection_and_add_to_betslip(self):
        """
    ...
    def test_005_verify_selection_details_in_betslip(self):
        ...
        EXPECTED: Odds
        EXPECTED: Stake box
        EXPECTED: Potential returns etc are displayed in betslip
        """
        pass
