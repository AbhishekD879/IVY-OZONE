...
class Test_C44870421_Verify_Tote_UK_International_Results(Common):
    ...
    def test_003_click_on_results(self):
        ...
        EXPECTED: User is displayed list of International Tote meetings available for the day 'By Latest Results' selected by default.
        EXPECTED: options (By latest results & By meetings) are available.
        """
        pass
