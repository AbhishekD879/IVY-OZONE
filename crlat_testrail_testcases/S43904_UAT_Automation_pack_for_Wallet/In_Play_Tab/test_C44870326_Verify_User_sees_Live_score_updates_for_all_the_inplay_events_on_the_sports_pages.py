...
class Test_C44870326_Verify_User_sees_Live_score_updates_for_all_the_inplay_events_on_the_sports_pages(Common):
    ...
    def test_006_repeat_step_2_to_5_for_sportstennis_with_servebasketball(self):
        """
        DESCRIPTION: Repeat step #2 to #5 for sports
        DESCRIPTION: Tennis (With serve),Basketball
        EXPECTED: 
        """
        pass
