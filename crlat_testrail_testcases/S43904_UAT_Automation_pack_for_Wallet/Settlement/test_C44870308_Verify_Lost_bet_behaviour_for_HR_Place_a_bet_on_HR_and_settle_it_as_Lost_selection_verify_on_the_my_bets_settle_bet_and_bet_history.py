...
@pytest.mark.betslip
@vtest
class Test_C44870308_Verify_Lost_bet_behaviour_for_HR_Place_a_bet_on_HR_and_settle_it_as_Lost_selection_verify_on_the_my_bets_settle_bet_and_bet_history(Common):
    """
    TR_ID: C44870308
