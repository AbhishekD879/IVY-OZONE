...
class Test_C44870247_Verify_user_can_navigate_to_Account_MY_ACCAs_page_Check_user_can_see_the_placed_ACCA_bets_Check_EDIT_MY_BET_onboarding_popup_and_features_Perform_edit_my_bet_and_check_confirm_Cancel_features____When_Edited___The_ACCA_edited_s(Common):
    ...
    def test_005_click_on_edit_my_bet_click_on_the_x_for_one_selection_and_then_click_on_the_betslip_in_the_tab_bar_verify_that_you_see_the_do_you_want_to_cancel_editing_pop_up_and_it_should_have_the_buttons_cancel_edit_and_continue_editing_buttons_and_they_should_work(self):
        """
        DESCRIPTION: Click on Edit My BET, click on the X for one selection and then click on the "BETSLIP" in the tab bar. Verify that you see the "Do you want to cancel editing?" pop up and it should have the buttons Cancel Edit and Continue Editing buttons and they should work
