...
@pytest.mark.betslip
@vtest
class Test_C59898445_Single_Football_Bet_Countered_by_Stake(Common):
    """
    TR_ID: C59898445
    ...
    def test_001_add_football_selection_to_quick_betbetsliptrigger_overask__try_to_place_bet_with_higher_stake_than_a_max_allowed_stake(self):
        """
