...
@pytest.mark.betslip
@vtest
class Test_C59898446_Single_Tennis_Bet_Countered_by_Price(Common):
    """
    TR_ID: C59898446
    ...
    def test_001_add_tennis_selection_to_quick_betbetsliptrigger_overask_try_to_place_bet_with_higher_stake_than_a_max_allowed_stake(self):
        """
