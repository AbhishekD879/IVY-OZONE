...
@pytest.mark.betslip
@vtest
class Test_C59898447_Single_Football_Outright_Bet_Countered_from_EW_to_Win_Only(Common):
    """
    TR_ID: C59898447
    ...
    def test_001_add_football_selection_to_quick_betbetsliptrigger_overask__select_ew_checkbox_and_try_to_place_bet_with_higher_stake_than_a_max_allowed_stake(self):
        """
