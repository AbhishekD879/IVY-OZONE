...
@pytest.mark.betslip
@vtest
class Test_C59898478_Single_bet_is_split_into_2_singles_part_of_the_stake_is_offered_at_one_LP_price_and_the_rest_of_it_at_another_LP_priceUnlinked(Common):
    """
    TR_ID: C59898478
    NAME: Single bet is split into 2 singles: part of the stake is offered at one LP price and the rest of it at another LP price.(Unlinked)
    DESCRIPTION: 
    ...
    def test_002_split_the_single_bet_into_2_1st_part_of_the_stake_is_offered_at_original_lp_and_2nd_part_at_another_lpunlinked(self):
        """
        DESCRIPTION: Split the single bet into 2: 1st part of the stake is offered at original LP and 2nd part at another LP.(Unlinked)
    ...
    def test_004_if_customer_accepts__the_offer_without_removing_any_single(self):
        """
    ...
    def test_006_split_the_single_bet_into_2_1st_part_of_the_stake_is_offered_at_another_lp_and_the_2nd_part_at_original_lpunlinked(self):
        """
        DESCRIPTION: Split the single bet into 2: 1st part of the stake is offered at another LP and the 2nd part at original LP.(Unlinked)
        EXPECTED: Customer should see in the counter offer for 2 singles, with the stakes being highlighted for both the selections
        EXPECTED: Customer is able to accept, remove one of the offers, or decline the counter offer.
        """
        pass
