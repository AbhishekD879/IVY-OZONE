...
@pytest.mark.sports
@vtest
class Test_C60075290_Verify_Market_Selector_dropdown_list_on_Boxing_Competitions_page(Common):
    """
    TR_ID: C60075290
    NAME: Verify 'Market Selector' dropdown list on Boxing Competitions page
