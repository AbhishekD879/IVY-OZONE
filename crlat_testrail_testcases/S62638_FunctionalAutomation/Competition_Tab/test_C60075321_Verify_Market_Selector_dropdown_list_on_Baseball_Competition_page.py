...
@pytest.mark.sports
@vtest
class Test_C60075321_Verify_Market_Selector_dropdown_list_on_Baseball_Competition_page(Common):
    """
    TR_ID: C60075321
    NAME: Verify 'Market Selector' dropdown list on Baseball Competition page
