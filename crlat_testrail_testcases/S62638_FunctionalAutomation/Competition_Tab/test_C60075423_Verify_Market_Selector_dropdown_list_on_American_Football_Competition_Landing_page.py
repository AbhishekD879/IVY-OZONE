...
@pytest.mark.sports
@vtest
class Test_C60075423_Verify_Market_Selector_dropdown_list_on_American_Football_Competition_Landing_page(Common):
    """
    TR_ID: C60075423
    NAME: Verify 'Market Selector' dropdown list on American Football Competition Landing page
