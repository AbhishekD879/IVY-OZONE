...
@pytest.mark.sports
@vtest
class Test_C60075424_Verify_Market_Selector_sticky_behavior_on_American_Football_Competition_Landing_page(Common):
    """
    TR_ID: C60075424
    NAME: Verify 'Market Selector'  sticky behavior on American Football Competition Landing page
