...
@pytest.mark.sports
@vtest
class Test_C60075443_Verify_Market_Selector_dropdown_list_on_Rugby_Union_Competition_page(Common):
    """
    TR_ID: C60075443
    NAME: Verify 'Market Selector' dropdown list on Rugby Union  Competition page
