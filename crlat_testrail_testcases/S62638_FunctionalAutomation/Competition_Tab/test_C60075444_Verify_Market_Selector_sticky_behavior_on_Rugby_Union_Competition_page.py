...
@pytest.mark.sports
@vtest
class Test_C60075444_Verify_Market_Selector_sticky_behavior_on_Rugby_Union_Competition_page(Common):
    """
    TR_ID: C60075444
    NAME: Verify 'Market Selector'  sticky behavior on Rugby Union  Competition  page
