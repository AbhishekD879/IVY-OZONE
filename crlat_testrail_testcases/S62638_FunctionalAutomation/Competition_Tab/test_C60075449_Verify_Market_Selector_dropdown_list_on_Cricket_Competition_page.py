...
@pytest.mark.sports
@vtest
class Test_C60075449_Verify_Market_Selector_dropdown_list_on_Cricket_Competition_page(Common):
    """
    TR_ID: C60075449
    NAME: Verify 'Market Selector' dropdown list on Cricket Competition page
    ...
    PRECONDITIONS: 2. Go to the Cricket Competition page -> 'Matches' tab
    PRECONDITIONS: **Note:**
