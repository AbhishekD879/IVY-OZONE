...
@pytest.mark.sports
@vtest
class Test_C60075491_Verify_Market_Selector_sticky_behavior_on_Baseball_Competition_page(Common):
    """
    TR_ID: C60075491
    NAME: Verify 'Market Selector'  sticky behavior on Baseball Competition page
