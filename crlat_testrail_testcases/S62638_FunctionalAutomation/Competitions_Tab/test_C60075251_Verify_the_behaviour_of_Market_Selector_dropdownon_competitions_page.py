...
@pytest.mark.sports
@vtest
class Test_C60075251_Verify_the_behaviour_of_Market_Selector_dropdownon_competitions_page(Common):
    """
    TR_ID: C60075251
    NAME: Verify the behaviour of 'Market Selector' dropdownon competitions page
