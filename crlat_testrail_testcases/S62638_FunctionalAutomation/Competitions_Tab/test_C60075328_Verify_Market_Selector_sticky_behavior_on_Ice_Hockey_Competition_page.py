...
@pytest.mark.sports
@vtest
class Test_C60075328_Verify_Market_Selector_sticky_behavior_on_Ice_Hockey_Competition_page(Common):
    """
    TR_ID: C60075328
    NAME: Verify 'Market Selector'  sticky behavior on Ice Hockey Competition page
