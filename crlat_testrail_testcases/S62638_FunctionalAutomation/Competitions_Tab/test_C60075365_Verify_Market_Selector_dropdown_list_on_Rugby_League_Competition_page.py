...
@pytest.mark.sports
@vtest
class Test_C60075365_Verify_Market_Selector_dropdown_list_on_Rugby_League_Competition_page(Common):
    """
    TR_ID: C60075365
    NAME: Verify 'Market Selector' dropdown list on Rugby League Competition page
