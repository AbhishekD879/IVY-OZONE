...
@pytest.mark.sports
@vtest
class Test_C60075534_Verify_Market_Selector_sticky_behavior_on_Rugby_League_Competition_page(Common):
    """
    TR_ID: C60075534
    NAME: Verify 'Market Selector'  sticky behavior on Rugby League  Competition  page
