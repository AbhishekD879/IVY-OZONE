...
@pytest.mark.sports
@vtest
class Test_C60075241_Verify_previously_selected_option_state_is_saved_in_Market_Selector_after_switching_between_Today_Tomorrow_Future_tabs_on_Football_landing_page(Common):
    """
    TR_ID: C60075241
