...
@pytest.mark.sports
@vtest
class Test_C60075390_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Specific_Competition_Page(Common):
    """
    TR_ID: C60075390
    NAME: Verify  the behaviour of ‘Handicap WW market’ Template  in Specific Competition Page
