...
@pytest.mark.sports
@vtest
class Test_C60075392_Verify_previously_selected_Handicap_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_American_Football_Landing_Page(Common):
    """
    TR_ID: C60075392
    NAME: Verify previously selected ‘Handicap WW Market’ Template is saved when user is switching between Today/Tomorrow/Future on American Football  Landing Page
    ...
    def test_002_select_handicap_in_the_market_selector_dropdown_listhandicap_in_lads_and_spread_in_coral(self):
        """
    ...
    def test_003_verify_text_of_the_labels_for_handicap_in_matches_tabtodayhandicap_in_lads_and_spread_in_coral(self):
        """
    ...
    def test_010_repeat_step_1_9_for_the_below_markettotal_pointsexcept_step3(self):
        """
