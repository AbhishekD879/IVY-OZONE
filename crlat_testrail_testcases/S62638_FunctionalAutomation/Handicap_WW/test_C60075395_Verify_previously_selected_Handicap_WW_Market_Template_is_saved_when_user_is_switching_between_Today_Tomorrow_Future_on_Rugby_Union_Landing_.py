...
@pytest.mark.sports
@vtest
class Test_C60075395_Verify_previously_selected_Handicap_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Rugby_Union_Landing_Page(Common):
    """
    TR_ID: C60075395
