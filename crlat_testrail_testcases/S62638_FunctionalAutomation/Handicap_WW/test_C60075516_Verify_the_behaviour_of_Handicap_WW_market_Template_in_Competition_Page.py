...
@pytest.mark.sports
@vtest
class Test_C60075516_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Competition_Page(Common):
    """
    TR_ID: C60075516
    ...
    def test_007_verify_ga_tracking_for_the_puck_line(self):
        """
