...
@pytest.mark.sports
@vtest
class Test_C60075521_Verify_previously_selected_Handicap_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Cricket_Landing_Page(Common):
    """
    TR_ID: C60075521
    NAME: Verify previously selected ‘Handicap WW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Cricket Landing Page
    ...
    def test_008_verify_text_of_the_labels_for_handicap_in_matches_tab(self):
        """
