...
@pytest.mark.sports
@vtest
class Test_C60075556_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Matches_Tab(Common):
    """
    TR_ID: C60075556
    ...
    def test_008_repeat_steps_3_7_for_the_below_market_home_team_total_points_away_team_total_points_handicap_except_step_4(self):
        """
