...
@pytest.mark.sports
@vtest
class Test_C60075558_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Inplay_Tab(Common):
    """
    TR_ID: C60075558
    NAME: Verify the behaviour of ‘Handicap WW market’ Template in Inplay Tab
