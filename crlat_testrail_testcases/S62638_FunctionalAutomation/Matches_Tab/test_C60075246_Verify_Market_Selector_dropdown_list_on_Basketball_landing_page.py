...
@pytest.mark.sports
@vtest
class Test_C60075246_Verify_Market_Selector_dropdown_list_on_Basketball_landing_page(Common):
    """
    TR_ID: C60075246
    NAME: Verify 'Market Selector' dropdown list on Basketball landing page
    ...
    def test_005_select_total_points_in_the_market_selector_dropdown_list(self):
        """
    ...
    def test_006_repeat_step_3_for_the_following_markets_money_line_handicap_handicap_in_lads_and_spread_in_coral_home_team_total_points_away_team_total_points(self):
        """
