...
@pytest.mark.sports
@vtest
class Test_C60075271_Verify_Market_Selector_dropdown_list_on_Rugby_Union_landing_page(Common):
    """
    TR_ID: C60075271
    NAME: Verify 'Market Selector' dropdown list on Rugby Union landing page
    ...
    def test_006_repeat_step_2_for_the_following_markets_handicap_2_wayhandicap_total_points(self):
        """
