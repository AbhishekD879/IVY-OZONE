...
@pytest.mark.sports
@vtest
class Test_C60075310_Verify_Market_Selector_dropdown_list_behavior_in_Matches_Tab(Common):
    """
    TR_ID: C60075310
    NAME: Verify 'Market Selector' dropdown list behavior in Matches Tab
