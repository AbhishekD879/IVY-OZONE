...
@pytest.mark.sports
@vtest
class Test_C60075360_Verify_previously_selected_option_state_is_saved_in_Market_Selector_after_switching_between_Today_Tomorrow_Future_tabs_on_Rugby_League_landing_page(Common):
    """
    TR_ID: C60075360
    NAME: Verify previously selected option state is saved in 'Market Selector' after switching between Today/Tomorrow/Future tabs on Rugby League landing page
    DESCRIPTION: This test case verifies that previously selected option state is saved in 'Market Selector' after switching between Today/Tomorrow/Future tabs on Rugby League landing page
    ...
    def test_003_switch_to_the_tomorrow_tab(self):
        ...
        EXPECTED: Note:
        EXPECTED: If events are not present for Match Result market and if events are present for either Handicap 2-way or Total Points markets then those markets will be displayed in the switcher (Same logic applies to Today/Tomorrow/Future Tabs)
    ...
    def test_005_repeat_steps_1_7_for_the_below_markets_handicap_2_way_total_points(self):
        """
