...
@pytest.mark.sports
@vtest
class Test_C60075375_Verify_Market_Selector_sticky_behavior_in_Matches_tab_in_Ice_Hockey_landing_page(Common):
    """
    TR_ID: C60075375
    NAME: Verify 'Market Selector'  sticky behavior in Matches tab in Ice Hockey landing page
