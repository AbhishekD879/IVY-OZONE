...
@pytest.mark.sports
@vtest
class Test_C60075442_Verify_the_behavior_of_the_market_drop_down_list(Common):
    """
    TR_ID: C60075442
    NAME: Verify the behavior of the market drop down list
    DESCRIPTION: This test case verifies the behavior of the market drop down list
    ...
    PRECONDITIONS: 2. Go to the Rugby Union & League Landing page -> 'Matches' tab
    PRECONDITIONS: Note:
    ...
    def test_004_click_on_the_market_which_is_higlighted(self):
        ...
        EXPECTED: Selected markets should be displayed
        """
        pass
