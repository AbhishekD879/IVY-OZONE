...
@pytest.mark.sports
@vtest
class Test_C60075336_Verify_WDW_market_Template_is_displaying_by_default_for_Rugby_Union_Landing_Page_on_Matches_Tab_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075336
    NAME: Verify ‘WDW market’ Template is displaying by default for Rugby Union Landing Page on Matches Tab under Market Selector Dropdown
