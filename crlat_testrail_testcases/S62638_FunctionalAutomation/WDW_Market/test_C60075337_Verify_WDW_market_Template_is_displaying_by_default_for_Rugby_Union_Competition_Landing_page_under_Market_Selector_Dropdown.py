...
@pytest.mark.sports
@vtest
class Test_C60075337_Verify_WDW_market_Template_is_displaying_by_default_for_Rugby_Union_Competition_Landing_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075337
    NAME: Verify ‘WDW market’ Template is displaying by default for Rugby Union Competition Landing page  under Market Selector Dropdown
