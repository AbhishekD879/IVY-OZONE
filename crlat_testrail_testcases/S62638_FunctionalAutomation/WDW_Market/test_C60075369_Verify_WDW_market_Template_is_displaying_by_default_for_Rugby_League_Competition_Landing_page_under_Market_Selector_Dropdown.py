...
@pytest.mark.sports
@vtest
class Test_C60075369_Verify_WDW_market_Template_is_displaying_by_default_for_Rugby_League_Competition_Landing_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075369
    NAME: Verify ‘WDW market’ Template is displaying by default for Rugby League Competition Landing page  under Market Selector Dropdown
    DESCRIPTION: This test case verifies displaying of ‘WDW market’ Template is displaying by default for Rugby League Competition Landing page under Market Selector Dropdown
    ...
    PRECONDITIONS: * |Match Betting(WDW)| - "Match Betting"
