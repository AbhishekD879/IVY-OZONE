...
@pytest.mark.sports
@vtest
class Test_C60075386_Verify_the_behaviour_of_WDW_market_Template_on_Competitions_Tab_for_Golf(Common):
    """
    TR_ID: C60075386
    NAME: Verify the behaviour of  ‘WDW market’ Template on Competitions Tab for Golf
