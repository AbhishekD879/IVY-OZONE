...
@pytest.mark.sports
@vtest
class Test_C60075509_Verify_previously_selected_WDW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Cricket_Landing_page(Common):
    """
    TR_ID: C60075509
    NAME: Verify previously selected ‘WDW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Cricket Landing page
