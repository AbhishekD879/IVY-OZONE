...
@pytest.mark.sports
@vtest
class Test_C60075530_Verify_the_behaviour_of_WDW_market_Template_on_Matches_Tab_for_Darts(Common):
    """
    TR_ID: C60075530
    NAME: Verify  the behaviour of ‘WDW market’ Template on Matches Tab for Darts
