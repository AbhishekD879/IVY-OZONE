...
@pytest.mark.sports
@vtest
class Test_C60075532_Verify_the_behaviour_of_WDW_market_Template_on_Competitions_Tab_for_Darts(Common):
    """
    TR_ID: C60075532
    NAME: Verify the behaviour of ‘WDW market’ Template on Competitions Tab for Darts
