...
@pytest.mark.sports
@vtest
class Test_C60075305_Verify_the_behaviour_of_WW_market_Template_on_Matches_Tab_for_Darts(Common):
    """
    TR_ID: C60075305
    NAME: Verify  the behaviour of ‘WW market’ Template on Matches Tab for Darts
