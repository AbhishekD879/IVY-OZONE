...
@pytest.mark.sports
@vtest
class Test_C60075317_Verify_WW_market_Template_is_displaying_while_changing_the_markets_in_the_Market_Switcher_dropdown_on_Snooker_Competition_Page(Common):
    """
    TR_ID: C60075317
