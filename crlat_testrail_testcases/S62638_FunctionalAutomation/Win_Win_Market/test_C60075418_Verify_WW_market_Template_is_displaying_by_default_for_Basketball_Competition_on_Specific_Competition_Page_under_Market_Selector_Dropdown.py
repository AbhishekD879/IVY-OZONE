...
@pytest.mark.sports
@vtest
class Test_C60075418_Verify_WW_market_Template_is_displaying_by_default_for_Basketball_Competition_on_Specific_Competition_Page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075418
