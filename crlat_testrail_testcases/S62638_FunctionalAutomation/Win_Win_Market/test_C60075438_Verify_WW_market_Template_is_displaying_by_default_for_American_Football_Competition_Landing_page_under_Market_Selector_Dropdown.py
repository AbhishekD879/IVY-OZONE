...
@pytest.mark.sports
@vtest
class Test_C60075438_Verify_WW_market_Template_is_displaying_by_default_for_American_Football_Competition_Landing_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075438
