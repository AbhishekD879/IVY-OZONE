...
@pytest.mark.sports
@vtest
class Test_C60075453_Verify_previously_selected_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Cricket_landing_page(Common):
    """
    TR_ID: C60075453
    NAME: Verify previously selected ‘WW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Cricket landing page
