...
@pytest.mark.sports
@vtest
class Test_C60075454_Verify_WW_market_Template_is_displaying_by_default_for_Cricket_Competition_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075454
    NAME: Verify ‘WW market’ Template is displaying by default for  Cricket Competition page  under Market Selector Dropdown
