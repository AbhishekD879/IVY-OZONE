...
@pytest.mark.sports
@vtest
class Test_C60075485_Verify_previously_selected_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Snooker_landing_page(Common):
    """
    TR_ID: C60075485
    NAME: Verify previously selected ‘WW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Snooker  landing page
