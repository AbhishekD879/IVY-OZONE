...
@pytest.mark.sports
@vtest
class Test_C60075493_Verify_WW_market_Template_is_displaying_by_default_for_Baseball_Landing_Page_on_Matches_Tab_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075493
    NAME: Verify ‘WW market’ Template is displaying by default for Baseball Landing Page on Matches Tab under Market Selector Dropdown
