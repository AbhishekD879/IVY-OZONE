...
@pytest.mark.sports
@vtest
class Test_C60075499_Verify_WW_market_Template_is_displaying_by_default_for_Ice_hockey_Landing_Page_on_Matches_Tab_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60075499
    NAME: Verify ‘WW market’ Template is displaying by default for Ice hockey Landing Page on Matches Tab under Market Selector Dropdown
    DESCRIPTION: This test case verifies displaying of ‘WW market’ Template is displaying by default for Ice hockey Landing Page on Matches Tab under Market Selector Dropdown
