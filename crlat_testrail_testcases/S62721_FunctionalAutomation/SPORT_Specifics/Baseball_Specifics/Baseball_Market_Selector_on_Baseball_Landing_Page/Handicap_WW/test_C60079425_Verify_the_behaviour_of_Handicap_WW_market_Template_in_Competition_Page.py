...
@pytest.mark.sports
@vtest
class Test_C60079425_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Competition_Page(Common):
    """
    TR_ID: C60079425
    NAME: Verify  the behaviour of ‘Handicap WW market’ Template  in Competition Page
    ...
    def test_005_verify_text_of_the_labels_for_run_line(self):
        """
