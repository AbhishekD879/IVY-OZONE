...
@pytest.mark.sports
@vtest
class Test_C60079393_Verify_Market_Selectorin_Matches_tab_on_Baseball_landing_page(Common):
    """
    TR_ID: C60079393
    NAME: Verify 'Market Selector'in Matches tab on Baseball landing page
