...
@pytest.mark.sports
@vtest
class Test_C60079401_Verify_WW_market_Template_is_displaying_by_default_for_Baseball_Competition_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60079401
    NAME: Verify ‘WW market’ Template is displaying by default for Baseball  Competition page  under Market Selector Dropdown
    DESCRIPTION: This test case verifies displaying of ‘WW market’ Template is displaying by default for Baseball Competition page under Market Selector Dropdown
    ...
    PRECONDITIONS: 2. Go to the Baseball Landing Page -> 'Click on Competitions Tab'
    PRECONDITIONS: Note:
