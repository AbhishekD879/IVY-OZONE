...
@pytest.mark.sports
@vtest
class Test_C60079267_Verify_Basketball_US_Live_Scores_Displaying_when_Score_was_Changed_for_HOME_AWAY_Team(Common):
    """
    TR_ID: C60079267
    NAME: Verify Basketball US Live Scores Displaying when Score was Changed for HOME/AWAY Team
    DESCRIPTION: This test case verifies Basketball US Live Scores Displaying when Score was Changed for HOME/AWAY Team
    ...
    def test_010_verify_score_change_before_application_is_opened(self):
        """
