...
@pytest.mark.sports
@vtest
class Test_C60079316_Verify_Market_Selector_sticky_behavior_on_Basketball_landing_page(Common):
    """
    TR_ID: C60079316
    NAME: Verify 'Market Selector'  sticky behavior on Basketball landing page
