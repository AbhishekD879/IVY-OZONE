...
@pytest.mark.sports
@vtest
class Test_C60079253_Verify_Events_Grouping(Common):
    """
    TR_ID: C60079253
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Basketball=6)
    PRECONDITIONS: *   X.XX - current supported version of OpenBet release
    PRECONDITIONS: *   ZZ - dispSortName specific value for each Sport, shows the primary marker (e.g. Basketball-HH).
    PRECONDITIONS: *   LL - language (e.g. en, ukr)
