...
@pytest.mark.sports
@vtest
class Test_C60079366_Verify_Market_Selector_sticky_behavior_on_Boxing_Competitions_page(Common):
    """
    TR_ID: C60079366
    NAME: Verify 'Market Selector'  sticky behavior on Boxing Competitions page
