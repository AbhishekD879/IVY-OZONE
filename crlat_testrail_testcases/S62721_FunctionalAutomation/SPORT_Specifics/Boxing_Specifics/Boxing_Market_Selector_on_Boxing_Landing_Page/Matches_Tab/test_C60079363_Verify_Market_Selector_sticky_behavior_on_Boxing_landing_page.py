...
@pytest.mark.sports
@vtest
class Test_C60079363_Verify_Market_Selector_sticky_behavior_on_Boxing_landing_page(Common):
    """
    TR_ID: C60079363
    NAME: Verify 'Market Selector'  sticky behavior on Boxing  landing page
