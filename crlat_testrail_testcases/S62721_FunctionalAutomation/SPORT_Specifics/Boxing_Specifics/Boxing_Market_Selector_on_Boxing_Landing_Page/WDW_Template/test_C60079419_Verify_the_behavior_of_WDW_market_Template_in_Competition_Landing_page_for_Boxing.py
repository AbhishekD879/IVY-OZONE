...
@pytest.mark.sports
@vtest
class Test_C60079419_Verify_the_behavior_of_WDW_market_Template_in_Competition_Landing_page_for_Boxing(Common):
    """
    TR_ID: C60079419
    NAME: Verify  the behavior of ‘WDW market’ Template in  Competition Landing page for Boxing
