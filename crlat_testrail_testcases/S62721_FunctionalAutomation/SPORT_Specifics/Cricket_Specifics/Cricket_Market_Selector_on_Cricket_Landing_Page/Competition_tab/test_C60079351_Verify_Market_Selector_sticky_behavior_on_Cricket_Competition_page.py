...
@pytest.mark.sports
@vtest
class Test_C60079351_Verify_Market_Selector_sticky_behavior_on_Cricket_Competition_page(Common):
    """
    TR_ID: C60079351
    NAME: Verify 'Market Selector'  sticky behavior on Cricket Competition page
