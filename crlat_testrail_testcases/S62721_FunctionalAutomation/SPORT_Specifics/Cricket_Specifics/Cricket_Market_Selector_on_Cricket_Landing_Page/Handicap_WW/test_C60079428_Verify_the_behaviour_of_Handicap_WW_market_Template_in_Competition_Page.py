...
@pytest.mark.sports
@vtest
class Test_C60079428_Verify_the_behaviour_of_Handicap_WW_market_Template_in_Competition_Page(Common):
    """
    TR_ID: C60079428
    ...
    def test_008_repeat_3_7_steps_for_the_below_markets_next_over_runs_team_runs_runs_at_fall_of_next_wicket(self):
        """
