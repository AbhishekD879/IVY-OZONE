...
@pytest.mark.sports
@vtest
class Test_C60079348_Verify_Market_Selector_sticky_behavior_on_Cricket_landing_page(Common):
    """
    TR_ID: C60079348
    NAME: Verify 'Market Selector'  sticky behavior on Cricket landing page
