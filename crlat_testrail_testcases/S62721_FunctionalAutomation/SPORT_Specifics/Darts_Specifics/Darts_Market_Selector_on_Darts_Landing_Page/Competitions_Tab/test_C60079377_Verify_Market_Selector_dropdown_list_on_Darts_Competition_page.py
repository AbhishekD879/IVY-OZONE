...
@pytest.mark.sports
@vtest
class Test_C60079377_Verify_Market_Selector_dropdown_list_on_Darts_Competition_page(Common):
    """
    TR_ID: C60079377
    NAME: Verify 'Market Selector' dropdown list on Darts Competition page
