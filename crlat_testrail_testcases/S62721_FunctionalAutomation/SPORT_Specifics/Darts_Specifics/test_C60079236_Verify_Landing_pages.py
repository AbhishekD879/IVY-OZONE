...
@pytest.mark.sports
@vtest
class Test_C60079236_Verify_Landing_pages(Common):
    """
    TR_ID: C60079236
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Darts=13)
    ...
    def test_005_verify_events_order_in_the_leagues__competitions_section(self):
        """
        DESCRIPTION: Verify events order in the 'Leagues & Competitions' section
