...
@pytest.mark.sports
@vtest
class Test_C60079372_Verify_Market_Selector_sticky_behavior_on_Golf_Competitions_page(Common):
    """
    TR_ID: C60079372
    NAME: Verify 'Market Selector'  sticky behavior on Golf Competitions page
