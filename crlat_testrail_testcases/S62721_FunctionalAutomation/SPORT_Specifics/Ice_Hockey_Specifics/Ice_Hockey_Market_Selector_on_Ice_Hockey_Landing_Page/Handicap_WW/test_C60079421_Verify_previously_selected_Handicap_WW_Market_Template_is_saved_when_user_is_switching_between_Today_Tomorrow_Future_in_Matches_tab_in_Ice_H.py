...
@pytest.mark.sports
@vtest
class Test_C60079421_Verify_previously_selected_Handicap_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_in_Matches_tab_in_Ice_Hockey_Landing_Page(Common):
    """
    TR_ID: C60079421
