...
@pytest.mark.sports
@vtest
class Test_C60079405_Verify_WW_market_Template_is_displaying_by_default_for_Ice_hockey_Landing_Page_on_Matches_Tab_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60079405
