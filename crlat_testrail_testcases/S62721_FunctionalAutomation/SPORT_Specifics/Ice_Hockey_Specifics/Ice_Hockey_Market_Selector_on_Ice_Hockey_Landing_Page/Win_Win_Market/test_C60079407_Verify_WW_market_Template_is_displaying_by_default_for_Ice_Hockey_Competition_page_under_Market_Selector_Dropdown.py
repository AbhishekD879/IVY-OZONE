...
@pytest.mark.sports
@vtest
class Test_C60079407_Verify_WW_market_Template_is_displaying_by_default_for_Ice_Hockey_Competition_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60079407
    NAME: Verify ‘WW market’ Template is displaying by default for Ice Hockey Competition page  under Market Selector Dropdown
