...
@pytest.mark.sports
@vtest
class Test_C60079220_Verify_Primary_Market_for_Ice_Hockey(Common):
    """
    TR_ID: C60079220
    NAME: Verify Primary Market for Ice Hockey
    DESCRIPTION: This test case verifies Primary Market for 'Ice Hockey' Sport.
    ...
    PRECONDITIONS: * Go to Ice Hockey landing page
    """
    ...
    def test_002_verify_order_of_priceodds_buttons_for_us_and_non_us_events(self):
        """
