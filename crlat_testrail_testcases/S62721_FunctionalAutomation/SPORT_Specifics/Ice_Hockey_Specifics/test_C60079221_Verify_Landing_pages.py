...
@pytest.mark.sports
@vtest
class Test_C60079221_Verify_Landing_pages(Common):
    """
    TR_ID: C60079221
    NAME: Verify Landing pages
    DESCRIPTION: This test case verifies  'Leagues & Competitions' sorting type
    ...
    PRECONDITIONS: *   XXX - the event ID (Ice Hockey=22)
    PRECONDITIONS: *   X.XX - current supported version of OpenBet release
    PRECONDITIONS: *   LL - language (e.g. en, ukr)
    """
