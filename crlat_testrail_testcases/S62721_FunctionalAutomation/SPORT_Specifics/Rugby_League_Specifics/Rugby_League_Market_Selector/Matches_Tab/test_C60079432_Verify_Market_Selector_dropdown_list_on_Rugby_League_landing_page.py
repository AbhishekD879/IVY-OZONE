...
@pytest.mark.sports
@vtest
class Test_C60079432_Verify_Market_Selector_dropdown_list_on_Rugby_League_landing_page(Common):
    """
    TR_ID: C60079432
    NAME: Verify 'Market Selector' dropdown list on Rugby League landing page
    ...
    def test_006_repeat_steps_2_to_5_for_the_following_markets_handicap_2_way_total_points(self):
        """
