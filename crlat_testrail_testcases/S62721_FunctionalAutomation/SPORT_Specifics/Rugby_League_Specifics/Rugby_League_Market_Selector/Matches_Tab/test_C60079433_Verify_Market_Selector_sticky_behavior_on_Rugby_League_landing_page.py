...
@pytest.mark.sports
@vtest
class Test_C60079433_Verify_Market_Selector_sticky_behavior_on_Rugby_League_landing_page(Common):
    """
    TR_ID: C60079433
    NAME: Verify 'Market Selector'  sticky behavior on Rugby League  landing page
