...
@pytest.mark.sports
@vtest
class Test_C60079445_Verify_WDW_market_Template_is_displaying_by_default_for_Rugby_League_Landing_Page_on_Matches_Tab_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60079445
    NAME: Verify ‘WDW market’ Template is displaying by default for Rugby League Landing Page on Matches Tab under Market Selector Dropdown
    DESCRIPTION: This test case verifies displaying of ‘WDW market’ Template is displaying by default for Rugby League Landing Page on Matches Tab under Market Selector Dropdown
    ...
    PRECONDITIONS: 2. Go to the Rugby League Landing page -> 'Click on Matches Tab'
    PRECONDITIONS: **Note:**
    ...
    def test_002_verify_displaying_for_preplay_events_for_match_betting(self):
        """
        DESCRIPTION: Verify displaying for Preplay events for 'Match Betting'
        EXPECTED: Only Preplay events are displayed
        """
        pass

    def test_003_verify_text_of_the_labels_for_match_betting(self):
        """
        DESCRIPTION: Verify text of the labels for 'Match Betting'
