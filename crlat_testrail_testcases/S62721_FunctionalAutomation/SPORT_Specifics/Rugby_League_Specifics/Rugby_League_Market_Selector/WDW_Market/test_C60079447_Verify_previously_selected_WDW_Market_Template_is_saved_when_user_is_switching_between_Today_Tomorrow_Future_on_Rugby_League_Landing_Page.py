...
@pytest.mark.sports
@vtest
class Test_C60079447_Verify_previously_selected_WDW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Rugby_League_Landing_Page(Common):
    """
    TR_ID: C60079447
    NAME: Verify previously selected ‘WDW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Rugby League Landing Page
    DESCRIPTION: This test case verifies that previously selected ‘WDW Market’ Template is saved when user is switching between Today/Tomorrow/Future on Rugby League Landing Page
