...
@pytest.mark.sports
@vtest
class Test_C60079256_Verify_Primary_Market_for_Rugby_League(Common):
    """
    TR_ID: C60079256
    NAME: Verify Primary Market for Rugby League
    DESCRIPTION: This test case verifies Primary Market for 'Rugby League' Sport
    ...
    PRECONDITIONS: * Go to Rugby League landing page
    """
