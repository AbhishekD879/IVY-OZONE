...
@pytest.mark.sports
@vtest
class Test_C60079258_Verify_Rugby_League_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C60079258
    ...
    DESCRIPTION: Mobile [C31302474]
    DESCRIPTION: Desktop [C31302475]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_rugby_league_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_rugby_league_pages(self):
        """
    ...
    def test_005_go_to_rugby_league_landing_page__in_play_tabmodule(self):
        """
