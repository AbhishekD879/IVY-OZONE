...
@pytest.mark.sports
@vtest
class Test_C60079412_Verify_WDW_market_Template_is_displaying_by_default_for_Rugby_Union_Competition_Landing_page_under_Market_Selector_Dropdown(Common):
    """
    TR_ID: C60079412
