...
@pytest.mark.sports
@vtest
class Test_C60079413_Verify_previously_selected_WDW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_Rugby_Union_Landing_Page(Common):
    """
    TR_ID: C60079413
