...
@pytest.mark.sports
@vtest
class Test_C60079239_Verify_Rugby_Union_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C60079239
    ...
    DESCRIPTION: Mobile [C30929735]
    DESCRIPTION: Desktop [C30929736]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_rugby_union_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_rugby_union_pages(self):
        """
    ...
    def test_005_go_to_rugby_union_landing_page__in_play_tabmodule(self):
        """
