...
@pytest.mark.sports
@vtest
class Test_C60079388_Verify_Market_Selector_sticky_behavior_on_Snooker_Competition_page(Common):
    """
    TR_ID: C60079388
    NAME: Verify 'Market Selector'  sticky behavior on Snooker Competition page
