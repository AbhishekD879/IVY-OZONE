...
@pytest.mark.sports
@vtest
class Test_C60079383_Verify_Market_Selector__dropdown_in_Matches_tab_for_Snooker_landing_page(Common):
    """
    TR_ID: C60079383
    NAME: Verify 'Market Selector'   dropdown  in Matches tab for Snooker landing page
    ...
    def test_006_repeat_steps_3_to_5_for_the_following_markets_handicap_total_frames(self):
        """
        DESCRIPTION: Repeat steps 3 to 5 for the following markets:
