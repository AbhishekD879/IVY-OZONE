...
@pytest.mark.sports
@vtest
class Test_C60079241_Verify_Landing_pages(Common):
    """
    TR_ID: C60079241
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Snooker=32)
    ...
    def test_002_tapsnooker_icon_on_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Snooker' icon on the Sports Menu Ribbon
        EXPECTED: *   Snooker Landing Page is opened
