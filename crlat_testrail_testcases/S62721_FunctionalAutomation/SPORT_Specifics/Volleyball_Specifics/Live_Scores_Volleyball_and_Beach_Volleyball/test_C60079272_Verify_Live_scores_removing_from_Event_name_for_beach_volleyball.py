...
@pytest.mark.sports
@vtest
class Test_C60079272_Verify_Live_scores_removing_from_Event_name_for_beach_volleyball(Common):
    """
    TR_ID: C60079272
    NAME: Verify Live scores removing from Event name for beach volleyball
    DESCRIPTION: This test case verifies BIP scores in Event Name are replaced to ''v''  for Beach Volleyball events on Front End
    ...
    PRECONDITIONS: 3. Go to OB and create BeachVolleyball live event with name:
