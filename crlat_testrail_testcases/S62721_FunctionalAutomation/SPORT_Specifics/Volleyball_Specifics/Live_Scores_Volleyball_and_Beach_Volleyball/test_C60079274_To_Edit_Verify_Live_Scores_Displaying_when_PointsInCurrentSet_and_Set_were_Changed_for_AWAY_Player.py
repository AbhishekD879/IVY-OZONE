...
@pytest.mark.sports
@vtest
class Test_C60079274_To_Edit_Verify_Live_Scores_Displaying_when_PointsInCurrentSet_and_Set_were_Changed_for_AWAY_Player(Common):
    """
    TR_ID: C60079274
    NAME: [To Edit] Verify Live Scores Displaying when PointsInCurrentSet and Set were Changed for AWAY Player
    DESCRIPTION: This test case verifies live scores displaying when PointsInCurrentSet was changed for AWAY player.
    ...
    PRECONDITIONS: 1) In order to have a Scores Volleyball and Beach Volleyball event should be BIP event
    ...
    PRECONDITIONS: *   **role_code=AWAY**  - to determine AWAY team
    """
    ...
    def test_005_change_pointsincurrentset_in_betgenius_tool_or_ob_ti_tool_within_event_name_for_away_player(self):
        """
    ...
    def test_006_change_set_score_in_betgenius_tool_or_ob_ti_tool_within_event_name_for_away_player(self):
        """
    ...
    def test_007_verify_pointsincurrentset_and_set_change_for_away_player_for_sections_in_a_collapsed_state(self):
        """
        DESCRIPTION: Verify PointsInCurrentSet and Set change for AWAY player for sections in a collapsed state
    ...
    def test_008_verify_pointsincurrentset_and_set_change_before_application_is_opened(self):
        ...
        EXPECTED: If application was not started/opened and PointsInCurrentSet and Set were changed for AWAY player, after opening application and verified event - updated PointsInCurrentSet will be shown there
        """
        pass
