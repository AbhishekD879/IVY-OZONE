...
@pytest.mark.sports
@vtest
class Test_C60079359_Verify_Market_Selector_dropdown_list_on_Volleyball_Competition_page(Common):
    """
    TR_ID: C60079359
    NAME: Verify 'Market Selector' dropdown list on Volleyball Competition page
