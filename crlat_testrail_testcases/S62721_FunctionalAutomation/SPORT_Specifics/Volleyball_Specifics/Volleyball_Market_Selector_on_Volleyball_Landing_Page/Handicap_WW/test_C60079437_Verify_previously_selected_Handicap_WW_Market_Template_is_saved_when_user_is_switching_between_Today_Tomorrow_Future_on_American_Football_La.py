...
@pytest.mark.sports
@vtest
class Test_C60079437_Verify_previously_selected_Handicap_WW_Market_Template_is_saved_when_user_is_switching_between_Today_Tomorrow_Future_on_American_Football_Landing_Page(Common):
    """
    TR_ID: C60079437
    ...
    def test_002_select_set_handicap_in_the_market_selector_dropdown_list(self):
        """
    ...
    def test_005_verify_ga_tracking_for_the_set_handicap(self):
        """
