...
@pytest.mark.sports
@vtest
class Test_C60079357_Verify_Market_Selector_sticky_behavior_on_Volleyball_landing_page(Common):
    """
    TR_ID: C60079357
    NAME: Verify 'Market Selector'  sticky behavior on Volleyball landing page
