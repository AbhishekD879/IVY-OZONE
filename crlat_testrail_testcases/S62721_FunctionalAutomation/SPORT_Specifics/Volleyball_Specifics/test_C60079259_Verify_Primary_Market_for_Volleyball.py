...
@pytest.mark.sports
@vtest
class Test_C60079259_Verify_Primary_Market_for_Volleyball(Common):
    """
    TR_ID: C60079259
    NAME: Verify Primary Market for Volleyball
    DESCRIPTION: This test case verifies Primary Market for 'Volleyball' Sport
    ...
    PRECONDITIONS: * Go to Volleyball landing page
    """
