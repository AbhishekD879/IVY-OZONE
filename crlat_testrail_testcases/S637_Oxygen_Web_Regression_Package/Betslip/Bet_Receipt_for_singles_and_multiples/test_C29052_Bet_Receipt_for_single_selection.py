...
@pytest.mark.betslip
@vtest
class Test_C29052_Bet_Receipt_for_single_selection(Common):
    """
    TR_ID: C29052
    NAME: Bet Receipt for single selection
    DESCRIPTION: This test case verifies placing a single bet
    ...
    def test_002_verify_bet_receiptlayout(self):
        """
    ...
    def test_005_verify_cardlayout(self):
        """
