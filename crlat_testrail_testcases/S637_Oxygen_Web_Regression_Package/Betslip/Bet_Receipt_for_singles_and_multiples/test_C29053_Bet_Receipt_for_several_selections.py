...
@pytest.mark.betslip
@vtest
class Test_C29053_Bet_Receipt_for_several_selections(Common):
    """
    TR_ID: C29053
    NAME: Bet Receipt for several selections
    DESCRIPTION: This test case verifies placing the several selections
    DESCRIPTION: AUTOTEST [C1501906]
    DESCRIPTION: AUTOTEST [C527782]
    ...
    PRECONDITIONS: 4. Make bet placement for several selections (from the same event)
    ...
    def test_005_verify_bet_receipt_for_several_selections(self):
        """
        DESCRIPTION: Verify Bet Receipt for several selections
        ...
        EXPECTED: * 'Promo' icon if available
