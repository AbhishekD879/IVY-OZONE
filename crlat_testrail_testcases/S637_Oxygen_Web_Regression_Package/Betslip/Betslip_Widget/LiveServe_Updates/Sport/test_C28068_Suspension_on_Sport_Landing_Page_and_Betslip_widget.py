...
@pytest.mark.betslip
@vtest
class Test_C28068_Suspension_on_Sport_Landing_Page_and_Betslip_widget(Common):
    """
    TR_ID: C28068
    NAME: Suspension on <Sport> Landing Page and Betslip widget
    DESCRIPTION: This test case verifies suspension on <Sport> Landing page and Betslip widget
    ...
    def test_005_trigger_suspensionof_current_eventmarketoutcome(self):
        ...
        EXPECTED: Price/Odds buttons of this event immediately become disabled on <Sport> Landing page
        """
        pass
    ...
    def test_009_open_matches_tomorrow_tab(self):
        """
    ...
    def test_011_open_matches_future_tab(self):
        """
