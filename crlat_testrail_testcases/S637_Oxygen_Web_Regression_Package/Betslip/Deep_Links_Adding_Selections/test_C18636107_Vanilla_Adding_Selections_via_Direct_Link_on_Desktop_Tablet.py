...
@pytest.mark.betslip
@vtest
class Test_C18636107_Vanilla_Adding_Selections_via_Direct_Link_on_Desktop_Tablet(Common):
    """
    TR_ID: C18636107
    NAME: [Vanilla] Adding Selections via Direct Link on Desktop/Tablet
    ...
    def test_002_choose_one_sport_event_on_siteserver(self):
        """
        DESCRIPTION: Choose one <Sport> event on SiteServer
        EXPECTED: 
        """
        pass
