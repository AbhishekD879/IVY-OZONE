...
@pytest.mark.betslip
@vtest
class Test_C18636108_Vanilla_Verify_Adding_Suspended_Selections_via_Direct_Link(Common):
    """
    TR_ID: C18636108
    NAME: [Vanilla] Verify Adding Suspended Selections via Direct Link
    ...
    def test_003_enter_direct_url_with_suspended_outcome_ids__outcomestatuscode_sin_address_bar__press_enter_key(self):
        ...
        EXPECTED: 4.  Error message is shown on the Bet Slip for each suspended selection:
