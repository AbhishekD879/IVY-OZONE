...
@pytest.mark.betslip
@vtest
class Test_C29098_Verify_Adding_Selections_via_Direct_Link_when_Event_is_Suspended(Common):
    """
    TR_ID: C29098
    ...
    def test_003_enter_direct_urlwith_valid_outcome_ids_fro_suspended_eventseventstatuscodesin_address_bar__press_enter_key(self):
        ...
        EXPECTED: 4.  Error message on red background is shown on the Bet Slip for each selection from suspended event(s):
