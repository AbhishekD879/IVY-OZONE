...
@pytest.mark.betslip
@vtest
class Test_C29102_Verify_Adding_the_Same_Selections_Several_Times_via_Direct_Link(Common):
    """
    TR_ID: C29102
    NAME: Verify Adding the Same Selections Several Times via Direct Link
    DESCRIPTION: This test case verifies whether adding the same selections via direct link is possible
