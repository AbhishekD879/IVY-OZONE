...
@pytest.mark.betslip
@vtest
class Test_C2323005_Betslip_Reflection_on_Sport_Market_Suspended_Unsuspended_for_Multiple_Bet(Common):
    """
    TR_ID: C2323005
    ...
    DESCRIPTION: AUTOTEST MOBILE: [C9698363]
    DESCRIPTION: AUTOTEST DESKTOP: [C2323039]
    ...
    def test_002_suspend_market_for_one_of_the_eventsmarketstatuscodesand_at_the_same_time_have_betslip_page_opened_to_watch_for_updates(self):
        """
    ...
    def test_003_unsuspend_the_same_marketmarketstatuscodeaand_at_the_same_tame_have_betslip_page_opened_to_watch_for_updates(self):
        """
    ...
    def test_005_suspend_two_markets_for_two_eventsmarketstatuscodesand_at_the_same_time_have_betslip_page_opened_to_watch_for_updates(self):
        """
    ...
    def test_006_unsuspend_the_same_marketmarketstatuscodeaand_at_the_same_tame_have_betslip_page_opened_to_watch_for_updates(self):
        """
        DESCRIPTION: Unsuspend the same market:
        DESCRIPTION: **marketStatusCode="A"**
        DESCRIPTION: and at the same tame have Betslip page opened to watch for updates
