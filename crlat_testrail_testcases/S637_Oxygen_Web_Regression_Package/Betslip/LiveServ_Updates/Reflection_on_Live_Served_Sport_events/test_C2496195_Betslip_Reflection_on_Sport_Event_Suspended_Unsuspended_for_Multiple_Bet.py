...
@pytest.mark.betslip
@vtest
class Test_C2496195_Betslip_Reflection_on_Sport_Event_Suspended_Unsuspended_for_Multiple_Bet(Common):
    """
    TR_ID: C2496195
    ...
    def test_002_suspend_one_of_the_eventseventstatuscodesand_at_the_same_time_have_betslip_page_opened_to_watch_for_updates(self):
        """
        ...
        EXPECTED: ![](index.php?/attachments/get/33919)
        EXPECTED: **Ladbrokes:**
        EXPECTED: * All selection box is greyed out for suspended event
        ...
        EXPECTED: ![](index.php?/attachments/get/33920)
        """
        pass

    def test_003_unsuspend_the_same_eventeventstatuscodeaand_at_the_same_tame_have_betslip_page_opened_to_watch_for_updates(self):
        """
    ...
    def test_005_suspend_two_of_the_eventseventstatuscodesand_at_the_same_time_have_betslip_page_opened_to_watch_for_updates(self):
        """
        ...
        EXPECTED: ![](index.php?/attachments/get/33917)
        EXPECTED: **Ladbrokes:**
        EXPECTED: * All selection box is greyed out for suspended event
        EXPECTED: * 'SUSPENDED' label is sown at the center of selection' for suspended event
        EXPECTED: * 'Place Bet' ( 'Login and Place Bet') button is disabled and greyed out
        ...
        EXPECTED: ![](index.php?/attachments/get/33918)
        """
        pass

    def test_006_unsuspend_the_same_eventeventstatuscodeaand_at_the_same_tame_have_betslip_page_opened_to_watch_for_updates(self):
        """
        DESCRIPTION: Unsuspend the same event:
        DESCRIPTION: **eventStatusCode="A"**
        DESCRIPTION: and at the same tame have Betslip page opened to watch for updates
