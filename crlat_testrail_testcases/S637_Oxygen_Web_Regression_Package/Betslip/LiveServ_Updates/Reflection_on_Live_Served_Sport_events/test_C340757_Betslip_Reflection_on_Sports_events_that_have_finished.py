...
@pytest.mark.betslip
@vtest
class Test_C340757_Betslip_Reflection_on_Sports_events_that_have_finished(Common):
    """
    TR_ID: C340757
    ...
    DESCRIPTION: AUTOTEST Mobile: [C2610570]
    DESCRIPTION: AUTOTEST Desktop: [C2610579]
    ...
    def test_001_add_sport_selection_to_the_betslip_and_open_the_betslip(self):
        """
        DESCRIPTION: Add <Sport> selection to the Betslip and Open the Betslip
