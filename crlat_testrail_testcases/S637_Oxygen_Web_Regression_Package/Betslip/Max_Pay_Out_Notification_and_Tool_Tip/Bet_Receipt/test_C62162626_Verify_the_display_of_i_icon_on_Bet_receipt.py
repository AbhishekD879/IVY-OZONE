...
@pytest.mark.betslip
@vtest
class Test_C62162626_Verify_the_display_of_i_icon_on_Bet_receipt(Common):
    """
    TR_ID: C62162626
    NAME: Verify the display of 'i' icon on Bet receipt
    DESCRIPTION: This test case verifies the display of 'i' icon on the bet receipt
