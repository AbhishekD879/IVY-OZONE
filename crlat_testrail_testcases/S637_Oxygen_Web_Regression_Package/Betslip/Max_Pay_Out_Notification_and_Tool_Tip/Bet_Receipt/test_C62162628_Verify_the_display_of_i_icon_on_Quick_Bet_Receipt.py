...
@pytest.mark.betslip
@vtest
class Test_C62162628_Verify_the_display_of_i_icon_on_Quick_Bet_Receipt(Common):
    """
    TR_ID: C62162628
    NAME: Verify the display of 'i' icon on Quick Bet Receipt
    DESCRIPTION: This test case verifies the display of 'i' icon on Quick Bet Receipt
    ...
    def test_002_click_on_any_selection_from_any_eventsportracing_to_trigger_quick_bet_slip(self):
        """
        DESCRIPTION: Click on any selection from ANY event(Sport/Racing) to trigger Quick Bet slip
    ...
    def test_004_click_on_place_bet_and_validate_the_display_of_i_icon(self):
        ...
        EXPECTED: * Quick Bet receipt should be generated
    ...
    def test_005_click_or_hover_on_the_i_icon(self):
        ...
        EXPECTED: * Tool Tip should be displayed
        """
        pass
