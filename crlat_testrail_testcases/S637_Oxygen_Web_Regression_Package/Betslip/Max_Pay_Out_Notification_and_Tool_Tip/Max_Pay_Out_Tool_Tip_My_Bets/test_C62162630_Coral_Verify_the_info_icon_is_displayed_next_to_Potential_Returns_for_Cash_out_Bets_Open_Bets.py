...
@pytest.mark.betslip
@vtest
class Test_C62162630_Coral_Verify_the_info_icon_is_displayed_next_to_Potential_Returns_for_Cash_out_Bets_Open_Bets(Common):
    """
    TR_ID: C62162630
    NAME: Coral: Verify the info icon is displayed next to Potential Returns for Cash out Bets & Open Bets
    DESCRIPTION: This test case verifies the display of 'i' icon in My Bets Open Bets and Cash out Bets tab
    ...
    def test_005_navigate_to_my_bets_section(self):
        ...
        EXPECTED: * Look for the placed bet (Only if the Bet has Cashout)
        EXPECTED: * 'i' icon is displayed next to Potential Returns
        """
        pass
    ...
    def test_007_click_on_open_bets_tab_in_my_bets_section(self):
        """
        DESCRIPTION: Click on Open Bets tab in My Bets section
