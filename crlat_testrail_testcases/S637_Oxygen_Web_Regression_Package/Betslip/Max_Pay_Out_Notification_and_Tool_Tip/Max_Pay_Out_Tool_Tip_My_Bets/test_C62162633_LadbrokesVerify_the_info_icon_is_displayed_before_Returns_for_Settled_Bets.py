...
@pytest.mark.betslip
@vtest
class Test_C62162633_LadbrokesVerify_the_info_icon_is_displayed_before_Returns_for_Settled_Bets(Common):
    """
    TR_ID: C62162633
    NAME: Ladbrokes:Verify the info icon is displayed before Returns for Settled Bets
    ...
    def test_006_navigate_to_my_bets_section__settled_bets(self):
        """
