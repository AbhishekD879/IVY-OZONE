...
@pytest.mark.betslip
@vtest
class Test_C62162595_Verify_the_display_of_Max_Pay_Out_banner__Multiple_Single_Bets(Common):
    """
    TR_ID: C62162595
    NAME: Verify the display of Max Pay Out banner - Multiple Single Bets
    ...
    def test_002_add_multiple_selections_from_any_eventsportracing(self):
        """
        DESCRIPTION: Add multiple selections from ANY event(Sport/Racing)
