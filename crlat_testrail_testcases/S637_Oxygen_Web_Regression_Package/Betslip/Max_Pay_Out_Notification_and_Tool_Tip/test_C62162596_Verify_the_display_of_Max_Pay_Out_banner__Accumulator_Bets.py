...
@pytest.mark.betslip
@vtest
class Test_C62162596_Verify_the_display_of_Max_Pay_Out_banner__Accumulator_Bets(Common):
    """
    TR_ID: C62162596
    NAME: Verify the display of Max Pay Out banner - Accumulator Bets
    DESCRIPTION: This Test case verifies the display Of Max Payout banner on Betslip for Acca bets
    ...
    def test_002_add_acca_selections_from_any_eventsportracing(self):
        """
        DESCRIPTION: Add ACCA selections from ANY event(Sport/Racing)
