...
@pytest.mark.betslip
@vtest
class Test_C62162598_Verify_the_display_of_Max_Pay_Out_banner__Expand_and_Collapse_Numpad(Common):
    """
    TR_ID: C62162598
    NAME: Verify the display of Max Pay Out banner - Expand and Collapse Numpad
    DESCRIPTION: This Test case verifies the display Of Max Payout banner on Numpad - Expanded & Collapsed view
    ...
    def test_003_enter_stake_and_validate_the_display_of_max_payout_banner_on_numpadentered_stake_should_trigger_the_estimated_potential_returns_higher_than_maximum_payout_configured(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161019582)
        """
        pass

    def test_004_collapse_the_numpad(self):
        """
        DESCRIPTION: Collapse the Numpad
        EXPECTED: * Max Pay out banner should be displayed
        EXPECTED: * Text displayed should be same as configured in CMS
        EXPECTED: * T&C'S link should be displayed
        EXPECTED: * 'i' icon should be displayed
        EXPECTED: ![](index.php?/attachments/get/161019581)
        """
        pass
