...
@pytest.mark.betslip
@vtest
class Test_C62951386_Verify_the_display_of_Max_Pay_out_banner_on_Bet_Builder_BYB_Betslip(Common):
    """
    TR_ID: C62951386
    NAME: Verify the display of Max Pay out banner on Bet Builder /BYB  Betslip
    ...
    def test_002_add_selections_for_byb_bet_and_click_on_place_bet(self):
        """
        DESCRIPTION: Add Selections for BYB bet and Click on Place Bet
        EXPECTED: 
        """
        pass
