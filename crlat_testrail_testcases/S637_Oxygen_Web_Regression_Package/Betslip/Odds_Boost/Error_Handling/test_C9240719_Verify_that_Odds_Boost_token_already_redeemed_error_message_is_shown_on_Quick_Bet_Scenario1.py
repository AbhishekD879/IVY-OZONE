...
@vtest
class Test_C9240719_Verify_that_Odds_Boost_token_already_redeemed_error_message_is_shown_on_Quick_Bet_Scenario1(Common):
    """
    TR_ID: C9240719
    NAME: Verify that 'Odds Boost token already redeemed' error message is shown on Quick Bet (Scenario1)
    DESCRIPTION: This test case verifies that 'Odds Boost token already redeemed' error message is shown on Quick Bet
    ...
    def test_001_add_different_selection_to_quick_bet_in_two_windowsverify_that_odds_boost_button_is_shown_in_both_windows(self):
        """
        DESCRIPTION: Add different selection to Quick Bet in two windows
