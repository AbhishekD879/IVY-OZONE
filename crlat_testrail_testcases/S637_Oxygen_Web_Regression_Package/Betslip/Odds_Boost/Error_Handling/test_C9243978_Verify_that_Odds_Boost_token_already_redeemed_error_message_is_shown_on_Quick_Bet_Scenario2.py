...
@vtest
class Test_C9243978_Verify_that_Odds_Boost_token_already_redeemed_error_message_is_shown_on_Quick_Bet_Scenario2(Common):
    """
    TR_ID: C9243978
    NAME: Verify that 'Odds Boost token already redeemed' error message is shown on Quick Bet (Scenario2)
    ...
    def test_001_add_selection_to_quick_betadd_stake_and_tap_boost_buttonverify_that_odds_are_boosted(self):
        """
