...
@vtest
class Test_C9243980_Verify_that_Odds_Boost_token_already_redeemed_error_message_is_shown_on_Quick_Bet_Scenario3(Common):
    """
    TR_ID: C9243980
    NAME: Verify that 'Odds Boost token already redeemed' error message is shown on Quick Bet (Scenario3)
