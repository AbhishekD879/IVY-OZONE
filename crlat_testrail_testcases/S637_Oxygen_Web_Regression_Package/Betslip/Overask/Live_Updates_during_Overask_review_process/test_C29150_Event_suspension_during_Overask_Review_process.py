...
@pytest.mark.betslip
@vtest
class Test_C29150_Event_suspension_during_Overask_Review_process(Common):
    """
    TR_ID: C29150
    ...
    def test_004_while_review_is_pending_trigger_event_suspension_for_selection_under_the_review(self):
        """
