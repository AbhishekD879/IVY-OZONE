...
@pytest.mark.betslip
@vtest
class Test_C29152_Selection_suspension_during_Overask_Review_process(Common):
    """
    TR_ID: C29152
    NAME: Selection suspension during Overask Review process
    DESCRIPTION: This test case verifies Selection suspension during Oversk Review process
    ...
    def test_004_while_review_is_pending_trigger_selection_suspension_for_selection_under_the_review(self):
        """
        DESCRIPTION: While review is pending trigger selection suspension for selection under the review
