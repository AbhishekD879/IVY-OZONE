...
@pytest.mark.betslip
@vtest
class Test_C58694729_Verify_Betslip_is_cleared_after_logged_out_during_Overask_and_trader_makes_an_offer_declines_bet_bet_expires(Common):
    """
    TR_ID: C58694729
    NAME: Verify Betslip is cleared after logged out during Overask and  trader makes an offer/declines bet/bet expires
    DESCRIPTION: This test case verifies that  Betslip is cleared after tapping logging out during OA and offer from the trader is not shown after log in
    ...
    PRECONDITIONS: 2. Add Stake bigger than MaxAllowed
    ...
    def test_002_trigger_log_out_from_appon_desktop_tap_logout_button_in_account_menuon_web_mobile_refresh_page_or_close_and_reopen_tab_and_then_tap_logout_button_in_the_account_menuon_wrappers_kill_and_reopen_the_app(self):
        """
    ...
    def test_003_perform_either_of_the_following__decline_the_bet_in_ti_betbi_request__make_the_offer_in_ti_betbi_request__wait_till_the_overask_bet_pendingoffer_time_expires_in_ti_betbi_request(self):
        """
        DESCRIPTION: Perform either of the following:
        DESCRIPTION: - Decline the bet in TI (Bet>BI Request)
        DESCRIPTION: - Make the offer in TI (Bet>BI Request)
        DESCRIPTION: - Wait till the Overask bet pending/offer time expires in TI (Bet>BI Request)
        EXPECTED: 
        """
        pass
    ...
    def test_006_tap_login_buttonlogin_with_user1_from_preconditions(self):
        ...
        EXPECTED: - Selection added in preconditions is NOT shown in Betslip
        EXPECTED: - Offer from trader is not shown
        """
        pass
