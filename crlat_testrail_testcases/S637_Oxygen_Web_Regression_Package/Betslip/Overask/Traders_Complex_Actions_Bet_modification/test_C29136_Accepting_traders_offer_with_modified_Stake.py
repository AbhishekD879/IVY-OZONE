...
@pytest.mark.betslip
@vtest
class Test_C29136_Accepting_traders_offer_with_modified_Stake(Common):
    """
    TR_ID: C29136
    ...
    DESCRIPTION: Instruction how to modify Stake via an Overask offer: https://confluence.egalacoral.com/pages/viewpage.action?pageId=41190955
    ...
    def test_004_trigger_stake_modification_by_trader_and_verify_new_stake_value_displaying_in_betslip(self):
        ...
        EXPECTED: *   The new Stake value is shown in green
        EXPECTED: *   The Estimate returns are updated according to new Stake value (also highlighted in green)
