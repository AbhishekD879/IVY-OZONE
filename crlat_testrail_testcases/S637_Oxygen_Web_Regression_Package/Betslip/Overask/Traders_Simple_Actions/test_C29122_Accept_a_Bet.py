...
class Test_C29122_Accept_a_Bet(Common):
    ...
    def test_006_desktop_add_a_few_selections_without_clicking_go_betting_button_multiples_section(self):
        """
        DESCRIPTION: [Desktop] Add a few selections without clicking 'Go Betting' button, 'Multiples' section
        EXPECTED: * Bet Receipt is automatically changed to Betslip
        """
        pass

    def test_007_mobile_add_a_few_selections_and_go_betslip_multiples_section(self):
        """
        DESCRIPTION: [Mobile] Add a few selections and go Betslip, 'Multiples' section
        EXPECTED: 
        """
        pass

    def test_008_repeat_steps__3_6_for_multiple_bet(self):
        """
