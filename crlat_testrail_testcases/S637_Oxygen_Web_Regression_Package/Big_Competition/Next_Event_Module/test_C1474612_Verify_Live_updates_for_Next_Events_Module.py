...
@pytest.mark.sports
@vtest
class Test_C1474612_Verify_Live_updates_for_Next_Events_Module(Common):
    """
    TR_ID: C1474612
    NAME: Verify Live updates for Next Events Module
    DESCRIPTION: 
    ...
    PRECONDITIONS: 'Next events module should be created, set up and enabled in CMS
    PRECONDITIONS: List of events should be configured in 'Next events' module
    ...
    def test_002_navigate_to_big_competition___featured_tab___next_events_module(self):
        """
        DESCRIPTION: Navigate to 'Big Competition' -> 'Featured' tab -> 'Next Events' module
        EXPECTED: 'Next events' module is displayed successfully
        """
        pass

    def test_003_in_backoffice_tool_change_the_price_for_any_selection_from_next_events_module_and_save_changes(self):
        """
        DESCRIPTION: In Backoffice tool change the price for any selection from 'Next Events' module and save changes
        EXPECTED: 
        """
        pass
    ...
    def test_008_logout_and_navigate_to_big_competition___featured_tab___next_events_module(self):
        """
        DESCRIPTION: Logout and navigate to 'Big Competition' -> 'Featured' tab -> 'Next Events' module
        EXPECTED: 'Next events' module is displayed successfully
        """
        pass
    ...
    def test_016_navigate_to_big_competition___featured_tab___next_events_module(self):
        """
        DESCRIPTION: Navigate to 'Big Competition' -> 'Featured' tab -> 'Next Events' module
        EXPECTED: 'Next events' module is displayed successfully
        """
    ...
    def test_017_in_backoffice_tool_and_set_any_selection_from_next_events_module_to_not_displayed_and_save_changes(self):
        """
        DESCRIPTION: In Backoffice tool and set any selection from 'Next Events' module to 'Not Displayed' and save changes
        EXPECTED: Corresponding selection should not be displayed
        """
        pass

    def test_018_back_to_backoffice_tool_and_set_selection_to_displayed_and_save_changesrefresh_the_page(self):
        """
