...
@pytest.mark.sports
@vtest
class Test_C1641529_Verify_Next_Events_Individual_Module_data_correctness(Common):
    """
    TR_ID: C1641529
    NAME: Verify Next Events Individual Module data correctness
    DESCRIPTION: This test case verifies data correctness for Next Events Individual Module on Big Competition page.
    PRECONDITIONS: * Competition should be created, set up and enabled in CMS -> Big Competition section
    PRECONDITIONS: * Module with type = 'NEXT_EVENTS_INDIVIDUAL' should be created, enabled and set up in CMS
    ...
    def test_003_go_to_next_events_individual_module(self):
        """
        DESCRIPTION: Go to Next Events Individual Module
        EXPECTED: 
        """
        pass
