...
@pytest.mark.other
@vtest
class Test_C64537861_Verify_the_message_on_module_screen_whenever_Universal_module_is_reordered_in_the_segmented_view(Common):
    """
    TR_ID: C64537861
    ...
    def test_003_reorder_the_records_in_universal(self):
        ...
        EXPECTED: User should able to reorder the records in Universal view.whatever the display order changes in Universal view should   reflect in segmented view as well
        """
        pass
