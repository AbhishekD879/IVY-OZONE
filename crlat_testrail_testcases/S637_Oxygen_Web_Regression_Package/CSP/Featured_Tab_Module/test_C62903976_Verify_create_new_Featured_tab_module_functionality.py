...
@pytest.mark.other
@vtest
class Test_C62903976_Verify_create_new_Featured_tab_module_functionality(Common):
    """
    TR_ID: C62903976
    NAME: Verify create new Featured tab module functionality
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module
    ...
    def test_006_click_on_create_featured_tab_moduleverify_detail_page(self):
        """
        DESCRIPTION: Click on create Featured Tab module,Verify detail page
        EXPECTED: Featured Tab module detail page should be opened with existing fields and new radio buttons Universal ,Segment(s) inclusion.
        """
        pass
    ...
    def test_007_verify_by_entering__all_mandatory_feilds_and_click_create_cta(self):
        ...
        EXPECTED: Upon Clicking Create CTA ,new Featured Tab module should be created and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
