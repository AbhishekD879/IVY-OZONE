...
@pytest.mark.other
@vtest
class Test_C62903977_Verify_create_new_Featured_tab_module_by_Category_ID(Common):
    """
    TR_ID: C62903977
    NAME: Verify create new Featured tab module by Category ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with Category ID
    ...
    def test_006_click_on_create_featured_tab_module_with_category_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with Category ID
        EXPECTED: User should able to create Featured module with Category ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
