...
@pytest.mark.other
@vtest
class Test_C62903978_Verify_create_new_Featured_tab_module_by_Class_ID(Common):
    """
    TR_ID: C62903978
    NAME: Verify create new Featured tab module by Class ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with Class ID
    ...
    def test_006_click_on_create_featured_tab_module_with_class_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with Class ID
        EXPECTED: User should able to create Featured module with Class ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
