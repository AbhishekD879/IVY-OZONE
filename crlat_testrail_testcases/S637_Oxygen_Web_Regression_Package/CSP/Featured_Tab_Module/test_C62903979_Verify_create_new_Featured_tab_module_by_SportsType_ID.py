...
@pytest.mark.other
@vtest
class Test_C62903979_Verify_create_new_Featured_tab_module_by_SportsType_ID(Common):
    """
    TR_ID: C62903979
    NAME: Verify create new Featured tab module by <Sports>Type ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with <Sports>Type ID
    ...
    def test_006_click_on_create_featured_tab_module_with_ltsportsgttype_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with &lt;Sports&gt;Type ID
        EXPECTED: User should able to create Featured module with &lt;Sports&gt;Type ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
