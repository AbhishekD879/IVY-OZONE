...
@pytest.mark.other
@vtest
class Test_C62903981_Verify_create_new_Featured_tab_module_by_Selection_ID(Common):
    """
    TR_ID: C62903981
    NAME: Verify create new Featured tab module by Selection ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with Selection ID
    ...
    def test_006_click_on_create_featured_tab_module_with_selection_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with Selection ID
        EXPECTED: User should able to create Featured module with Selection ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
