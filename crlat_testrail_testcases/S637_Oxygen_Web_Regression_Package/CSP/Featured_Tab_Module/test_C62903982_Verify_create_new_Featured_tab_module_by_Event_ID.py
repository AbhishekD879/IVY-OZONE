...
@pytest.mark.other
@vtest
class Test_C62903982_Verify_create_new_Featured_tab_module_by_Event_ID(Common):
    """
    TR_ID: C62903982
    NAME: Verify create new Featured tab module by Event ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with Event ID
    ...
    def test_006_click_on_create_featured_tab_module_with_event_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with Event ID
        EXPECTED: User should able to create Featured module with Event ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
