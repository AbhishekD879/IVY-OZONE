...
@pytest.mark.other
@vtest
class Test_C62903983_Verify_create_new_Featured_tab_module_by_Market_ID(Common):
    """
    TR_ID: C62903983
    NAME: Verify create new Featured tab module by Market ID
    DESCRIPTION: This test case verifies the CMS configurations for Featured tab module with Market ID
    ...
    def test_006_click_on_create_featured_tab_module_with_market_id(self):
        """
        DESCRIPTION: Click on create Featured tab module with Market ID
        EXPECTED: User should able to create Featured module with Market ID and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
