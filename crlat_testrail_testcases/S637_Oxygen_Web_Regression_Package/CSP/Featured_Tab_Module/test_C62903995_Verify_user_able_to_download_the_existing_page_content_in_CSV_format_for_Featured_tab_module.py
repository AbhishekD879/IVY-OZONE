...
@pytest.mark.other
@vtest
class Test_C62903995_Verify_user_able_to_download_the_existing_page_content_in_CSV_format_for_Featured_tab_module(Common):
    """
    TR_ID: C62903995
    NAME: Verify user able to download the existing page content in CSV format for Featured tab module
    ...
    def test_001_login_to_cms_as_admin_user(self):
        ...
        EXPECTED: User should able to logged in successfully.
        """
        pass
    ...
    def test_003_click_on_download_csv_cta_button(self):
        ...
        EXPECTED: "Download CSV" CTA button should be clickable.
        """
        pass

    def test_004_verify_the_content_in_csv_format(self):
        """
        DESCRIPTION: Verify the content in CSV format
        EXPECTED: Should allow to download the existing page content in CSV format
        """
        pass
