...
@pytest.mark.other
@vtest
class Test_C62903996_Verify_Featured_tab_module_ordering_for_universal(Common):
    """
    TR_ID: C62903996
    NAME: Verify Featured tab module ordering for universal
    DESCRIPTION: Test case verifies possibility to order Featured tab module module for Universal
    ...
    def test_004_verify_newly_created_featured_tab_modules_ordering(self):
        """
        DESCRIPTION: Verify newly created Featured tab modules ordering
    ...
    def test_005_verify_the_order_of_the_featured_tab_module_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Featured tab module module for universal is as per order in the CMS.
