...
@pytest.mark.other
@vtest
class Test_C62903997_Verify_Segment_dropdown_list_able_to_see_Universal_and_existing_segments_one_below_the_other_in_alphabetical_order(Common):
    """
    TR_ID: C62903997
    ...
    def test_005_(self):
        """
        DESCRIPTION: 
        EXPECTED: B) if user select any segment from drop down list the Featured tab modules in that segment should display in alphabetical order.
        """
        pass
    ...
    def test_006_(self):
        """
        DESCRIPTION: 
        EXPECTED: C) If we remove all Featured tab modules of any segment it should not display in drop down
        """
        pass
