...
@pytest.mark.other
@vtest
class Test_C62904011_Create_new_Featured_tab_module_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904011
    NAME: Create new Featured tab module with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new Featured tab module with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_create_button(self):
        ...
        EXPECTED: Universal Featured tab module should be created Successfully
        """
        pass
