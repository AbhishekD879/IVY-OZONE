...
@pytest.mark.other
@vtest
class Test_C62904012_Create_new_Featured_tab_module_with_universalSingle_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904012
    NAME: Create new Featured tab module with universal(Single segment exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new Featured tab module with universal (single segment exclusion)
    ...
    def test_006_enter_segment_name_in_segments_exclusion_text_box_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal Featured tab module should be created Successfully with single segment exclusion
        """
        pass
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_featured_tab_module(self):
        ...
        EXPECTED: Newly created Featured tab module should be shown for
        EXPECTED: 1.Universal(not segmented) users
        EXPECTED: 2.Loggedout users
        EXPECTED: 3.Segmented user except segment which is mentioned in Segment(s) exclusion text box
        """
        pass
