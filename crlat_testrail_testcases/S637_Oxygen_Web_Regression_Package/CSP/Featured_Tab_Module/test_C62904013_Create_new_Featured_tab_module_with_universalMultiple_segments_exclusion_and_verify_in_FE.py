...
@pytest.mark.other
@vtest
class Test_C62904013_Create_new_Featured_tab_module_with_universalMultiple_segments_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904013
    NAME: Create new Featured tab module with universal(Multiple segments exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new Featured tab module with universal for multiple segment exclusion
    ...
    def test_006_enter_more_than_one_segments_name_in_segments_exclusion_text_box_with_comma_separated_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal Featured tab module should be created Successfully with multiple segment(s)exclusion
        """
        pass
