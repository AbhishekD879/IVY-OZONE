...
@pytest.mark.other
@vtest
class Test_C62904014_Create_new_Featured_tab_module_with_Segments_Inclusion_single_segment_and_verify_in_FE(Common):
    """
    TR_ID: C62904014
    NAME: Create new Featured tab module with Segment(s) Inclusion (single segment) and verify in FE
    DESCRIPTION: This test case verifies creating a new Featured tab module with Segment(s) Inclusion (single segment)
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_featured_tab_module_for_segmented_user(self):
        """
        DESCRIPTION: Load Oxygen app and verify newly created Featured tab module for segmented user
