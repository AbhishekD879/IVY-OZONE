...
@pytest.mark.other
@vtest
class Test_C62904017_Verify_Edit_exit_Featured_tab_module_with_universalwith_single_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904017
    NAME: Verify Edit exit Featured tab module with universal(with single segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Updated Featured tab module should be shown for Universal user except specific segments
        """
        pass
