...
@pytest.mark.other
@vtest
class Test_C62904018_Verify_Edit_Featured_tab_module_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904018
    NAME: Verify Edit Featured tab module with universal(with multiple segment exclusion) and verify in FE
