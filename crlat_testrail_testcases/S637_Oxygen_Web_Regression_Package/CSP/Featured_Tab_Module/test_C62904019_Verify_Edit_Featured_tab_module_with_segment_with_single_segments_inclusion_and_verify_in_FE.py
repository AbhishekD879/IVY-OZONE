...
@pytest.mark.other
@vtest
class Test_C62904019_Verify_Edit_Featured_tab_module_with_segment_with_single_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904019
    NAME: Verify Edit Featured tab module with segment (with single segment(s) inclusion) and verify in FE
    ...
    def test_003_click_on_featured_tab_module__link(self):
        """
    ...
    def test_004_click_on_existing_featured_tab_module__with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module  with segment inclusion
        EXPECTED: Featured tab module  detail page should be opened  with universal and segment(s) inclusion text box
        """
        pass
    ...
    def test_007_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Updated Featured tab module  should be shown for specific segmented user
        """
        pass
