...
@pytest.mark.other
@vtest
class Test_C62904020_Verify_Edit_Featured_tab_module_with_segment_with_multiple_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904020
    NAME: Verify Edit Featured tab module with segment (with multiple segment(s) inclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Updated Featured tab module should be shown for specific segmented users
        """
        pass
