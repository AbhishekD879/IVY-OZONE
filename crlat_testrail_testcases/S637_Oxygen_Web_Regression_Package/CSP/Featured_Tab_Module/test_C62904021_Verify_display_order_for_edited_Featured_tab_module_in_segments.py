...
@pytest.mark.other
@vtest
class Test_C62904021_Verify_display_order_for_edited_Featured_tab_module_in_segments(Common):
    """
    TR_ID: C62904021
    NAME: Verify display order for edited Featured tab module in segments
    DESCRIPTION: This test case verifies display order for edited Featured tab module in segments
    ...
    def test_004_click_on_existing_featured_tab_module_with_segment_inclusion(self):
        ...
        EXPECTED: Featured tab module detail page should be opened  with Segment(s)  inclusion radio button and segment(s) inclusion text box
        """
        pass
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: Featured tab module should be update successfully. Should navigate to Featured tab module module page
        """
        pass
