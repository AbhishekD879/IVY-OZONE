...
@pytest.mark.other
@vtest
class Test_C62904022_Verify_edit_Featured_tab_module_with_segment_with_segments_inclusion_to_Universal_and_vise_versa_and_verify_in_FE(Common):
    """
    TR_ID: C62904022
    NAME: Verify edit Featured tab module with segment (with segment(s) inclusion) to Universal and vise versa and verify in FE
    DESCRIPTION: This test case verifies editing of existing Segment(s) inclusion Featured tab module
    ...
    def test_004_click_on_existing_featured_tab_module_with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module with segment inclusion
        EXPECTED: Featured tab module detail page should be opened  with Segment inclusion and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_featured_tab_module_select_universal_radio_button(self):
        """
        DESCRIPTION: Edit existing Featured tab module ,select Universal radio button
    ...
    def test_007_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Updated Featured tab module should be shown as universal view
        """
        pass
