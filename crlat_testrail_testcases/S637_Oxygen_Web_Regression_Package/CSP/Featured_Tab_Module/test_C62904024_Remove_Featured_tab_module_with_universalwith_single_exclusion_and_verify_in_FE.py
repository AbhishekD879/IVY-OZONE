...
@pytest.mark.other
@vtest
class Test_C62904024_Remove_Featured_tab_module_with_universalwith_single_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904024
    NAME: Remove Featured tab module with universal(with single exclusion) and verify in FE
    ...
    def test_004_click_on_existing_featured_tab_module_with_universal_with_single_exclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module with Universal (with single exclusion)
