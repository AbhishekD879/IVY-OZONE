...
@pytest.mark.other
@vtest
class Test_C62904025_Remove_Featured_tab_module_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904025
    NAME: Remove Featured tab module with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_featured_tab_module_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module with Universal (with multiple exclusion)
