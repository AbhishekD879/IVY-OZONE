...
@pytest.mark.other
@vtest
class Test_C62904026_Verify_Remove_Featured_tab_module_with_Segmentwith_single_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904026
    NAME: Verify Remove Featured tab module with Segment(with single inclusion) and verify in FE
    ...
    def test_004_click_on_existing_featured_tab_module_with_segmentwith_single_inclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module with Segment(with single inclusion)
        EXPECTED: Featured tab module detail page should be opened  with Universal (with single exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Removed Featured tab module should not be shown in application, Featured tab module should be removed from specific segment
        """
        pass
