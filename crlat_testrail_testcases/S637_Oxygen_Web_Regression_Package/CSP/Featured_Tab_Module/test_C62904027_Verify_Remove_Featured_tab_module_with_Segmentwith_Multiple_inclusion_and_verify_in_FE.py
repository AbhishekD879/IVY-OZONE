...
@pytest.mark.other
@vtest
class Test_C62904027_Verify_Remove_Featured_tab_module_with_Segmentwith_Multiple_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62904027
    NAME: Verify Remove Featured tab module with Segment(with Multiple inclusion) and verify in FE
    ...
    def test_004_click_on_existing_featured_tab_module_with_segmentwith_multiple_inclusion(self):
        """
        DESCRIPTION: Click on existing Featured tab module with Segment(with Multiple inclusion)
        EXPECTED: Featured tab module detail page should be opened  with Universal (with Multiple exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_featured_tab_module(self):
        ...
        EXPECTED: Removed Featured tab module should not be shown in application, Featured tab module should be removed from specific segments
        """
        pass
