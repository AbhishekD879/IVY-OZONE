...
@pytest.mark.other
@vtest
class Test_C63761094_Verify_Module_ribbon_tab_module_ordering_for_universal(Common):
    """
    TR_ID: C63761094
    NAME: Verify Module ribbon tab module ordering for universal
    DESCRIPTION: Test case verifies possibility to order Module ribbon tab module for Universal
    ...
    def test_004_verify_newly_created_module_ribbon_tabs_ordering(self):
        """
        DESCRIPTION: Verify newly created Module ribbon tabs ordering
    ...
    def test_005_verify_the_order_of_the_module_ribbon_tab_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Module ribbon tab module for universal is as per order in the CMS.
