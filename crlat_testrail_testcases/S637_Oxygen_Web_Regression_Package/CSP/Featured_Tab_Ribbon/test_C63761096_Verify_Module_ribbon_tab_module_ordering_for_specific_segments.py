...
@pytest.mark.other
@vtest
class Test_C63761096_Verify_Module_ribbon_tab_module_ordering_for_specific_segments(Common):
    """
    TR_ID: C63761096
    NAME: Verify Module ribbon tab module ordering for specific segments
    DESCRIPTION: Test case verifies possibility to order Module ribbon tab module for specific segments
    ...
    def test_003_click_on_module_ribbon_tab_link(self):
        ...
        EXPECTED: User should be able to view Already Created Module ribbon tabs should be displayed.
        """
        pass

    def test_004_verify_newly_created_module_ribbon_tabs_ordering_for_specific_segments(self):
        """
        DESCRIPTION: Verify newly created Module ribbon tabs ordering for specific segments
    ...
    def test_006_verify_the_order_of_the_module_ribbon_tab_module_for_specific_segments_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Module ribbon tab module for specific segments is as per order in the CMS.
