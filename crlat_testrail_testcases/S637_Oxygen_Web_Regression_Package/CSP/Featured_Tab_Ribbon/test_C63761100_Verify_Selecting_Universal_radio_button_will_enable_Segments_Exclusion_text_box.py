...
@pytest.mark.other
@vtest
class Test_C63761100_Verify_Selecting_Universal_radio_button_will_enable_Segments_Exclusion_text_box(Common):
    """
    TR_ID: C63761100
    ...
    def test_007_load_oxygen_app_and_verify_module_ribbon_tab(self):
        """
        DESCRIPTION: Load Oxygen app and verify Module ribbon tab
        EXPECTED: Universal user should able to view Module ribbon tabs across the application except in football (as we have configured segment(s) Exclusion as Football)
        """
        pass
