...
@pytest.mark.other
@vtest
class Test_C63761101_Verify_Selecting_segments_inclusion_radio_button_will_enable_Segments_inclusion_text_box(Common):
    """
    TR_ID: C63761101
    ...
    def test_007_load_oxygen_app_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: For only football segmented user should able to view Module ribbon tab (as we have configured segment(s) inclusion as Football)
        """
        pass
