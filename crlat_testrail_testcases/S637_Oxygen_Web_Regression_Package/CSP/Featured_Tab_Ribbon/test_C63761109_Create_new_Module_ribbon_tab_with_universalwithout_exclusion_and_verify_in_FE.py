...
@pytest.mark.other
@vtest
class Test_C63761109_Create_new_Module_ribbon_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761109
    NAME: Create new Module ribbon tab with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new Module ribbon tab with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_create_button(self):
        ...
        EXPECTED: Universal Module ribbon tab should be created Successfully
        """
        pass
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_module_ribbon_tab(self):
        ...
        EXPECTED: Universal user and logged out should able view Module ribbon tab
        """
        pass
