...
@pytest.mark.other
@vtest
class Test_C63761112_Create_new_Module_ribbon_tab_with_Segments_Inclusion_single_segment_and_verify_in_FE(Common):
    """
    TR_ID: C63761112
    NAME: Create new Module ribbon tab with Segment(s) Inclusion (single segment) and verify in FE
    DESCRIPTION: This test case verifies creating a new Module ribbon tab with Segment(s) Inclusion (single segment)
    ...
    def test_006_enter_segment_name_in_segments_inclusion_text_box_click_on_save_changes_button(self):
        ...
        EXPECTED: Segmented Module ribbon tab should be created Successfully
        """
        pass

    def test_007_load_oxygen_app_and_verify_newly_created_module_ribbon_tab_for_segmented_user(self):
        """
        DESCRIPTION: Load Oxygen app and verify newly created Module ribbon tab for segmented user
        EXPECTED: Specific segment user should able view Module ribbon tab.
        """
        pass
