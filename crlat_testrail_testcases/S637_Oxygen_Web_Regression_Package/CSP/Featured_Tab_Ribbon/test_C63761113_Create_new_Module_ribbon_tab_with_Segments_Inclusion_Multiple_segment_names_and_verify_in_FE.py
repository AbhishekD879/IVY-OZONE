...
@pytest.mark.other
@vtest
class Test_C63761113_Create_new_Module_ribbon_tab_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C63761113
    NAME: Create new Module ribbon tab with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new Module ribbon tab with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_004_click_on_create_module_ribbon_tab_cta_button(self):
        """
        DESCRIPTION: Click on Create Module ribbon tab CTA button
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_module_ribbon_tab(self):
        ...
        EXPECTED: Specific segmented users should able view Module ribbon tab
        """
        pass
