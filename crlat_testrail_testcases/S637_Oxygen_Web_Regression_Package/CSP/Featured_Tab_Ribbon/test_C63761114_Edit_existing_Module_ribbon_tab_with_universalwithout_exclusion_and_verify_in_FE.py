...
@pytest.mark.other
@vtest
class Test_C63761114_Edit_existing_Module_ribbon_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761114
    NAME: Edit existing Module ribbon tab with universal(without exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: Updated Module ribbon tab should be shown for Universal user
        """
        pass
