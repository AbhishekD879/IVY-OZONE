...
@pytest.mark.other
@vtest
class Test_C63761115_Verify_Edit_exit_Module_ribbon_tab_with_universalwith_single_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761115
    NAME: Verify Edit exit Module ribbon tab with universal(with single segment exclusion) and verify in FE
    DESCRIPTION: This test case verifies editing of existing Universal segmented Module ribbon tab
    ...
    def test_004_click_on_existing_module_ribbon_tab_with_segment_exclusion(self):
        """
        DESCRIPTION: Click on existing Module ribbon tab with segment exclusion
        EXPECTED: Module ribbon tab detail page should be opened  with universal and segment(s) exclusion text box
        """
        pass
    ...
    def test_007_load_oxygen_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: Updated Module ribbon tab should be shown for Universal user and segmented user except specific segments
        """
        pass
