...
@pytest.mark.other
@vtest
class Test_C63761116_Verify_Edit_Module_ribbon_tab_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761116
    NAME: Verify Edit Module ribbon tab with universal(with multiple segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: Updated Module ribbon tab should be shown for Universal user except specific segments
        """
        pass
