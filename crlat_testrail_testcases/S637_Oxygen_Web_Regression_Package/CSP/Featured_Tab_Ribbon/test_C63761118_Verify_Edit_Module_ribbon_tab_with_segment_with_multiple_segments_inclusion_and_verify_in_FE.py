...
@pytest.mark.other
@vtest
class Test_C63761118_Verify_Edit_Module_ribbon_tab_with_segment_with_multiple_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761118
    NAME: Verify Edit Module ribbon tab with segment (with multiple segment(s) inclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: Updated Module ribbon tab should be shown for specific segmented users
        """
        pass
