...
@pytest.mark.other
@vtest
class Test_C63761120_Verify_edit_Module_ribbon_tab_with_segment_with_segments_inclusion_to_Universal_and_vise_versa_and_verify_in_FE(Common):
    """
    TR_ID: C63761120
    NAME: Verify edit Module ribbon tab with segment (with segment(s) inclusion) to Universal and vise versa and verify in FE
    ...
    def test_004_click_on_existing_module_ribbon_tab_with_segment_inclusion(self):
        ...
        EXPECTED: Module ribbon tab detail page should be opened  with Segment inclusion and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_module_ribbon_tab_select_universal_radio_button(self):
        """
        DESCRIPTION: Edit existing Module ribbon tab ,select Universal radio button
    ...
    def test_007_load_oxygen_and_verify_module_ribbon_tab(self):
        ...
        EXPECTED: Updated Module ribbon tab should be shown as universal view
        """
        pass
