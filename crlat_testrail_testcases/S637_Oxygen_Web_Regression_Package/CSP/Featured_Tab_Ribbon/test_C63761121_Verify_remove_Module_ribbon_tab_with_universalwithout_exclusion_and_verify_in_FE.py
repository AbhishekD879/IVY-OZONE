...
@pytest.mark.other
@vtest
class Test_C63761121_Verify_remove_Module_ribbon_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761121
    NAME: Verify remove Module ribbon tab with universal(without exclusion) and verify in FE
    ...
    def test_001_repeat_the_above_steps_for_universal_to_segment_inclusion(self):
        ...
        EXPECTED: Updated Module ribbon tab should be Shown in specific segmented view
        """
        pass
    ...
    def test_004_click_on_existing_module_ribbon_tab_with_universal_without_exclusion(self):
        """
        DESCRIPTION: Click on existing Module ribbon tab with Universal (without exclusion)
        EXPECTED: Module ribbon tab detail page should be opened  with Universal (without exclusion)
        """
        pass
