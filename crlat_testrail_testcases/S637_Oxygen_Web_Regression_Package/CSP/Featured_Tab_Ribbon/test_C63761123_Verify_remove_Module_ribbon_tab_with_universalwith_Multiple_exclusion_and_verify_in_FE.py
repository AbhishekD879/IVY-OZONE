...
@pytest.mark.other
@vtest
class Test_C63761123_Verify_remove_Module_ribbon_tab_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C63761123
    NAME: Verify remove Module ribbon tab with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_module_ribbon_tab_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing Module ribbon tab with Universal (with multiple exclusion)
