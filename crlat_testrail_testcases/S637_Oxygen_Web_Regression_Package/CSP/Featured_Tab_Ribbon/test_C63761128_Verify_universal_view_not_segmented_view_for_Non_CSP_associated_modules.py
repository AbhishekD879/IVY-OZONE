...
@pytest.mark.other
@vtest
class Test_C63761128_Verify_universal_view_not_segmented_view_for_Non_CSP_associated_modules(Common):
    """
    TR_ID: C63761128
    ...
    PRECONDITIONS: 2)Create a some Segmented and universal Module ribbon tabs
