...
@pytest.mark.other
@vtest
class Test_C62701181_Verify_universal_viewuniversal_exculed_and_universal_for_not_logged_in_user(Common):
    """
    TR_ID: C62701181
    NAME: Verify universal view(universal exculed and universal) for not logged in user
