...
@pytest.mark.other
@vtest
class Test_C62701183_Verify_universal_viewuniversal_exclued_and_universal_for_not_segmented_user(Common):
    """
    TR_ID: C62701183
    NAME: Verify universal view(universal exclued and universal) for not segmented user
    DESCRIPTION: This test case verifies Universal view for not segmented to any specific segment
    ...
    def test_002_login_with_not_segmented_user(self):
        """
        DESCRIPTION: Login with not segmented user
        EXPECTED: User should login successfully
        """
        pass

    def test_003_verify_universal_view(self):
        """
        DESCRIPTION: Verify universal view
        EXPECTED: 1) User should see universal view and universal exclusion.
        EXPECTED: 2) Segmented footer menu should not display
        EXPECTED: 3) If segmented user login to application, universal and segmented footer menu for that user should display
        """
        pass
