...
@pytest.mark.other
@vtest
class Test_C62701184_Verify_universal_with_excluded_segement_view_for_segmented_loggedout_user(Common):
    """
    TR_ID: C62701184
    NAME: Verify universal (with excluded segement) view for segmented loggedout user
    ...
    def test_004_logout_user_from_application(self):
        ...
        EXPECTED: User should loggedout successfully
        """
        pass
