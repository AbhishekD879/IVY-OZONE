...
@pytest.mark.other
@vtest
class Test_C62701196_Verify_Footer_menu_module_ordering_for_universal(Common):
    """
    TR_ID: C62701196
    NAME: Verify Footer menu module ordering for universal
    DESCRIPTION: Test case verifies possibility to order Footer menu module for Universal
    ...
    def test_005_verify_the_order_of_the_footer_menu_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Footer Menu module for universal is as per order in the CMS.
        EXPECTED: The order is as defined in CMS.
        """
        pass

    def test_006_reorder_by_drag_and_drop_in_cms_and_verify_the_order_in_fe(self):
        """
