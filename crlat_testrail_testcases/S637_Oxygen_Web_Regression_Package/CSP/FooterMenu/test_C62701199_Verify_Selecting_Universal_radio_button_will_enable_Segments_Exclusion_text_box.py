...
@pytest.mark.other
@vtest
class Test_C62701199_Verify_Selecting_Universal_radio_button_will_enable_Segments_Exclusion_text_box(Common):
    """
    TR_ID: C62701199
    ...
    def test_007_load_oxygen_app_and_verify_footer_menu(self):
        ...
        EXPECTED: Univarsal user should able to view footer menus except football ((as we have configured segment(s) Exclusion as Football)
        """
        pass
