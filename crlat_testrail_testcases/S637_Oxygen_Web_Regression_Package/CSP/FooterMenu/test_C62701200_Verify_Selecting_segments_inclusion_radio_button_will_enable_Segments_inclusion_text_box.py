...
@pytest.mark.other
@vtest
class Test_C62701200_Verify_Selecting_segments_inclusion_radio_button_will_enable_Segments_inclusion_text_box(Common):
    """
    TR_ID: C62701200
    ...
    def test_005_select_segments_inclusion_button(self):
        ...
        EXPECTED: Upon selecting  segment(s) inclusion radio button ,Segment(s) inclusion text box should be enabled and able to enter text (ex: Football)
        """
        pass
    ...
    def test_007_load_oxygen_app_and_verify_footer_menu(self):
        ...
        EXPECTED: For only football segmented user should able to view  footer menu (as we have configured segment(s) inclusion as Football)
        """
        pass
