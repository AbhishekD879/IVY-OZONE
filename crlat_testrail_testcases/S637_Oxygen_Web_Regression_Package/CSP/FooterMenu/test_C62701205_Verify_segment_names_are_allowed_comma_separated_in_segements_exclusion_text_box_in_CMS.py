...
@pytest.mark.other
@vtest
class Test_C62701205_Verify_segment_names_are_allowed_comma_separated_in_segements_exclusion_text_box_in_CMS(Common):
    """
    TR_ID: C62701205
    NAME: Verify segment name(s) are allowed comma separated in segement(s) exclusion text box in CMS
    ...
    def test_006_verify_user_able_to_enter_more_than_one_segment_name_in_segments_exclusion_text_box(self):
        ...
        EXPECTED: User should be able to enter more than one segment name with comma (,) seperated
        """
        pass
