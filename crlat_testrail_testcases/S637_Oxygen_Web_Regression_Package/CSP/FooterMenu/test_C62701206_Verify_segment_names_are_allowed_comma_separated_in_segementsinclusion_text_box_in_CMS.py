...
@pytest.mark.other
@vtest
class Test_C62701206_Verify_segment_names_are_allowed_comma_separated_in_segementsinclusion_text_box_in_CMS(Common):
    """
    TR_ID: C62701206
    NAME: Verify segment name(s) are allowed comma separated in segement(s)inclusion text box in CMS
