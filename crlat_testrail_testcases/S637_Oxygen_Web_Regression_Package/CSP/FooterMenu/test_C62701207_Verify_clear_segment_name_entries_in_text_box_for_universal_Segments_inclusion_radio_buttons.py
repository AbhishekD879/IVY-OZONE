...
@pytest.mark.other
@vtest
class Test_C62701207_Verify_clear_segment_name_entries_in_text_box_for_universal_Segments_inclusion_radio_buttons(Common):
    """
    TR_ID: C62701207
    NAME: Verify clear segment name entries in text box for universal/Segment(s) inclusion radio buttons
    DESCRIPTION: This test case verifies clear segments name entires in text boxes
    ...
    def test_006_select_segmentsinclusion_radio_button(self):
        ...
        EXPECTED: a)Segment(s) inclusion test box should enable b)Existing segment names in segment(s) exclusion text box should be cleared
        """
        pass

    def test_007_repeated_56_steps_for_segments_inclusion_radio_button(self):
        """
