...
@pytest.mark.other
@vtest
class Test_C62701210_Create_new_primary_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701210
    NAME: Create new primary tab with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new primary(Footer menu) with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_save_changes_button(self):
        """
        DESCRIPTION: Segment(s) exclusion text box leave empty ,click on save changes button
        EXPECTED: Universal Footer menu should be created Sucessfully
        """
        pass
