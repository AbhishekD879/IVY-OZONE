...
@pytest.mark.other
@vtest
class Test_C62701212_Create_new_primary_tab_Footer_menuwith_universalMultiple_segments_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701212
    NAME: Create new primary tab (Footer menu)with universal(Multiple segments exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new primary tab (Footer menu) with universal for multiple segment exclusion
    ...
    def test_006_enter_more_than_one_segments_name_in_segments_exclusion_text_box_with_comma_separatedclick_on_save_changes_button(self):
        """
        ...
        EXPECTED: Universal Footer menu should be created Sucessfully with multiple segment(s)exclusion
        """
        pass
