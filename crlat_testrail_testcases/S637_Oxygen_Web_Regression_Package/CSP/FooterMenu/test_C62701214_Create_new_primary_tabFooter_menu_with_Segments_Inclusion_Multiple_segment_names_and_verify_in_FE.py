...
@pytest.mark.other
@vtest
class Test_C62701214_Create_new_primary_tabFooter_menu_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C62701214
    NAME: Create new primary tab(Footer menu) with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new primary tab (Footer menu) with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_footer_menu(self):
        ...
        EXPECTED: Specific segmented users only should able view newly created Footer menu.
