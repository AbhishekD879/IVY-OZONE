...
@pytest.mark.other
@vtest
class Test_C62701215_Edit_primary_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701215
    NAME: Edit primary tab with universal(without exclusion) and verify in FE
