...
@pytest.mark.other
@vtest
class Test_C62701219_Edit_primary_tab_with_segment_with_multiple_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701219
    NAME: Edit primary tab with segment (with multiple segment(s) inclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_footer_menu(self):
        ...
        EXPECTED: Updated footer menu should be shown for specific segmented users
        """
        pass
