...
@pytest.mark.other
@vtest
class Test_C62701220_Verify_display_order_for_edited_footer_menu_in_segments(Common):
    """
    TR_ID: C62701220
    NAME: Verify display order for edited footer menu in segments
    DESCRIPTION: This test case verifies display order for edited footer menu in segments
    ...
    def test_004_click_on_existing_footer_menu_with_segment_inclusion(self):
        ...
        EXPECTED: Footer menu detail page should be opened  with Segment(s)  inclusion radio button and segment(s) inclusion text box
        """
        pass
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: Footer menu should be update successfully.Should navigate to Footer menu module page
        """
        pass
