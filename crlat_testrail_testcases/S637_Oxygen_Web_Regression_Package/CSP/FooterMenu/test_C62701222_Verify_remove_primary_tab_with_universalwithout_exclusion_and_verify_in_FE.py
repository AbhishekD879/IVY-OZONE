...
@pytest.mark.other
@vtest
class Test_C62701222_Verify_remove_primary_tab_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701222
    NAME: Verify remove primary tab with universal(without exclusion) and verify in FE
    ...
    def test_004_click_on_existing_footer_menu_with_universal_without_exclusion(self):
        """
        DESCRIPTION: Click on existing Footer menu with Universal (without exclusion)
        EXPECTED: Footer menu detail page should be opened  with Universal (without exclusion)
        """
        pass
