...
@pytest.mark.other
@vtest
class Test_C62701223_Verify_remove_primary_tab_with_universalwith_single_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701223
    NAME: Verify remove primary tab with universal(with single exclusion) and verify in FE
    ...
    def test_004_click_on_existing_footer_menu_with_universal_with_single_exclusion(self):
        """
        DESCRIPTION: Click on existing Footer menu with Universal (with single exclusion)
    ...
    def test_006_load_oxygen_and_verify_footer_menu(self):
        ...
        EXPECTED: Removed footer menu should not be shown in application
        """
        pass
