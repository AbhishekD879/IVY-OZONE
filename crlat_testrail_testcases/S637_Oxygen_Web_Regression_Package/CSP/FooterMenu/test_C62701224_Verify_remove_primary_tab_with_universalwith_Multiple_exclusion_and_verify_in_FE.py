...
@pytest.mark.other
@vtest
class Test_C62701224_Verify_remove_primary_tab_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701224
    NAME: Verify remove primary tab with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_footer_menu_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing Footer menu with Universal (with multiple exclusion)
