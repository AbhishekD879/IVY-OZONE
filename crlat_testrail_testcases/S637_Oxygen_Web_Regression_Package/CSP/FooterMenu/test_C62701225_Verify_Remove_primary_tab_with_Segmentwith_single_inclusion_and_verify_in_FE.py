...
@pytest.mark.other
@vtest
class Test_C62701225_Verify_Remove_primary_tab_with_Segmentwith_single_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701225
    NAME: Verify Remove primary tab with Segment(with single inclusion) and verify in FE
    ...
    def test_004_click_on_existing_footer_menu_with_segmentwith_single_inclusion(self):
        """
        DESCRIPTION: Click on existing Footer menu with Segment(with single inclusion)
        EXPECTED: Footer menu detail page should be opened  with Universal (with single exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_footer_menu(self):
        ...
        EXPECTED: Removed footer menu should not be shown in application,Footer menu should be removed from specific segment
        """
        pass
