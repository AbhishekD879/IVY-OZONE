...
@pytest.mark.other
@vtest
class Test_C62701227_Verify_Edit_Remove_should_be_disabled_for_records_other_than_selected_segment_in_the_dropdownin_detail_view_as_well(Common):
    """
    TR_ID: C62701227
    ...
    def test_004_select_one_of_the_segment_dropdownand_verify_editremove_button_for_otherthan_selected_segment_on_footer_menues_page(self):
        """
        DESCRIPTION: Select one of the segment dropdown,and verify Edit/remove button for otherthan selected segment on Footer menues Page
        EXPECTED: User should able to select from the segment drop down.Edit/Remove button should be disable.
        """
        pass

    def test_005_navigate_to_footermenu_detail_page_of_other_than_selected_segment(self):
        """
        DESCRIPTION: Navigate to footermenu detail page of other than selected segment
        EXPECTED: Edit/Remove button should be disable ,should not allow to edit/remove in detail view
        """
        pass
