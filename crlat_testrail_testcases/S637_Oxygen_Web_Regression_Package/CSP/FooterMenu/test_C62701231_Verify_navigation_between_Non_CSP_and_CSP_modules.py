...
@pytest.mark.other
@vtest
class Test_C62701231_Verify_navigation_between_Non_CSP_and_CSP_modules(Common):
    """
    TR_ID: C62701231
    ...
    def test_006_verify_navigation_between_csp_and_non_csp_modules(self):
        ...
        EXPECTED: Navigation should be ease and respective modules/page load successfully.
        """
        pass
