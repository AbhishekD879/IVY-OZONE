...
@pytest.mark.other
@vtest
class Test_C62764600_Verify_create_new_Highlights_Carousel_functionality(Common):
    """
    TR_ID: C62764600
    NAME: Verify create new Highlights Carousel functionality
    DESCRIPTION: This test case verifies the CMS configurations for Highlights Carousel
    ...
    def test_003_click_on_highlights_carousel_link(self):
        ...
        EXPECTED: c) Title, segment(s),segment(s) exclusion, Enabled, display from, display to, Remove and Edit Columns should be displayed.
        """
        pass

    def test_004_click_on_create_highlights_carousel_moduleverify_detail_page(self):
        """
        DESCRIPTION: Click on create Highlights Carousel module,Verify detail page
        EXPECTED: Highlights Carousel module detail page should be opened with existing fields and new radio buttons Universal ,Segment(s) inclusion.
        """
        pass

    def test_005_verify_by_entering__all_mandatory_feilds_and_click_create_cta(self):
        """
        DESCRIPTION: Verify by entering  all mandatory feilds and click Create CTA
        EXPECTED: Upon Clicking Create CTA ,new Highlights Carousel module should be created and appended at the end of the list of existing segment-specific configurations by default and allow reordering.
        """
        pass
