...
@pytest.mark.other
@vtest
class Test_C62764611_Verify_user_able_to_download_the_existing_page_content_in_CSV_format_for_Highlights_Carousel(Common):
    """
    TR_ID: C62764611
    NAME: Verify user able to download the existing page content in CSV format for Highlights Carousel
