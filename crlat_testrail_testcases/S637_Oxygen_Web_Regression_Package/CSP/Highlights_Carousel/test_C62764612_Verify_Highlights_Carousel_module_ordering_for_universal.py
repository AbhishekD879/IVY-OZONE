...
@pytest.mark.other
@vtest
class Test_C62764612_Verify_Highlights_Carousel_module_ordering_for_universal(Common):
    """
    TR_ID: C62764612
    NAME: Verify Highlights Carousel module ordering for universal
    DESCRIPTION: Test case verifies possibility to order Highlights Carousel module for Universal
    ...
    def test_004_verify_newly_created_highlights_carousels_ordering(self):
        """
        DESCRIPTION: Verify newly created Highlights Carousels ordering
    ...
    def test_005_verify_the_order_of_the_highlights_carousel_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Highlights Carousel module for universal is as per order in the CMS.
