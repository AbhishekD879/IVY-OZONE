...
@pytest.mark.other
@vtest
class Test_C62764614_Verify_Highlights_Carousel_module_ordering_for_specific_segments(Common):
    """
    TR_ID: C62764614
    NAME: Verify Highlights Carousel module ordering for specific segments
    DESCRIPTION: Test case verifies possibility to order Highlights Carousel module for specific segments
    ...
    def test_003_click_on_highlights_carousel_link(self):
        ...
        EXPECTED: User should be able to view Already Created Highlights Carousels should be displayed.
        """
        pass

    def test_004_verify_newly_created_highlights_carousels_ordering_for_specific_segments(self):
        """
        DESCRIPTION: Verify newly created Highlights Carousels ordering for specific segments
    ...
    def test_006_verify_the_order_of_the_highlights_carousel_module_for_specific_segments_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Highlights Carousel module for specific segments is as per order in the CMS.
