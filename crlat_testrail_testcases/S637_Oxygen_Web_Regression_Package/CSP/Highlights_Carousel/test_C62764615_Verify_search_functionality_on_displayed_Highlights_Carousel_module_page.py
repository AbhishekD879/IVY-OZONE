...
@pytest.mark.other
@vtest
class Test_C62764615_Verify_search_functionality_on_displayed_Highlights_Carousel_module_page(Common):
    """
    TR_ID: C62764615
    NAME: Verify search functionality on displayed Highlights Carousel module page.
    DESCRIPTION: This test case verifies search functionality by text in the records shown on the table in Highlights Carousel module page.
    ...
    def test_003_click_at_search_for_highlights_carousel(self):
        """
        DESCRIPTION: Click at "Search for Highlights Carousel"
    ...
    def test_004_search_by_link_tittle(self):
        ...
        EXPECTED: b) results should retain from selected drop down only which means if user select any segment search should not display Highlights Carousels in other segment
        """
        pass
