...
@pytest.mark.other
@vtest
class Test_C62764619_Verify_Selecting_segments_inclusion_radio_button_will_enable_Segments_inclusion_text_box(Common):
    """
    TR_ID: C62764619
    ...
    def test_007_load_oxygen_app_and_verify_highlights_carousel(self):
        ...
        EXPECTED: For only football segmented user should able to view Highlights Carousel (as we have configured segment(s) inclusion as Football)
        """
        pass
