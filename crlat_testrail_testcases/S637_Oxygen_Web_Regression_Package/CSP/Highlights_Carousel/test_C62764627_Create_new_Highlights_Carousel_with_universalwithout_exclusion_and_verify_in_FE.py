...
@pytest.mark.other
@vtest
class Test_C62764627_Create_new_Highlights_Carousel_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764627
    NAME: Create new Highlights Carousel with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new Highlights Carousel with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_create_button(self):
        ...
        EXPECTED: Universal Highlights Carousel should be created Successfully
        """
        pass
