...
@pytest.mark.other
@vtest
class Test_C62764628_Create_new_Highlights_Carousel_with_universalSingle_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764628
    NAME: Create new Highlights Carousel with universal(Single segment exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new Highlights Carousel with universal (single segment exclusion)
    ...
    def test_006_enter_segment_name_in_segments_exclusion_text_box_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal Highlights Carousel should be created Successfully with single segment exclusion
        """
        pass
