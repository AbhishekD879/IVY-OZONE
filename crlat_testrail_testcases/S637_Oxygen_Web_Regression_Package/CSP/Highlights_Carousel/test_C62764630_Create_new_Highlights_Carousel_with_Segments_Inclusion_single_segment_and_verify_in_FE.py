...
@pytest.mark.other
@vtest
class Test_C62764630_Create_new_Highlights_Carousel_with_Segments_Inclusion_single_segment_and_verify_in_FE(Common):
    """
    TR_ID: C62764630
    NAME: Create new Highlights Carousel with Segment(s) Inclusion (single segment) and verify in FE
    DESCRIPTION: This test case verifies creating a new Highlights Carousel with Segment(s) Inclusion (single segment)
    ...
    def test_006_enter_segment_name_in_segments_inclusion_text_box_click_on_save_changes_button(self):
        ...
        EXPECTED: Segmented Highlights Carousel should be created Successfully
        """
        pass

    def test_007_load_oxygen_app_and_verify_newly_created_highlights_carousel_for_segmented_user(self):
        """
        DESCRIPTION: Load Oxygen app and verify newly created Highlights Carousel for segmented user
        EXPECTED: Specific segmented user only should able view newly created Highlights Carousel.
