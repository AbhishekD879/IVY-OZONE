...
@pytest.mark.other
@vtest
class Test_C62764631_Create_new_Highlights_Carousel_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C62764631
    NAME: Create new Highlights Carousel with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new Highlights Carousel with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_004_click_on_create_highlights_carousel_cta_button(self):
        """
        DESCRIPTION: Click on Create Highlights Carousel CTA button
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_highlights_carousel(self):
        ...
        EXPECTED: Specific segmented users only should able view newly created Highlights Carousel.
