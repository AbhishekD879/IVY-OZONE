...
@pytest.mark.other
@vtest
class Test_C62764632_Edit_existing_Highlights_Carousel_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764632
    NAME: Edit existing Highlights Carousel with universal(without exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Updated Highlight Carousel should be shown for
