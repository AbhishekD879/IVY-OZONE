...
@pytest.mark.other
@vtest
class Test_C62764633_Verify_edit_existing_Highlights_Carousel_with_universalwith_single_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764633
    NAME: Verify edit existing Highlights Carousel with universal(with single segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Updated Highlights Carousel should be shown for
