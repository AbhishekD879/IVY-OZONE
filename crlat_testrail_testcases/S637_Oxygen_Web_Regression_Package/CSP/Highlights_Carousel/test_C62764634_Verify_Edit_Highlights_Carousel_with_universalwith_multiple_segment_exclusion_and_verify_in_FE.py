...
@pytest.mark.other
@vtest
class Test_C62764634_Verify_Edit_Highlights_Carousel_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764634
    NAME: Verify Edit Highlights Carousel with universal(with multiple segment exclusion) and verify in FE
    DESCRIPTION: This test case verifies editing of existing Universal segmented Highlights Carousel
    ...
    def test_004_click_on_existing_highlights_carousel_with_segment_exclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel with segment exclusion
        EXPECTED: Highlights Carousel detail page should be opened  with universal and segment(s) exclusion text box
        """
        pass
    ...
    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Updated Highlights Carousel should be shown for Universal user except specific segments
        """
        pass
