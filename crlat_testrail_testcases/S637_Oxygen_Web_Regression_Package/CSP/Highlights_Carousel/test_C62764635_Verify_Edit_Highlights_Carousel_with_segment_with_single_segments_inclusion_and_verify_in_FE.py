...
@pytest.mark.other
@vtest
class Test_C62764635_Verify_Edit_Highlights_Carousel_with_segment_with_single_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764635
    NAME: Verify Edit Highlights Carousel with segment (with single segment(s) inclusion) and verify in FE
    ...
    def test_003_click_on_highlights_carousel__link(self):
        """
    ...
    def test_004_click_on_existing_highlights_carousel__with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel  with segment inclusion
        EXPECTED: Highlights Carousel  detail page should be opened  with universal and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_highlights_carousel(self):
        """
        DESCRIPTION: Edit existing Highlights Carousel
    ...
    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Updated Highlights Carousel  should be shown for specific segmented user
        """
        pass
