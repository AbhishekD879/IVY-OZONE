...
@pytest.mark.other
@vtest
class Test_C62764636_Verify_Edit_Highlights_Carousel_with_segment_with_multiple_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764636
    NAME: Verify Edit Highlights Carousel with segment (with multiple segment(s) inclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Updated Highlights Carousel should be shown for specific segmented users
        """
        pass
