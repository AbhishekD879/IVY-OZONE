...
@pytest.mark.other
@vtest
class Test_C62764637_Verify_display_order_for_edited_Highlights_Carousel_in_segments(Common):
    """
    TR_ID: C62764637
    NAME: Verify display order for edited Highlights Carousel in segments
    DESCRIPTION: This test case verifies display order for edited Highlights Carousel in segments
    ...
    def test_004_click_on_existing_highlights_carousel_with_segment_inclusion(self):
        ...
        EXPECTED: Highlights Carousel detail page should be opened  with Segment(s)  inclusion radio button and segment(s) inclusion text box
        """
        pass
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: Highlights Carousel should be update successfully. Should navigate to Highlights Carousel module page
        """
        pass
