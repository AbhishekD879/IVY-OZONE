...
@pytest.mark.other
@vtest
class Test_C62764638_Verify_edit_Highlights_Carousel_with_segment_with_segments_inclusion_to_Universal_and_vise_versa_and_verify_in_FE(Common):
    """
    TR_ID: C62764638
    NAME: Verify edit Highlights Carousel with segment (with segment(s) inclusion) to Universal and vise versa and verify in FE
    DESCRIPTION: This test case verifies editing of existing Segment(s) inclusion Highlights Carousel
    ...
    def test_004_click_on_existing_highlights_carousel_with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel with segment inclusion
        EXPECTED: Highlights Carousel detail page should be opened  with Segment inclusion and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_highlights_carousel_select_universal_radio_button(self):
        """
        DESCRIPTION: Edit existing Highlights Carousel ,select Universal radio button
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: Highlights Carousel should be update successfully.
        """
        pass

    def test_007_load_oxygen_and_verify_highlights_carousel(self):
        """
        DESCRIPTION: Load oxygen and verify Highlights Carousel
        EXPECTED: Updated Highlights Carousel should be shown as universal view
        """
        pass
