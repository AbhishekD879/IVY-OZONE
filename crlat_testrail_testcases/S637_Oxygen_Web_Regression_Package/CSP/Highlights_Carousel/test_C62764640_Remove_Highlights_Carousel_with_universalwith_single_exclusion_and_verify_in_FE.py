...
@pytest.mark.other
@vtest
class Test_C62764640_Remove_Highlights_Carousel_with_universalwith_single_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764640
    NAME: Remove Highlights Carousel with universal(with single exclusion) and verify in FE
    ...
    def test_004_click_on_existing_highlights_carousel_with_universal_with_single_exclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel with Universal (with single exclusion)
