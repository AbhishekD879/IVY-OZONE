...
@pytest.mark.other
@vtest
class Test_C62764641_Remove_Highlights_Carousel_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764641
    NAME: Remove Highlights Carousel with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_highlights_carousel_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel with Universal (with multiple exclusion)
