...
@pytest.mark.other
@vtest
class Test_C62764643_Verify_Remove_Highlights_Carousel_with_Segmentwith_Multiple_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764643
    NAME: Verify Remove Highlights Carousel with Segment(with Multiple inclusion) and verify in FE
    ...
    def test_004_click_on_existing_highlights_carousel_with_segmentwith_multiple_inclusion(self):
        """
        DESCRIPTION: Click on existing Highlights Carousel with Segment(with Multiple inclusion)
        EXPECTED: Highlights Carousel detail page should be opened  with Universal (with Multiple exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_highlights_carousel(self):
        ...
        EXPECTED: Removed Highlights Carousel should not be shown in application, Highlights Carousel should be removed from specific segments
        """
        pass
