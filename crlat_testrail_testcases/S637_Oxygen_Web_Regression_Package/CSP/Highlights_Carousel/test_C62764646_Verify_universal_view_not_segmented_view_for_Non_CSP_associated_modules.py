...
@pytest.mark.other
@vtest
class Test_C62764646_Verify_universal_view_not_segmented_view_for_Non_CSP_associated_modules(Common):
    """
    TR_ID: C62764646
    ...
    PRECONDITIONS: 2)Create a some Segmented and universal Highlights Carousels
