...
@pytest.mark.other
@vtest
class Test_C62764649_Verify_segmented_view_for_specific_exTennis_segmented_user_with_universal_excluded_other_then_tennis(Common):
    """
    TR_ID: C62764649
    ...
    def test_002_verify_segmented_view_for_logged_in_user_extennis_(self):
        ...
        EXPECTED: User should able to view segmented and Universal along with Universal Highlights Carousel segment(s) exclusion (ex:other then Tennis)
        """
        pass
    ...
    def test_003_login_in_fe_with_segmented_userwhich_is_configured_in_segments_exclusion_text_box_cms(self):
        ...
        EXPECTED: User should able view segmented and Universal without Universal Highlights Carousel segment(s) exclusion
        """
        pass
