...
@pytest.mark.other
@vtest
class Test_C62900117_Verify_user_able_to_download_the_existing_page_content_in_CSV_format_for_Quick_links(Common):
    """
    TR_ID: C62900117
    NAME: Verify user able to download the existing page content in CSV format for Quick links
