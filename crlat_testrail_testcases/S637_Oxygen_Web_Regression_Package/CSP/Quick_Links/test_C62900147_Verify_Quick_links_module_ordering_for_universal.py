...
@pytest.mark.other
@vtest
class Test_C62900147_Verify_Quick_links_module_ordering_for_universal(Common):
    """
    TR_ID: C62900147
    NAME: Verify Quick links module ordering for universal
    DESCRIPTION: Test case verifies possibility to order Quick links module for Universal
    ...
    def test_004_verify_newly_created_quick_linkss_ordering(self):
        """
        DESCRIPTION: Verify newly created Quick linkss ordering
    ...
    def test_005_verify_the_order_of_the_quick_links_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Quick links module for universal is as per order in the CMS.
