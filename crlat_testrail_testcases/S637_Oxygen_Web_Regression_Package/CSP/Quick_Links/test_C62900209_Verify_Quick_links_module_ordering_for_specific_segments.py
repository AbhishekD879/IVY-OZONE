...
@pytest.mark.other
@vtest
class Test_C62900209_Verify_Quick_links_module_ordering_for_specific_segments(Common):
    """
    TR_ID: C62900209
    NAME: Verify Quick links module ordering for specific segments
    DESCRIPTION: Test case verifies possibility to order Quick links module for specific segments
    ...
    def test_003_click_on_quick_links_link(self):
        ...
        EXPECTED: User should be able to view Already Created Quick linkss should be displayed.
        """
        pass

    def test_004_verify_newly_created_quick_linkss_ordering_for_specific_segments(self):
        """
        DESCRIPTION: Verify newly created Quick linkss ordering for specific segments
    ...
    def test_006_verify_the_order_of_the_quick_links_module_for_specific_segments_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the Quick links module for specific segments is as per order in the CMS.
