...
@pytest.mark.other
@vtest
class Test_C62900225_Verify_search_functionality_on_displayed_Quick_links_module_page(Common):
    """
    TR_ID: C62900225
    NAME: Verify search functionality on displayed Quick links module page.
    DESCRIPTION: This test case verifies search functionality by text in the records shown on the table in Quick links module page.
    ...
    def test_003_click_at_search_for_quick_links(self):
        """
        DESCRIPTION: Click at "Search for Quick links"
    ...
    def test_005_(self):
        """
        DESCRIPTION: 
        EXPECTED: b) results should retain from selected drop down only which means if user select any segment search should not display Quick linkss in other segment
        """
        pass
