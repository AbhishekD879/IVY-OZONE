...
@pytest.mark.other
@vtest
class Test_C62900244_Verify_Quick_links_display_as_per_selected_segment_from_drop_down_list(Common):
    """
    TR_ID: C62900244
    NAME: Verify Quick links display as per selected segment from drop down list
    DESCRIPTION: This test case verifies segment dropdown functionality on Quick links module page.
