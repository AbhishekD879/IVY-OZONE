...
@pytest.mark.other
@vtest
class Test_C62900264_Verify_Selecting_Universal_radio_button_will_enable_Segments_Exclusion_text_box(Common):
    """
    TR_ID: C62900264
    ...
    def test_007_load_oxygen_app_and_verify_quick_links(self):
        ...
        EXPECTED: Universal user should able to view Quick linkss across the application except in football (as we have configured segment(s) Exclusion as Football)
        """
        pass
