...
@pytest.mark.other
@vtest
class Test_C62900470_Create_new_Quick_links_with_universalMultiple_segments_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900470
    NAME: Create new Quick links with universal(Multiple segments exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new Quick links with universal for multiple segment exclusion
    ...
    def test_006_enter_more_than_one_segments_name_in_segments_exclusion_text_box_with_comma_separated_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal Quick links should be created Successfully with multiple segment(s)exclusion
        """
        pass
