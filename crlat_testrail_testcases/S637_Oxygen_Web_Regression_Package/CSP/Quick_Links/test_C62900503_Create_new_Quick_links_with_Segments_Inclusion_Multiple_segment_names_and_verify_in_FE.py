...
@pytest.mark.other
@vtest
class Test_C62900503_Create_new_Quick_links_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C62900503
    NAME: Create new Quick links with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new Quick links with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_004_click_on_create_quick_links_cta_button(self):
        """
        DESCRIPTION: Click on Create Quick links CTA button
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_quick_links(self):
        ...
        EXPECTED: Specific segmented users only should able view newly created Quick links.
