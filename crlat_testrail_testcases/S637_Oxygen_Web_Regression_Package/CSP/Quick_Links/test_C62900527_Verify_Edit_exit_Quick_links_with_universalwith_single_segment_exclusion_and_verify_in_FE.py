...
@pytest.mark.other
@vtest
class Test_C62900527_Verify_Edit_exit_Quick_links_with_universalwith_single_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900527
    NAME: Verify Edit exit Quick links with universal(with single segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Updated Quick links should be shown for Universal user except specific segments
        """
        pass
