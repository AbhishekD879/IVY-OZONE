...
@pytest.mark.other
@vtest
class Test_C62900569_Verify_Edit_Quick_links_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900569
    NAME: Verify Edit Quick links with universal(with multiple segment exclusion) and verify in FE
