...
@pytest.mark.other
@vtest
class Test_C62900570_Verify_Edit_Quick_links_with_segment_with_single_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900570
    NAME: Verify Edit Quick links with segment (with single segment(s) inclusion) and verify in FE
    ...
    def test_003_click_on_quick_links__link(self):
        """
    ...
    def test_004_click_on_existing_quick_links__with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Quick links  with segment inclusion
        EXPECTED: Quick links  detail page should be opened  with universal and segment(s) inclusion text box
        """
        pass
    ...
    def test_007_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Updated Quick links  should be shown for specific segmented user
        """
        pass
