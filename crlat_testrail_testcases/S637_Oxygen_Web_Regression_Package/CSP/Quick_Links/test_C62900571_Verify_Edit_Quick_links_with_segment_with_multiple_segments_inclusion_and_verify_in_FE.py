...
@pytest.mark.other
@vtest
class Test_C62900571_Verify_Edit_Quick_links_with_segment_with_multiple_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900571
    NAME: Verify Edit Quick links with segment (with multiple segment(s) inclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Updated Quick links should be shown for specific segmented users
        """
        pass
