...
@pytest.mark.other
@vtest
class Test_C62900603_Verify_display_order_for_edited_Quick_links_in_segments(Common):
    """
    TR_ID: C62900603
    NAME: Verify display order for edited Quick links in segments
    DESCRIPTION: This test case verifies display order for edited Quick links in segments
    ...
    def test_004_click_on_existing_quick_links_with_segment_inclusion(self):
        ...
        EXPECTED: Quick links detail page should be opened  with Segment(s)  inclusion radio button and segment(s) inclusion text box
        """
        pass
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: Quick links should be update successfully. Should navigate to Quick links module page
        """
        pass
