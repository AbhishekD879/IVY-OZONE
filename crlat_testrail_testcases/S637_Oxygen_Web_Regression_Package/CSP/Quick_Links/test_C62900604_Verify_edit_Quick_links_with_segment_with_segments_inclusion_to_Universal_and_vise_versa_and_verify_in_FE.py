...
@pytest.mark.other
@vtest
class Test_C62900604_Verify_edit_Quick_links_with_segment_with_segments_inclusion_to_Universal_and_vise_versa_and_verify_in_FE(Common):
    """
    TR_ID: C62900604
    NAME: Verify edit Quick links with segment (with segment(s) inclusion) to Universal and vise versa and verify in FE
    DESCRIPTION: This test case verifies editing of existing Segment(s) inclusion Quick links
    ...
    def test_004_click_on_existing_quick_links_with_segment_inclusion(self):
        """
        DESCRIPTION: Click on existing Quick links with segment inclusion
        EXPECTED: Quick links detail page should be opened  with Segment inclusion and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_quick_links_select_universal_radio_button(self):
        """
        DESCRIPTION: Edit existing Quick links ,select Universal radio button
    ...
    def test_007_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Updated Quick links should be shown as universal view
        """
        pass
