...
@pytest.mark.other
@vtest
class Test_C62900636_Verify_remove_Quick_links_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900636
    NAME: Verify remove Quick links with universal(without exclusion) and verify in FE
    ...
    def test_001_repeat_the_above_steps_for_universal_to_segment_inclusion(self):
        ...
        EXPECTED: Updated Quick links should be Shown in specific segmented view
        """
        pass
    ...
    def test_004_click_on_existing_quick_links_with_universal_without_exclusion(self):
        """
        DESCRIPTION: Click on existing Quick links with Universal (without exclusion)
        EXPECTED: Quick links detail page should be opened  with Universal (without exclusion)
        """
        pass
