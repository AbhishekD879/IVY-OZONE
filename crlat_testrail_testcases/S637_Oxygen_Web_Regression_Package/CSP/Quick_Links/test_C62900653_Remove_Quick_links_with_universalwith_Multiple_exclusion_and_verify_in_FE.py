...
@pytest.mark.other
@vtest
class Test_C62900653_Remove_Quick_links_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900653
    NAME: Remove Quick links with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_quick_links_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing Quick links with Universal (with multiple exclusion)
