...
@pytest.mark.other
@vtest
class Test_C62900657_Verify_Remove_Quick_links_with_Segmentwith_single_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900657
    NAME: Verify Remove Quick links with Segment(with single inclusion) and verify in FE
    ...
    def test_004_click_on_existing_quick_links_with_segmentwith_single_inclusion(self):
        """
        DESCRIPTION: Click on existing Quick links with Segment(with single inclusion)
    ...
    def test_006_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Removed Quick links should not be shown in application, Quick links should be removed from specific segment
        """
        pass
