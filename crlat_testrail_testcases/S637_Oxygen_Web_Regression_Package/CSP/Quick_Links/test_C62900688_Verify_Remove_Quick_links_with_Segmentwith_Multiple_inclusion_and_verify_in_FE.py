...
@pytest.mark.other
@vtest
class Test_C62900688_Verify_Remove_Quick_links_with_Segmentwith_Multiple_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62900688
    NAME: Verify Remove Quick links with Segment(with Multiple inclusion) and verify in FE
    ...
    def test_004_click_on_existing_quick_links_with_segmentwith_multiple_inclusion(self):
        """
        DESCRIPTION: Click on existing Quick links with Segment(with Multiple inclusion)
        EXPECTED: Quick links detail page should be opened  with Universal (with Multiple exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_quick_links(self):
        ...
        EXPECTED: Removed Quick links should not be shown in application, Quick links should be removed from specific segments
        """
        pass
