...
@pytest.mark.other
@vtest
class Test_C62900723_Verify_edit_Remove_should_be_enabled_only_for_records_selected_segment_in_the_dropdown(Common):
    """
    TR_ID: C62900723
    ...
    def test_004_select_one_of_the_segment_dropdown_and_verify_editremove_button_for_only_selected_segment_on_quick_links_page(self):
        """
        DESCRIPTION: Select one of the segment dropdown, and verify Edit/remove button for only selected segment on Quick links Page
        EXPECTED: User should able to select from the segment drop down. Edit/Remove button should be enabled for only selected segment on Quick links Page
        """
        pass
