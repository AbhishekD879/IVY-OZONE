...
@pytest.mark.other
@vtest
class Test_C62900724_Verify_universal_view_not_segmented_view_for_Non_CSP_associated_modules(Common):
    """
    TR_ID: C62900724
    ...
    PRECONDITIONS: 2)Create a some Segmented and universal Quick linkss
