...
@pytest.mark.other
@vtest
class Test_C62969692_Verify_user_can_able_to_download_report_from_Download_ReportCTA(Common):
    """
    TR_ID: C62969692
    NAME: Verify user can able to download report from  "Download Report"CTA
    DESCRIPTION: This test case verifies user can able to download report from  "Download Report"CTA
