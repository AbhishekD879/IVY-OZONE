...
@pytest.mark.other
@vtest
class Test_C62701140_Verify_user_able_to_download_the_existing_page_content_in_CSV_format_for_super_button(Common):
    """
    TR_ID: C62701140
    NAME: Verify user able to download the existing page content in CSV format for super button
