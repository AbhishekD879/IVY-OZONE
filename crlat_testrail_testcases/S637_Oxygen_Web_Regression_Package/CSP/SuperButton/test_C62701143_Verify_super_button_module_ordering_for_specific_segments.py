...
@pytest.mark.other
@vtest
class Test_C62701143_Verify_super_button_module_ordering_for_specific_segments(Common):
    """
    TR_ID: C62701143
    NAME: Verify super button module ordering for specific segments
    DESCRIPTION: Test case verifies possibility to order super button module for specific segments
    ...
    def test_004_verify_newly_created_super_buttons_ordering_for_specific_segments(self):
        """
        DESCRIPTION: Verify newly created super buttons ordering for specific segments
    ...
    def test_006_verify_the_order_of_the_super_button_module_for_specific_segments_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the super button module for specific segments is as per order in the CMS.
