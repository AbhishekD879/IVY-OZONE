...
@pytest.mark.other
@vtest
class Test_C62701156_Create_new_Super_button_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701156
    NAME: Create new Super button with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new Super button with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_create_button(self):
        ...
        EXPECTED: Universal Super button should be created Successfully
        """
        pass
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_super_button(self):
        ...
        EXPECTED: 3.All segmented users
        """
        pass
