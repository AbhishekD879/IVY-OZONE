...
@pytest.mark.other
@vtest
class Test_C62701158_Create_new_Super_button_with_universalMultiple_segments_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701158
    NAME: Create new Super button with universal(Multiple segments exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new Super button with universal for multiple segment exclusion
    ...
    def test_006_enter_more_than_one_segments_name_in_segments_exclusion_text_box_with_comma_separated_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal Super button should be created Successfully with multiple segment(s)exclusion
        """
        pass
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_super_button(self):
        ...
        EXPECTED: Newly created Super button should be shown for
