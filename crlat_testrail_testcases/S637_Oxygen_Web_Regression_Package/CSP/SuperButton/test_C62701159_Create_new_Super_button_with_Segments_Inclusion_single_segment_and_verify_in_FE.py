...
@pytest.mark.other
@vtest
class Test_C62701159_Create_new_Super_button_with_Segments_Inclusion_single_segment_and_verify_in_FE(Common):
    """
    TR_ID: C62701159
    NAME: Create new Super button with Segment(s) Inclusion (single segment) and verify in FE
    DESCRIPTION: This test case verifies creating a new Super button with Segment(s) Inclusion (single segment)
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_super_button_for_segmented_user(self):
        """
        DESCRIPTION: Load Oxygen app and verify newly created Super button for segmented user
        EXPECTED: Specific segmented user only should able view newly created Super button.
