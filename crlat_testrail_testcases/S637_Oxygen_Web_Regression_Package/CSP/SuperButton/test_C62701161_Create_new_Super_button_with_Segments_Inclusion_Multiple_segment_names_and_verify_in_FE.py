...
@pytest.mark.other
@vtest
class Test_C62701161_Create_new_Super_button_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C62701161
    NAME: Create new Super button with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new Super button with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_004_click_on_create_super_button_cta_button(self):
        """
        DESCRIPTION: Click on Create Super button CTA button
    ...
    def test_006_enter_more_than_one_segment_name_in_segments_inclusion_text_box_with_comma_separated_click_on_save_changes_button(self):
        ...
        EXPECTED: Segmented Super button should be created Successfully
        """
        pass

    def test_007_load_oxygen_app_and_verify_newly_created_super_button(self):
        """
        DESCRIPTION: Load Oxygen app and verify newly created Super button
        EXPECTED: Specific segmented users should able view newly created Footer menu.
