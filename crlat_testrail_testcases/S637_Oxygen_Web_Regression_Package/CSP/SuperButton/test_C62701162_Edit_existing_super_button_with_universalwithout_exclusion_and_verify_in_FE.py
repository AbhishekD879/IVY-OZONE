...
@pytest.mark.other
@vtest
class Test_C62701162_Edit_existing_super_button_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701162
    NAME: Edit existing super button with universal(without exclusion) and verify in FE
