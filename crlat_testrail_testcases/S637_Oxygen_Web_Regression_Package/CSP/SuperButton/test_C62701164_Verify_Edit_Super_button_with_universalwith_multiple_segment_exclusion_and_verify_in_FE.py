...
@pytest.mark.other
@vtest
class Test_C62701164_Verify_Edit_Super_button_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701164
    NAME: Verify Edit Super button with universal(with multiple segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_super_button(self):
        ...
        EXPECTED: Updated Super button should be shown for Universal user except specific segments
        """
        pass
