...
@pytest.mark.other
@vtest
class Test_C62701165_Verify_Edit_Super_button_with_segment_with_single_segments_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701165
    NAME: Verify Edit Super button with segment (with single segment(s) inclusion) and verify in FE
    ...
    def test_003_click_on_super_button__link(self):
        """
    ...
    def test_004_click_on_existing_super_button__with_segment_inclusion(self):
        """
    ...
    def test_007_load_oxygen_and_verify_super_button(self):
        ...
        EXPECTED: Updated Super button  should be shown for specific segmented user
        """
        pass
