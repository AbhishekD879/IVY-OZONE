...
@pytest.mark.other
@vtest
class Test_C62701169_Verify_remove_super_button_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701169
    NAME: Verify remove super button with universal(without exclusion) and verify in FE
    ...
    def test_001_repeat_the_above_steps_for_universal_to_segment_inclusion(self):
        ...
        EXPECTED: Updated super button should be Shown in specific segmented view
        """
        pass
    ...
    def test_004_click_on_existing_super_button_with_universal_without_exclusion(self):
        """
        DESCRIPTION: Click on existing super button with Universal (without exclusion)
        EXPECTED: super button detail page should be opened  with Universal (without exclusion)
        """
        pass
