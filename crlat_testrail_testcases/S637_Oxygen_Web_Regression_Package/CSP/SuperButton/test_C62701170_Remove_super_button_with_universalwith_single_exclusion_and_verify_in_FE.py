...
@pytest.mark.other
@vtest
class Test_C62701170_Remove_super_button_with_universalwith_single_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701170
    NAME: Remove super button with universal(with single exclusion) and verify in FE
    ...
    def test_004_click_on_existing_super_button_with_universal_with_single_exclusion(self):
        """
        DESCRIPTION: Click on existing super button with Universal (with single exclusion)
