...
@pytest.mark.other
@vtest
class Test_C62701171_Remove_super_button_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701171
    NAME: Remove super button with universal(with Multiple exclusion) and verify in FE
    DESCRIPTION: This test case verifies removal Universal (with Multiple exclusion)
    ...
    def test_004_click_on_existing_super_button_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing super button with Universal (with multiple exclusion)
        EXPECTED: super button detail page should be opened  with Universal (with multiple exclusion)
        """
        pass
    ...
    def test_005_click_on_remove_button(self):
        ...
        EXPECTED: super button should be removed successfully
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_super_button(self):
        ...
        EXPECTED: Removed super button should not be shown in application
        """
        pass
