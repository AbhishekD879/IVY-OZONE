...
@pytest.mark.other
@vtest
class Test_C62701173_Verify_Remove_super_button_with_Segmentwith_Multiple_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62701173
    NAME: Verify Remove super button with Segment(with Multiple inclusion) and verify in FE
    ...
    def test_004_click_on_existing_super_button_with_segmentwith_multiple_inclusion(self):
        """
        DESCRIPTION: Click on existing super button with Segment(with Multiple inclusion)
    ...
    def test_006_load_oxygen_and_verify_super_button(self):
        ...
        EXPECTED: Removed super button should not be shown in application, super button should be removed from specific segments
        """
        pass
