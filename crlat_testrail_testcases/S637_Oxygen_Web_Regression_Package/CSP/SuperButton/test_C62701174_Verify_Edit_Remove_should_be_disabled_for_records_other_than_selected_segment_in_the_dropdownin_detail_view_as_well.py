...
@pytest.mark.other
@vtest
class Test_C62701174_Verify_Edit_Remove_should_be_disabled_for_records_other_than_selected_segment_in_the_dropdownin_detail_view_as_well(Common):
    """
    TR_ID: C62701174
    ...
    def test_004_select_one_of_the_segment_dropdown_and_verify_editremove_button_for_only_selected_segment_on_super_buttons_page(self):
        """
        DESCRIPTION: Select one of the segment dropdown, and verify Edit/remove button for only selected segment on super buttons' Page
        EXPECTED: User should able to select from the segment drop down. Edit/Remove button should be enabled for only selected segment on super buttons' Page
        """
        pass

    def test_005_navigate_to_super_button_detail_page_of_selected_segment(self):
        """
        DESCRIPTION: Navigate to Super button detail page of selected segment
