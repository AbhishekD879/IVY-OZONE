...
@pytest.mark.other
@vtest
class Test_C62701176_Verify_universal_view_not_segmented_view_for_Non_CSP_associated_modules(Common):
    """
    TR_ID: C62701176
    ...
    PRECONDITIONS: 2)Create a some Segmented and universal super buttons
