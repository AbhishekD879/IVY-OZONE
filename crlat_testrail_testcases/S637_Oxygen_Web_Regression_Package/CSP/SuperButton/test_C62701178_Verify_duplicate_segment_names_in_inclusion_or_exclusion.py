...
@pytest.mark.other
@vtest
class Test_C62701178_Verify_duplicate_segment_names_in_inclusion_or_exclusion(Common):
    """
    TR_ID: C62701178
    ...
    def test_007_edit_exisiting_universal_super_button_with_duplicate_segments_name(self):
        """
        DESCRIPTION: Edit exisiting Universal Super button with duplicate segments name
        EXPECTED: Duplicate segment names should allowed
        EXPECTED: Content user has to make sure to configure correct segment names as in optimove
        """
        pass
