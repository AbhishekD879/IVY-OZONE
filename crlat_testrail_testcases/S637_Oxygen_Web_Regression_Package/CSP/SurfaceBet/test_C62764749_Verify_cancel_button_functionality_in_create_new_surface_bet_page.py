...
@pytest.mark.other
@vtest
class Test_C62764749_Verify_cancel_button_functionality_in_create_new_surface_bet_page(Common):
    """
    TR_ID: C62764749
    NAME: Verify cancel button functionality in create new surface bet page
    DESCRIPTION: This test case verifies cancel process while creating new surface bet.
    ...
    def test_003_click_on_surface_bet_link(self):
        ...
        EXPECTED: User should be able to view Create surface bet CTA and Already Created surface bets should be displayed.
        """
        pass

    def test_004_click_on_create_surface_bet(self):
        """
