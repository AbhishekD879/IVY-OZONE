...
@pytest.mark.other
@vtest
class Test_C62764750_Verify_user_able_to_download_the_existing_page_content_in_CSV_format_for_surface_bet(Common):
    """
    TR_ID: C62764750
    NAME: Verify user able to download the existing page content in CSV format for surface bet
