...
@pytest.mark.other
@vtest
class Test_C62764751_Verify_surface_bet_module_ordering_for_universal(Common):
    """
    TR_ID: C62764751
    NAME: Verify surface bet module ordering for universal
    DESCRIPTION: Test case verifies possibility to order surface bet module for Universal
    ...
    def test_004_verify_newly_created_surface_bets_ordering(self):
        """
        DESCRIPTION: Verify newly created surface bets ordering
    ...
    def test_005_verify_the_order_of_the_surface_bet_module_for_universal_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the surface bet module for universal is as per order in the CMS.
