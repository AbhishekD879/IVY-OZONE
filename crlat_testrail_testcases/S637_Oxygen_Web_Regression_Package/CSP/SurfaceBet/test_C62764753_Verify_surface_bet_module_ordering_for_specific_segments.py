...
@pytest.mark.other
@vtest
class Test_C62764753_Verify_surface_bet_module_ordering_for_specific_segments(Common):
    """
    TR_ID: C62764753
    NAME: Verify surface bet module ordering for specific segments
    DESCRIPTION: Test case verifies possibility to order surface bet module for specific segments
    ...
    def test_003_click_on_surface_bet_link(self):
        ...
        EXPECTED: User should be able to view Already Created surface bets should be displayed.
        """
        pass

    def test_004_verify_newly_created_surface_bets_ordering_for_specific_segments(self):
        """
        DESCRIPTION: Verify newly created surface bets ordering for specific segments
    ...
    def test_006_verify_the_order_of_the_surface_bet_module_for_specific_segments_is_as_per_order_in_the_cms(self):
        """
        DESCRIPTION: Verify the order of the surface bet module for specific segments is as per order in the CMS.
