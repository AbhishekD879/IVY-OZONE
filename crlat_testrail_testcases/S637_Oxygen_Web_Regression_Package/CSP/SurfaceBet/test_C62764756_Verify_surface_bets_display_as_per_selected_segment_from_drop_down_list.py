...
@pytest.mark.other
@vtest
class Test_C62764756_Verify_surface_bets_display_as_per_selected_segment_from_drop_down_list(Common):
    """
    TR_ID: C62764756
    NAME: Verify surface bets display as per selected segment from drop down list
    DESCRIPTION: This test case verifies segment dropdown functionality on surface bet module page.
