...
@pytest.mark.other
@vtest
class Test_C62764758_Verify_Selecting_segments_inclusion_radio_button_will_enable_Segments_inclusion_text_box(Common):
    """
    TR_ID: C62764758
    ...
    def test_007_load_oxygen_app_and_verify_surface_bet(self):
        ...
        EXPECTED: For only football segmented user should able to view surface bet (as we have configured segment(s) inclusion as Football)
        """
        pass
