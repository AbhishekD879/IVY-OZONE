...
@pytest.mark.other
@vtest
class Test_C62764766_Create_new_surface_bet_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764766
    NAME: Create new surface bet with universal(without exclusion) and verify in FE
    DESCRIPTION: This test case verifies creating a new surface bet with universal (without exclusion)
    ...
    def test_006_segments_exclusion_text_box_leave_empty_click_on_create_button(self):
        ...
        EXPECTED: Universal surface bet should be created Successfully
        """
        pass
