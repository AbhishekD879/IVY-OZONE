...
@pytest.mark.other
@vtest
class Test_C62764767_Create_new_surface_bet_with_universalSingle_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764767
    NAME: Create new surface bet with universal(Single segment exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new surface bet with universal (single segment exclusion)
    ...
    def test_006_enter_segment_name_in_segments_exclusion_text_box_click_on_save_changes_button(self):
        ...
        EXPECTED: Universal surface bet should be created Successfully with single segment exclusion
        """
        pass
