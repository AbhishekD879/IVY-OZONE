...
@pytest.mark.other
@vtest
class Test_C62764768_Create_new_surface_bet_with_universalMultiple_segments_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764768
    NAME: Create new surface bet with universal(Multiple segments exclusion ) and verify in FE
    DESCRIPTION: This test case verifies creating a new surface bet with universal for multiple segment exclusion
