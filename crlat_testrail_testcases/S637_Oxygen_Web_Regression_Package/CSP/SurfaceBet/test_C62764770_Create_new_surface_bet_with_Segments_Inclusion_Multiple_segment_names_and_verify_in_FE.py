...
@pytest.mark.other
@vtest
class Test_C62764770_Create_new_surface_bet_with_Segments_Inclusion_Multiple_segment_names_and_verify_in_FE(Common):
    """
    TR_ID: C62764770
    NAME: Create new surface bet with Segment(s) Inclusion (Multiple segment names) and verify in FE
    DESCRIPTION: This test case verifies creating a new surface bet with Segment(s) Inclusion (Multiple segment names)
    ...
    def test_004_click_on_create_surface_bet_cta_button(self):
        """
        DESCRIPTION: Click on Create surface bet CTA button
    ...
    def test_007_load_oxygen_app_and_verify_newly_created_surface_bet(self):
        ...
        EXPECTED: Specific segmented users only should able view newly created surface bet.
