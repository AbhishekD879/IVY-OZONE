...
@pytest.mark.other
@vtest
class Test_C62764771_Verify_Edit_existing_surface_bet_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764771
    NAME: Verify Edit existing surface bet with universal(without exclusion) and verify in FE
