...
@pytest.mark.other
@vtest
class Test_C62764772_Verify_Edit_exitsting_surface_bet_with_universalwith_single_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764772
    NAME: Verify Edit exitsting surface bet with universal(with single segment exclusion) and verify in FE
    ...
    def test_007_load_oxygen_and_verify_surface_bet(self):
        ...
        EXPECTED: Updated Surface bet should be shown for
