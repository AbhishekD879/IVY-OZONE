...
@pytest.mark.other
@vtest
class Test_C62764773_Verify_Edit_surface_bet_with_universalwith_multiple_segment_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764773
    NAME: Verify Edit surface bet with universal(with multiple segment exclusion) and verify in FE
    DESCRIPTION: This test case verifies editing of existing Universal segmented surface bet
    ...
    def test_004_click_on_existing_surface_bet_with_segment_exclusion(self):
        """
        DESCRIPTION: Click on existing surface bet with segment exclusion
        EXPECTED: surface bet detail page should be opened  with universal and segment(s) exclusion text box
        """
        pass
    ...
    def test_007_load_oxygen_and_verify_surface_bet(self):
        ...
        EXPECTED: Updated surface bet should be shown for Universal user except specific segments
        """
        pass
