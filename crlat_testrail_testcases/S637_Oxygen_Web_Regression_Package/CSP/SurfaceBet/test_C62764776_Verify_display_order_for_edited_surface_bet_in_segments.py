...
@pytest.mark.other
@vtest
class Test_C62764776_Verify_display_order_for_edited_surface_bet_in_segments(Common):
    """
    TR_ID: C62764776
    NAME: Verify display order for edited surface bet in segments
    DESCRIPTION: This test case verifies display order for edited surface bet in segments
    ...
    def test_004_click_on_existing_surface_bet_with_segment_inclusion(self):
        ...
        EXPECTED: surface bet detail page should be opened  with Segment(s)  inclusion radio button and segment(s) inclusion text box
        """
        pass
    ...
    def test_006_click_on_save_changes_button(self):
        ...
        EXPECTED: surface bet should be update successfully. Should navigate to surface bet module page
        """
        pass
