...
@pytest.mark.other
@vtest
class Test_C62764777_Verify_edit_surface_bet_with_segment_with_segments_inclusion_to_Universal_and_vise_versa_and_verify_in_FE(Common):
    """
    TR_ID: C62764777
    NAME: Verify edit surface bet with segment (with segment(s) inclusion) to Universal and vise versa and verify in FE
    ...
    def test_004_click_on_existing_surface_bet_with_segment_inclusion(self):
        ...
        EXPECTED: surface bet detail page should be opened  with Segment inclusion and segment(s) inclusion text box
        """
        pass

    def test_005_edit_existing_surface_bet_select_universal_radio_button(self):
        """
        DESCRIPTION: Edit existing surface bet ,select Universal radio button
    ...
    def test_007_load_oxygen_and_verify_surface_bet(self):
        ...
        EXPECTED: Updated surface bet should be shown as universal view
        """
        pass
