...
@pytest.mark.other
@vtest
class Test_C62764778_Verify_remove_surface_bet_with_universalwithout_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764778
    NAME: Verify remove surface bet with universal(without exclusion) and verify in FE
    ...
    def test_001_repeat_the_above_steps_for_universal_to_segment_inclusion(self):
        ...
        EXPECTED: Updated surface bet should be Shown in specific segmented view
        """
        pass
    ...
    def test_004_click_on_existing_surface_bet_with_universal_without_exclusion(self):
        """
        DESCRIPTION: Click on existing surface bet with Universal (without exclusion)
        EXPECTED: surface bet detail page should be opened  with Universal (without exclusion)
        """
        pass
    ...
    def test_006_load_oxygen_and_verify_surface_bet(self):
        ...
        EXPECTED: Removed surface bet should not be shown in application
        """
        pass
