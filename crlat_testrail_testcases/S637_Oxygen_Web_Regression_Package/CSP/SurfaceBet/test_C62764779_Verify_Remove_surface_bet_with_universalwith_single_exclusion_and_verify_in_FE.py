...
@pytest.mark.other
@vtest
class Test_C62764779_Verify_Remove_surface_bet_with_universalwith_single_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764779
    NAME: Verify Remove surface bet with universal(with single exclusion) and verify in FE
    ...
    def test_004_click_on_existing_surface_bet_with_universal_with_single_exclusion(self):
        """
        DESCRIPTION: Click on existing surface bet with Universal (with single exclusion)
