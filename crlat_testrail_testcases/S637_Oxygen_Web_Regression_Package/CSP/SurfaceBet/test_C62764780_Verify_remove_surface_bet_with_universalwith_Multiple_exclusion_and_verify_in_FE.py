...
@pytest.mark.other
@vtest
class Test_C62764780_Verify_remove_surface_bet_with_universalwith_Multiple_exclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764780
    NAME: Verify remove surface bet with universal(with Multiple exclusion) and verify in FE
    ...
    def test_004_click_on_existing_surface_bet_with_universal_with_multiple_exclusion(self):
        """
        DESCRIPTION: Click on existing surface bet with Universal (with multiple exclusion)
