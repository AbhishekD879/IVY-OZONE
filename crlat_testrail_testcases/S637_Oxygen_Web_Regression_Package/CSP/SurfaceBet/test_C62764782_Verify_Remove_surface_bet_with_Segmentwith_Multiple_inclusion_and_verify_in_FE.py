...
@pytest.mark.other
@vtest
class Test_C62764782_Verify_Remove_surface_bet_with_Segmentwith_Multiple_inclusion_and_verify_in_FE(Common):
    """
    TR_ID: C62764782
    NAME: Verify Remove surface bet with Segment(with Multiple inclusion) and verify in FE
    ...
    def test_004_click_on_existing_surface_bet_with_segmentwith_multiple_inclusion(self):
        """
        DESCRIPTION: Click on existing surface bet with Segment(with Multiple inclusion)
    ...
    def test_006_load_oxygen_and_verify_surface_bet(self):
        ...
        EXPECTED: Removed surface bet should not be shown in application, surface bet should be removed from specific segments
        """
        pass
