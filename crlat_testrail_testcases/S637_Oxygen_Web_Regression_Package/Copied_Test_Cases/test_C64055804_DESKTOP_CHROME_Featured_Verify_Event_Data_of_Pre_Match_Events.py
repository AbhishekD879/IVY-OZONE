...
@pytest.mark.other
@vtest
class Test_C64055804_DESKTOP_CHROME_Featured_Verify_Event_Data_of_Pre_Match_Events(Common):
    """
    TR_ID: C64055804
    NAME: [DESKTOP CHROME] Featured: Verify Event Data of Pre-Match Events
    DESCRIPTION: 
    PRECONDITIONS: 
    """
