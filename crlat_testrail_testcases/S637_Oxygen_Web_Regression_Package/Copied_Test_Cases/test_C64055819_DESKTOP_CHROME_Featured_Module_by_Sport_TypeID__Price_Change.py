...
@pytest.mark.other
@vtest
class Test_C64055819_DESKTOP_CHROME_Featured_Module_by_Sport_TypeID__Price_Change(Common):
    """
    TR_ID: C64055819
    NAME: [DESKTOP CHROME] Featured Module by Sport TypeID - Price Change
    DESCRIPTION: 
    PRECONDITIONS: 
    """
