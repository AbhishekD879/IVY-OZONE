...
@vtest
class Test_C64569866_Verify_GO_TO_SPORTS_CTA_on_My_Bets_page_if_user_has_bets_in_Cashout_Openbets_Settledbets_tabs(Common):
    """
    TR_ID: C64569866
    NAME: Verify 'GO TO SPORTS' CTA on My Bets page if user has bets in Cashout/Openbets/Settledbets tabs.
    DESCRIPTION: Verify 'GO TO SPORTS' CTA on My Bets page if user has bets in Cashout/Openbets/Settledbets tabs.
    ...
    def test_003_tap_cashout_tab(self):
        ...
        EXPECTED: * User able to see 'GO TO SPORTS' CTA at the bottom of the page
        """
        pass
