...
@pytest.mark.other
@vtest
class Test_C60709305_Match_day_rewards_page__terms_and_conditions_CMS_configuration(Common):
    """
    TR_ID: C60709305
    NAME: Match day rewards page - terms and conditions CMS configuration
    DESCRIPTION: This test case is to config Match day rewards page terms and conditions in CMS
    ...
    def test_002_click_on_special_pages___match_day_rewards_page__from_left_pane(self):
        """
    ...
    def test_003_click_on_terms_and_conditions_page(self):
        """
        DESCRIPTION: Click on terms and conditions page
        EXPECTED: Terms and conditions page should open with rich editable text box
        """
        pass
    ...
    def test_005_give_reference_url_for_full_terms_and_conditions_and_save_changes(self):
        """
        DESCRIPTION: Give reference URL for full terms and conditions and save changes
        EXPECTED: Details should saved successfully
        """
        pass

    def test_006_perform_edit_or_delete_operation_each_section_and_verify(self):
        """
