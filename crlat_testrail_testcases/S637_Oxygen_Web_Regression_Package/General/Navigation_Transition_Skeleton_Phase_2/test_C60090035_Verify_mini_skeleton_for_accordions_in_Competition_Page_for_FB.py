...
@pytest.mark.sports
@vtest
class Test_C60090035_Verify_mini_skeleton_for_accordions_in_Competition_Page_for_FB(Common):
    """
    TR_ID: C60090035
    NAME: Verify mini skeleton for accordions in Competition Page for FB
    DESCRIPTION: This test case verifies mini loading skeleton inside accordions in Football Competitions page while content loads so that user gets feedback that something is happening when expanding accordions.
    ...
    PRECONDITIONS: - User is on Football Competitions page where accordions can be expanded
    ...
    def test_001_tap_on_any_collapsed_accordion_on_the_competition_page(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/122292767)
