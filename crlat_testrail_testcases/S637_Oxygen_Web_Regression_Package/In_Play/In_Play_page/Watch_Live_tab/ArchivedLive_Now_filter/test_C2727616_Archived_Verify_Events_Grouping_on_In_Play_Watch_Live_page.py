...
@pytest.mark.in_play
@vtest
class Test_C2727616_Archived_Verify_Events_Grouping_on_In_Play_Watch_Live_page(Common):
    """
    TR_ID: C2727616
    ...
    def test_001_verify_live_now_view(self):
        """
        DESCRIPTION: Verify 'Live Now' view
        EXPECTED: *   Sections with Sports' names are visible
        EXPECTED: *   Events are grouped by 'categoryId' (by Sports)
        EXPECTED: *   First accordion is expanded by default
