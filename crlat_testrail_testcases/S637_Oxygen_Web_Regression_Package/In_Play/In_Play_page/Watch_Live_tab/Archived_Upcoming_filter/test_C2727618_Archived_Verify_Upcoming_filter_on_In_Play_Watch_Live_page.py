...
@pytest.mark.in_play
@vtest
class Test_C2727618_Archived_Verify_Upcoming_filter_on_In_Play_Watch_Live_page(Common):
    """
    TR_ID: C2727618
    NAME: [Archived] Verify 'Upcoming' filter on 'In-Play Watch Live' page
    DESCRIPTION: This test case verifies 'Upcoming' filter on 'In-Play Watch Live' page.
    ...
    def test_001_verify_first_level_accordions_title_within_upcoming_page(self):
        """
        DESCRIPTION: Verify first level accordion's title within 'Upcoming' page
        EXPECTED: First level accordions within 'Upcoming' page are titled in the format:
        EXPECTED: <Sport Name>
        """
        pass
    ...
    def test_002_verify_second_level_accordions_title_within_each_sport_accordion(self):
        ...
        EXPECTED: The accordion's titles are in the following format and correspond to the following attributes:
