...
@pytest.mark.in_play
@vtest
class Test_C12797358_Subscriptions_on_initial_load_when_VirtualScroll_is_disabled(Common):
    """
    TR_ID: C12797358
    NAME: Subscriptions on initial load when VirtualScroll is disabled
    DESCRIPTION: This test case verifies subscriptions on initial load of In-play content on 'In-play' tab (Home page) and 'Watch live' tab (In-play page) when VirtualScroll is disabled in CMS.
    ...
    def test_001_verify_subscriptions_on_initial_load_of_in_play_content(self):
        ...
        EXPECTED: * Count of subscriptions to leagues corresponds to the value, set in 'InPlayCompetitionsExpanded' in CMS
        EXPECTED: ![](index.php?/attachments/get/30548)
        """
        pass
