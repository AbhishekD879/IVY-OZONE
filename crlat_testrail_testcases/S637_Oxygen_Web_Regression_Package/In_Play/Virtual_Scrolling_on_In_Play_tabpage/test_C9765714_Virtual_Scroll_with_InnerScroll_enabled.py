...
@pytest.mark.in_play
@vtest
class Test_C9765714_Virtual_Scroll_with_InnerScroll_enabled(Common):
    """
    TR_ID: C9765714
    NAME: Virtual Scroll with InnerScroll enabled
    DESCRIPTION: This test case verifies Virtual Scroll functionality on 'In-play' tab (Home page) and 'Watch live' tab (In-play page) when InnerScroll is enabled in CMS.
