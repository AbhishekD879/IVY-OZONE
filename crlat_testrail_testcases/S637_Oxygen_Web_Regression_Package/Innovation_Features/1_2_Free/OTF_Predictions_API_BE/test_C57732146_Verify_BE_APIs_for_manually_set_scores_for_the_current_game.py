...
@pytest.mark.other
@vtest
class Test_C57732146_Verify_BE_APIs_for_manually_set_scores_for_the_current_game(Common):
    """
    TR_ID: C57732146
    NAME: Verify BE APIs for manually set scores for the current game
    DESCRIPTION: This test case verifies BE APIs for manually set scores for the event in Postman
    ...
    PRECONDITIONS: - In the CMS create one current active game and add event id (active can be just one game)
    ...
    def test_001_open_app_and_sett_predictions(self):
        """
        DESCRIPTION: Open app and sett predictions
        EXPECTED: Predictions are setted
        """
        pass

    def test_002_go_to_the_postman_and_sett_the_scores_for_this_game_and_event(self):
        """
        DESCRIPTION: Go to the Postman and sett the scores for this game and event
        EXPECTED: Scores are setted
        EXPECTED: response Status: 200
        """
        pass

    def test_003_go_bigquery_and_verify_that_scores_are_set_in_the_tableselect_from_ladbrokes_big_query_12free_pl_resultsorder_by_resulteddate_desc(self):
        """
        ...
        EXPECTED: scores are set in the table
        """
        pass

    def test_004_go_to_kibana_and_check_logs(self):
        """
