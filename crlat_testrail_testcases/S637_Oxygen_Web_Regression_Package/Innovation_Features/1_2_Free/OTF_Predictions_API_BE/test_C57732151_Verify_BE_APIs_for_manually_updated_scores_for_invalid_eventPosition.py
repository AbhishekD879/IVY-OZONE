...
@pytest.mark.other
@vtest
class Test_C57732151_Verify_BE_APIs_for_manually_updated_scores_for_invalid_eventPosition(Common):
    """
    TR_ID: C57732151
    NAME: Verify BE APIs for manually updated scores for invalid eventPosition
    DESCRIPTION: This test case verifies BE APIs for manually updated scores for invalid eventPosition
    ...
    def test_001_go_to_the_postman_and_sett_the_scores_for_this_game_with_invalid_event_eventposition_too_small_or_too_large(self):
        """
        DESCRIPTION: Go to the Postman and sett the scores for this game with invalid event eventPosition (too small or too large)
    ...
    def test_003_go_to_kibana_and_check_logs(self):
        ...
        EXPECTED: Scores are not present in the logs
        """
        pass
