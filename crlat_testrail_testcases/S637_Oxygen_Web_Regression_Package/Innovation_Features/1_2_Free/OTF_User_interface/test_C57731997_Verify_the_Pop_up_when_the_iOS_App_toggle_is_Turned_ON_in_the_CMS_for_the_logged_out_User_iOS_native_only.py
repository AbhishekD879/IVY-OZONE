...
@pytest.mark.other
@vtest
class Test_C57731997_Verify_the_Pop_up_when_the_iOS_App_toggle_is_Turned_ON_in_the_CMS_for_the_logged_out_User_iOS_native_only(Common):
    """
    TR_ID: C57731997
    NAME: Verify the Pop-up when the iOS App toggle is Turned 'ON' in the CMS for the logged out User [iOS native only]
    DESCRIPTION: This test case verifies the Pop-up when the iOS App toggle is Turned 'ON' in the CMS for the logged out User [iOS native only].
    DESCRIPTION: This text case also verifies that any 'Please login' pop-up will not occur till the User is redirected to the browser.
    PRECONDITIONS: Please look for some insights on a pages as follow:
    PRECONDITIONS: https://confluence.egalacoral.com/display/SPI/How+to+run+unpublished+Qubit+variation+on+Ladbrokes
    PRECONDITIONS: 1. The User is logged out on the iOS app.
    ...
    def test_004_tap_on_the_quick_link_play_1_2_free_on_the_home_page__football_sports_page_again(self):
        """
        DESCRIPTION: Tap on the quick link 'Play 1-2-FREE...' on the Home page / Football sports page again.
        EXPECTED: The Pop-up is successfully displayed with next elements:
        EXPECTED: 1. Title: "1-2-Free has moved!".
        EXPECTED: 2. Message: "To play 1-2-free on this device, please visit ladbrokes.com"
        EXPECTED: 3. Amber CTA1: "Go to Ladbrokes".
    ...
    def test_005_tap_on_the_go_to_ladbrokes_button(self):
        ...
        EXPECTED: The default browser is opened with the 1-2-game Splash page and the 'Login/Register' pop-up in a tab.
        """
        pass

    def test_006_log_in_with_the_valid_credentials(self):
        """
        DESCRIPTION: Log in with the valid credentials.
        EXPECTED: The Splash page with CTA buttons is displayed.
        """
        pass
