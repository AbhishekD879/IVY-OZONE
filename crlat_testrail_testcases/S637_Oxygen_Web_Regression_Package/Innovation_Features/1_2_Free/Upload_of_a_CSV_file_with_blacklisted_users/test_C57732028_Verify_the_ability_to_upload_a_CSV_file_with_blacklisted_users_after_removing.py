...
@pytest.mark.other
@vtest
class Test_C57732028_Verify_the_ability_to_upload_a_CSV_file_with_blacklisted_users_after_removing(Common):
    """
    TR_ID: C57732028
    NAME: Verify the ability to upload a CSV file with blacklisted users after removing
    DESCRIPTION: This test case verifies the ability to upload a CSV file with blacklisted users after removing a previously uploaded CSV file.
    ...
    def test_006_click_on_the_remove_file_button(self):
        """
        DESCRIPTION: Click on the 'Remove File' button.
        EXPECTED: The name of the file is cleaned from the 'Upload Blacklisted Users [CSV]' row.
        EXPECTED: The 'Save Changes' and 'Revert Changes' buttons become active.
        """
        pass

    def test_007_click_on_the_upload_file_button(self):
        """
        DESCRIPTION: Click on the 'Upload File' button.
        EXPECTED: The pop-up is opened.
        """
    ...
    def test_008_select_a_csv_file_from_your_computer_in_the_opened_pop_up(self):
        """
        DESCRIPTION: Select a CSV file from your computer in the opened pop-up.
        EXPECTED: The 'Open' button becomes active.
        """
