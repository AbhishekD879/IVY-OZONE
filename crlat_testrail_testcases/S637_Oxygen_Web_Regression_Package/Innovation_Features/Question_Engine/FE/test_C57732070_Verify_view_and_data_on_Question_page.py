...
@pytest.mark.other
@vtest
class Test_C57732070_Verify_view_and_data_on_Question_page(Common):
    """
    TR_ID: C57732070
    NAME: Verify view and data on 'Question' page
    DESCRIPTION: This test case verifies view and data on 'Question' page
    ...
    PRECONDITIONS: 3. The user has not played Correct 4
    """
    ...
    def test_002_tap_on_play_now_for_free_button(self):
        ...
        EXPECTED: https://app.zeplin.io/project/5d4b121f8d5c26520b23a39a/screen/5d4d962a83622d9b72bf3e86
        EXPECTED: - All data retrieved from CMS and correctly displayed
        """
        pass
