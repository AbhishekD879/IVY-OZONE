...
@pytest.mark.other
@vtest
class Test_C57732152_To_editVerify_error_message_logging(Common):
    """
    TR_ID: C57732152
    NAME: [To-edit]Verify error message logging
    ...
    PRECONDITIONS: 1. Some exception/errors already happens during the request processing
    ...
    def test_002_type_in_search_field_error(self):
        """
        DESCRIPTION: Type in Search field 'Error'
        EXPECTED: Errors related to Question Engine displayed
        EXPECTED: (Backend should log the error with request path and message and exception data)
        """
        pass
