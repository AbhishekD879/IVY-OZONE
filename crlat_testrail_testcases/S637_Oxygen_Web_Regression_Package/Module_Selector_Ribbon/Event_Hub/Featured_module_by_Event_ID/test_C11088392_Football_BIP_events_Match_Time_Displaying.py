...
@pytest.mark.other
@vtest
class Test_C11088392_Football_BIP_events_Match_Time_Displaying(Common):
    """
    TR_ID: C11088392
    NAME: Football BIP events: Match Time Displaying
    DESCRIPTION: This test case verifies match time displaying and updating of Football BIP event in Featured module on the EventHub tab by Football EventID.
