...
@pytest.mark.other
@vtest
class Test_C11088460_Tennis_BIP_events_Live_Score_displaying_and_updating(Common):
    """
    TR_ID: C11088460
    NAME: Tennis BIP events: Live Score displaying and updating
    DESCRIPTION: This test case verifies Live Score displaying and updating on Tennis BIP events on the EventHub tab in Featured module by Tennis EventID.
    PRECONDITIONS: 1. Event Hub is created in CMS > Sport Pages > Event Hub.
    PRECONDITIONS: 2. Modules by Tennis BIP EventId with an available score and not BIP EventId are created in CMS.
    ...
    def test_001_navigate_to_the_module_with_bip_event_and_verify_tennis_event_with_scores_available(self):
        """
        DESCRIPTION: Navigate to the module with BIP Event and verify Tennis event with Scores available
    ...
    def test_002_verify_game_score_displaying(self):
        ...
        EXPECTED: Each Score for particular player is shown near a player name
        """
        pass
    ...
    def test_009_trigger_the_following_situationfact_is_changed_for_home_player_rolecodeplayer_1__on_the_higest_periodindex_levelandfact_is_changed_for_home_player_on_periodcodegame_level_of_the_highest_periodindex(self):
        """
    ...
    def test_010_trigger_the_following_situationfact_is_changed_for_away_player_rolecodeplayer_2__on_higher_periodindex_levelandfact_is_changed_for_away_player_on_periodcodegame_level_of_the_highest_periodindex(self):
        """
        DESCRIPTION: Trigger the following situation:
