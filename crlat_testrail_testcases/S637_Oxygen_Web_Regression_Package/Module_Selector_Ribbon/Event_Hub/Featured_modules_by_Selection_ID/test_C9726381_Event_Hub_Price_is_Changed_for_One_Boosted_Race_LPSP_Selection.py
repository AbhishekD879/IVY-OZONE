...
@pytest.mark.other
@vtest
class Test_C9726381_Event_Hub_Price_is_Changed_for_One_Boosted_Race_LPSP_Selection(Common):
    """
    TR_ID: C9726381
    NAME: Event Hub: Price is Changed for One Boosted Race LP,SP Selection
    ...
    PRECONDITIONS: 3. There should be an event with Boosted Race LP, SP selection (in CMS event is added by **selection Id**, in BO TI the event's primary market has 'LP Available' & 'SP Available' check boxes checked) on 'Event Hub' tab
