...
@pytest.mark.other
@vtest
class Test_C9726405_Event_Hub_Highlights_Carousel__cards_displaying_based_on_suspend_option_on_selection_market_event_levels(Common):
    """
    TR_ID: C9726405
    NAME: Event Hub: Highlights Carousel - cards' displaying based on "suspend" option on selection/market/event levels
