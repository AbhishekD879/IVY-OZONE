...
@pytest.mark.other
@vtest
class Test_C9726407_Event_Hub_Highlights_Carousel__displaying_cards_of_resulted_events(Common):
    """
    TR_ID: C9726407
    NAME: Event Hub: Highlights Carousel - displaying cards of resulted events
    ...
    PRECONDITIONS: - You should have an active Highlights Carousels with 2 active events in CMS > Sport Pages > Event Hub > Highlights Carousel
