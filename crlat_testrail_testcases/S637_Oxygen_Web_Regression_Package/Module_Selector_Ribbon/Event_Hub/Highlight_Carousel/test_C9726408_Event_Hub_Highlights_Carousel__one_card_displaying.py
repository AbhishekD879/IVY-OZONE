...
@pytest.mark.other
@vtest
class Test_C9726408_Event_Hub_Highlights_Carousel__one_card_displaying(Common):
    """
    TR_ID: C9726408
    NAME: Event Hub: Highlights Carousel - one card displaying
    ...
    PRECONDITIONS: - You should have an active Highlights Carousel with 1 active event in CMS > Sport Pages > Event Hub > Highlights Carousel
    ...
    def test_002___in_cms__sport_pages__event_hub__highlights_carousel_add_one_more_active_event_to_your_highlights_carousel__in_application_refresh_the_page_and_verify_cards_displaying(self):
        """
        DESCRIPTION: - In CMS > Sport Pages > Event Hub > Highlights Carousel add one more active event to your Highlights Carousel
