...
@pytest.mark.other
@vtest
class Test_C9726254_Event_Hub_Re_establishing_connection_and_receiving_updates_after_browser_app_is_moved_from_background(Common):
    """
    TR_ID: C9726254
    NAME: Event Hub: Re-establishing connection and receiving updates after browser/app is moved from background
    ...
    def test_005_verify_event_hub_tab(self):
        """
        DESCRIPTION: Verify Event Hub tab
