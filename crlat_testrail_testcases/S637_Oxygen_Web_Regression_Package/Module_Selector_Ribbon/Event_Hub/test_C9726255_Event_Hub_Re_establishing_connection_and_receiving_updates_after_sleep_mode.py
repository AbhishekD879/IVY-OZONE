...
@pytest.mark.other
@vtest
class Test_C9726255_Event_Hub_Re_establishing_connection_and_receiving_updates_after_sleep_mode(Common):
    """
    TR_ID: C9726255
    NAME: Event Hub: Re-establishing connection and receiving updates after sleep mode
