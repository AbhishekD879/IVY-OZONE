...
@vtest
class Test_C2987416_Highlights_Carousel_displaying_based_on_active_option_for_particular_highlights_carousel(Common):
    """
    TR_ID: C2987416
    ...
    def test_002___in_cms__sport_pages__homepage__highlights_carousel_deactivate_one_of_the_displayed_highlights_carousels__in_application_refresh_the_page_and_verify_highlights_carousel_displaying(self):
        """
    ...
    def test_003___in_cms__sport_pages__homepage__highlights_carousel_deactivate_another_highlights_carousels_that_is_still_displayed__in_application_refresh_the_page_and_verify_highlights_carousel_displaying(self):
        """
