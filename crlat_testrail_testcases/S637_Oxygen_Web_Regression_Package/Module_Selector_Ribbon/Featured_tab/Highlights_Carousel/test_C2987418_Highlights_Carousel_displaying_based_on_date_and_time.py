...
@vtest
class Test_C2987418_Highlights_Carousel_displaying_based_on_date_and_time(Common):
    """
    TR_ID: C2987418
    ...
    PRECONDITIONS: - You should have 3 active Highlights Carousels with active events in CMS > Sport Pages > Homepage > Highlights Carousel:
    ...
    def test_002___in_cms__sport_pages__homepage__highlights_carousel_edit_currently_displayed_highlights_carousel_to_be_undisplayed_in_couple_minutes__in_cms__sport_pages__homepage__highlights_carousel_edit_future_highlights_carousel_to_be_displayed_in_couple_minutes__wait_for_the_configured_time_and_refresh_the_page_in_application__verify_highlights_carousel_displaying(self):
        """
