...
@vtest
class Test_C60351312_Verify_team_kits_displaying_if_only_one_kit_is_mapped_to_team_name_with_EventID(Common):
    """
    TR_ID: C60351312
    NAME: Verify team kits displaying if only one kit is mapped to team name with EventID
    DESCRIPTION: This test case verifies displaying of team kits of events cards in Highlights Carousels if only one kit is mapped to team name with EventID
    ...
    def test_001_verify_team_kits_displaying_on_events_cards_in_highlights_carousels_if_one_of_team_name_has_no_mapped_team_kit(self):
        ...
        EXPECTED: - Both team kits are NOT displayed on Highlights Carousel configured by EventID
