...
@vtest
class Test_C9776602_CMS_Verify_Events_Retrieving_by_eventId(Common):
    """
    TR_ID: C9776602
    ...
    def test_003_fill_in_all_required_fields_with_valid_data_go_to_select_eventsby_field_and_select__eventnote_date_range_is_not_taken_into_account_when_retrieving_events_by_eventid_marketid_and_selectionid(self):
        """
    ...
    def test_005_go_back_to_cms_and_enter_eventid_of_the_eventnot_racing_from_step_4_into_id_fieldpress_reload_button_and_verify_the_retrieving_of_selected_event(self):
        """
