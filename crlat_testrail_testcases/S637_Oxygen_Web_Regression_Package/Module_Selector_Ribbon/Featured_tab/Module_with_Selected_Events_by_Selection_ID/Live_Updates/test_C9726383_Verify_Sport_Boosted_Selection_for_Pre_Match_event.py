...
@vtest
class Test_C9726383_Verify_Sport_Boosted_Selection_for_Pre_Match_event(Common):
    """
    TR_ID: C9726383
    ...
    def test_013_clicktapanywhere_on_event_card_except_for_price_buttons_within_verified_module(self):
        """
