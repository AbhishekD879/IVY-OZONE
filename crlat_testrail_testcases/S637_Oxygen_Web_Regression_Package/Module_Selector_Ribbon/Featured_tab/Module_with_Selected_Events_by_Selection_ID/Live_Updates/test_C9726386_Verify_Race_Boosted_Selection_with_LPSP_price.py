...
@vtest
class Test_C9726386_Verify_Race_Boosted_Selection_with_LPSP_price(Common):
    """
    TR_ID: C9726386
    ...
    def test_011_verifycash_out_and_star_label_on_top_right_corner(self):
        """
    ...
    def test_016_click_anywhere_on_event_card_except_for_price_buttons_within_verified_module(self):
        """
    ...
    def test_017_go_to_cms_home_module_open_created_module_on_the_previous_steps(self):
        """
    ...
    def test_018_set_races_selection_id_wherepricetypecodessplpbutthere_are_no_pricenumpricedenpricedec_attributes_in_outcome_section_in_ss_responce_use_link_from_preconditions_to_find_details_about_race_event(self):
        """
    ...
    def test_019_repeat_steps__6_11(self):
        """
    ...
    def test_020_verify_priceodds_button_within_created_module(self):
        """
        DESCRIPTION: Verify 'Price/Odds' button within created Module
    ...
    def test_021_repeat_steps__14_16(self):
        """
    ...
    def test_022_repeat_steps__1_7___triggerwait_until_for_event_based_on_which_module_was_created_isstartedtrue_attribute_will_be_set__refresh_page(self):
        """
        DESCRIPTION: Repeat steps # 1-7 -> Trigger/wait until for event based on which module was created '**isStarted="true"**' attribute will be set -> Refresh page
        EXPECTED: Verified module is no more shown within 'Featured' section
        """
        pass
