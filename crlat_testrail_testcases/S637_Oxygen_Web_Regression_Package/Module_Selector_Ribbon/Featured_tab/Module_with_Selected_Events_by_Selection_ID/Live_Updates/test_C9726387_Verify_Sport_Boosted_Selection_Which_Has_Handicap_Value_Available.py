...
@vtest
class Test_C9726387_Verify_Sport_Boosted_Selection_Which_Has_Handicap_Value_Available(Common):
    """
    TR_ID: C9726387
    ...
    def test_009_for_desktopload_oxygen_application_and_verify_module_is_displayed(self):
        ...
        EXPECTED: **For Desktop:**
        EXPECTED: Featured Module with selection is from the pre-match event from any market is displayed on Desktop
        """
        pass
    ...
    def test_016_verify_cash_out_and_star_label_on_top_right_corner(self):
        """
    ...
    def test_017_verify_priceodds_button_within_created_module(self):
        """
    ...
    def test_018_add_selection_to_the_betslip_from_module_in_featured_section(self):
        """
    ...
    def test_019_open_betslip_page(self):
        """
    ...
    def test_020_place_a_bet_by_clickingtapping_bet_now_button(self):
        """
    ...
    def test_021_click_anywhere_on_event_card_except_for_price_buttons_within_the_verified_module(self):
        """
    ...
    def test_022_for_mobiletabletrepeat_steps__1_7___trigger_situation_when_for_market_based_on_which_module_was_createdismarketbetinrunattribute_will_be_removed__refresh_page(self):
        """
        DESCRIPTION: **For Mobile/Tablet:**
