...
@vtest
class Test_C2854772_Verify_Price_Odds_for_3_Way_Market(Common):
    """
    TR_ID: C2854772
    ...
    def test_005_verify_order_of_priceodds_buttons_for_3_way_market(self):
        """
    ...
    def test_006_click_on_priceodds_button_to_add_selection_to_the_betslip(self):
        """
