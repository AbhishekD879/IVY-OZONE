...
@vtest
class Test_C29406_Tennis_BIP_events_Live_Score_displaying_and_updating(Common):
    """
    TR_ID: C29406
    NAME: Tennis BIP events: Live Score displaying and updating
    DESCRIPTION: This test case verifies Live Score displaying and updating on Tennis BIP events on the Featured tab (mobile/tablet)/ Featured section (desktop).
    DESCRIPTION: NOTE: UAT assistance is needed in order to generate live scores for BIP event.
    DESCRIPTION: **Jira tickets:** BMA-3592
    PRECONDITIONS: 1) Make sure you have retrieved Tennis BIP events with an available score
    ...
    def test_003_verify_tennis_event_with_scores_available(self):
        """
    ...
    def test_004_verify_game_score_displaying(self):
        """
    ...
    def test_005_verify_game_score_correctness_for_each_player(self):
        """
    ...
    def test_006_verify_game_score_ordering(self):
        """
    ...
    def test_007_verify_set_score_displaying(self):
        """
    ...
    def test_008_verify_set_score_correctness_for_each_player(self):
        """
    ...
    def test_009_verify_set_score_ordering(self):
        """
    ...
    def test_010_verify_value_below_the_tennis_icon(self):
        """
    ...
    def test_011_trigger_the_following_situationfactis_changed_for_home_player_rolecodeplayer_1_on_the_higestperiodindexlevelandfactis_changed_for_home_player_on_periodcodegame_level_of_the_highestperiodindex(self):
        """
    ...
    def test_012_trigger_the_following_situationfactis_changed_for_away_player_rolecodeplayer_2_on_higherperiodindexlevelandfactis_changed_for_away_player_on_periodcodegame_level_of_the_highestperiodindex(self):
        """
        DESCRIPTION: Trigger the following situation:
    ...
    def test_013_trigger_the_following_situationnew_set_appears(self):
        """
        DESCRIPTION: Trigger the following situation:
    ...
    def test_014_verify_event_which_doesnt_have_live_score_available(self):
        """
