...
@vtest
class Test_C11366790_Verify_module_created_by_Sport_Primary_market_ID(Common):
    """
    TR_ID: C11366790
    NAME: Verify module created by <Sport> Primary market ID
    DESCRIPTION: This test case verifies featured module created by <Sport> Primary Market ID
    ...
    PRECONDITIONS: 3. Featured module by Primary Market Id is created in CMS > Featured tab module
