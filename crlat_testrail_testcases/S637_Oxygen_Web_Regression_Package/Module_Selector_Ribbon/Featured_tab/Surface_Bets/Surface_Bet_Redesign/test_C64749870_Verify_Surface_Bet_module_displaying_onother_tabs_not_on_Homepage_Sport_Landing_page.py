...
@vtest
class Test_C64749870_Verify_Surface_Bet_module_displaying_onother_tabs_not_on_Homepage_Sport_Landing_page(Common):
    """
    TR_ID: C64749870
    NAME: Verify Surface Bet module displaying on
other tabs (not on Homepage/Sport Landing page)
    DESCRIPTION: Test case verifies that Surface Bets
    DESCRIPTION: aren't shown on other tabs
