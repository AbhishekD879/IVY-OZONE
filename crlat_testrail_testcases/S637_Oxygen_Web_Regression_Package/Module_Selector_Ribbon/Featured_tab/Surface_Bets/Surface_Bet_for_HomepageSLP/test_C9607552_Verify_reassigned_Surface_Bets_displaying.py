...
@vtest
class Test_C9607552_Verify_reassigned_Surface_Bets_displaying(Common):
    """
    TR_ID: C9607552
    ...
    PRECONDITIONS: 2. Open the Home page and SLP in the application
    ...
    def test_001_in_the_cms_edit_the_surface_bet_uncheck_display_on_highlights_tab_assign_the_surface_bet_to_some_slp(self):
        """
        DESCRIPTION: In the CMS edit the Surface Bet, uncheck "Display on Highlights tab", assign the Surface Bet to some SLP
        EXPECTED: 
        """
        pass
