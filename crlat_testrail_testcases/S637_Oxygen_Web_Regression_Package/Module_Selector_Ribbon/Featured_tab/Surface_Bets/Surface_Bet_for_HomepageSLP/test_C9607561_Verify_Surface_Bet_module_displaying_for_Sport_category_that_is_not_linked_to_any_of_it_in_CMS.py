...
@vtest
class Test_C9607561_Verify_Surface_Bet_module_displaying_for_Sport_category_that_is_not_linked_to_any_of_it_in_CMS(Common):
    """
    TR_ID: C9607561
    NAME: Verify Surface Bet module displaying for Sport category that is not linked to any of it in CMS.
    DESCRIPTION: Test case verifies that Surface Bet module is not shown on the Sport Landing Page if there isn't Surface Bet added to this sport category
