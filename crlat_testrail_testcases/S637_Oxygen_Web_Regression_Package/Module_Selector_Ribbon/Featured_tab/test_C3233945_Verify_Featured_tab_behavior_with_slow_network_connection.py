...
@vtest
class Test_C3233945_Verify_Featured_tab_behavior_with_slow_network_connection(Common):
    """
    TR_ID: C3233945
    ...
    def test_006_repeat_steps_2_5_for_featured_module_created_by_type_id_race_type_id_selection_id_race_grid_enhanced_multiples(self):
        """
