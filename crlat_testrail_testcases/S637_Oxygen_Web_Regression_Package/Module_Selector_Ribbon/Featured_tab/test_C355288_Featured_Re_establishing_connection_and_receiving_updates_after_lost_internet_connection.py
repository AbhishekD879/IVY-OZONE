...
@vtest
class Test_C355288_Featured_Re_establishing_connection_and_receiving_updates_after_lost_internet_connection(Common):
    """
    TR_ID: C355288
    NAME: Featured: Re-establishing connection and receiving updates after lost internet connection
