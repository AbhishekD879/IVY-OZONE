...
@vtest
class Test_C64597400_Verify_that_the_user_should_be_able_to_select_dates_for_various_months_and_years_using_the_calendar_provided_for_the_From_and_To_grids(Common):
    """
    TR_ID: C64597400
    ...
    def test_004_select_of_tap_any_date_in_the_from_and_to_calendar_grids(self):
        """
        DESCRIPTION: Select of tap any date in the From and To calendar grids.
