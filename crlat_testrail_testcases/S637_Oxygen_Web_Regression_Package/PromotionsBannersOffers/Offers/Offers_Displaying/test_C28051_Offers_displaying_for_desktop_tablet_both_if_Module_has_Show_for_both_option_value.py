...
@vtest
class Test_C28051_Offers_displaying_for_desktop_tablet_both_if_Module_has_Show_for_both_option_value(Common):
    """
    TR_ID: C28051
    NAME: Offers displaying for desktop/tablet/both if Module has 'Show for both' option value
    DESCRIPTION: This test case verifies Offers displaying for desktop/tablet/both if Module has 'Show for both' option value
    ...
    PRECONDITIONS: 2. Offers with different 'Show for Desktop or Tablet or Both' option value are available.
    PRECONDITIONS: 3) All Offers are related to Offer Module with 'Display for Both (tablet and desktop)' option value checked
    """
    keep_browser_open = True

    def test_001_select_offer_with_show_for_tablet_only_option_valueload_oxygen_application_and_verify_its_displaying_on_desktop_and_tablet_devices(self):
        """
        DESCRIPTION: Select Offer with 'Show for Tablet only' option value.
        DESCRIPTION: Load Oxygen application and verify its displaying on desktop and tablet devices
        EXPECTED: *   Offer is NOT displayed on Desktop
        EXPECTED: *   Offer is displayed on Tablets
        """
        pass

    def test_002_select_offer_with_show_for_desktop_only_option_valueload_oxygen_application_and_verify_its_displaying_on_desktop_and_tablet_devices(self):
        """
