...
@vtest
class Test_C29322_Promotions_Displaying_for_Existing_Users(Common):
    """
    TR_ID: C29322
    ...
    DESCRIPTION: AUTOTEST Mobile: [C2861826]
    DESCRIPTION: AUTOTEST Desktop: [C2861828]
    PRECONDITIONS: 
    """
    keep_browser_open = True

    def test_001_add_new_promotion_in_cms_selectshow_for_existing_users_option_and_save_changes(self):
        """
