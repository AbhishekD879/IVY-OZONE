...
@vtest
class Test_C8146656_Verify_that_Bets_are_not_duplicated_during_bet_placement_via_Quickbet(Common):
    """
    TR_ID: C8146656
    NAME: Verify that Bets are not duplicated during bet placement via Quickbet
    DESCRIPTION: This test case verifies that Bets are not duplicated during bet placement via Quickbet(especially after closing QuickBet right after several price or status changes)
