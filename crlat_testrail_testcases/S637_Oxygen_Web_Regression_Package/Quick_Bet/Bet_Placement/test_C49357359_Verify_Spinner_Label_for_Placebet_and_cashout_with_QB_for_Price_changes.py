...
@vtest
class Test_C49357359_Verify_Spinner_Label_for_Placebet_and_cashout_with_QB_for_Price_changes(Common):
    """
    TR_ID: C49357359
    NAME: Verify Spinner + Label for Placebet and cashout with QB for Price changes
    DESCRIPTION: This test case verifies displaying of price changes (Horse racing, Greyhounds - SP/LP prices) and sports (for preplay events)
    ...
    PRECONDITIONS: 4. Navigate to any racing landing page (for example, Horse racing or Greyhounds) and sports (for preplay events)
    """
    keep_browser_open = True

    def test_001_add_any_race_lpsp_selection_or_sports_selections_to_quick_bet(self):
        """
        DESCRIPTION: Add any <Race> LP/SP selection or sports selections to Quick Bet
        ...
        EXPECTED: ![](index.php?/attachments/get/122294484)
        """
        pass

    def test_002_tap_on_the_stake_field__enter_any_value(self):
        """
    ...
    def test_004_tap_on_place_bet_button(self):
        ...
        EXPECTED: * Spinner + PLACE BET label is displayed on clicking on on 'Place bet' button for a few seconds
    ...
    def test_005_verify_the_bet_receipt(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/59204805) ![](index.php?/attachments/get/59204806)
        """
        pass
    ...
    def test_008_go_to_the_bet_that_was_just_placed_and_verify_that_the_bet_receipt_fields_are_correct(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/59204807) ![](index.php?/attachments/get/59204808)
        """
        pass
    ...
    def test_009_now_click_on_cashout(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/122294485)
        """
        pass
