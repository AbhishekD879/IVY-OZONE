...
@vtest
class Test_C49357395_Verify_BPP_and_cashout_via_QB_for_Price_changes_Virtuals(Common):
    """
    TR_ID: C49357395
    NAME: Verify BPP and cashout via QB for Price changes (Virtuals)
    DESCRIPTION: This test case verifies displaying of Spinner + Place Bet label on clicking 'Place Bet' Button and Spinner + cashing out label on clicking on 'Cashout' button when there are price changes for Virtuals
    ...
    def test_001_add_any_sport_or_race_lpsp_selection_from_virtuals_for_example_football_greyhounds_horse_racing_etc(self):
        """
        DESCRIPTION: Add any <Sport> or <Race> LP/SP selection from Virtuals (for example, Football, Greyhounds, Horse Racing etc)
    ...
    def test_004_verify_the_bet_receipt(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/122292570)
        """
        pass
    ...
    def test_008_now_click_on_cashout_if_available(self):
        """
        DESCRIPTION: Now click on cashout (if available)
