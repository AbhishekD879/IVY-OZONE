...
@vtest
class Test_C884567_Reflection_on_Sport_Event_suspended_unsuspended_for_live_served_events(Common):
    """
    TR_ID: C884567
    NAME: Reflection on <Sport> Event suspended/unsuspended for live served events
    DESCRIPTION: This test case verifies Quick Bet reflection when <Sport> Event is Suspended/Unsuspended.
    ...
    def test_006_suspend_event_in_backoffice_tool_trigger_the_following_situation_for_this_eventeventstatuscode_s(self):
        """
    ...
    def test_008_unsuspend_event_in_backoffice_tool_trigger_the_following_situation_for_this_eventeventstatuscode_a(self):
        """
    ...
    def test_009_check_update_in_quick_bet(self):
        ...
        EXPECTED: - 'LOGIN & PLACE BET' is disable  until Stake is entered and 'Add to Betslip' button is enabled
        """
        pass
