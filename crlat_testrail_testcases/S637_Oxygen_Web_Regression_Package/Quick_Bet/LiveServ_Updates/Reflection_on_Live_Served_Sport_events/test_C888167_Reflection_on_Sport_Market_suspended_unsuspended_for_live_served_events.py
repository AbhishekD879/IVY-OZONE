...
@vtest
class Test_C888167_Reflection_on_Sport_Market_suspended_unsuspended_for_live_served_events(Common):
    """
    TR_ID: C888167
    NAME: Reflection on <Sport> Market suspended/unsuspended for live served events
    DESCRIPTION: This test case verifies Quick Bet reflection when <Sport> Market is Suspended/Unsuspended.
    ...
    def test_008_unsuspend_market_in_backoffice_tool_trigger_the_following_situation_for_this_marketmarketstatuscode_aeventstatuscode_a(self):
        """
