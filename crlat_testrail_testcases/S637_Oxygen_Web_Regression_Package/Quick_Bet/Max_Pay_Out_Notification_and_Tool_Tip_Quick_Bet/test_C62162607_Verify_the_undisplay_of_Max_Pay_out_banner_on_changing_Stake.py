...
@vtest
class Test_C62162607_Verify_the_undisplay_of_Max_Pay_out_banner_on_changing_Stake(Common):
    """
    TR_ID: C62162607
    ...
    def test_004_edit_the_stake_and_validate_the_display_of_max_payout_banneredited_stake_should_trigger_the_estimated_potential_returns_less_than_the_maximum_payout_configured(self):
        """
        DESCRIPTION: Edit the Stake and Validate the display of Max payout banner
        DESCRIPTION: (Edited Stake should trigger the Estimated /Potential Returns less than the Maximum Payout configured)
