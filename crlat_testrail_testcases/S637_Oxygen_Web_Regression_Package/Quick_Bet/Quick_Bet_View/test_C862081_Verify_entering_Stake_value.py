...
@vtest
class Test_C862081_Verify_entering_Stake_value(Common):
    """
    TR_ID: C862081
    ...
    def test_002_tap_on_stake_field(self):
        ...
        EXPECTED: * "Stake" placeholder text is shown within box
    ...
    def test_008_tap_return_button_on_numeric_keyboard(self):
        ...
        EXPECTED: * 'stake value' is shown within box
    ...
    def test_009_set_cursor_over_stake_field_again(self):
        ...
        EXPECTED: *  'stake value' remains shown within box
