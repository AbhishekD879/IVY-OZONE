...
@pytest.mark.races
@vtest
class Test_C403337_ER_Steps_6_7_need_to_be_updatedVerify_Races_details_page_displaying_for_finished_event_after_device_sleeping_or_losing_connection(Common):
    """
    TR_ID: C403337
    NAME: (ER Steps 6-7 need to be updated)Verify Races details page displaying for finished event after device sleeping or losing connection
    DESCRIPTION: This test case verifies Races details page displaying for finished event after device sleeping or losing connection
    ...
    def test_005_trigger_finishing_of_event_from_step_3(self):
        """
        DESCRIPTION: Trigger finishing of event from step 3
