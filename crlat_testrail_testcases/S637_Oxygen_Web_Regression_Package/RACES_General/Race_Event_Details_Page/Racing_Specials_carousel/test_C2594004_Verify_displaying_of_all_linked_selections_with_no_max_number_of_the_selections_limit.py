...
@pytest.mark.races
@vtest
class Test_C2594004_Verify_displaying_of_all_linked_selections_with_no_max_number_of_the_selections_limit(Common):
    """
    TR_ID: C2594004
    NAME: Verify displaying of all linked selections with no max number of the selections limit
    DESCRIPTION: This test case verifies that there is no limit user can add selections to Specials carousel
    ...
    PRECONDITIONS: - You should have a linked over 10 selections to <Race> event
    ...
    def test_001_verify_selections_in_specials_carousel(self):
        """
        DESCRIPTION: Verify selections in Specials carousel
        EXPECTED: - All linked selections are displayed within the carousel
        EXPECTED: - There is no limit of linked selections to the event
        """
        pass
