...
@pytest.mark.
@vtest
class Test_C59486934_Verify_that_user_can_view_the_BOG_signposting_in_Horse_Racing_Result_Tab(Common):
    """
    TR_ID: C59486934
    NAME: Verify that user can view the  BOG signposting in Horse Racing "Result Tab"
    ...
    def test_007_verify_the_bog_signposting(self):
        ...
        EXPECTED: It should be displayed
        """
        pass
