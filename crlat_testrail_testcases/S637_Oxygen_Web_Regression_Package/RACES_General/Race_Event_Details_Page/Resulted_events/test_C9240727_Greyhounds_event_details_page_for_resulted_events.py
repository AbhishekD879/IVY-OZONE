...
@pytest.mark.races
@vtest
class Test_C9240727_Greyhounds_event_details_page_for_resulted_events(Common):
    """
    TR_ID: C9240727
    NAME: Greyhounds event details page for resulted events
    DESCRIPTION: This test case verifies UI elements on resulted Greyhounds details page
    ...
    PRECONDITIONS: - You should have resulted Greyhounds events with next configurations:
    PRECONDITIONS: - 1) Each-way should be neabled
    ...
    PRECONDITIONS: - 4) With information received about trainer, jokey etc. (For Greyhounds we receive this information from TimeForm)
    ...
    PRECONDITIONS: - You should be on a Greyhounds details page
    """
    ...
    def test_006_verify_non_runners_section(self):
        ...
        EXPECTED: - Trap and greyhound name
        EXPECTED: - For Ladbrokes: trainer and jokey should be displayed for non runners
        """
        pass

    def test_007_verify_order_os_sections(self):
        """
        DESCRIPTION: Verify order os sections
