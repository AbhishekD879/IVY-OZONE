...
@pytest.mark.races
@vtest
class Test_C29002_Verify_events_that_passed_Suspension_Time(Common):
    """
    TR_ID: C29002
    NAME: Verify events that passed "Suspension Time"
    DESCRIPTION: This test case verifies special events removing from the Greyhound Landing Page if they passed "Suspension Time"
    ...
    def test_003_checkeventsuspendattimesimple_filter_innetworks_tab_in_console(self):
        """
        DESCRIPTION: Check **event.suspendAtTime** simple filter in Networks tab (in Console)
    ...
    def test_004_pick_greyhounds_special_event_which_is_shown_on_landing_page_and_check_ss_response_for_it(self):
        """
        DESCRIPTION: Pick Greyhounds Special event which is shown on Landing Page and check SS response for it
    ...
    def test_005_wait_until_time_ofsuspendattime_passed__refresh_landing_page(self):
        """
