...
@vtest
class Test_C62933360_Verify_creation_of_pots_in_Horse_Selection_Page_using_Individual_Race_checkbox(Common):
    """
    TR_ID: C62933360
    NAME: Verify creation of pots in Horse Selection Page using Individual Race checkbox
    DESCRIPTION: This test case verifies creation of pots in Horse Selection Page using Individual Race checkbox
    ...
    def test_004_select_individual_race_check_box(self):
        """
        DESCRIPTION: Select Individual Race check box
