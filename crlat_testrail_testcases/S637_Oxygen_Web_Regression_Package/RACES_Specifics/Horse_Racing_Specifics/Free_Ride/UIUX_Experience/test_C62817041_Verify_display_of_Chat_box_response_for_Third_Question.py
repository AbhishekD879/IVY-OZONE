...
@vtest
class Test_C62817041_Verify_display_of_Chat_box_response_for_Third_Question(Common):
    """
    TR_ID: C62817041
    ...
    PRECONDITIONS: 5. User should select answers for First and Second questions
    PRECONDITIONS: 6. User should on Third question as Step 3 of 3 page
    """
    ...
    def test_004_verify_the_display_of_chat_box_response(self):
        ...
        EXPECTED: Chat box response should be displayed as per the CMS configurations from 'Chat box Q3 response' field
        """
        pass
