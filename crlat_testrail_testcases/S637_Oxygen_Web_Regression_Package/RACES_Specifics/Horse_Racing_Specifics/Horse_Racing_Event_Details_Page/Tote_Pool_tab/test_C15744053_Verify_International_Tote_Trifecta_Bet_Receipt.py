...
@pytest.mark.races
@vtest
class Test_C15744053_Verify_International_Tote_Trifecta_Bet_Receipt(Common):
    """
    TR_ID: C15744053
    NAME: Verify International Tote Trifecta Bet Receipt
    DESCRIPTION: This test case verifies Trifecta bet receipt, which appears in betslip after the user has placed an International Trifecta Tote bet
    ...
    PRECONDITIONS: User should have placed an International Trifecta Tote bet
    """
    keep_browser_open = True

    def test_001_verify_trifecta_international_tote_bet_receipt_header(self):
        """
        DESCRIPTION: Verify Trifecta International Tote Bet Receipt Header
    ...
    def test_002_verify_trifecta__international_tote_bet_receipt_subheader(self):
        """
        DESCRIPTION: Verify Trifecta  International Tote Bet Receipt subheader
    ...
    def test_003_verify_trifecta__international_tote_bet_receipt_card_for_exacta_bet(self):
        """
        DESCRIPTION: Verify Trifecta  International Tote Bet Receipt card for Exacta Bet
        EXPECTED: The following information is displayed on the bet receipt:
        EXPECTED: "Singles " label in the section header
        EXPECTED: Bet ID(Coral)/Receipt No(Ladbrokes)
        EXPECTED: Tote selections name
        EXPECTED: Eg: 1st Drops of Jup
        EXPECTED: 2nd Massina
        EXPECTED: 3rd coralf
        EXPECTED: Bet Type name / Meeting ( Trifecta / 13.25 Place )
    ...
    def test_008_click_on_reuse_selection_button(self):
        ...
        EXPECTED: International Trifecta  bet appears in the BetSlip again
        """
        pass

    def test_009_place_an_international_tote_trifecta__bet_again(self):
        """
        DESCRIPTION: Place an International Tote Trifecta  bet again
