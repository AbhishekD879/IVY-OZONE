...
@pytest.mark.races
@vtest
class Test_C2912431_To_Update_Verify_International_Tote_Place_Bet_Placement(Common):
    """
    TR_ID: C2912431
    NAME: [To Update] Verify International Tote Place Bet Placement
