...
@pytest.mark.races
@vtest
class Test_C2912432_To_update_Verify_International_Tote_Win_Bet_Receipt(Common):
    """
    TR_ID: C2912432
    NAME: [To update] Verify International Tote Win Bet Receipt
    ...
    def test_001_verify_win_international_tote_bet_receipt_header(self):
        """
        DESCRIPTION: Verify Win International Tote Bet Receipt Header
    ...
    def test_002_verify_win_international_tote_bet_receipt_subheader(self):
        """
        DESCRIPTION: Verify Win International Tote Bet Receipt subheader
    ...
    def test_003_verify_win_international_tote_bet_receipt_card_for_win_bet(self):
        """
        DESCRIPTION: Verify Win International Tote Bet Receipt card for Win Bet
