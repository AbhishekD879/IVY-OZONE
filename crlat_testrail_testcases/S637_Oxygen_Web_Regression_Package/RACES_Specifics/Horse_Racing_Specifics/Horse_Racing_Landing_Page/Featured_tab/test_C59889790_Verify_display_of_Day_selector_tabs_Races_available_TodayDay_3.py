...
@pytest.mark.races
@vtest
class Test_C59889790_Verify_display_of_Day_selector_tabs_Races_available_TodayDay_3(Common):
    """
    TR_ID: C59889790
    NAME: Verify display of Day selector tabs-Races available Today,Day 3
    DESCRIPTION: Verify that Today and Day 3 name is displayed when there are races scheduled for Today and Day 3
    PRECONDITIONS: 1: Login to TI and schedule races for only Today and Day 3
    """
    ...
    def test_004_verify_the_day_selector_tabs_displayed_in_the_country_panel(self):
        ...
        EXPECTED: 1: Today and Day 3 name should be displayed
        EXPECTED: 2: User should be able to switch between tabs
        """
        pass
