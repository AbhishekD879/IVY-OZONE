...
@pytest.mark.races
@vtest
class Test_C15874972_Verify_displaying_data_on_UI_when_no_information_is_gotten_from_Open_Bet_HR(Common):
    """
    TR_ID: C15874972
    NAME: Verify displaying data on UI when no information is gotten from Open Bet (HR)
    DESCRIPTION: This test case verifies that app pages are properly displayed when data from Open Bet is unavailable or partially missing (HR)
