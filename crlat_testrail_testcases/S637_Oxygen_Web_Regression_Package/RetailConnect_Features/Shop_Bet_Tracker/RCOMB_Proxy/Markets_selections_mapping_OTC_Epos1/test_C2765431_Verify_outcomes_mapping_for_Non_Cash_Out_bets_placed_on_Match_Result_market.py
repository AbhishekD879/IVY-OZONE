...
@pytest.mark.retail
@vtest
class Test_C2765431_Verify_outcomes_mapping_for_Non_Cash_Out_bets_placed_on_Match_Result_market(Common):
    """
    TR_ID: C2765431
    NAME: Verify outcomes mapping for Non Cash Out bets placed on 'Match Result' market
    ...
    def test_006__select_barcode_which_contain_eventbet_placed_on_market_correct_score_event_type_name__fb_bip_ftwld_and_repeat_steps_1_5(self):
        """
        DESCRIPTION: * Select barcode which contain event/bet placed on market "Correct Score" (Event Type Name = FB BIP FTWLD) and repeat steps №1-5
        EXPECTED: 
        """
        pass
