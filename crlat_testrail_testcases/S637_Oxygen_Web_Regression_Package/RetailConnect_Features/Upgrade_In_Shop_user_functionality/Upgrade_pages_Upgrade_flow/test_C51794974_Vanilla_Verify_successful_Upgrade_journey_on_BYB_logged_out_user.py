...
@vtest
class Test_C51794974_Vanilla_Verify_successful_Upgrade_journey_on_BYB_logged_out_user(Common):
    """
    TR_ID: C51794974
    NAME: [Vanilla] Verify successful Upgrade journey on BYB (logged out user)
    DESCRIPTION: This test case verifies successful Upgrade journey when the logged out In-Shop user attempts to place a BYB
    ...
    def test_002_login_with_in_shop_user(self):
        """
    ...
    def test_003_click_on_upgrade_button(self):
        """
    ...
    def test_004_follow_upgrade_journey_fill_in_all_required_fields_and_complete_steps_and_click_create_account_buttonuse_email___usernameinternalgvccom_template(self):
        """
    ...
    def test_005_log_in_with_username_and_password_perform_funds_deposit_if_needed_and_place_byb_bet(self):
        """
    ...
    def test_007_login_with_upgraded_user_and_navigate_to_byb_bet_builder_event__add_selections_and_try_to_place_bet(self):
        """
        ...
        EXPECTED: - User is able to place BYB bet
        """
        pass
