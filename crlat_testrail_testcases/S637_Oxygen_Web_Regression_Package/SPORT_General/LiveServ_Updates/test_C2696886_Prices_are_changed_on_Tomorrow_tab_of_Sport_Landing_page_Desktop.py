...
@pytest.mark.sports
@vtest
class Test_C2696886_Prices_are_changed_on_Tomorrow_tab_of_Sport_Landing_page_Desktop(Common):
    """
    TR_ID: C2696886
    NAME: Prices are changed on Tomorrow tab of <Sport> Landing page [Desktop]
    DESCRIPTION: This test case verifies prices changes on Tomorrow tab of <Sport> Landing page (for desktop only)
    DESCRIPTION: AUTOTEST Mobile: [C2727279]
    DESCRIPTION: AUTOTEST Desktop: [C2727281]
    ...
    def test_001_open_tomorrow_tab_of_sport_landing_page_for_desktop_only(self):
        """
        DESCRIPTION: Open Tomorrow tab of <Sport> Landing page (for desktop only)
