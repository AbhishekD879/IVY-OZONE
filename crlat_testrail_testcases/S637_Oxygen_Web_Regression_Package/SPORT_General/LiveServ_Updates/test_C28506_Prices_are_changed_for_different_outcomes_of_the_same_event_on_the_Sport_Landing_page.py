...
@pytest.mark.sports
@vtest
class Test_C28506_Prices_are_changed_for_different_outcomes_of_the_same_event_on_the_Sport_Landing_page(Common):
    """
    TR_ID: C28506
    NAME: Prices are changed for different outcomes of the same event on the <Sport> Landing page
    DESCRIPTION: The test-case verifies whether Prices are changed for different outcomes of the same event on the <Sport> Landing page
    ...
    def test_004_trigger_price_change_for_several_outcomes_of_primary_market_market_for_the_same_event_from_the_current_page(self):
        """
        DESCRIPTION: Trigger price change for several outcomes of '<Primary market>' market for the same event from the current page
