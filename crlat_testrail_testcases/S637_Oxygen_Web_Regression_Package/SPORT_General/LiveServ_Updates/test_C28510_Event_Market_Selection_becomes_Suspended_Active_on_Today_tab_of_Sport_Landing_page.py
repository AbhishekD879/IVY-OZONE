...
@pytest.mark.sports
@vtest
class Test_C28510_Event_Market_Selection_becomes_Suspended_Active_on_Today_tab_of_Sport_Landing_page(Common):
    """
    TR_ID: C28510
    NAME: Event/Market/Selection becomes Suspended/Active on Today tab of <Sport> Landing page
    DESCRIPTION: This test case verifies suspension/unsuspension of Event on Today tab of <Sport> Landing page
    ...
    def test_001___open_today_tab_of_sport_landing_page_for_desktop__open_matches_tab_of_sport_landing_page_for_mobile(self):
        """
        DESCRIPTION: - Open Today tab of <Sport> Landing page (for desktop)
        DESCRIPTION: - Open Matches tab of <Sport> Landing page (for mobile)
        EXPECTED: * Today tab (for desktop) / Matches tab (for mobile) is selected
    ...
    def test_002_trigger_the_following_situation_for_todays_eventeventstatuscodes__and_at_the_same_time_have_today_tab_opened_to_watch_for_updates_for_desktop__and_at_the_same_time_have_matches_tab_opened_to_watch_for_updates_for_mobile(self):
        """
        DESCRIPTION: Trigger the following situation for today's event:
        DESCRIPTION: **eventStatusCode="S"**
        DESCRIPTION: - and at the same time have Today tab opened to watch for updates (for desktop)
    ...
    def test_004_change_attribute_for_this_eventeventstatuscodea__and_at_the_same_time_have_today_tab_opened_to_watch_for_updates_for_desktop__and_at_the_same_time_have_matches_tab_opened_to_watch_for_updates_for_mobile(self):
        """
    ...
    def test_008_repeat_steps_2_6_for_suspension_on_outcome_leveloutcomestatuscodesoutcomestatuscodea(self):
        """
