...
@pytest.mark.sports
@vtest
class Test_C820529_Verify_newly_created_markets_selections_on_Sport_Event_Details_Page(Common):
    """
    TR_ID: C820529
    ...
    def test_004_in_ti_tool_create_new_market_without_selections_verify_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Create new market (without selections)> Verify Event Details page of <Sport> event
    ...
    def test_006_in_ti_tool_add_selections_to_the_newly_created_market_in_step_4__in_application_verify_opened_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Add selection(s) to the newly created market (in step 4) > In application: Verify opened Event Details page of <Sport> event
    ...
    def test_008_refresh_event_details_page_of_sport_event_in_ti_tool_add_another_selection_to_the_market_from_step_4__in_application_verify_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: Refresh Event Details page of <Sport> event >
    ...
    def test_010_in_ti_tool_create_new_market_with_selections_in_application_verify_opened_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Create new market with selections> In application: Verify opened Event Details page of <Sport> event
        EXPECTED: - Newly created market with selections automatically appear on the page
        EXPECTED: - All other markets are displayed in their actual state (expanded or collapsed)
        EXPECTED: - If order of newly created market is > 2, the market is shown collapsed
        EXPECTED: - If order of newly created market is < 2, the market is shown expanded
    ...
    def test_013_in_ti_tool_add_combined_market_without_selectionsin_application_verify_opened_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Add combined market without selections>In application: Verify opened Event Details page of <Sport> event
        EXPECTED: Newly created market is NOT displayed
        """
        pass
    ...
    def test_015_in_ti_tool_add_selections_to_one_market_within_combined_markets_group__in_application_verify_opened_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Add selection(s) to one market within combined markets group > In application: Verify opened Event Details page of <Sport> event
    ...
    def test_017_refresh_event_details_page_of_sport_event_in_ti_tool_add_another_selection_to_the_available_combined_market___in_application_verify_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: Refresh Event Details page of <Sport> event >
        DESCRIPTION: In TI tool: Add another selection to the available combined market  > In application: Verify Event Details page of <Sport> event
        EXPECTED: Newly created selection automatically appears on the page for a corresponding combined market
        """
        pass

    def test_018_in_ti_tool_add_selections_to_other_markets_within_combined_markets_group__verify_event_details_page_of_sport_event(self):
        """
        DESCRIPTION: In TI tool: Add selection(s) to other market(s) within combined markets group > Verify Event Details page of <Sport> event
