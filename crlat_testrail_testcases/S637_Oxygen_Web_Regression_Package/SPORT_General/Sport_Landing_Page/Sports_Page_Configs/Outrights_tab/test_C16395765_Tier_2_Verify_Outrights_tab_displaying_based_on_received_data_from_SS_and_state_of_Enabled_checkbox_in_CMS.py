...
@pytest.mark.sports
@vtest
class Test_C16395765_Tier_2_Verify_Outrights_tab_displaying_based_on_received_data_from_SS_and_state_of_Enabled_checkbox_in_CMS(Common):
    """
    TR_ID: C16395765
    NAME: [Tier 2] Verify 'Outrights' tab displaying based on received data from SS and state of 'Enabled' checkbox in CMS
    ...
    PRECONDITIONS: 2. Navigate to Tier 2 Sport Landing page where 'Outrights' tab is enabled in CMS ('checkEvents: 'true' set by default for Tier 2 Sports)
