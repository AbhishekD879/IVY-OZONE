...
@pytest.mark.other
@vtest
class Test_C59192713_Verify_error_handling_of_Failed_Class_request_on_Outrights_tab(Common):
    """
    TR_ID: C59192713
    NAME: Verify error handling of Failed Class request on 'Outrights' tab
    DESCRIPTION: This test case verifies error handling of Failed Class request on 'Outrights' tab for both Tier 1 and Tier 2 Sports
    PRECONDITIONS: 1. Load Oxygen app
    PRECONDITIONS: 2. Navigate to any Sport Landing page with Tier 1 Sport configuration -> 'Outrights' tab
    ...
    def test_003_navigate_to_any_sport_landing_page_with_tier_2_sport_configuration___outrights_tab__and_block_class_request_in_chrome_dev_tools___request_blocking(self):
        """
        DESCRIPTION: Navigate to any Sport Landing page with Tier 2 Sport configuration -> 'Outrights' tab  and block Class request in Chrome Dev tools -> Request blocking
        EXPECTED: 
        """
        pass
