...
@pytest.mark.sports
@vtest
class Test_C60035080_Verify_Time_Filters_Component_on_Competitions_tab_for_Tier_1_sports(Common):
    """
    TR_ID: C60035080
    NAME: Verify Time Filters Component on Competitions tab for Tier 1 sports
    DESCRIPTION: This test case verifies Time Filters Component on Competitions tab for Tier 1 sports
    ...
    def test_001_clicktap_on_some_league(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/121591740)
        """
        pass
    ...
    def test_004_return_to_app_tier1_sport_landing_page_gt_competitionand_look_at_filters(self):
        """
