...
@pytest.mark.in_play
@vtest
class Test_C59925202_Verify_MS_on_Competitions_Tab_for_AmFootball_when_no_events_are_found(Common):
    """
    TR_ID: C59925202
    NAME: Verify MS on Competitions Tab for Am.Football when no events are found
