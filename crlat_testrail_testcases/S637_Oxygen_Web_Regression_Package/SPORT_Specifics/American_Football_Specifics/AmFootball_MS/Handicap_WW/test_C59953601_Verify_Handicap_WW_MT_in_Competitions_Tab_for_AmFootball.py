...
@pytest.mark.sports
@vtest
class Test_C59953601_Verify_Handicap_WW_MT_in_Competitions_Tab_for_AmFootball(Common):
    """
    TR_ID: C59953601
    ...
    def test_008_repeat_3_7_steps_for_the_below_markettotal_pointsexpect_step_4(self):
        """
