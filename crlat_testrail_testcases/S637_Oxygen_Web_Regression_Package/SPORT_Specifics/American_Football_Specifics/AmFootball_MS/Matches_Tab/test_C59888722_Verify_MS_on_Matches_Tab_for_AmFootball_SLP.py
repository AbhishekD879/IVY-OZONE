...
@pytest.mark.sports
@vtest
class Test_C59888722_Verify_MS_on_Matches_Tab_for_AmFootball_SLP(Common):
    """
    TR_ID: C59888722
    ...
    def test_006_repeat_steps_3_5_for_the_following_markets_handicap_handicap_in_lads_and_spread_in_coral_60_minute_betting_total_points(self):
        """
