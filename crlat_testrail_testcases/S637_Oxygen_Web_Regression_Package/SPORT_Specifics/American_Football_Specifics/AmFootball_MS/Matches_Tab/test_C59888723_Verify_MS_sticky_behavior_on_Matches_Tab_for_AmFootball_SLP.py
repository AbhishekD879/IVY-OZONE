...
@pytest.mark.sports
@vtest
class Test_C59888723_Verify_MS_sticky_behavior_on_Matches_Tab_for_AmFootball_SLP(Common):
    """
    TR_ID: C59888723
    NAME: Verify MS sticky behavior on Matches Tab for Am.Football SLP
