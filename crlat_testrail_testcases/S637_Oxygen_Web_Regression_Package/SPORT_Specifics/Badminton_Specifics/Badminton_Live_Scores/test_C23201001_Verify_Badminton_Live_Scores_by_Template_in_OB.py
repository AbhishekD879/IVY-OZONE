...
@pytest.mark.sports
@vtest
class Test_C23201001_Verify_Badminton_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C23201001
    ...
    DESCRIPTION: Mobile [C34181866]
    DESCRIPTION: Desktop [C42275552]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_badminton_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_badminton_pages(self):
        """
        ...
        EXPECTED: ![](index.php?/attachments/get/36799)
        """
        pass
    ...
    def test_005_go_to_badminton_landing_page__in_play_tabmodule(self):
        """
    ...
    def test_006_navigate_to_edp_of_the_appropriate_event(self):
        ...
        EXPECTED: - Serving is shown as a dot near the player with '*' in the name
        EXPECTED: ![](index.php?/attachments/get/36800)
        """
        pass
