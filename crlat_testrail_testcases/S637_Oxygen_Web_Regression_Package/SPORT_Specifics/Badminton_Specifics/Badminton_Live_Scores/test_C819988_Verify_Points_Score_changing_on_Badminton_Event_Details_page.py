...
@pytest.mark.sports
@vtest
class Test_C819988_Verify_Points_Score_changing_on_Badminton_Event_Details_page(Common):
    """
    TR_ID: C819988
    NAME: Verify Points Score changing on Badminton Event Details page
    DESCRIPTION: This test case verifies Points Score changing on Event Details page.
    ...
    def test_004_change_points_score_for_home_team(self):
        """
    ...
    def test_005_change_points_score_for_away_team(self):
        """
    ...
    def test_006_verify_points_score_animation_for_each_team(self):
        """
        DESCRIPTION: Verify Points Score animation for each team
        EXPECTED: * New Points Score slides and starts displaying new value immediately under 'P' label
        """
        pass
