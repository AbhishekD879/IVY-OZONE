...
@pytest.mark.other
@vtest
class Test_C22653940_Verify_Primary_market_for_Badminton(Common):
    """
    TR_ID: C22653940
    NAME: Verify Primary market for Badminton
    DESCRIPTION: This test case verifies Primary Market for 'Badminton' Sport
    ...
    PRECONDITIONS: dispSortName: ‘HH’,
    PRECONDITIONS: dispSortNameIncludeOnly: ‘HH’,
    PRECONDITIONS: marketTemplateMarketNameIntersects: ‘|Match Winner|'
    PRECONDITIONS: * Load Oxygen app
    PRECONDITIONS: * Go to Badminton landing page
    """
    keep_browser_open = True

    def test_001_verify_todays_matches_page(self):
        """
        DESCRIPTION: Verify Today's Matches page
    ...
    def test_003_verify_priceodds_button_for_2_way_market(self):
        ...
        EXPECTED: For **Match Winner** primary market selections are shown in one row next to the Event name and are ordered by the rule:
    ...
    def test_007_repeat_steps_1_3_step_1_only_for_tomorrow_and_future_tabs_for_desktop_for_tomorrow_tab_for_desktop_only_future_tab_for_desktop_only_competition_tab_mobile_only_competition_detailed_page_mobile_where_applicable_live_stream_pagetab___live_now_and_upcoming_filters_highlights_carousel_module_created_on_homepage_landing_page_featured_tab_module_created_by_typeid_live_stream_widget(self):
        """
        DESCRIPTION: Repeat steps №1-3 (step 1 only for Tomorrow and Future tabs for Desktop) for:
