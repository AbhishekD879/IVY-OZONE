...
@pytest.mark.sports
@vtest
class Test_C23201019_Verify_Baseball_Live_Scores_by_Template_in_OB_Only_Ladbrokes(Common):
    """
    TR_ID: C23201019
    NAME: Verify Baseball Live Scores by Template in OB (Only Ladbrokes)
    DESCRIPTION: This test case verifies that Live Score for Baseball are shown and updated through OB name template
    DESCRIPTION: AUTOTEST MOBILE : [C34162265]
    DESCRIPTION: DESKTOP : [C34792793]
    ...
    def test_005_go_to_baseball_landing_page__in_play_tabmodule(self):
        """
