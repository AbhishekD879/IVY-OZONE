...
@pytest.mark.sports
@vtest
class Test_C28694_Verify_Events_Grouping(Common):
    """
    TR_ID: C28694
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Baseball=5)
    PRECONDITIONS: *   X.XX - current supported version of OpenBet release
    PRECONDITIONS: *   ZZ - dispSortName specific value for each Sport, shows the primary marker (e.g. Baseball-HH).
    PRECONDITIONS: *   LL - language (e.g. en, ukr)
    ...
    def test_002_tapbaseball_icon_on_the_sports_menu_ribbon(self):
        ...
        EXPECTED: *   Baseball Landing Page/Single view is opened (all the events are displayed on the page, grouped by sections: in-play/outrights...)
        """
        pass
