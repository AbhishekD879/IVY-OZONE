...
@pytest.mark.sports
@vtest
class Test_C23066013_Verify_Basketball_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C23066013
    ...
    DESCRIPTION: Mobile [C31341008]
    DESCRIPTION: Desktop [C31542974]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_basketball_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_basketball_pages(self):
        """
    ...
    def test_005_go_to_basketball_landing_page__in_play_tab(self):
        """
    ...
    def test_006_navigate_to_basketball_landing_page__competitions_tabselect_appropriate_competition_to__event_where_scores_should_be_checked(self):
        """
