...
@pytest.mark.sports
@vtest
class Test_C59888460_Verify_MS_on_Specific_Competitions_page_for_Basketball(Common):
    """
    TR_ID: C59888460
    ...
    def test_005_verify_bet_placement_for_single_bet_for_the_below_markets_money_line_total_points_handicap_handicap_in_lads_and_spread_in_coral_home_team_total_points_away_team_total_points_current_half_total_points_current_quarter_total_points(self):
        """
