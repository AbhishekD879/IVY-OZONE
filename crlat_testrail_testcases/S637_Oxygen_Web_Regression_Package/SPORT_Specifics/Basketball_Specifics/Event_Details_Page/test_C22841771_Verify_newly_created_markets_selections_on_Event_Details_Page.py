...
@pytest.mark.sports
@vtest
class Test_C22841771_Verify_newly_created_markets_selections_on_Event_Details_Page(Common):
    """
    TR_ID: C22841771
    NAME: Verify newly created markets & selections on Event Details Page
    DESCRIPTION: This test case verifies automatically displaying newly created markets/selections on In-Play/Pre-Match Basketball Event Details Page
    ...
    def test_002_go_to_in_playpre_match_event_details_page_of_basketball_event(self):
        """
        DESCRIPTION: Go to In-Play/Pre-Match event Details page of Basketball event
    ...
    def test_006_in_ti_tool_add_selections_to_the_newly_created_market_in_step_4__in_application_verify_opened_event_details_page_of_the_event(self):
        """
        DESCRIPTION: In TI tool: Add selection(s) to the newly created market (in step 4) > In application: Verify opened Event Details page of the event
        ...
        EXPECTED: - For In-Play event details page: Only Markets with attribute isMarketBetInRun="true" on the market level automatically appear
    ...
    def test_008_refresh_event_details_page_of_basketball_event_in_ti_tool_add_another_selection_to_the_market_from_step_4__in_application_verify_event_details_page(self):
        """
        DESCRIPTION: Refresh Event Details page of basketball event >
    ...
    def test_013_in_ti_tool_add_combined_market_without_selectionsin_application_verify_opened_event_details_page(self):
        """
        DESCRIPTION: In TI tool: Add combined market without selections>In application: Verify opened Event Details page
        EXPECTED: Newly created market is NOT displayed
        """
        pass
    ...
    def test_017_refresh_event_details_page_of_basketball_event_in_ti_tool_add_another_selection_to_the_available_combined_market__in_application_verify_event_details_page(self):
        """
        DESCRIPTION: Refresh Event Details page of Basketball event >
