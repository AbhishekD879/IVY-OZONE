...
@pytest.mark.sports
@vtest
class Test_C28741_Verify_Primary_Market_for_Bowls(Common):
    """
    TR_ID: C28741
    NAME: Verify Primary Market for Bowls
    DESCRIPTION: This test case verifies Primary Market for 'Bowls' Sport
    ...
    def test_001_tapbowls_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_003_verify_priceodds_buttons_for_2_way_marketwhere_is_dispsortnamehh(self):
        """
        DESCRIPTION: Verify Price/Odds buttons for 2-Way Market (where is dispSortName="HH")
        EXPECTED: For 2-way **Match Betting** primary market selections are shown in one row next to the Event name and are ordered by the rule:
