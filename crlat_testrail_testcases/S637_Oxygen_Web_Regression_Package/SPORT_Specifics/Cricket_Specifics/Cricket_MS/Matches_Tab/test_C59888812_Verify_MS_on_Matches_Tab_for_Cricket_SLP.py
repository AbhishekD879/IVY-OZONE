...
@pytest.mark.sports
@vtest
class Test_C59888812_Verify_MS_on_Matches_Tab_for_Cricket_SLP(Common):
    """
    TR_ID: C59888812
    ...
    def test_007_verify_bet_placement_for_single_multiple_and_quick_bet_for_the_below_markets_match_result_total_sixes(self):
        """
