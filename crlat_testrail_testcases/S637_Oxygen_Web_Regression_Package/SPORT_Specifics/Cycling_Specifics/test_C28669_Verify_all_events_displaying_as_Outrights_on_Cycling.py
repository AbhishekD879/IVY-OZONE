...
@pytest.mark.sports
@vtest
class Test_C28669_Verify_all_events_displaying_as_Outrights_on_Cycling(Common):
    """
    TR_ID: C28669
    NAME: Verify all events displaying as Outrights on Cycling
    ...
    def test_001_tapcycling_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_003_repeat_steps_2_for_in_play_tab_on_sport_ladning_page_desktop_only_in_play_tab_on_homepage__live_now_and_upcoming_filters_in_play_sport_page___live_now_and_upcoming_filters_in_play_widget_on_desktop_tomorrow_tab_for_desktop_only_future_tab_for_desktop_only_outrighs_tab_mobile_only_competition_detailed_page___outright_tab_mobile_where_applicable_live_stream_pagetab___live_now_and_upcoming_filters_highlights_carousel_module_created_on_homepage_landing_page_featured_tab_module_created_by_typeid(self):
        """
        ...
        DESCRIPTION: * 'Competition Detailed' page -> Outright tab (mobile, where applicable)
