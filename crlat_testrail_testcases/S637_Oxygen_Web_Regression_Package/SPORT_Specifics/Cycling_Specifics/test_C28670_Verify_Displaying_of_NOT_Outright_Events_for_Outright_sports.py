...
@pytest.mark.sports
@vtest
class Test_C28670_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28670
    ...
    def test_002_tap_cycling_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Cycling' icon from the Sports Menu Ribbon
        EXPECTED: Desktop:
    ...
    def test_007_tap_tomorrow_tab_for_desktop_onle(self):
        """
        DESCRIPTION: Tap** 'Tomorrow'** tab (for desktop onle)
