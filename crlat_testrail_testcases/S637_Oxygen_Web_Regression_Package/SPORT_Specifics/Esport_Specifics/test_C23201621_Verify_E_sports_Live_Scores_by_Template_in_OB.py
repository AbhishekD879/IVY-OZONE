...
@pytest.mark.sports
@vtest
class Test_C23201621_Verify_E_sports_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C23201621
    NAME: Verify E-sports Live Scores by Template in OB
    DESCRIPTION: This test case verifies that Live Score for E-sports are shown and updated through OB name template
    PRECONDITIONS: **Configurations:**
    PRECONDITIONS: Create events using OB.
    ...
    def test_001_for_mobiletablet_in_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_esports_pages_home_page__featured_tab__in_play_module_highlight_carousel_featured_module_created_by_type_idevent_id_home_page__in_play_tab_home_page__live_stream_tab_e_sports_landing_page__in_play_module(self):
        """
        DESCRIPTION: **For Mobile/Tablet:**
        DESCRIPTION: * **'In-Play'** page from the Sports Menu Ribbon
        DESCRIPTION: Check on **'Watch live'** and **ESports** pages
        ...
        DESCRIPTION: * **E-sports Landing page > 'In Play'** module
        ...
        EXPECTED: ![](index.php?/attachments/get/36817)
        """
        pass

    def test_002_for_desktop_in_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_esports_pages_home_page__in_play_and_live_stream_module_check_in_play_tab_and_live_stream_tabs_sports_landing_page__in_play_widget_and_live_stream_widget_e_sports_landing_page__in_play_tab(self):
        """
        ...
        DESCRIPTION: * **E-sports Landing page > 'In Play'** tab
        EXPECTED: - Scores are NOT shown in the event name
        EXPECTED: - Each score for particular team is shown in the same row as team's name near the Price/Odds button
        EXPECTED: - Score corresponds to the ** 'value'** attribute from WS
        EXPECTED: Score for the home team is shown opposite the home team name (roleCode="HOME"/"TEAM_1")
    ...
    def test_003_navigate_to_edp_of_the_appropriate_event(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/36818)
        """
        pass
