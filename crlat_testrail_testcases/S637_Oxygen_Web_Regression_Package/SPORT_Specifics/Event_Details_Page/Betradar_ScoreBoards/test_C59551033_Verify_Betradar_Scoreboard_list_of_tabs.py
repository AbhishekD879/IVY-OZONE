...
@pytest.mark.sports
@vtest
class Test_C59551033_Verify_Betradar_Scoreboard_list_of_tabs(Common):
    """
    TR_ID: C59551033
    ...
    PRECONDITIONS: Make sure the Table Tennis Inplay event which is subscribed to Betradar Scoreboards
