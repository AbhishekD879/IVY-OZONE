...
@pytest.mark.sports
@vtest
class Test_C59551040_Verify_the_visualization_and_scoreboard_soon_after_the_event_is_finished_Best_of_5_games(Common):
    """
    TR_ID: C59551040
    NAME: Verify the visualization and scoreboard soon after the event is finished : Best of 5 games
    DESCRIPTION: Test case verifies visualization and scoreboard after the event is finished for the event doubles with best of 5 games
    ...
    def test_003_verify_ui_of_match_finish_event(self):
        ...
        EXPECTED: 2:3 or 3:2
        EXPECTED: 3:0 or 0:3
        EXPECTED: 7 : Each game details scores of each team eg in set 1 team A scores 4 and Team B scores 11 all the details should display in table format
        EXPECTED: 8. Table tennis pitch should display
        EXPECTED: 9. On top of net Label : Match and game won details should display
        EXPECTED: 10 : current game number should display on left side to the net
        ...
        EXPECTED: 14 : Timer should display at last game (TBD)
        """
        pass

    def test_004_repeat_above_step_for_the_event_singles_with_best_of_5_games(self):
        """
        DESCRIPTION: Repeat above step for the event singles with best of 5 games
        EXPECTED: 
        """
        pass
