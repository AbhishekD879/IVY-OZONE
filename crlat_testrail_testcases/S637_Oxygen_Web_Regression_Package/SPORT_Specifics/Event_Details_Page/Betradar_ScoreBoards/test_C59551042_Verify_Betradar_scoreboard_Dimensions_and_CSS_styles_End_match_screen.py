...
@pytest.mark.sports
@vtest
class Test_C59551042_Verify_Betradar_scoreboard_Dimensions_and_CSS_styles_End_match_screen(Common):
    """
    TR_ID: C59551042
    NAME: Verify Betradar scoreboard Dimensions and CSS styles : End match screen
    DESCRIPTION: Test case verifies Betradar scoreboard Dimensions and CSS styles for the end of match screen
    ...
    def test_003_verify_overall_dimension_of_the_screen____click_on_player_name_on_pitch(self):
        """
    ...
    def test_004_verify_font_styles_in_header___click_on_table_tennis_league_text(self):
        """
