...
@vtest
class Test_C62700717_Verify_shape_of_the_team_as_crests_in_FE_when_no_image_is_uploaded_in_Asset_Manager_for_a_team(Common):
    """
    TR_ID: C62700717
    NAME: Verify shape of the team as crests in FE, when no image is uploaded in Asset Manager for a team.
    DESCRIPTION: Verify shape of the team as crests in FE, when no image is uploaded in Asset Manager for a team.
    ...
    def test_005_validate_the_shape_of_the_team_as_crests_in_fe(self):
        """
        DESCRIPTION: Validate the shape of the team as crests in FE
        EXPECTED: shape of the team should display as crests in FE, when no image is uploaded in Asset Manager for a team.
        """
        pass
