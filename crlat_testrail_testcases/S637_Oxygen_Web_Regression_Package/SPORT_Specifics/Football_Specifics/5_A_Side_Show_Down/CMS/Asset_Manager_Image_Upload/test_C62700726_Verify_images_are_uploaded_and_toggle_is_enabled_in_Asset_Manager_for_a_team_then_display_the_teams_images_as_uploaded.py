...
@vtest
class Test_C62700726_Verify_images_are_uploaded_and_toggle_is_enabled_in_Asset_Manager_for_a_team_then_display_the_teams_images_as_uploaded(Common):
    """
    TR_ID: C62700726
    NAME: Verify images are uploaded and toggle is enabled in Asset Manager for a team then  display the teams images as uploaded.
    DESCRIPTION: Verify images are uploaded and toggle is enabled in Asset Manager for a team then  display the teams images as uploaded.
    ...
    def test_002_validate_the_display_of_5_a_side_showdown_tab_in_left_side_menu_cms(self):
        """
        DESCRIPTION: Validate the display of '5-A Side showdown' tab in left side menu CMS
    ...
    def test_005_leaderboard_toggle_is_on(self):
        """
        DESCRIPTION: Leaderboard toggle is "ON"
        EXPECTED: Leaderboard toggle should be enabled
        """
        pass
    ...
    def test_007_validate_the_shape_of_the_team_images_in_fe(self):
        ...
        EXPECTED: shape of the team should display as uploaded in FE , when image is uploaded in Asset Manager for a team.
        """
        pass
