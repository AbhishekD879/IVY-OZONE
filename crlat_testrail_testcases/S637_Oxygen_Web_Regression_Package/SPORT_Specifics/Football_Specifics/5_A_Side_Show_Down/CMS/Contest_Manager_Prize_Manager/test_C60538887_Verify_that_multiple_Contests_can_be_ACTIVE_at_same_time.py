...
@vtest
class Test_C60538887_Verify_that_multiple_Contests_can_be_ACTIVE_at_same_time(Common):
    """
    TR_ID: C60538887
    NAME: Verify that multiple Contests can be ACTIVE at same time
    DESCRIPTION: This test case verifies that Multiple Contests can be ACTIVE at the same time
    PRECONDITIONS: 1: User should have admin access to CMS
    PRECONDITIONS: 2: 5-A Side Showdown menu should be configured in CMS
    PRECONDITIONS: 3: Multiple Contests should be created with the same Start Time & Date
    ...
    def test_004_validate_multiple_contests_created_with_same_start_time(self):
        """
        DESCRIPTION: Validate Multiple Contests created with same Start Time
        EXPECTED: * All Contests will be displayed in the table
        EXPECTED: * All Contests are ACTIVE
        EXPECTED: * All Contests have the same Start Time
        EXPECTED: *Note: No limit to the number of Contests that are created*
        """
        pass
