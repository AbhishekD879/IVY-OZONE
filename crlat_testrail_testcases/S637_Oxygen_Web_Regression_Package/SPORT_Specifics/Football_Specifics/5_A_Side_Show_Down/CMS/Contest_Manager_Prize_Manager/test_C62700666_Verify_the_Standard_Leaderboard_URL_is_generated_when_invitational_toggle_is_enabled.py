...
@vtest
class Test_C62700666_Verify_the_Standard_Leaderboard_URL_is_generated_when_invitational_toggle_is_enabled(Common):
    """
    TR_ID: C62700666
    NAME: Verify the Standard Leaderboard URL is generated  when invitational toggle is enabled
    DESCRIPTION: This test case verifies the Standard Leaderboard URL when invitational toggle is enabled
    ...
    def test_010_check_the_standard_leaderboard_url_which_is_generated(self):
        """
        DESCRIPTION: Check the Standard Leaderboard URL which is generated
        EXPECTED: Standard Leaderboard URL should be automatically popped when clicked on save changes button.
        """
        pass
