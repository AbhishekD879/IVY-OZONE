...
@vtest
class Test_C62700689_Verify_default_5_a_side_logo_is_displayed_in_entry_confirmation_Pre_live__post_leaderboards_FEfor_toggle_off_logo_field(Common):
    """
    TR_ID: C62700689
    NAME: Verify default 5-a-side logo is displayed in entry confirmation/ Pre/live / post leaderboards (FE),for toggle off logo field.
    DESCRIPTION: Verify default 5-a-side logo is displayed in entry confirmation/ Pre/live / post leaderboards (FE),for toggle off logo field.
    ...
    def test_004_4_validate_toggle_off_for_background_image(self):
        """
        DESCRIPTION: 4. Validate toggle "OFF" for background image
        EXPECTED: toggle should "OFF"
        """
        pass
    ...
    def test_006_6_validate_the_default_logo__is_displayed(self):
        """
        DESCRIPTION: 6. Validate the default logo  is displayed
        EXPECTED: default logo image should display in entry confirmation & pre/live and post leaderboards
        """
        pass
