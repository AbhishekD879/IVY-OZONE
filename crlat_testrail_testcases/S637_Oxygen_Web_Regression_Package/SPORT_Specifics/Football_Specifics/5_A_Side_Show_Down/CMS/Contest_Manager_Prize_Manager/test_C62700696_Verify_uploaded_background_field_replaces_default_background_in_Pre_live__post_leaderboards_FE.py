...
@vtest
class Test_C62700696_Verify_uploaded_background_field_replaces_default_background_in_Pre_live__post_leaderboards_FE(Common):
    """
    TR_ID: C62700696
    NAME: Verify uploaded background field replaces default background in Pre/live / post leaderboards (FE).
    DESCRIPTION: Verify uploaded background field replaces default background in Pre/live / post leaderboards (FE).
    ...
    def test_004_4_upload_background_image_in_background_field_for_a_contest(self):
        """
        DESCRIPTION: 4. Upload background image in background field for a contest
        EXPECTED: background image should be added
        """
        pass
    ...
    def test_006_6_validate_the_uploaded_background_image_displayed(self):
        """
        DESCRIPTION: 6. Validate the uploaded background image displayed
        EXPECTED: Uploaded image should display in pre/live and post leaderboards
        """
        pass
