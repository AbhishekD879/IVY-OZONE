...
@vtest
class Test_C60539962_Verify_display_of_Secondary_Message_in_Entry_Confirmation_for_Leaderboard_in_Bet_Receipt(Common):
    """
    TR_ID: C60539962
    NAME: Verify display of Secondary Message in  Entry Confirmation for Leaderboard in Bet Receipt
    ...
    def test_004_verify_the_entry_confirmation_displayed_on_the_bet_receipt(self):
        ...
        EXPECTED: The secondary message description text should be three lines and the rest will be truncated. It will be displayed '..." if we have more than 3 lines.
