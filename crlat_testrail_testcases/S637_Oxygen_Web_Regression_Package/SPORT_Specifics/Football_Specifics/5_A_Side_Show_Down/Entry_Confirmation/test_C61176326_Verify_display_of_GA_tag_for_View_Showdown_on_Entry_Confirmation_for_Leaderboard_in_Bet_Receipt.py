...
@vtest
class Test_C61176326_Verify_display_of_GA_tag_for_View_Showdown_on_Entry_Confirmation_for_Leaderboard_in_Bet_Receipt(Common):
    """
    TR_ID: C61176326
    NAME: Verify display of GA tag for View Showdown on Entry Confirmation for Leaderboard in Bet Receipt
    ...
    def test_004_verify_the_entry_confirmation_displayed_on_the_bet_receipt(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/160999963)
        """
        pass
    ...
    def test_006_verify_ga_tracking_for_view_entry_cta(self):
        """
