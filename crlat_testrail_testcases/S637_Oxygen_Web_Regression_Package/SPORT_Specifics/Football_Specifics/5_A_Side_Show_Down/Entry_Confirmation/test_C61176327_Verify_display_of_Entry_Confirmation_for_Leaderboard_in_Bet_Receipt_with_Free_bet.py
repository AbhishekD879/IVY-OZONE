...
@vtest
class Test_C61176327_Verify_display_of_Entry_Confirmation_for_Leaderboard_in_Bet_Receipt_with_Free_bet(Common):
    """
    TR_ID: C61176327
    NAME: Verify display of Entry Confirmation for Leaderboard in Bet Receipt with Free bet
    ...
    def test_005_place_a_5_a_side_bet_using_free_bet_satisfying_the_pre_conditions_mentionedfree_bet_toggle_is_enabled_in_cms__5_a_side_showdown__contest(self):
        """
    ...
    def test_006_place_a_5_a_side_bet_using_free_bet_satisfying_the_pre_conditions_mentionedfree_bet_toggle_is_disabled_in_cms__5_a_side_showdown__contest(self):
        """
        DESCRIPTION: Place a 5-A Side bet using free bet satisfying the pre-conditions mentioned
