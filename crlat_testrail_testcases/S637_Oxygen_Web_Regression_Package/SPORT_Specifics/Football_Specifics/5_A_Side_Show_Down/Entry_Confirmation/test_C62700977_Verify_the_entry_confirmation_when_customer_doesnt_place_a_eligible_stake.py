...
@vtest
class Test_C62700977_Verify_the_entry_confirmation_when_customer_doesnt_place_a_eligible_stake(Common):
    """
    TR_ID: C62700977
    NAME: Verify the entry confirmation when customer doesn't place a eligible stake.
    ...
    def test_003_navigate_through_standard_leaderboard_url_or_from_football_landing_page_and_click_on_build_team(self):
        """
    ...
    def test_004_build_a_team_and_click_on_place_bet(self):
        ...
        EXPECTED: Entry confirmation message should not displayed after placing the bet as stake criteria is not met.
        """
        pass
