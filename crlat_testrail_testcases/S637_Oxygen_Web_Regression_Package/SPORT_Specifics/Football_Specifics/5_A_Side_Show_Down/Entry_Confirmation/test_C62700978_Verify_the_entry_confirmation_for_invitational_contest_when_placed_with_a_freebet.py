...
@vtest
class Test_C62700978_Verify_the_entry_confirmation_for_invitational_contest_when_placed_with_a_freebet(Common):
    """
    TR_ID: C62700978
    NAME: Verify the entry confirmation for invitational contest when placed with a freebet.
    ...
    def test_002_navigate_through_standard_leaderboard_url_or_from_football_landing_page_and_click_on_build_team(self):
        """
        DESCRIPTION: Navigate through standard Leaderboard URL or from Football Landing page and click on Build team
        EXPECTED: It will navigate to 5-A-Side pitch
        """
        pass

    def test_003_build_a_team_and_click_on_place_bet_and_select_freebet_freebet_should_be_matching_with_the_eligible_stake(self):
        """
        DESCRIPTION: Build a team and click on place bet and select Freebet (Freebet should be matching with the eligible stake)
        EXPECTED: Entry confirmation message is displayed after placing the bet with eligible stake.
        """
        pass

    def test_004_verify_the_entry_confirmation_message(self):
        """
