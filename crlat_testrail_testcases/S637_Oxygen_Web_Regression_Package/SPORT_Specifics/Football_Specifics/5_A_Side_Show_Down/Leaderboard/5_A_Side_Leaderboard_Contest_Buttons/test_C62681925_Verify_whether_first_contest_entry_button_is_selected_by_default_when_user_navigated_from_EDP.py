...
@vtest
class Test_C62681925_Verify_whether_first_contest_entry_button_is_selected_by_default_when_user_navigated_from_EDP(Common):
    """
    TR_ID: C62681925
    NAME: Verify whether first contest entry button is selected by default when user navigated from EDP
    DESCRIPTION: 
    ...
    def test_005_check_whether_the_first_contest_entry_button_is_highlighted_by_default_when_user_navigated_from_edp(self):
        """
        DESCRIPTION: Check whether the first contest entry button is highlighted by default when user navigated from EDP
        EXPECTED: first button should be default selected with blue color highlighting.
        """
        pass
