...
@vtest
class Test_C62681926_Verify_whether_the_contest_entry_button_becomes_blue_on_selectON_and_white_on_deselectOFF(Common):
    """
    TR_ID: C62681926
    NAME: Verify whether the contest entry button becomes blue on select(ON) and white on deselect(OFF)
    DESCRIPTION: 
    ...
    def test_004_verify_whether_the_active_contest_entry_buttons_are_shown_on_betslip(self):
        ...
        EXPECTED: Active contest entry buttons should be present in betslip with the CMS contest creation priority order.
        """
        pass

    def test_005_verify_whether_the_contest_entry_button_becomes_blue_on_selecting_and_white_on_deselecting(self):
        """
        DESCRIPTION: Verify whether the contest entry button becomes blue on selecting and white on deselecting
        EXPECTED: It should be BLUE in ON state and WHITE in OFF state
        """
        pass
