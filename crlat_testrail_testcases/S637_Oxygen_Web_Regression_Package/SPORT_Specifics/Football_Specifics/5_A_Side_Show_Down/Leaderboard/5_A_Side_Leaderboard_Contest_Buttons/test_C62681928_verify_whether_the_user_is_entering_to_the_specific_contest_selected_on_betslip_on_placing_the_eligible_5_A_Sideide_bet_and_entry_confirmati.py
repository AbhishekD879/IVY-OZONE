...
@vtest
class Test_C62681928_verify_whether_the_user_is_entering_to_the_specific_contest_selected_on_betslip_on_placing_the_eligible_5_A_Sideide_bet_and_entry_confirmation_is_shown(Common):
    """
    TR_ID: C62681928
    NAME: verify whether the user is entering to the specific contest selected on betslip on placing the eligible 5-A-Sideide bet and entry confirmation is shown
    DESCRIPTION: 
    ...
    def test_005_select_an_active_contest_from_the_displayed_contest_entry_button_and_place_an_eligible_5_a_side_bet_for_that_contest(self):
        """
        DESCRIPTION: Select an active contest from the displayed contest entry button and place an eligible 5-A-Side bet for that contest
        EXPECTED: User should be able to place a 5-A-Side bet from the contest selected
        """
        pass

    def test_006_check_if_the_entry_confirmation_message_is_shown_after_placing_the_eligible_5_a_side_bet(self):
        """
        DESCRIPTION: Check if the entry confirmation message is shown after placing the eligible 5-A-Side bet
        EXPECTED: Entry confirmation message should be shown on placing eligible bet
        """
        pass
