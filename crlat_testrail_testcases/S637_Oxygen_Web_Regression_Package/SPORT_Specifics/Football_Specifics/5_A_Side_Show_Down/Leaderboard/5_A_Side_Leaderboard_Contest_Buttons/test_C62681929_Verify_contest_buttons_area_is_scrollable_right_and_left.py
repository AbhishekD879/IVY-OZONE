...
@vtest
class Test_C62681929_Verify_contest_buttons_area_is_scrollable_right_and_left(Common):
    """
    TR_ID: C62681929
    NAME: Verify contest buttons area is scrollable right and left
    DESCRIPTION: 
    ...
    def test_005_check_whether_the_contest_entry_buttons_are_scrollable_to_left_and_right(self):
        """
        DESCRIPTION: Check whether the contest entry buttons are scrollable to left and right
        EXPECTED: Contest entry button should be scrollable
        """
        pass
