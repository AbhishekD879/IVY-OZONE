...
@vtest
class Test_C62681938_Verify_display_of_contest_using_real_user_when_that_contest_has_real_accounts_checked_in_cms(Common):
    """
    TR_ID: C62681938
    NAME: Verify display of contest using real user when that contest has real accounts checked in cms
    DESCRIPTION: 
