...
@vtest
class Test_C60540521_Verify_display_of_My_Entries_and_Position_Summary_Widget_Leaderboard(Common):
    """
    TR_ID: C60540521
    NAME: Verify display of My Entries and Position Summary Widget Leaderboard
    ...
    def test_008_verify_the_display_of_position_summary_widgetonly_one_team_entered_in_the_showdown(self):
        ...
        EXPECTED: * The horizontal bar is split into to Colours - the green representing the positions in the prizes and the red representing the other positions
