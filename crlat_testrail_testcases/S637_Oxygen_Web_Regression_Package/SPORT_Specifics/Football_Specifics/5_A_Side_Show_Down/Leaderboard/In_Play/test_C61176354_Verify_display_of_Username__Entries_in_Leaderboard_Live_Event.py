...
@vtest
class Test_C61176354_Verify_display_of_Username__Entries_in_Leaderboard_Live_Event(Common):
    """
    TR_ID: C61176354
    NAME: Verify display of Username - Entries in Leaderboard -Live Event
    ...
    def test_003_verify_the_display_of_leaderboard_when_the_matchevent_is_in_play(self):
        ...
        EXPECTED: *where X = the amount of places paid a prize*
