...
@vtest
class Test_C61176355_Verify_display_of_Positions_in_Leaderboard_Live_Event(Common):
    """
    TR_ID: C61176355
    NAME: Verify display of Positions in Leaderboard -Live Event
    ...
    DESCRIPTION: Limit can be set from Back End to mimic the 500+ entries scenario in Live.
    ...
    def test_009_display_of_prizeif_the_entry_is_currently_winning_a_prize_based_on_the_pay_table(self):
        """
        DESCRIPTION: Display of Prize
        DESCRIPTION: **If the entry is currently winning a Prize based on the pay table**
        ...
        EXPECTED: Example:
        EXPECTED: Position 10 = £10 Ticket and Position 11 = No prize and 2 teams are tied for 10th, then both are paid the same prize in full.
        """
        pass
