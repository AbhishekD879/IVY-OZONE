...
@vtest
class Test_C61176357_Verify_display_of_Prizes_for_Entries_in_Leaderboard_Live_Event(Common):
    """
    TR_ID: C61176357
    NAME: Verify display of Prizes for Entries in Leaderboard -Live Event
