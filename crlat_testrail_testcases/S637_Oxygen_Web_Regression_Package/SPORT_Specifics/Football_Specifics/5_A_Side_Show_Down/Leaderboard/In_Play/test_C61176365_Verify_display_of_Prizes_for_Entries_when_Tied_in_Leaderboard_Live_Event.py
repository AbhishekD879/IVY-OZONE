...
@vtest
class Test_C61176365_Verify_display_of_Prizes_for_Entries_when_Tied_in_Leaderboard_Live_Event(Common):
    """
    TR_ID: C61176365
    NAME: Verify display of Prizes for Entries when Tied in Leaderboard -Live Event
