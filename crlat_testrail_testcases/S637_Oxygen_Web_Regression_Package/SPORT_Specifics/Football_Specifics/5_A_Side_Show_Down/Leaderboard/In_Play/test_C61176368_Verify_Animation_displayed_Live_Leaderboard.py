...
@vtest
class Test_C61176368_Verify_Animation_displayed_Live_Leaderboard(Common):
    """
    TR_ID: C61176368
    NAME: Verify Animation displayed -Live Leaderboard
    ...
    def test_006_verify_the_display_of_my_entriesmultiple_teams_entered_in_the_showdown(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000374)
        """
        pass
    ...
    def test_009_verify_the_display_of_position_summary_widgetmultiple_teams_entered_in_the_showdown(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000375)
