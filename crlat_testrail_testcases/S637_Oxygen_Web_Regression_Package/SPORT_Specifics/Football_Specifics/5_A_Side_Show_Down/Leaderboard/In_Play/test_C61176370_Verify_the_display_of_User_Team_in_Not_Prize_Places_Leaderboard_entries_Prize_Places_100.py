...
@vtest
class Test_C61176370_Verify_the_display_of_User_Team_in_Not_Prize_Places_Leaderboard_entries_Prize_Places_100(Common):
    """
    TR_ID: C61176370
    NAME: Verify the display of User Team in Not Prize Places -Leaderboard entries (Prize Places < 100)
    ...
    def test_004_user_team_in_prize_placesverify_the_display_of_users_teams(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000435)
        """
        pass
    ...
    def test_005_user_team_not_in_prize_placesverify_the_display_of_users_teams(self):
        ...
        EXPECTED: * Teams should be highlighted as mentioned in the designs
        EXPECTED: ![](index.php?/attachments/get/161000436)
        """
        pass
