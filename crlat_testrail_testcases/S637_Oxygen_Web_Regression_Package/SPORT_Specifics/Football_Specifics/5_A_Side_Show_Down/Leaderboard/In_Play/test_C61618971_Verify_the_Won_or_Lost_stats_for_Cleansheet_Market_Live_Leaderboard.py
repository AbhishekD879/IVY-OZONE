...
@vtest
class Test_C61618971_Verify_the_Won_or_Lost_stats_for_Cleansheet_Market_Live_Leaderboard(Common):
    """
    TR_ID: C61618971
    NAME: Verify the Won or Lost stats for Cleansheet Market_Live Leaderboard
    ...
    def test_004_verify_the_won_or_lost_displayed_for_clean_sheet_marketplace_bet_with_clean_sheet_market(self):
        """
        DESCRIPTION: Verify the Won or Lost displayed for Clean sheet Market
        DESCRIPTION: **Place bet with Clean sheet market**
        EXPECTED: * If a goal is conceded for that player, "X" should be seen indicating it as lost.
        EXPECTED: * If no goals are conceded till the end of the match a green tick should be seen indicating it as won.
        """
        pass
