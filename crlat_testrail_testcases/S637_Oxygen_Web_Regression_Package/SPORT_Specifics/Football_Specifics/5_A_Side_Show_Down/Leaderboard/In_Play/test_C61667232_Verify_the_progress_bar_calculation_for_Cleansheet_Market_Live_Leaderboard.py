...
@vtest
class Test_C61667232_Verify_the_progress_bar_calculation_for_Cleansheet_Market_Live_Leaderboard(Common):
    """
    TR_ID: C61667232
    NAME: Verify the progress bar calculation for Cleansheet Market_Live Leaderboard
