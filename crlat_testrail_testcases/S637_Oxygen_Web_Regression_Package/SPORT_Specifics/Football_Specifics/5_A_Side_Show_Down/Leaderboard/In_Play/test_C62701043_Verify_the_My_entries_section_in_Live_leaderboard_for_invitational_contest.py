...
@vtest
class Test_C62701043_Verify_the_My_entries_section_in_Live_leaderboard_for_invitational_contest(Common):
    """
    TR_ID: C62701043
    NAME: Verify the My entries section in Live leaderboard for invitational contest.
    DESCRIPTION: This test case verifies the my entries section in Live leaderboard
    ...
    def test_002_2_navigate_to_live_leaderboard_and_check_my_entries_sectionif_user_entered_more_than_one_entry_then_navigate_to_view_all_my_entries(self):
        """
        DESCRIPTION: 2. Navigate to Live leaderboard, and check My entries section
        DESCRIPTION: If user entered more than one entry, then navigate to view all my entries
        EXPECTED: 2. Teams entered by the user should be displayed in My entries section.
        EXPECTED: View all my entries should have all the teams entered by the user (if more than one team)
        """
        pass
