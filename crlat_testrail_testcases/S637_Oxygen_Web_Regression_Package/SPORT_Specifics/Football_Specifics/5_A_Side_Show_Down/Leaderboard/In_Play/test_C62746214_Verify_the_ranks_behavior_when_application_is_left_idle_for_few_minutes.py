...
@vtest
class Test_C62746214_Verify_the_ranks_behavior_when_application_is_left_idle_for_few_minutes(Common):
    """
    TR_ID: C62746214
    NAME: Verify the ranks behavior when application is left idle for few minutes
    DESCRIPTION: Verify the ranks behavior when application is left idle for few minutes
    ...
    def test_007_validate_ranks_behavior_when_application_is_left_idle_for_few_minutes(self):
        """
        DESCRIPTION: Validate ranks behavior when application is left idle for few minutes
        EXPECTED: Ranks should be update according to data provide by opta updates without any UI disturbances
        """
        pass
