...
@vtest
class Test_C61176331_Verify_the_display_of_Header_area_Post_Match_Leaderboard(Common):
    """
    TR_ID: C61176331
    NAME: Verify the display of  Header area -Post Match Leaderboard
    ...
    def test_004_validate_the_display_of_header_area(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000055)
        """
        pass
