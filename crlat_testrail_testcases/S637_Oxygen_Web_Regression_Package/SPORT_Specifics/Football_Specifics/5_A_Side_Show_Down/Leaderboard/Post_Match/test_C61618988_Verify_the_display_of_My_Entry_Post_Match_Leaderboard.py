...
@vtest
class Test_C61618988_Verify_the_display_of_My_Entry_Post_Match_Leaderboard(Common):
    """
    TR_ID: C61618988
    NAME: Verify the display of My Entry- Post Match Leaderboard
    ...
    def test_004_validate_the_display_of_my_entries_widget(self):
        ...
        EXPECTED: * **My Entry** widget should be displayed
        EXPECTED: * ALL the customer's teams should be stacked in order of finishing position
        EXPECTED: ![](index.php?/attachments/get/161000041)
        """
        pass
