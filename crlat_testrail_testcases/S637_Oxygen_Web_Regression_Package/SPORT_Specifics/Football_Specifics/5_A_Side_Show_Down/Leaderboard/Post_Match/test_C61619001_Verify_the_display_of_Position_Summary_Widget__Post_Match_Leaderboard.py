...
@vtest
class Test_C61619001_Verify_the_display_of_Position_Summary_Widget__Post_Match_Leaderboard(Common):
    """
    TR_ID: C61619001
    NAME: Verify the display of Position Summary Widget - Post Match Leaderboard
    ...
    def test_004_validate_the_display_of_position_summary_widget(self):
        """
        DESCRIPTION: Validate the display of Position Summary Widget
        EXPECTED: * Position summary widget should be displayed (Same as in Live Leaderboard)
        EXPECTED: * Each bubble representing the User Team
        EXPECTED: ![](index.php?/attachments/get/161000044)
        EXPECTED: ![](index.php?/attachments/get/161000046)
        """
        pass
