...
@vtest
class Test_C61619003_Verify_the_display_Prizes_Post_Match_Leaderboard(Common):
    """
    TR_ID: C61619003
    NAME: Verify the display Prizes- Post Match Leaderboard
    ...
    def test_004_validate_the_display_of_prizes_leaderboard(self):
        """
        DESCRIPTION: Validate the display of Prizes Leaderboard
        EXPECTED: * Prizes should be displayed for the entries which are in Prize Places
        EXPECTED: * Maximum of 2 Prizes should be displayed
        """
        pass
