...
@vtest
class Test_C62701054_Verify_the_Standard_Leaderboard_URL_is_navigated_to_the_respective_Post_leaderboard(Common):
    """
    TR_ID: C62701054
    NAME: Verify the Standard Leaderboard URL is navigated to the respective Post leaderboard.
    ...
    def test_002_2_navigate_through_standard_leaderboard_url_for_a_logged_outlogin_user_when_the_event_is_in_settled(self):
        """
        DESCRIPTION: 2. Navigate through Standard Leaderboard URL for a logged out/Login user when the event is in settled
        EXPECTED: 2. It should navigate to the respective Post leaderboard page
        """
        pass
