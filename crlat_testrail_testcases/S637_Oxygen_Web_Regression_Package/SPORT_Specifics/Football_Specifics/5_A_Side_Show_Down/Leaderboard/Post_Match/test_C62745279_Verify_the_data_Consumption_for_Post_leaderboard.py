...
@vtest
class Test_C62745279_Verify_the_data_Consumption_for_Post_leaderboard(Common):
    """
    TR_ID: C62745279
    NAME: Verify the data Consumption for Post leaderboard.
    DESCRIPTION: This test case verifies if stats are received when the event is settled then they are not consumed by Leaderboard
    ...
    def test_001_navigate_to_post_leaderboard(self):
        """
        DESCRIPTION: Navigate to Post leaderboard.
        EXPECTED: Post leaderboard page is opened with My entries widget, Position summary bar and all the 100 entries in Leaderbaord.
        """
        pass

    def test_002_when_stat_updates_are_received_verify_if_they_are_updated_in_leaderboard(self):
        """
        DESCRIPTION: When stat updates are received verify if they are updated in Leaderboard
        EXPECTED: After event is settled, no stat updates should be consumed by Leaderboard.
        """
        pass
