...
@pytest.mark.other
@vtest
class Test_C64377612_Verify_header_is_received_as_soon_as_et1h_is_sent_and_stats_are_not_updated_after_that(Common):
    """
    TR_ID: C64377612
    NAME: Verify header is received as soon as et1h is sent and stats are not updated after that
    DESCRIPTION: Verify header is received as soon as et1h is sent and stats are not updated after that
    ...
    def test_004_send_et1h_from_postpone_which_is_extra_time(self):
        """
        DESCRIPTION: Send et1h from postpone which is extra time
        EXPECTED: et1h should be sent
        """
        pass

    def test_005_observe_header_is_received_as_soon_as_et1h_is_sentverify_using_validate_header_flag_string_in_kibana(self):
        """
        DESCRIPTION: Observe header is received as soon as et1h is sent
        DESCRIPTION: Verify using "Validate header flag" string in kibana
        EXPECTED: Header should be true in kibana as soon as et1h is sent
        """
        pass
