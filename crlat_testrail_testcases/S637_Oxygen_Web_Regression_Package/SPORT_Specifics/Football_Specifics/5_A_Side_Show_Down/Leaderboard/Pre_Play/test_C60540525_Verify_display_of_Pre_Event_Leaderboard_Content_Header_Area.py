...
@vtest
class Test_C60540525_Verify_display_of_Pre_Event_Leaderboard_Content_Header_Area(Common):
    """
    TR_ID: C60540525
    NAME: Verify display of Pre-Event Leaderboard Content-Header Area
