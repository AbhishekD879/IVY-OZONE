...
@vtest
class Test_C61176341_Verify_the_display_Entry_Button_when_Contest_is_Full_Pre_Event_Leaderboard__Entry_Area(Common):
    """
    TR_ID: C61176341
    NAME: Verify the display Entry Button when Contest is Full -Pre-Event Leaderboard - Entry Area
    ...
    def test_002_entry_button_when_contest_is_fullshowdown_contest_entries_reached_maximum_limit_navigate_to_pre_event_leaderboard_verify_the_display_of_entry_button(self):
        """
    ...
    def test_003_when_user_reached_max_entries_and_also_the_contest_is_full_navigate_to_pre_event_leaderboard_verify_the_display_of_entry_button(self):
        """
