...
@vtest
class Test_C61618947_Verify_the_display_of_Tied_Position_Pre_Event_Leaderboard(Common):
    """
    TR_ID: C61618947
    NAME: Verify the display of Tied Position_Pre-Event Leaderboard
    ...
    def test_003_verify_the_display_of_my_entrieswhen_user_entries_have_tied_position(self):
        """
