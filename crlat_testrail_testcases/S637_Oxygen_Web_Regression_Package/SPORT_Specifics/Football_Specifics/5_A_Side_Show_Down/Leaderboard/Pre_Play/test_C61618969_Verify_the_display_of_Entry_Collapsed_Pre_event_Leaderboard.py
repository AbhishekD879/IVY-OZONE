...
@vtest
class Test_C61618969_Verify_the_display_of_Entry_Collapsed_Pre_event_Leaderboard(Common):
    """
    TR_ID: C61618969
    NAME: Verify the display of Entry Collapsed_Pre-event Leaderboard
    ...
    def test_003_tap_on_one_entry(self):
        """
    ...
    def test_004_tap_on_another_entry(self):
        """
