...
@vtest
class Test_C61619052_Verify_the_display_of_Ticket_Prizes_Pre_Event_Leaderboard__Prize_pool_information(Common):
    """
    TR_ID: C61619052
    NAME: Verify the display of Ticket Prizes Pre-Event Leaderboard - Prize pool information
    DESCRIPTION: This test case verifies the display of Ticket Prizes in Pre-Event Leaderboard
    ...
    def test_004_verify_the_display_of_prize_information_when_the_below_is_configured_in_cmscms_configurations_prize_type__ticket_prize_signposting___image_uploaded_prize_name__prize_value_or_both___configured(self):
        """
