...
@vtest
class Test_C61619053_Verify_the_display_Voucher_Prizes_in_Pre_Event_Leaderboard__Prize_pool_information(Common):
    """
    TR_ID: C61619053
    NAME: Verify the display Voucher Prizes in  Pre-Event Leaderboard - Prize pool information
    DESCRIPTION: This test case verifies the display of Voucher Prizes in Pre-Event Leaderboard
    ...
    def test_004_verify_the_display_of_prize_information_when_the_below_is_configured_in_cmscms_configurations_prize_type__voucher_prize_signposting___image_uploaded_prize_name__prize_value_or_both___configured(self):
        """
