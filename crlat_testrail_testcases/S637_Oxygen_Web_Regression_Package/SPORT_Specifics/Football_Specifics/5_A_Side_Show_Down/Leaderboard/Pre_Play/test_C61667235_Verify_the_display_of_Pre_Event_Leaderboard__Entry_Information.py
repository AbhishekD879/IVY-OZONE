...
@vtest
class Test_C61667235_Verify_the_display_of_Pre_Event_Leaderboard__Entry_Information(Common):
    """
    TR_ID: C61667235
    NAME: Verify the display of Pre-Event Leaderboard - Entry Information
    ...
    def test_008_click_anywhere_on_the_expanded_entry_except_on_team_progress(self):
        """
