...
@vtest
class Test_C62700979_Verify_build_team_CTA_for_Private_invitational_contest_for_logged_out_user(Common):
    """
    TR_ID: C62700979
    NAME: Verify build team CTA for Private invitational contest for logged out user
    DESCRIPTION: This test case verifies the CTA button for a logged out user for Private invitational contest
