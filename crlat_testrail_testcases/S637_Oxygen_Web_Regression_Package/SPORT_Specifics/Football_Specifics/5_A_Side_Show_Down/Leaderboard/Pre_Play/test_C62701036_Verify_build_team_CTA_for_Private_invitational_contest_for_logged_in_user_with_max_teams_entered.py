...
@vtest
class Test_C62701036_Verify_build_team_CTA_for_Private_invitational_contest_for_logged_in_user_with_max_teams_entered(Common):
    """
    TR_ID: C62701036
    NAME: Verify build team CTA for Private invitational contest for logged in user with max teams entered.
    DESCRIPTION: Verify build team CTA for Private invitational contest for logged in user with one team entered.
    PRECONDITIONS: "Pre-Play""""""1: User should have admin access to CMS
    ...
    PRECONDITIONS: 8. Navigate through magic link and place all the availabe bets for the user.
    ...
    def test_001_1_copy_the_magic_link_from_invitational_contest_cmssteps_mentioned_in_pre_conditions(self):
        """
        DESCRIPTION: 1. Copy the magic link from invitational contest CMS,(Steps mentioned in Pre-conditions)
        EXPECTED: 1. Magic link should be available.
        """
        pass

    def test_002_2_copy_on_the_magic_link_in_browser(self):
        """
        DESCRIPTION: 2. Copy on the Magic link in browser
        EXPECTED: 2. When navigated through the magic link user must navigate to Pre-leaderboard of the contest configured.
        """
        pass
