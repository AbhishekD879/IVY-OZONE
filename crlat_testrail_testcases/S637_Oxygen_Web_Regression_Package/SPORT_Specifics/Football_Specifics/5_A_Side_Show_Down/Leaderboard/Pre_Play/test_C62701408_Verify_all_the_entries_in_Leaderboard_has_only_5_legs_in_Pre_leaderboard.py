...
@vtest
class Test_C62701408_Verify_all_the_entries_in_Leaderboard_has_only_5_legs_in_Pre_leaderboard(Common):
    """
    TR_ID: C62701408
    NAME: Verify all the entries in Leaderboard has only 5 legs in Pre leaderboard.
    ...
    def test_006_tap_on_one_entry(self):
        """
    ...
    def test_007_tap_on_another_entry(self):
        """
    ...
    def test_008_verify_the_number_of_legs_for_each_entry(self):
        """
        DESCRIPTION: Verify the number of legs for each entry
