...
@vtest
class Test_C62701941_Verify_the_Pre_Leaderboard_Prize_table_when_we_have_more_than_100k_customers(Common):
    """
    TR_ID: C62701941
    NAME: Verify the Pre- Leaderboard Prize table when we have more than 100k customers.
    DESCRIPTION: This test case verifies the Prize table in Pre-leaderboard when we have users more than 100k
    ...
    def test_001_navigate_to_cms_configure_the_prize_pool_data_for_20k_customer_with__filed_and__of_entries_both(self):
        """
        DESCRIPTION: Navigate to CMS, configure the Prize pool data for 20k customer with % filed and # of entries both.
        EXPECTED: Navigate to Prize pool table in Pre- leader board and verify that no positions are missing in Prize pool or no positions have two prizes by default.
        """
        pass
