...
@vtest
class Test_C64377603_Verify_when_unvoided_bets_are_lesser_than_contest_left_size(Common):
    """
    TR_ID: C64377603
    NAME: Verify when unvoided bets are lesser than contest left size.
    DESCRIPTION: This test case verifies the unvoiding of bets, when we have less unvoided bets than the contest limit left
    ...
    def test_002_modify_line_upsmodifying_line_ups_is_only_possible_in_test0_add_players_whose_bets_are_voided_previouslynote__line_ups_should_be_received_where_there_are_changes_with_player_dataexample_1st_line_upsabcdefghiuvxyz_player_bets_are_voided_in_the_above_case2nd_line_upsabcdefghiuvxyz(self):
        ...
        EXPECTED: Unvoiding process should be triggered as the contest limit is more than the unvoided bets count
