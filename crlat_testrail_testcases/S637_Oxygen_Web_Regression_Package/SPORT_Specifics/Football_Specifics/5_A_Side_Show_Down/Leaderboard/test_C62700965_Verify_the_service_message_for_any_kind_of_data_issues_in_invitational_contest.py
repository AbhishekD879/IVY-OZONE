...
@vtest
class Test_C62700965_Verify_the_service_message_for_any_kind_of_data_issues_in_invitational_contest(Common):
    """
    TR_ID: C62700965
    NAME: Verify the service message for any kind of data issues in invitational contest
    ...
    def test_001_1_navigate_to_the_contest_in_cms(self):
        """
        DESCRIPTION: 1 Navigate to the contest in CMS.
        EXPECTED: 1. Enable the CMS service message and can input around 100 characters
        """
        pass

    def test_002_2_navigate_to_the_same_contest_in_fe_login_or_logout(self):
        """
        DESCRIPTION: 2. Navigate to the same contest in FE (Login or Logout)
        EXPECTED: 2. Message entered in CMS, should be available above the header area in Live leaderboard page.
        """
        pass
