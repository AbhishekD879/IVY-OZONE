...
@vtest
class Test_C64378742_Verify_the_CMS_user_is_able_switch_ON_of_anytime_in_PRE_LIVE_POST_leaderbaords_before_the_payout_trigger_then_prize_automation_should_proceed(Common):
    """
    TR_ID: C64378742
    NAME: Verify the CMS user is able switch ON of anytime in PRE/LIVE/POST leaderbaords, before the payout trigger, then prize automation should proceed.
    DESCRIPTION: Verify the CMS user is able switch ON of anytime in PRE/LIVE/POST leaderbaords, before the payout trigger, then prize automation should proceed.
    ...
    def test_005_verify_cms_user_is_able_switch_toggle_on_of_anytime_in_prelivepost_leaderbaords_before_the_prize_automation_has_kicked_in(self):
        """
        DESCRIPTION: Verify CMS user is able switch toggle ON of anytime in PRE/LIVE/POST leaderbaords, before the prize automation has kicked in
        EXPECTED: Automatic prize switch toggle ON of anytime in PRE/LIVE/POST leaderbaords, before the prize automation has kicked in
        """
        pass

    def test_006_verify_in_fe_automatic_prize_payout_trigger_after_the_90m_of_match(self):
        """
        DESCRIPTION: Verify in FE "Automatic Prize Payout" trigger after the 90m of match
