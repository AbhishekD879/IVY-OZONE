...
@vtest
class Test_C64378771_Verify_the_prize_payout_trigger_when_event_is_in_undisplay_after_bets_are_placed_and_ERT10_is_received(Common):
    """
    TR_ID: C64378771
    NAME: Verify the prize payout trigger when event is in undisplay after bets are placed and ERT+10 is received
    DESCRIPTION: 
    ...
    def test_004_make_the_event_undisplay(self):
        """
        DESCRIPTION: Make the event undisplay
        EXPECTED: Event should be undisplayed
        """
        pass

    def test_005_send_ertwhich_is_replay_incident___replay_stat_in_tst0_wait_until_event_is_finishedhlv0(self):
        """
    ...
    def test_006_from_the_time_ert_sent_after_10_min_send_1_more_stat_in_tst0_observe_header_is_receivedverify_using_validate_header_flag_string_in_kibana(self):
        """
