...
@pytest.mark.other
@vtest
class Test_C64378806_Verify_Prize_allocation_when_matches_are_extended_to_Extra_time(Common):
    """
    TR_ID: C64378806
    NAME: Verify Prize allocation when matches are extended to Extra time
    DESCRIPTION: 
    ...
    def test_005_send_et1h_from_postpone_which_is_extra_time(self):
        """
    ...
    def test_006_observe_header_is_received_as_soon_as_et1h_is_sentverify_using_validate_header_flag_string_in_kibana(self):
        """
