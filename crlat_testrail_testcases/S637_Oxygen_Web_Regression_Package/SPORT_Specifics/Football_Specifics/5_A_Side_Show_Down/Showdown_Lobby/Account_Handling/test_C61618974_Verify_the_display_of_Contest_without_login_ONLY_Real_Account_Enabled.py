...
@vtest
class Test_C61618974_Verify_the_display_of_Contest_without_login_ONLY_Real_Account_Enabled(Common):
    """
    TR_ID: C61618974
    NAME: Verify the display of Contest without login ONLY Real Account Enabled
    DESCRIPTION: This test case verifies that Contest will be displayed when Real Account Enabled in CMS> Contest Details page
    ...
    def test_001_launch_ladbrokes(self):
        ...
        EXPECTED: User should be able to launch the ladbrokes application successfully
    ...
    def test_003_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_real_account_enabled(self):
        """
