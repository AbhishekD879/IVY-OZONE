...
@vtest
class Test_C61618975_Verify_the_display_of_Contest_with_LoginTest_User_ONLY_Real_Account_Enabled(Common):
    """
    TR_ID: C61618975
    NAME: Verify the display of Contest with Login(Test User) ONLY Real Account Enabled
    DESCRIPTION: This test case verifies the display of Contest to Test account user when ONLY Real Account is enabled in CMS (CMS > Contest Details Page)
    ...
    PRECONDITIONS: 6: REAL ACCOUNT should be enabled in CMS
    ...
    def test_001_launch_ladbrokes(self):
        ...
        EXPECTED: User should launch Ladbrokes application successfully
        """
        pass

    def test_002_login_with_a_test_account_user(self):
        """
        DESCRIPTION: Login with a Test account User
    ...
    def test_003_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: User should be able to view 5-A Side Lobby
        """
        pass

    def test_004_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_real_account_enabled(self):
        """
        DESCRIPTION: Validate the display of Contest in Lobby
        DESCRIPTION: **CONTEST in CMS should have Real Account Enabled**
        EXPECTED: Contest should be displayed in the 5-A Side Lobby
        """
        pass
