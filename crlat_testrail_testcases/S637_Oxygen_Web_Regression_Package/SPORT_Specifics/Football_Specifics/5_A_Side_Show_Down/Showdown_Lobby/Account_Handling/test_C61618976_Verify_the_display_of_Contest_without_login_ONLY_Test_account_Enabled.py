...
@vtest
class Test_C61618976_Verify_the_display_of_Contest_without_login_ONLY_Test_account_Enabled(Common):
    """
    TR_ID: C61618976
    NAME: Verify the display of Contest without login ONLY Test account Enabled
    ...
    def test_003_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_test_account_enabled(self):
        """
