...
@vtest
class Test_C61618977_Verify_the_display_of_Contest_with_LoginTest_User_ONLY_Test_account_enabled(Common):
    """
    TR_ID: C61618977
    NAME: Verify the display of Contest with Login(Test User) ONLY Test account enabled
    ...
    def test_004_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_test_account_enabled(self):
        ...
        EXPECTED: Contest should be displayed in the lobby
        """
        pass
