...
@vtest
class Test_C61618978_Verify_the_display_of_Contest_with_LoginReal_User_ONLY_Test_account_enabled(Common):
    """
    TR_ID: C61618978
    NAME: Verify the display of Contest with Login(Real User) ONLY Test account enabled
    DESCRIPTION: This test case verifies the display of Contest when Only Test account is enabled
    ...
    def test_003_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: User should be able to view Lobby
        """
        pass

    def test_004_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_test_account_enabled(self):
        """
        DESCRIPTION: Validate the display of Contest in Lobby
        DESCRIPTION: **CONTEST in CMS should have Test Account Enabled**
        EXPECTED: Contest should **NOT** be displayed in Lobby
        """
        pass
