...
@vtest
class Test_C61618981_Verify_the_display_of_Contest_without_Login_BOTH_Real_and_Test_Account_enabled(Common):
    """
    TR_ID: C61618981
    NAME: Verify the display of Contest without Login BOTH Real and Test Account enabled
    ...
    def test_003_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_real_account__test_account_enabled(self):
        """
