...
@vtest
class Test_C61618982_Verify_the_display_of_Contest_with_Login_Real_User_BOTH_Real_and_Test_Account_enabled(Common):
    """
    TR_ID: C61618982
    NAME: Verify the display of Contest with Login (Real User) BOTH Real and Test Account enabled
    DESCRIPTION: This test case verifies the display of Contest when BOTH Real & Test Account are enabled in CMS
    ...
    PRECONDITIONS: 6: **TEST ACCOUNT & REAL ACCOUNT** should be enabled in CMS
    ...
    def test_001_launch_ladbrokes(self):
        ...
        EXPECTED: User should be able to launch Ladbrokes successfully
        """
        pass

    def test_002_login_with_a_real_user(self):
        """
        DESCRIPTION: Login with a Real User
    ...
    def test_004_validate_the_display_of_contest_in_lobbycontest_in_cms_should_have_real_account__test_account_enabled(self):
        """
        DESCRIPTION: Validate the display of Contest in Lobby
        DESCRIPTION: **CONTEST in CMS should have Real Account & Test Account Enabled**
        EXPECTED: Contest should be displayed in Lobby
        """
        pass
