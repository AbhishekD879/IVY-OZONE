...
@vtest
class Test_C61618983_Verify_the_display_of_Contest_with_Login_Test_User_BOTH_Real_and_Test_account_enabled(Common):
    """
    TR_ID: C61618983
    NAME: Verify the display of Contest with Login (Test User) BOTH Real and Test account enabled
