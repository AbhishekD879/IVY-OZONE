...
@vtest
class Test_C61618984_Verify_the_entry_to_Contest_with_Test_User_ONLY_Real_Account_Enabled(Common):
    """
    TR_ID: C61618984
    NAME: Verify the entry to Contest with Test User ONLY Real Account Enabled
    DESCRIPTION: This test case verifies the entry into the Contest when logged in with Test User (ONLY Real Account Enabled in CMS)
    ...
    def test_003_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: User should be able to view the Lobby ,user should be able to see all contests
        """
        pass

    def test_004_navigate_to_the_contest_displayed_in_lobby_and_click_on_the_cardcontest_in_cms_should_have_real_account_enabled(self):
        """
    ...
    def test_006_place_qualifying_bet_to_the_contest(self):
        ...
        EXPECTED: * User should not be displayed Entry Confirmation
        EXPECTED: * User should not enter the Contest
        """
        pass
    ...
    def test_007_navigate_to_leaderboard_page_pre(self):
        ...
        EXPECTED: * Entry should not be made to the Contest
        """
        pass
