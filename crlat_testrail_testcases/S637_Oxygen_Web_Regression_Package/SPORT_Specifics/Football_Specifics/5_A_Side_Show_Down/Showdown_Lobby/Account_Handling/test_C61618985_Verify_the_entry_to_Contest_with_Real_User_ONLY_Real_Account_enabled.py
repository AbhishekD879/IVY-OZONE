...
@vtest
class Test_C61618985_Verify_the_entry_to_Contest_with_Real_User_ONLY_Real_Account_enabled(Common):
    """
    TR_ID: C61618985
    NAME: Verify the entry to Contest with Real User ONLY Real Account enabled
    DESCRIPTION: This test case verifies the entry into the Contest when logged in with Real User (ONLY Real Account Enabled in CMS)
    ...
    def test_003_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: User should be able to view the Lobby and should see only real account checked contests
        """
        pass
