...
@vtest
class Test_C61618987_Verify_the_entry_to_Contest_with_Test_User_BOTH_Real_and_Test_Account_Enabled(Common):
    """
    TR_ID: C61618987
    NAME: Verify the entry to Contest with Test User BOTH Real and Test Account Enabled
    DESCRIPTION: This test case verifies the entry into the Contest when logged in with Test User (BOTH  Real Account & Test Account Enabled in CMS)
