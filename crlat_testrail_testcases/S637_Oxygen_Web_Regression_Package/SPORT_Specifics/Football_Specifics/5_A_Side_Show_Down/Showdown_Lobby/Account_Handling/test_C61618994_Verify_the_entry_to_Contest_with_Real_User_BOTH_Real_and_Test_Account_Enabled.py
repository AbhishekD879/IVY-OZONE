...
@vtest
class Test_C61618994_Verify_the_entry_to_Contest_with_Real_User_BOTH_Real_and_Test_Account_Enabled(Common):
    """
    TR_ID: C61618994
    NAME: Verify the entry to Contest with Real User BOTH Real and Test Account Enabled
    DESCRIPTION: This test case verifies the entry into the Contest when logged in with Real User (BOTH  Real Account & Test Account Enabled in CMS)
    ...
    def test_004_navigate_to_the_contest_displayed_in_lobby_and_click_on_the_cardcontest_in_cms_should_have_test_account__real_account_enabled(self):
        """
        DESCRIPTION: Navigate to the Contest displayed in Lobby and click on the Card
        DESCRIPTION: **CONTEST in CMS should have Test Account & Real Account Enabled**
