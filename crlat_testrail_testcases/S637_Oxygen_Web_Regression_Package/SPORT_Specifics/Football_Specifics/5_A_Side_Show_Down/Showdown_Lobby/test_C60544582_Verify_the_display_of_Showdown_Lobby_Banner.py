...
@vtest
class Test_C60544582_Verify_the_display_of_Showdown_Lobby_Banner(Common):
    """
    TR_ID: C60544582
    NAME: Verify the display of Showdown Lobby Banner
    ...
    def test_005_verify_banner_display_when_toggled_off(self):
        """
        DESCRIPTION: Verify banner display when toggled off
        EXPECTED: Showdown cards should top aligned.
        """
        pass
