...
@vtest
class Test_C60569551_Verify_the_display_of_Showdown_Cards(Common):
    """
    TR_ID: C60569551
    NAME: Verify the display of Showdown Cards
    DESCRIPTION: This test case verifies the display of Showdown Cards
    DESCRIPTION: Note : Ticket & You won is descoped on the card.
    ...
    def test_005_verify_the_different_states_of_showdown_cards(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000177)
        EXPECTED: **IN PLAY**
        ...
        EXPECTED: Note : Ticket & You won is descoped on the card.
        """
        pass
    ...
    def test_006_verify_the_date__time_display(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000190)
        EXPECTED: **IN PLAY**
