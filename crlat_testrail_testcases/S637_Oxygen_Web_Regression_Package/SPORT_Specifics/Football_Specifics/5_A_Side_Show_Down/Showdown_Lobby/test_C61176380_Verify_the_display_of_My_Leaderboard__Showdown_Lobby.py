...
@vtest
class Test_C61176380_Verify_the_display_of_My_Leaderboard__Showdown_Lobby(Common):
    """
    TR_ID: C61176380
    NAME: Verify the display of My Leaderboard - Showdown Lobby
    ...
    def test_004_verify_the_banner_displaybanner_carousel_is_toggled_onindexphpattachmentsget130405367(self):
        ...
        EXPECTED: * Functionality within the banner, e.g. a countdown timer will be controlled by Sitecore banners project and not by Oxygen.(descoped)
        """
        pass

    def test_005_verify_the_display_of_show_down_cardsuser_did_not_enter_into_any_showdown_contestindexphpattachmentsget161000166indexphpattachmentsget130405366(self):
        """
        DESCRIPTION: Verify the display of Show Down Cards
        DESCRIPTION: **User did not enter into any Showdown Contest**
        DESCRIPTION: ![](index.php?/attachments/get/161000166)
        DESCRIPTION: ![](index.php?/attachments/get/130405366)
        ...
        EXPECTED: * Showdown contents must be upcoming or Live and not complete
        EXPECTED: they should be in order as set in the CMS
    ...
    def test_006_verify_the_display_of_my_show_downuser_has_entered_into_atleast_one_showdown_contestindexphpattachmentsget161000167(self):
        """
        DESCRIPTION: Verify the display of My Show Down
        DESCRIPTION: **User has entered into atleast one Showdown Contest**
        DESCRIPTION: ![](index.php?/attachments/get/161000167)
        EXPECTED: **My Leaderboard**
        EXPECTED: * User has entered one of these Showdowns
        EXPECTED: * There be a sub-section at the top of the lobby titled 'My Showdowns (X)'
        ...
        EXPECTED: **NOTE:** If a Showdown Card is included in the My Showdown section it SHOULD ALSO be included in the regular list or Last 7 Days section. It is expected to have duplicate Showdown cards here.
        """
        pass
