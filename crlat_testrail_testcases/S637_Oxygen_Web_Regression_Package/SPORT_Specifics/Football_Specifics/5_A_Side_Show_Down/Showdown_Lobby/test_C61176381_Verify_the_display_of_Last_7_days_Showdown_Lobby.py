...
@vtest
class Test_C61176381_Verify_the_display_of_Last_7_days_Showdown_Lobby(Common):
    """
    TR_ID: C61176381
    NAME: Verify the display of Last 7 days- Showdown Lobby
    ...
    def test_005_verify_the_display_of_show_down_cardsuser_did_not_enter_into_any_showdown_contestindexphpattachmentsget161000158(self):
        """
        DESCRIPTION: Verify the display of Show Down Cards
        DESCRIPTION: **User did not enter into any Showdown Contest**
        DESCRIPTION: ![](index.php?/attachments/get/161000158)
    ...
    def test_006_verify_the_display_of_my_leaderboarduser_has_entered_into_atleast_one_showdown_contestindexphpattachmentsget161000159(self):
        """
        DESCRIPTION: Verify the display of My Leaderboard
        DESCRIPTION: **User has entered into atleast one Showdown Contest**
        DESCRIPTION: ![](index.php?/attachments/get/161000159)
        ...
        EXPECTED: *  When isSettled flag is true then the Showdown card should be removed from the My Leaderboard area.
        EXPECTED: **NOTE:** If a Showdown Card is included in the My Leaderboard section it SHOULD ALSO be included in the regular list. It is expected to have duplicate Showdown cards here.
        """
        pass
    ...
    def test_007_verify_that_showdown_card_is_removed_from_my_leaderboardx_after_event_completion(self):
        ...
        EXPECTED: * Show card should show under Last 7 days section.
        """
        pass
