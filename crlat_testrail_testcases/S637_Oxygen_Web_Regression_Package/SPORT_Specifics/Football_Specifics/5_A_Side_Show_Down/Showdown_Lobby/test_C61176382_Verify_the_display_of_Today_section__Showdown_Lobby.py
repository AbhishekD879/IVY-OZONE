...
@vtest
class Test_C61176382_Verify_the_display_of_Today_section__Showdown_Lobby(Common):
    """
    TR_ID: C61176382
    NAME: Verify the display of Today section - Showdown Lobby
    ...
    def test_005_verify_the_display_of_show_down_cards_for_any_of_todays_eventshould_verify_with_ukgibraltar__vienna_time_zones_set_in_systemuser_did_not_enter_into_any_showdown_contestindexphpattachmentsget161000152(self):
        """
        DESCRIPTION: Verify the display of Show Down Cards for any of Today's event.
        ...
        DESCRIPTION: ![](index.php?/attachments/get/161000152)
        ...
        EXPECTED: * Showdown contents must be displayed in order set in CMS.
