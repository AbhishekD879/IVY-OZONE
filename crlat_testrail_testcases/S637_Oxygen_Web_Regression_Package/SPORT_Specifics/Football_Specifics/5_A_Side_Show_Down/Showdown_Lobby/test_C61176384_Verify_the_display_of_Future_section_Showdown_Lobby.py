...
@vtest
class Test_C61176384_Verify_the_display_of_Future_section_Showdown_Lobby(Common):
    """
    TR_ID: C61176384
    NAME: Verify the display of Future section -Showdown Lobby
    ...
    def test_004_verify_the_display_of_show_down_cards_for_future_eventsshould_verify_with_ukgibraltar__vienna_time_zones_set_in_systemuser_did_not_enter_into_any_showdown_contestindexphpattachmentsget161000123(self):
        """
        DESCRIPTION: Verify the display of Show Down Cards for future events.
        ...
        DESCRIPTION: ![](index.php?/attachments/get/161000123)
    ...
    def test_005_verify_the_display_of_showdown_cardwhen_contest_is_configured_in_cms_to_display__no(self):
        """
    ...
    def test_006_verify_the_display_of_showdown_cards_as_per_test_account_handling_bma_59539(self):
        """
