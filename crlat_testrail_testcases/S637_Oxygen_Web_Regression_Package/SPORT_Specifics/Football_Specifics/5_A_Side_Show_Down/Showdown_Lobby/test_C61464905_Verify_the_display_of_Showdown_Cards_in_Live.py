...
@vtest
class Test_C61464905_Verify_the_display_of_Showdown_Cards_in_Live(Common):
    """
    TR_ID: C61464905
    NAME: Verify the display of Showdown Cards in Live
    ...
    def test_004_verify_the_details_displayed_on_showdown_cards(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/130937056)
        EXPECTED: ![](index.php?/attachments/get/130937057)
        """
        pass

    def test_005_verify_the_data_on_showdown_card_when_event_is_live(self):
        """
        DESCRIPTION: Verify the data on showdown card, when event is LIVE.
        EXPECTED: **IN PLAY**
        EXPECTED: * Event is Live Match started then showdown card displayed is in Live Event state
        EXPECTED: * Live signposting should be displayed dynamically.
        EXPECTED: * Scores should be updated dynamically
        EXPECTED: ![](index.php?/attachments/get/130937059)
    ...
    def test_006_verify_the_date__time_display(self):
        ...
        EXPECTED: **IN PLAY**
        EXPECTED: * Event is in-play then Date/Time should be displayed as dynamically ticking match clock.
        EXPECTED: ![](index.php?/attachments/get/130937062)
        """
        pass
    ...
    def test_007_tap_on_showdown_card(self):
        ...
        EXPECTED: * User should be redirected to LIVE Leaderboard
