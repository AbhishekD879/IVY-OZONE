...
@vtest
class Test_C62700657_Verify_if_the_contest_is_shown_in_lobby_for_Public_invitational_contest(Common):
    """
    TR_ID: C62700657
    NAME: Verify if the contest is shown in lobby for Public invitational contest
    DESCRIPTION: This test case verifies the public invitational contest display in lobby when navigated through Standard Leaderboard URL
    ...
    PRECONDITIONS: 4: Contest with enabled invitation toggle and Public toggle should be configured in CMS
    ...
    def test_008_check_the_public_toggle(self):
        """
        DESCRIPTION: Check the Public toggle
    ...
    def test_010_navigate_to_lobby_and_check_for_the_created_contest_in_lobby(self):
        """
        DESCRIPTION: Navigate to lobby and check for the created contest in lobby.
        EXPECTED: Contest created should be available in lobby in CMS priority order.
        """
        pass
