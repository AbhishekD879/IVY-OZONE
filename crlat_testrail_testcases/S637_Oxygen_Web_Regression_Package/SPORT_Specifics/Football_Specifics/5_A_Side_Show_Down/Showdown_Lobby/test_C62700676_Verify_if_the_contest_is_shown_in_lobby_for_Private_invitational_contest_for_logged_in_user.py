...
@vtest
class Test_C62700676_Verify_if_the_contest_is_shown_in_lobby_for_Private_invitational_contest_for_logged_in_user(Common):
    """
    TR_ID: C62700676
    NAME: Verify if the contest is shown in lobby for Private invitational contest for logged in user
    DESCRIPTION: This test case verifies the Private invitational contest display in lobby when navigated through Standard Leaderboard URL when user is logged in
    ...
    def test_010_click_on_the_standard_leaderboard_url(self):
        """
        DESCRIPTION: Click on the Standard Leaderboard URL
