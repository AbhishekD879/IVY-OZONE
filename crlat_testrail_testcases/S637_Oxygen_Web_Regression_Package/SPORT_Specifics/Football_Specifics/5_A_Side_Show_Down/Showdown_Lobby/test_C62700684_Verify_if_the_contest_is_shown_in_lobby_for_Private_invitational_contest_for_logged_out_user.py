...
@vtest
class Test_C62700684_Verify_if_the_contest_is_shown_in_lobby_for_Private_invitational_contest_for_logged_out_user(Common):
    """
    TR_ID: C62700684
    NAME: Verify if the contest is shown in lobby for Private invitational contest for logged out user
    DESCRIPTION: This test case verifies the private invitational contest display in lobby when navigated through Standard Leaderboard URL when user is logged out
    ...
    PRECONDITIONS: 4: Contest with enabled invitation toggle and Private toggle should be configured in CMS
    ...
    def test_008_check_the_private_toggle(self):
        """
        DESCRIPTION: Check the private toggle
        EXPECTED: By default Private should be enabled
        """
        pass

    def test_009_click_on_save_button(self):
        """
        DESCRIPTION: Click on save button
        EXPECTED: All the details should be saved with entered data.
        """
        pass
    ...
    def test_010_click_on_the_standard_leaderboard_url_loggedout_user(self):
        ...
        EXPECTED: Copy the Standard Leaderboard URL and paste it in browser, Pre leader board page should be opened.
        """
        pass
    ...
    def test_011_navigate_back_to_lobby_from_pre_leaderboard(self):
        ...
        EXPECTED: The contest should not be opted in for in Lobby, because the user is not logged in.
        """
        pass
