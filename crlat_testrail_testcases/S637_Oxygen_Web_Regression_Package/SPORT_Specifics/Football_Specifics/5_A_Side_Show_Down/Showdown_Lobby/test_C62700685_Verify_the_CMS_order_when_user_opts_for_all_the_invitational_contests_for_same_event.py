...
@vtest
class Test_C62700685_Verify_the_CMS_order_when_user_opts_for_all_the_invitational_contests_for_same_event(Common):
    """
    TR_ID: C62700685
    NAME: Verify the CMS order when user opts for all the invitational contests for same event.
    ...
    def test_010_click_on_the_standard_leaderboard_url_of_all_contests_created_loggedin_user(self):
        """
        DESCRIPTION: Click on the Standard Leaderboard URL of all contests created (Loggedin user).
        EXPECTED: Copy the Standard Leaderboard URL and paste it in browser and login into the application, Preleader board pages should be opened.
        """
        pass
