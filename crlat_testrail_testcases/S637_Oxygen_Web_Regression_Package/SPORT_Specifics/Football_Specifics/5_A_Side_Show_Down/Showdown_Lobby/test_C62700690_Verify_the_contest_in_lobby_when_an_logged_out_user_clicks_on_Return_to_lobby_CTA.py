...
@vtest
class Test_C62700690_Verify_the_contest_in_lobby_when_an_logged_out_user_clicks_on_Return_to_lobby_CTA(Common):
    """
    TR_ID: C62700690
    NAME: Verify the contest in lobby when an logged out user clicks on Return to lobby CTA
    DESCRIPTION: This test case verifies the showdown cards behaviour for invitational contest
    ...
    def test_010_click_on_the_standard_leaderboard_url_loggedout_user(self):
        ...
        EXPECTED: Copy the Standard Leaderboard URL and paste it in browser and don't login into the application, Pre leader board page should be opened.
        """
        pass

    def test_011_click_on_return_to_lobby_in_pre_leaderboard_page(self):
        """
        DESCRIPTION: Click on "Return to lobby" in Pre-leaderboard page.
        EXPECTED: User navigates to lobby and the navigated contest should be added in the lobby
        """
        pass
