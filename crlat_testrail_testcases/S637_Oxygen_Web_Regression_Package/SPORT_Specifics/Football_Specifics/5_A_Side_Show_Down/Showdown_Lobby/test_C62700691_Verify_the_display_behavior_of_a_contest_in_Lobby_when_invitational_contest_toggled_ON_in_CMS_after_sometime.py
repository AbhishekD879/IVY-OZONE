...
@vtest
class Test_C62700691_Verify_the_display_behavior_of_a_contest_in_Lobby_when_invitational_contest_toggled_ON_in_CMS_after_sometime(Common):
    """
    TR_ID: C62700691
    NAME: Verify the display behavior of a contest in Lobby when invitational contest toggled ON in CMS after sometime
    ...
    def test_007_enter_the_event_id_and_make_the_disable_toggle_for_invitational_contest_and_check_lobby(self):
        """
        DESCRIPTION: Enter the event ID and make the disable toggle for invitational contest and check lobby.
        EXPECTED: Contest created should be displayed in lobby for logged in & logged out users and should act like normal contest
        """
        pass

    def test_008_now_navigate_to_the_contest_and_enable_toggle_for_invitational_contest_and_navigate_to_lobby(self):
        """
        DESCRIPTION: Now navigate to the contest and enable toggle for invitational contest and navigate to lobby
        EXPECTED: Contest shouldnot be displayed in lobby for loggedin or logged out users, until they are navigated through Standard Leaderboard URL or placed a bet already.
        """
        pass
