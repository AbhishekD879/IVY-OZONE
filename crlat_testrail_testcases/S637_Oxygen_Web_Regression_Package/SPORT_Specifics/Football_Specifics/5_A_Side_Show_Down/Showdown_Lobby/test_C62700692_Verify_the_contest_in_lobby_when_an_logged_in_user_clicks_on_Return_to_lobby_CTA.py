...
@vtest
class Test_C62700692_Verify_the_contest_in_lobby_when_an_logged_in_user_clicks_on_Return_to_lobby_CTA(Common):
    """
    TR_ID: C62700692
    NAME: Verify the contest in lobby when an logged in user clicks on Return to lobby CTA
    ...
    def test_010_click_on_the_standard_leaderboard_urlloggedin_user(self):
        """
        DESCRIPTION: Click on the Standard Leaderboard URL(Loggedin user).
