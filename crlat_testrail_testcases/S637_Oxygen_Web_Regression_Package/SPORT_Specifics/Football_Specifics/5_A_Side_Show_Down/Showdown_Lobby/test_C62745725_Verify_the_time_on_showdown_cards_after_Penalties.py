...
@vtest
class Test_C62745725_Verify_the_time_on_showdown_cards_after_Penalties(Common):
    """
    TR_ID: C62745725
    NAME: Verify the time on showdown cards after Penalties
    DESCRIPTION: Verify the time on showdown cards after Penalties
    ...
    def test_007_validate_time_on_showdown_cards_after_penalties(self):
        """
        DESCRIPTION: Validate time on showdown cards after Penalties
        EXPECTED: "PENS" label display on showdown cards and timer will not display on showdown cards section
        """
        pass
