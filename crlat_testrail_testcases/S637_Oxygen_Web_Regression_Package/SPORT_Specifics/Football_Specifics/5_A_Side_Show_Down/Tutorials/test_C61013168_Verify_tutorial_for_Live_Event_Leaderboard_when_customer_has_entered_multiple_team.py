...
@vtest
class Test_C61013168_Verify_tutorial_for_Live_Event_Leaderboard_when_customer_has_entered_multiple_team(Common):
    """
    TR_ID: C61013168
    NAME: Verify tutorial for Live-Event Leaderboard when customer has entered multiple team.
    DESCRIPTION: This Test case verifies the tutorial for Live-Event Leaderboard when customer has entered multiple team.
    ...
    PRECONDITIONS: User should be navigating through showdown for the first time & should have placed at more than one qualifying bet on 5-A-Side.
    """
    ...
    def test_003_click_on_any_card_which_has_live_icon(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161019227)
    ...
    def test_004_click_on_get_started_cta_and_verify_the_welcome_to_showdown_leaderboard_screenverify_ga_tracking_for_get_started_cta(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161019228)
    ...
    def test_007_click_on_next_button_and_verify_position_summary_bar_customer_has_multiple_teamsverify_ga_tracking_for_next_button(self):
        """
        ...
        EXPECTED: Close button is available to close the tutorial
        EXPECTED: Next button is displayed to navigate to another screen and the button is GA Tracked
        EXPECTED: ![](index.php?/attachments/get/161000060)
        """
        pass
