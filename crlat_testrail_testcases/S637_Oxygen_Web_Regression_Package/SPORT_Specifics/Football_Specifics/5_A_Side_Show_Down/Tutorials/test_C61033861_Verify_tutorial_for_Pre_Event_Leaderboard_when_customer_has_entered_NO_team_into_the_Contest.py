...
@vtest
class Test_C61033861_Verify_tutorial_for_Pre_Event_Leaderboard_when_customer_has_entered_NO_team_into_the_Contest(Common):
    """
    TR_ID: C61033861
    NAME: Verify tutorial for Pre-Event Leaderboard when customer has entered NO team into the Contest.
    DESCRIPTION: This test case verifies tutorial for Pre-Event Leaderboard when customer has entered NO team into the Contest.
    ...
    def test_002_navigate_to_pre_event_leaderboard_for_the_first_time(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161019231)
        """
        pass
    ...
    def test_004_verify_the_pre_event_leaderboard_tutorialwelcome_to_5_a_side_showdownclick_on_next__check_ga_tracking_for_cta_button(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/151652259)
    ...
    def test_006_verify_rules_area_screenclick_on_next___check_ga_tracking_for_cta_button(self):
        """
        DESCRIPTION: Verify Rules Area Screen
        DESCRIPTION: Click on Next &  Check GA tracking for CTA button.
        EXPECTED: * Rules Area screen should be displayed as per design
        EXPECTED: * All Rules Area text should be highlighted as per the design
    ...
    def test_007_verify_build_team_screenclick_on_next___check_ga_tracking_for_cta_button(self):
        """
        DESCRIPTION: Verify Build Team Screen
        DESCRIPTION: Click on Next &  Check GA tracking for CTA button.
        EXPECTED: * Build Team screen should be displayed as per design
        EXPECTED: * All Rules Area text and Build Team button is highlighted as
        EXPECTED: per the design
        EXPECTED: ![](index.php?/attachments/get/151652264)
        EXPECTED: * Text should be driven from CMS
        EXPECTED: * Close button is available to close the tutorial
        EXPECTED: * Next Button should be GA Tracked
        """
    ...
    def test_008_verify_rules_button_screenclick_on_finish___check_ga_tracking_for_cta_button(self):
        """
        DESCRIPTION: Verify Rules Button Screen
        DESCRIPTION: Click on Finish &  Check GA tracking for CTA button.
        EXPECTED: * Rules Button screen should be displayed as per design
        EXPECTED: * Rules button is highlighted as per the designs
        EXPECTED: ![](index.php?/attachments/get/151652265)
        EXPECTED: * Text should be driven from CMS
        EXPECTED: * Close button is available to close the tutorial
    ...
    def test_009_verify_from_step_3__with_the_same_user_for_the_second_time(self):
        """
