...
@vtest
class Test_C61619021_Verify_the_display_of_Tutorial_button_Live_Leaderboard_when_customer_has_entered_multiple_teams(Common):
    """
    TR_ID: C61619021
    NAME: Verify the display of Tutorial button -Live Leaderboard when customer has entered multiple teams
    DESCRIPTION: This Test Case Verifies the display of Tutorial button in Live Leaderboard when customer has entered multiple teams
    ...
    def test_003_click_on_the_tutorial_button(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/151652685)
    ...
    def test_006_click_on_next_and_verify_your_team_details_screenverify_ga_tracking_for_next_button(self):
        ...
        EXPECTED: Close button is available to close the Tutorial
        EXPECTED: Next button is displayed to navigate to another screen and the button is GA Tracked
        EXPECTED: ![](index.php?/attachments/get/151652819)
        """
        pass
    ...
    def test_007_click_on_next_button_and_verify_position_summary_bar_customer_has_multiple_teamsverify_ga_tracking_for_next_button(self):
        ...
        EXPECTED: Close button is available to close the tutorial
        EXPECTED: Next button is displayed to navigate to another screen and the button is GA Tracked
        EXPECTED: ![](index.php?/attachments/get/151652837)
        """
        pass
