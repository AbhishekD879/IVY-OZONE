...
@vtest
class Test_C61619023_Verify_the_display_of_Your_Team_Details_Live_Leaderboard(Common):
    """
    TR_ID: C61619023
    NAME: Verify the display of Your Team Details-Live Leaderboard
    DESCRIPTION: This Test Case Verifies the display of Your Team Details Screen in Live Leaderboard
    ...
    def test_003_click_on_any_card_which_has_live_icon(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000054)
