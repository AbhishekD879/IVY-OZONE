...
@vtest
class Test_C61619028_Verify_the_display_of_Prize_Pool_User_Team_already_entered_Pre_Leaderboard(Common):
    """
    TR_ID: C61619028
    NAME: Verify the display of Prize Pool_User Team already entered _Pre Leaderboard
    DESCRIPTION: This test case verifies the display of Prize Pool Screen when User Team already entered to Pre Leaderboard
