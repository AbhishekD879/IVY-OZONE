...
@vtest
class Test_C61619029_Verify_the_display_of_Rules_Screen_User_Team_already_entered_Pre_Leaderboard(Common):
    """
    TR_ID: C61619029
    NAME: Verify the display of Rules Screen_User Team already entered_Pre Leaderboard
    DESCRIPTION: This test case verifies the display of Rules Screen when User Team already entered to Pre Leaderboard
