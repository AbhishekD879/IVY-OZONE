...
@vtest
class Test_C61619030_Verify_the_display_of_Build_Another_Team_User_Team_already_entered_Pre_Leaderboard(Common):
    """
    TR_ID: C61619030
    NAME: Verify the display of Build Another Team_User Team already entered_Pre Leaderboard
    DESCRIPTION: This test case verifies the display of Build Another Team when User Team already entered to Pre Leaderboard
    ...
    def test_006_verify_rules_screenclick_on_next___check_ga_tracking_for_cta_button(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000294)
        EXPECTED: * Text should be driven from CMS
        EXPECTED: * Close button is available to close the tutorial
        EXPECTED: * Next Button should be GA Tracked
        """
