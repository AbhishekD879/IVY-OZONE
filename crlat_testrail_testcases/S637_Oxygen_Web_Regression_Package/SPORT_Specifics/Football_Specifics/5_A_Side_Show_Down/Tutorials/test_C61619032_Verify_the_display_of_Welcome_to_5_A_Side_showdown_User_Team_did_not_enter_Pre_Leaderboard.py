...
@vtest
class Test_C61619032_Verify_the_display_of_Welcome_to_5_A_Side_showdown_User_Team_did_not_enter_Pre_Leaderboard(Common):
    """
    TR_ID: C61619032
    NAME: Verify  the display of Welcome to 5-A Side showdown_User Team did not enter_Pre Leaderboard
    DESCRIPTION: This test case verifies the display of Welcome to 5-A Side showdown when User Team did not enter to Pre Leaderboard
