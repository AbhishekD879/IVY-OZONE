...
@vtest
class Test_C61619033_Verify_the_display_of_Prize_Pool_User_Team_did_not_enter_Pre_Leaderboard(Common):
    """
    TR_ID: C61619033
    NAME: Verify the display of Prize Pool_User Team did not enter_Pre Leaderboard
    DESCRIPTION: This test case verifies the display Prize Pool Screen when User Team did not enter in Pre Leaderboard
