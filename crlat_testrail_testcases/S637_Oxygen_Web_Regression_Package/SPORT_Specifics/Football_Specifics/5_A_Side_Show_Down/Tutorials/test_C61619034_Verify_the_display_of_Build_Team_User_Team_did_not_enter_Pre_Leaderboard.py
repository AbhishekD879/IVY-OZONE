...
@vtest
class Test_C61619034_Verify_the_display_of_Build_Team_User_Team_did_not_enter_Pre_Leaderboard(Common):
    """
    TR_ID: C61619034
    NAME: Verify the display of Build Team_User Team did not enter_Pre Leaderboard
    DESCRIPTION: This test case verifies the display of  Build Team screen when User Team did not enter to Pre Leaderboard
    ...
    def test_007_verify_build_team_screenclick_on_next___check_ga_tracking_for_cta_button(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000311)
        EXPECTED: * Text should be driven from CMS
        EXPECTED: * Close button is available to close the tutorial
        EXPECTED: * Next Button should be GA Tracked
        """
