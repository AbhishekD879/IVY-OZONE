...
@vtest
class Test_C61619035_Verify_the_display_of_Rules_Area_User_Team_did_not_enter_Pre_Leaderboard(Common):
    """
    TR_ID: C61619035
    NAME: Verify the display of Rules Area_User Team did not enter_Pre Leaderboard
    DESCRIPTION: This test case verifies the display of Rules Area when User Team did not enter to Pre Leaderboard
