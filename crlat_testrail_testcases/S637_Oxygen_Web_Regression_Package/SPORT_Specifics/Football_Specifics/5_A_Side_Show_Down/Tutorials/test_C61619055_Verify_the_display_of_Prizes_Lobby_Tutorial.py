...
@vtest
class Test_C61619055_Verify_the_display_of_Prizes_Lobby_Tutorial(Common):
    """
    TR_ID: C61619055
    NAME: Verify the display of Prizes_Lobby Tutorial
    DESCRIPTION: This test case verifies the display of Prizes screens in Showdown Lobby Tutorial Pages
    ...
    def test_002_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000242)
        """
        pass
