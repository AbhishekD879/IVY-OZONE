...
@vtest
class Test_C61619058_Verify_the_display_of_Finish_Screen_Lobby_Tutorial(Common):
    """
    TR_ID: C61619058
    NAME: Verify the display of Finish Screen_Lobby Tutorial
    DESCRIPTION: This test case verifies the display of Finish Screen in Showdown Lobby Tutorial Pages
    ...
    def test_002_navigate_to_5_a_side_lobby(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/140133839)
        """
        pass
    ...
    def test_006_click_on_next_button_and_verify_the_entry_stake_screenverify_ga_tracking_for_next_button(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/161000275)
        """
        pass

    def test_007_click_on_next_and_verify_the_finish_screenverify_ga_tracking_for_finish_button(self):
        """
        DESCRIPTION: Click on NEXT and Verify the Finish Screen
        ...
        EXPECTED: * Text is driven from CMS
        EXPECTED: * Close button is available that shuts the experience
        EXPECTED: * 'Finish' button shuts the experience and the Button is GA Tracked
        """
        pass
