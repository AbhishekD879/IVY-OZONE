...
@pytest.mark.sports
@vtest
class Test_C169131_Verify_Market_selector_drop_down_on_Competitions_page(Common):
    """
    TR_ID: C169131
    ...
    def test_008_verify_bet_placement_for_single_for_the_below_markets_match_result_to_qualify_next_team_to_score_extra_time_result_total_goals_overunder_25_both_teams_to_score_to_win_not_to_nil_ladbrokes_removed_from_ox_1003coral_from_ox_1011_match_result_and_both_teams_to_score_ladbrokes_added_from_ox_1003coral_from_ox_1011_draw_no_bet_1st_half_result(self):
        """
        DESCRIPTION: Verify Bet Placement for Single for the below markets
