...
@pytest.mark.sports
@vtest
class Test_C2072603_Verify_Football_Competition_Details_page_URL_structure(Common):
    """
    TR_ID: C2072603
    NAME: Verify Football Competition Details page URL structure
    DESCRIPTION: This test case verifies URL structure for Competition Details pages
    PRECONDITIONS: 1. Load Oxygen app
    PRECONDITIONS: 2. Navigate to Football landing page and choose 'Competition' tab
    ...
    def test_002_verify_url_structure(self):
        ...
        EXPECTED: https://{domain}/competitions/football/class/type
        EXPECTED: where
