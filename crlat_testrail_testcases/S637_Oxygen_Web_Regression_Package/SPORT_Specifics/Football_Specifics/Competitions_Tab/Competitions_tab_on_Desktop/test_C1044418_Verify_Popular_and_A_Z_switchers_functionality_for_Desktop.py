...
@pytest.mark.sports
@vtest
class Test_C1044418_Verify_Popular_and_A_Z_switchers_functionality_for_Desktop(Common):
    """
    TR_ID: C1044418
    ...
    def test_004_verify_navigation_between_popular_and_a_z_switchers(self):
        ...
        EXPECTED: * Selected switcher is highlighted by red line **CORAL**/ white line **Ladbrokes**
