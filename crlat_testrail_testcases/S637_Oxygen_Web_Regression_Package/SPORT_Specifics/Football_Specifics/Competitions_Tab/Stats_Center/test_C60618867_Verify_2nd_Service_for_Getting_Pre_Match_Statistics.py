...
@pytest.mark.
@vtest
class Test_C60618867_Verify_2nd_Service_for_Getting_Pre_Match_Statistics(Common):
    """
    TR_ID: C60618867
    NAME: Verify 2nd Service for Getting Pre-Match Statistics
    DESCRIPTION: This test case verifies displaying of pre-match statistic for upcoming events when different type of service is sent from the Sport Radar
    ...
    def test_003_send_via_postman_the_xml_where_servicename__schedulesandresultsnote_put_5_digits_before_the_xml_text_and_only_after_that_tap_send_button(self):
        """
        DESCRIPTION: Send via Postman the XML where servicename = 'schedulesandresults'
