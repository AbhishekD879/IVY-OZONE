...
@pytest.mark.
@vtest
class Test_C60618873_Verify_Service_for_Getting_Team_Squad_info(Common):
    """
    TR_ID: C60618873
    NAME: Verify Service for Getting Team Squad info
    DESCRIPTION: This test case verifies displaying of team squad information for particular team
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiteamteamidsquad___param_teamid___id_of_team(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/team/:teamId/squad
        DESCRIPTION: *   param :**teamId** - id of team
        EXPECTED: The endpoint returns team active squad
        """
        pass
