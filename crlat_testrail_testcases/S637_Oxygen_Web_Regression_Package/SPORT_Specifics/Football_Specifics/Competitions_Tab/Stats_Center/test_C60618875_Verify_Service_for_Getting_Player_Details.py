...
@pytest.mark.
@vtest
class Test_C60618875_Verify_Service_for_Getting_Player_Details(Common):
    """
    TR_ID: C60618875
    NAME: Verify Service for Getting Player Details
    DESCRIPTION: This test case verifies displaying of player details
    ...
    def test_001_load_postman_rest_client(self):
        ...
        EXPECTED: Postman Rest Client is loded
        """
        pass
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiplayerplayerid___param_playerid___id_of_playerall_params_are_taken_from_the_xml_file(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/player/:playerId
        DESCRIPTION: *   param :**playerId** - id of player
        DESCRIPTION: All params are taken from the XML file
        EXPECTED: The endpoint returns player details
        """
        pass
