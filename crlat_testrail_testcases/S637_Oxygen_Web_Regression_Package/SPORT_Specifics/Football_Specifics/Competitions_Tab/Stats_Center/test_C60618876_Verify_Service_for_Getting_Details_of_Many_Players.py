...
@pytest.mark.
@vtest
class Test_C60618876_Verify_Service_for_Getting_Details_of_Many_Players(Common):
    """
    TR_ID: C60618876
    NAME: Verify Service for Getting Details of Many Players
    DESCRIPTION: This test case verifies displaying of details for many players
    ...
    def test_003_send_via_postman_the_xml_where_servicename__squadnote_put_5_digits_before_the_xml_text_and_only_after_that_tap_send_button(self):
        """
        DESCRIPTION: Send via Postman the XML where servicename = 'squad'
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiplayerbody_should_have_array_of_player_idsall_params_are_taken_from_the_xml_file(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: domain}/api/player/
        DESCRIPTION: body should have array of player ids.
        DESCRIPTION: All params are taken from the XML file
        EXPECTED: The endpoint returns detaisl for many players
        """
        pass
