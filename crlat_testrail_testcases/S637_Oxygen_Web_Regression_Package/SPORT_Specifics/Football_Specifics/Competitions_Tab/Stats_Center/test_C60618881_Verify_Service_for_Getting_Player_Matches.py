...
@pytest.mark.
@vtest
class Test_C60618881_Verify_Service_for_Getting_Player_Matches(Common):
    """
    TR_ID: C60618881
    NAME: Verify Service for Getting Player Matches
    DESCRIPTION: This test case verifies displaying of player matches
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiplayer4697matches___param_playerid___id_of_player(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/player/4697/matches
