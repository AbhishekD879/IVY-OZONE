...
@pytest.mark.
@vtest
class Test_C60618883_Verify_Service_for_Getting_Team_Upcoming_Matches(Common):
    """
    TR_ID: C60618883
    NAME: Verify Service for Getting Team Upcoming Matches
    DESCRIPTION: This test case verifies displaying of team upcoming matches
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiteamidupcomingmatches___param_teamid___id_of_team(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/team/:id/upcomingmatches
        DESCRIPTION: *   param :**teamId** - id of team
        EXPECTED: The endpoint returns a list of team upcoming matches
        """
        pass
