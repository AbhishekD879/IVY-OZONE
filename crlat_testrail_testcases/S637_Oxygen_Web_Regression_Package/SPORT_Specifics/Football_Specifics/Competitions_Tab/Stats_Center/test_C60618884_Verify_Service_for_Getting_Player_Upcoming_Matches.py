...
@pytest.mark.
@vtest
class Test_C60618884_Verify_Service_for_Getting_Player_Upcoming_Matches(Common):
    """
    TR_ID: C60618884
    NAME: Verify Service for Getting Player Upcoming Matches
    DESCRIPTION: This test case verifies displaying of player upcoming matches
    ...
    def test_003_send_via_postman_the_xml_where_servicename__playerstatisticnote_put_5_digits_before_the_xml_text_and_only_after_that_tap_send_button(self):
        """
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiplayeridupcomingmatches___param_playerid___id_of_player(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/player/:id/upcomingmatches
        DESCRIPTION: *   param :**playerId** - id of player
        EXPECTED: The endpoint returns all player matches
        """
        pass
