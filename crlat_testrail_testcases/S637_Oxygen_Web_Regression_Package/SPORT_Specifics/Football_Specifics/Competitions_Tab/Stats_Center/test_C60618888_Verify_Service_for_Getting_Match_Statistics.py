...
@pytest.mark.
@vtest
class Test_C60618888_Verify_Service_for_Getting_Match_Statistics(Common):
    """
    TR_ID: C60618888
    NAME: Verify Service for Getting Match Statistics
    DESCRIPTION: This test case verifies displaying of match statistic information
