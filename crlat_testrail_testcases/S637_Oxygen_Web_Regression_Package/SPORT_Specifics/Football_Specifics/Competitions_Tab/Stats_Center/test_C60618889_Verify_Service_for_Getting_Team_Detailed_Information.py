...
@pytest.mark.
@vtest
class Test_C60618889_Verify_Service_for_Getting_Team_Detailed_Information(Common):
    """
    TR_ID: C60618889
    NAME: Verify Service for Getting Team Detailed Information
    DESCRIPTION: This test case verifies displaying of team detailed information
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapiteamteamiddetailsparam_teamid____id_of_teamparam_is_taken_from_the_xml(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/team/:teamId/details
        DESCRIPTION: param :teamId -   id of team
        DESCRIPTION: Param is taken from the XML
        EXPECTED: Team detailed information is returned by service
        """
        pass
