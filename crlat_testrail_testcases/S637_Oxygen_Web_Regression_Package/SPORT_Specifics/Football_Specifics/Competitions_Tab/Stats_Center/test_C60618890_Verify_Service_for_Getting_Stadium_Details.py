...
@pytest.mark.
@vtest
class Test_C60618890_Verify_Service_for_Getting_Stadium_Details(Common):
    """
    TR_ID: C60618890
    NAME: Verify Service for Getting Stadium Details
    DESCRIPTION: This test case verifies displaying of stadium detailed information
    ...
    def test_004_open_web_browser_and_tap_the_following_endpoint_for_checking_the_servicedomainapistadiumstadiumiddetailsparam_stadiumid___id_of_stadiumparam_is_taken_from_the_xml(self):
        """
        DESCRIPTION: Open web browser and tap the following endpoint for checking the service:
        DESCRIPTION: {domain}/api/stadium/:stadiumId/details
        DESCRIPTION: param :stadiumId - id of stadium
        DESCRIPTION: Param is taken from the XML
        EXPECTED: Stadium detailed information is returned by service
        """
        pass
