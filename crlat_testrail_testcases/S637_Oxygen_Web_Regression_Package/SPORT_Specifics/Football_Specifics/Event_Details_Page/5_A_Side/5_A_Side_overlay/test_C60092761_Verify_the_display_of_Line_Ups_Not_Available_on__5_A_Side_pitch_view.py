...
@vtest
class Test_C60092761_Verify_the_display_of_Line_Ups_Not_Available_on__5_A_Side_pitch_view(Common):
    """
    TR_ID: C60092761
    NAME: Verify the display of "Line-Ups Not Available" on   5-A Side pitch view
    DESCRIPTION: Verify that 'Line-Ups Not Available' is displayed below event name with info icon when Line ups are not available
