...
@vtest
class Test_C64569593_Verify_that_Pop_up_screen_appears_on_clicking_Create_BuildYourBet_Market(Common):
    """
    TR_ID: C64569593
    NAME: Verify that Pop-up screen appears on clicking Create BuildYourBet Market
    DESCRIPTION: 
