...
@vtest
class Test_C64569598_Verify_the_display_of_Popular_Market_Check_box(Common):
    """
    TR_ID: C64569598
    NAME: Verify the display of Popular Market Check box
    DESCRIPTION: 
    ...
    def test_005_validate_that_user_is_able_to_enter_incident_grouping_market_grouping_market_description(self):
        ...
        EXPECTED: * User should be able to enter Incident Grouping, Market Grouping, Market Description
        """
        pass
    ...
    def test_008_validate_user_navigation_to_edit_buildyourmarket_page_and_check_popular_markets_checkbox(self):
        """
        DESCRIPTION: Validate User Navigation to Edit BuildYourMarket page and check Popular Markets Checkbox
        EXPECTED: * User should be navigated to Edit BuildYourMarket page and Popular Markets Checkbox us checked
        """
        pass
