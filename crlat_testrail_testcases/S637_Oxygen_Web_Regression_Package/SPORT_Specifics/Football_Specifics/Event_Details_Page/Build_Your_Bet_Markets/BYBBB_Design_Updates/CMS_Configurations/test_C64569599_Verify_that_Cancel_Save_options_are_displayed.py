...
@vtest
class Test_C64569599_Verify_that_Cancel_Save_options_are_displayed(Common):
    """
    TR_ID: C64569599
    NAME: Verify that Cancel & Save options are displayed
    DESCRIPTION: 
    ...
    def test_008_validate_the_cancel__save_button_display(self):
        """
        DESCRIPTION: Validate the Cancel & Save button display
        EXPECTED: * When click on the save the enter Buildyour Market data should be saved
        EXPECTED: * When Click on Cancle the no data should be save and screen is closed
        """
        pass
