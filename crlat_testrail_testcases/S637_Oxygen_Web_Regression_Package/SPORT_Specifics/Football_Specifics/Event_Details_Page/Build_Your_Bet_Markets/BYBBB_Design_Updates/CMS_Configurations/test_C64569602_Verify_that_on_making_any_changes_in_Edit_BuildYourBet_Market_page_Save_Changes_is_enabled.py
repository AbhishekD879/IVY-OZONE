...
@vtest
class Test_C64569602_Verify_that_on_making_any_changes_in_Edit_BuildYourBet_Market_page_Save_Changes_is_enabled(Common):
    """
    TR_ID: C64569602
    NAME: Verify that on making any changes in Edit BuildYourBet Market page 'Save Changes' is enabled
    DESCRIPTION: 
    ...
    def test_009_navigate_to_the_above_created_market_and_click_on_edit_market(self):
        """
        DESCRIPTION: Navigate to the above created market and click on edit market
        EXPECTED: User should see the Edit BuildYourBet Market screen
        """
        pass

    def test_010_user_can_edit_any_of_the_datamarket_grouping_market_description_etc_save_button_should_be_enable(self):
        """
        DESCRIPTION: User can edit any of the data(Market Grouping, Market Description etc) save button should be enable
        EXPECTED: User should be able to edit changes and click on save should save successfully
        """
        pass
