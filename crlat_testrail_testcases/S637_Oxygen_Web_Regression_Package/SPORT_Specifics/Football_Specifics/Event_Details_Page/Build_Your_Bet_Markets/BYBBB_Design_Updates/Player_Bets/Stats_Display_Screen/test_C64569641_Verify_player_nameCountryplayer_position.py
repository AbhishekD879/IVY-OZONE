...
@vtest
class Test_C64569641_Verify_player_nameCountryplayer_position(Common):
    """
    TR_ID: C64569641
    NAME: Verify player name,Country,player position
    DESCRIPTION: This test case verifies the player name ,Country and player position in player stat screen
    ...
    def test_006_validate_the_stats_screen(self):
        ...
        EXPECTED: * Player name,Country,player position should be displayed in player stat screen
        EXPECTED: Ladbrokes:
        EXPECTED: ![](index.php?/attachments/get/9e1acec1-665c-4034-8c9a-c27d0d0710a6)
        """
        pass
