...
@vtest
class Test_C64569654_Verify_that_Show_More_is_displayed_and_on_Clicking_Show_More_Player_names_should_be_loaded_and_displayed(Common):
    """
    TR_ID: C64569654
    NAME: Verify that Show More is displayed and on Clicking Show More Player names should be loaded and displayed
    DESCRIPTION: Verify that Show More is displayed and on Clicking Show More Player names should be loaded and displayed
    PRECONDITIONS: 
    """
    ...
    def test_007_click_on_show_more(self):
        """
