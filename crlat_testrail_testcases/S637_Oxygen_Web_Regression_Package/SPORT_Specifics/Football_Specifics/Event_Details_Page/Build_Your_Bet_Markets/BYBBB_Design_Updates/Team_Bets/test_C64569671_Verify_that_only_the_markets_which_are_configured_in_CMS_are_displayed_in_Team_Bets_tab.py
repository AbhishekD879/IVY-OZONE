...
@vtest
class Test_C64569671_Verify_that_only_the_markets_which_are_configured_in_CMS_are_displayed_in_Team_Bets_tab(Common):
    """
    TR_ID: C64569671
    NAME: Verify that only the markets which are configured in CMS are displayed in Team Bets tab
    DESCRIPTION: 
    PRECONDITIONS: 
    """
