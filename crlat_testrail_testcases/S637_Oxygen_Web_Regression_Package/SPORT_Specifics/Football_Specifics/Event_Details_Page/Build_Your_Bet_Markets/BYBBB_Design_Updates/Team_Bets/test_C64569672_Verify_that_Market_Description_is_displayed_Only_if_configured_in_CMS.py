...
@vtest
class Test_C64569672_Verify_that_Market_Description_is_displayed_Only_if_configured_in_CMS(Common):
    """
    TR_ID: C64569672
    NAME: Verify that Market Description is displayed Only if configured in CMS
    DESCRIPTION: 
    PRECONDITIONS: 
    """
