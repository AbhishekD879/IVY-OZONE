...
@vtest
class Test_C64569673_Verify_that_Team_Bets_tab_is_not_displayed_when_there_are_no_Markets_confiured_in_CMS_with_the_filter(Common):
    """
    TR_ID: C64569673
    NAME: Verify that Team Bets tab is not displayed when there are no Markets confiured in CMS with the filter
    DESCRIPTION: 
    PRECONDITIONS: 
    """
