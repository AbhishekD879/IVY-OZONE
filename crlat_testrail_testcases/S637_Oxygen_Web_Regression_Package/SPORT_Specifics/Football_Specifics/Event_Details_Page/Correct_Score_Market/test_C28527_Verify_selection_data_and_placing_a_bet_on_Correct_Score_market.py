...
@pytest.mark.sports
@vtest
class Test_C28527_Verify_selection_data_and_placing_a_bet_on_Correct_Score_market(Common):
    """
    TR_ID: C28527
    ...
    def test_008_tap_add_to_betslip_ltpriceoddsgt_button_again(self):
        """
