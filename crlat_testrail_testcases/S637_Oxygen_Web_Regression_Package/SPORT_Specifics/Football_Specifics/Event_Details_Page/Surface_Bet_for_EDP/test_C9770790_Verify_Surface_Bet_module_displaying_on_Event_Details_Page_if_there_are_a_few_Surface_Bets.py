...
@vtest
class Test_C9770790_Verify_Surface_Bet_module_displaying_on_Event_Details_Page_if_there_are_a_few_Surface_Bets(Common):
    """
    TR_ID: C9770790
    ...
    PRECONDITIONS: 1. There are a few Surface Bets added to the Event Details page (EDP).
    PRECONDITIONS: 2. Content/Was price/Icon for one Surface Bet are not defined
    PRECONDITIONS: 3. Content/Was price/Icon for one Surface Bet are defined
    PRECONDITIONS: 4. Valid Selection Ids are set
    PRECONDITIONS: 5. Open this EDP in Oxygen application.
