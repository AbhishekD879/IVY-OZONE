...
@pytest.mark.sports
@vtest
class Test_C28569_Verify_Football_Jackpot_page(Common):
    """
    TR_ID: C28569
    NAME: Verify Football 'Jackpot' page
    DESCRIPTION: This test case verifies content of Football 'Jackpot' page
    DESCRIPTION: AUTOTEST [C918364]
    ...
    def test_006_tap_the_i_icon(self):
        """
        DESCRIPTION: Tap the 'i' icon
    ...
    def test_009_repeat_step_6(self):
        """
    ...
    def test_011_repeat_steps_5_10_on_tablet(self):
        """
        DESCRIPTION: Repeat steps 5-10 on tablet
    ...
    def test_012_verify_luck_dip_option(self):
        """
    ...
    def test_013_verify_the_main_body_of_the_page_ie_football_jackpot_coupon(self):
        """
    ...
    def test_014_verify_bet_placement_section(self):
        """
