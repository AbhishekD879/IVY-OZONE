...
@pytest.mark.sports
@vtest
class Test_C22892405_Verify_Football_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C22892405
    ...
    DESCRIPTION: Mobile [C24101775]
    DESCRIPTION: Desktop [C24618993]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_football_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_football_pages(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/36777)
        """
        pass
    ...
    def test_005_go_to_football_landing_page__in_play_tab(self):
        """
    ...
    def test_006_navigate_to_football_landing_page__competitions_tabselect_appropriate_competition_to__event_where_scores_should_be_checked(self):
        """
