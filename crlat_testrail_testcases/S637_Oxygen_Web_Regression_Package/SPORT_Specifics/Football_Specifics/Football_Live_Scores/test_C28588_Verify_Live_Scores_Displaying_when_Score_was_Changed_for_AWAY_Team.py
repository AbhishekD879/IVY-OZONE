...
@pytest.mark.sports
@vtest
class Test_C28588_Verify_Live_Scores_Displaying_when_Score_was_Changed_for_AWAY_Team(Common):
    """
    TR_ID: C28588
    NAME: Verify Live Scores Displaying when Score was Changed for AWAY Team
    DESCRIPTION: This test case verifies live scores displaying when score was changed for AWAY team.
    ...
    def test_005_trigger_the_following_situationvalueis_changed_for_away_team_rolecodeaway(self):
        """
    ...
    def test_009_tap_in_play_tab_from_the_homepagerepeat_steps_4_5(self):
        """
        DESCRIPTION: Tap 'In-Play' tab from the Homepage
        DESCRIPTION: Repeat steps №4-5
        EXPECTED: 'In-Play' tab is opened
        EXPECTED: Score is immediately start displaying new value for Away team
        """
    ...
    def test_014_verify_score_change_for_away_team_for_sections_in_a_collapsed_state(self):
        """
        DESCRIPTION: Verify Score change for AWAY team for sections in a collapsed state
    ...
    def test_015_verify_score_change_before_application_is_opened(self):
        ...
        EXPECTED: If application was not started/opened and Score was changed for AWAY team, after opening application and verified event - updated Score will be shown there
        """
        pass
