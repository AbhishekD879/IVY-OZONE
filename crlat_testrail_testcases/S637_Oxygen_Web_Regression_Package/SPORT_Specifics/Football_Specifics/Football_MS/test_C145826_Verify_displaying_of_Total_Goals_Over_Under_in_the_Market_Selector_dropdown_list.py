...
@pytest.mark.sports
@vtest
class Test_C145826_Verify_displaying_of_Total_Goals_Over_Under_in_the_Market_Selector_dropdown_list(Common):
    """
    TR_ID: C145826
    ...
    def test_001_go_to_network__gt_all__gt_preview_and_find_templatemarketname_attribute_for_total_goals_overunder_market_in_ss_response(self):
        """
    ...
    def test_005_go_to_network__gt_all__gt_preview_and_find_templatemarketname_attribute_for_total_goals_overunder_market_in_ss_response(self):
        """
        DESCRIPTION: Go to Network -&gt; All -&gt; **Preview** and find 'templateMarketName' attribute for 'Total Goals Over/Under' market in SS response
