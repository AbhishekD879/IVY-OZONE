...
@pytest.mark.sports
@vtest
class Test_C28635_Verify_Market_Selector_dropdown_list_on_Football_landing_page(Common):
    """
    TR_ID: C28635
    NAME: Verify 'Market Selector' dropdown list on Football landing page
    DESCRIPTION: This test case verifies 'Market Selector' dropdown list on the Football landing page and also verify Bet placement for Single and Quick Bet
    ...
    def test_005_verify_bet_placement_for_single_and_quick_bet_for_the_below_markets_match_result_to_qualify_total_goals_overunder_25_both_teams_to_score_to_win_and_both_teams_to_score_ladbrokes_removed_from_ox_1003_match_result_and_both_teams_to_score_ladbrokes_added_from_ox_1003_draw_no_bet_1st_half_result(self):
        """
