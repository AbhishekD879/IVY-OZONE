...
@pytest.mark.sports
@vtest
class Test_C28689_Verify_all_events_displaying_as_Outrights_on_Formula_1(Common):
    """
    TR_ID: C28689
    NAME: Verify all events displaying as Outrights on Formula 1
    ...
    def test_001_tap_formula_1_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_003_repeat_steps_2_for_in_play_tab_on_sport_landing_page_desktop_only_in_play_tab_on_homepage__live_now_and_upcoming_filters_in_play_sport_page___live_now_and_upcoming_filters_in_play_widget_on_desktop_tomorrow_tab_for_desktop_only_future_tab_for_desktop_only_outrighs_tab_mobile_only_competition_detailed_page___outrighs_tabmobile_where_applicable_live_stream_pagetab___live_now_and_upcoming_filters_highlights_carousel_module_created_on_homepage_landing_page_featured_tab_module_created_by_typeid(self):
        """
        DESCRIPTION: Repeat steps №2 for:
        DESCRIPTION: * In Play tab on Sport Landing page (Desktop ONLY)
