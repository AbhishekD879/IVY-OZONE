...
@pytest.mark.sports
@vtest
class Test_C28691_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28691
    ...
    def test_002_tap_speedway_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Speedway' icon from the Sports Menu Ribbon
        EXPECTED: *   'Speedway' Landing Page is opened
        EXPECTED: *   '**Events**'->'**Today**' tab is opened by default (for desktop)/ 'Matches' tab is opened (for mobile)
        """
        pass
