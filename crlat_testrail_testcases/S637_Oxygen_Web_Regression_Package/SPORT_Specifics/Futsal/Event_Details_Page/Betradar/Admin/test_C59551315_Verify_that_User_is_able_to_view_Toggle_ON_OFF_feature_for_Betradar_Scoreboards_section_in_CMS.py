...
@pytest.mark.sports
@vtest
class Test_C59551315_Verify_that_User_is_able_to_view_Toggle_ON_OFF_feature_for_Betradar_Scoreboards_section_in_CMS(Common):
    """
    TR_ID: C59551315
    ...
    PRECONDITIONS: 3: Betradar scoreboard configuration in CMS is enabled/Disabled.
    PRECONDITIONS: TBD?
    ...
    def test_002_load_oxygen_application_on_the_mobile_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the mobile device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard is available
        """
        pass

    def test_003_load_oxygen_application_on_the_desktop_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the Desktop device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard should not available
        """
        pass

    def test_004_load_oxygen_application_on_the_tablet_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the tablet device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard is available
        """
        pass
    ...
    def test_006_load_oxygen_application_on_the_mobile_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the mobile device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard is available
        """
    ...
    def test_007_load_oxygen_application_on_the_desktop_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the Desktop device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard should not available
        """
    ...
    def test_008_load_oxygen_application_on_the_tablet_device__navigate_to_fustal_edp_with_mapped_bet_radar_scoreboard(self):
        """
        DESCRIPTION: Load Oxygen application on the tablet device > Navigate to Fustal EDP with mapped Bet radar Scoreboard
        EXPECTED: Bet Radar Scoreboard is available
        """
