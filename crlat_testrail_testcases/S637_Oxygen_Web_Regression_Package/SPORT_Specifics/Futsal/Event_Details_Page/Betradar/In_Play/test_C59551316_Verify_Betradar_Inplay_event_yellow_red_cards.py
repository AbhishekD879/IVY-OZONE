...
@pytest.mark.sports
@vtest
class Test_C59551316_Verify_Betradar_Inplay_event_yellow_red_cards(Common):
    """
    TR_ID: C59551316
    ...
    def test_001_navigate_to_the_fustal_event_details_page_from_preconditions(self):
        ...
        EXPECTED: It should be navigated to Fustal EDP
        """
        pass

    def test_002_verify_display_of_futsal_inplay_incident_when_team_receives_yellowred_cards(self):
        """
        DESCRIPTION: Verify display of futsal Inplay incident when team receives yellow/red cards
