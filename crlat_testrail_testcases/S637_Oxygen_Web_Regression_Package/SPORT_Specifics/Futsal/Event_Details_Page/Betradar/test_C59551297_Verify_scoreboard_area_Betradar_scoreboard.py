...
@pytest.mark.sports
@vtest
class Test_C59551297_Verify_scoreboard_area_Betradar_scoreboard(Common):
    """
    TR_ID: C59551297
    NAME: Verify scoreboard area- Betradar scoreboard
    DESCRIPTION: Verify that header section(above the tabs) Team names are mentioned on either side, shirts images are before the Team Names and the Score is between the Team names separated by Colon and Game status is above the Score.
    ...
    def test_005_validate_the_scoreboard_section(self):
        ...
        EXPECTED: 4: Goal Score should be displayed below the match status
        """
        pass
