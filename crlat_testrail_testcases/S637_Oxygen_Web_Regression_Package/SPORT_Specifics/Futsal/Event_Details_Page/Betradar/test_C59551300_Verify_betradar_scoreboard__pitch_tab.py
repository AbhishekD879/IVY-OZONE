...
@pytest.mark.sports
@vtest
class Test_C59551300_Verify_betradar_scoreboard__pitch_tab(Common):
    """
    TR_ID: C59551300
    NAME: Verify betradar scoreboard - pitch tab
    DESCRIPTION: Verify that Betradar scoreboard contains the Category, Type & Match Timings as Day, Date Month and Time with (EST/CST/IST) mentioned Match Status, Silks & Team names with scores in the Pitch Tab
