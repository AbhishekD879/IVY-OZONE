...
@pytest.mark.sports
@vtest
class Test_C59551301_Verify_Betradar_scoreboard__Statistics_tab(Common):
    """
    TR_ID: C59551301
    NAME: Verify Betradar scoreboard - Statistics tab
    DESCRIPTION: Verify that STATISTICS tab is displayed in Betradar Scoreboard and the tab contains[TBD]
    ...
    def test_006_validate_statistics_tab(self):
        """
        DESCRIPTION: Validate STATISTICS tab
        EXPECTED: STATISTICS tab should be displayed in Betradar Scoreboard and all the details
        EXPECTED: TBD
        """
        pass
