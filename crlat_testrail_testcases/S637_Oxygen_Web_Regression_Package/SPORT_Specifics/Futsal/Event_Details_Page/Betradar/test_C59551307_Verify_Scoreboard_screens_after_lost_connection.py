...
@pytest.mark.sports
@vtest
class Test_C59551307_Verify_Scoreboard_screens_after_lost_connection(Common):
    """
    TR_ID: C59551307
    ...
    def test_001_navigate_to_prematch_futsal_edp_from_precondition(self):
        """
        DESCRIPTION: Navigate to Prematch Futsal EDP from Precondition
    ...
    def test_004_navigate_to_inplay_futsal_edp_from_precondition(self):
        """
        DESCRIPTION: Navigate to Inplay Futsal EDP from Precondition
        EXPECTED: It should navigated to Fustal EDP.
        """
        pass
