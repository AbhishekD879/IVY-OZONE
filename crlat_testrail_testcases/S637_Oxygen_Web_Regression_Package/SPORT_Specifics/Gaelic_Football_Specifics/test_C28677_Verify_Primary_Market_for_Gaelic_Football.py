...
@pytest.mark.sports
@vtest
class Test_C28677_Verify_Primary_Market_for_Gaelic_Football(Common):
    """
    TR_ID: C28677
    NAME: Verify Primary Market for Gaelic Football
    DESCRIPTION: This test case verifies Primary Market for 'Gaelic Football' Sport.
    PRECONDITIONS: http://backoffice-tst2.coral.co.uk/openbet-ssviewer/Drilldown/X.XX/EventToOutcomeForEvent/XXX?translationLang=LL
    PRECONDITIONS: *   XXX - event ID
    PRECONDITIONS: *   X.XX - current supported version of OpenBet release
    PRECONDITIONS: *   LL - language (e.g. en, ukr)
    PRECONDITIONS: * Load Oxygen application
    PRECONDITIONS: * Go to Gaelic Football landing page
    """
