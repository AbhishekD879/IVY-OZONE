...
@pytest.mark.sports
@vtest
class Test_C28678_Verify_Landing_pages(Common):
    """
    TR_ID: C28678
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Gaelic Football=53)
    ...
    def test_002_tapgaelic_football_icon_on_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Gaelic Football' icon on the Sports Menu Ribbon
        EXPECTED: *   Gaelic FootballLanding Page is opened
