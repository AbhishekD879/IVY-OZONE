...
@pytest.mark.sports
@vtest
class Test_C59889732_Verify_MS_on_Competitions_Tab_for_Golf(Common):
    """
    TR_ID: C59889732
    ...
    def test_005_verify_bet_placement_for_single_multiple_and_quick_bet_for_the_below_markets_2_ball_betting_3_ball_betting(self):
        """
