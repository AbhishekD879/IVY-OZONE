...
@pytest.mark.other
@vtest
class Test_C64293328_Fav_icon_on_header__not_enabled(Common):
    """
    TR_ID: C64293328
    NAME: Fav icon on header - not enabled
    DESCRIPTION: This tc verifies the functionality of fav icon on Groups tab header in disabled state
    ...
    def test_004_disable_fav_icon_in_the_header(self):
        """
        DESCRIPTION: Disable fav icon in the header.
        EXPECTED: All groups should be displayed according to their positions in groups tab
        """
        pass
