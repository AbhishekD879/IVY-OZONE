...
@pytest.mark.other
@vtest
class Test_C64293341_Successfully_Launching_a_IMG_Stream_when_event_is_not_yet_started(Common):
    """
    TR_ID: C64293341
    NAME: Successfully Launching a IMG Stream when event is not yet started
    ...
    PRECONDITIONS: Event should have following attributes: isMarketBetInRun = "true"
    PRECONDITIONS: It should be less than 2 minutes left before event Start Time, event should not be started
