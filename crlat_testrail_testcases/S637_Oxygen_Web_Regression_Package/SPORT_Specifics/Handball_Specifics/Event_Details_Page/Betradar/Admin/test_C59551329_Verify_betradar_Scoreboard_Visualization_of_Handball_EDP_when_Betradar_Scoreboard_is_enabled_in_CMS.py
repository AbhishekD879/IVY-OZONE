...
@pytest.mark.sports
@vtest
class Test_C59551329_Verify_betradar_Scoreboard_Visualization_of_Handball_EDP_when_Betradar_Scoreboard_is_enabled_in_CMS(Common):
    """
    TR_ID: C59551329
    NAME: Verify betradar Scoreboard & Visualization of Handball EDP when Betradar Scoreboard is enabled in CMS
    ...
    PRECONDITIONS: 2. In play Handball event(s) should present and subscribed to bet radar scoreboard
    ...
    def test_001_launch_the_application_and_navigate_to_handball_edp_from_home___handball___inplay(self):
        """
        DESCRIPTION: Launch the application and navigate to Handball EDP from Home - Handball - inplay
    ...
    def test_002_verify_table_handball_inplay_landing_page(self):
        """
        DESCRIPTION: verify table Handball inplay landing page
