...
@pytest.mark.sports
@vtest
class Test_C59551331_Verify_that_when_there_is_unavailability_or_discrepancy_in_Betradar_scoreboard(Common):
    """
    TR_ID: C59551331
    ...
    PRECONDITIONS: 1: Navigate to Sports Menu(Fustal)/From A-Z all Sports->Handball
    ...
    def test_001_launch_the_application_and_navigate_to_handball_edp_from_home___handball__inplay(self):
        """
        DESCRIPTION: Launch the application and navigate to Handball EDP from Home - Handball- inplay
        EXPECTED: Handball inplay landing page should display
        """
        pass
    ...
    def test_003_navigate_to_the_handball_event_details_page_from_preconditions(self):
        """
