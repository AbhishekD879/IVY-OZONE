...
@pytest.mark.sports
@vtest
class Test_C59551337_Verify_betradar_scoreboard__color_schemaLadbrokes_and_Coral(Common):
    """
    TR_ID: C59551337
    ...
    def test_001_launch_ladbrokes_url_and_navigate_to_handball_event_landing_page_from_a_z_menu___table_tennis___inplay(self):
        """
        DESCRIPTION: Launch ladbrokes URL and Navigate to Handball event landing page from A-Z menu - table tennis - inplay
        EXPECTED: 
        """
        pass
    ...
    def test_002_click_on_inplay_event_which_is_subscribed_to_betradar_scoreboard(self):
        ...
        EXPECTED: Handball event detail page should display
        """
        pass
    ...
    def test_003_click_on_any_tabstatistics_in_scoreboard_and_verify_color_schema(self):
        ...
        EXPECTED: The colour scheme should match with colors those have across our apps. as shown in markups
        """
        pass
