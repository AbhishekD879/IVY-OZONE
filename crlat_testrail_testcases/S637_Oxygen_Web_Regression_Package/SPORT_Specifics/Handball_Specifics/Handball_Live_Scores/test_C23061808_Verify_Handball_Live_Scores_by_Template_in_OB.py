...
@pytest.mark.sports
@vtest
class Test_C23061808_Verify_Handball_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C23061808
    ...
    DESCRIPTION: Mobile [C28946252]
    DESCRIPTION: Desktop [C28899038]
    ...
    def test_002_for_mobiletabletin_play_page_from_the_sports_menu_ribboncheck_on_watch_live_and_handball_pagesfor_desktopin_play_page_from_the_main_navigation_menu_at_the_universal_headercheck_on_watch_live_and_handball_pages(self):
        """
    ...
    def test_005_go_to_handball_landing_page__in_play_tabmodule(self):
        """
