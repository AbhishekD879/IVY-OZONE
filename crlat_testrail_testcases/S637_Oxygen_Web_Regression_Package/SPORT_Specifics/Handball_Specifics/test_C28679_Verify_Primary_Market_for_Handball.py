...
@pytest.mark.sports
@vtest
class Test_C28679_Verify_Primary_Market_for_Handball(Common):
    """
    TR_ID: C28679
    NAME: Verify Primary Market for Handball
    DESCRIPTION: This test case verifies Primary Market for 'Handball' Sport.
    ...
    PRECONDITIONS: * Go to Handball landing page
    """
