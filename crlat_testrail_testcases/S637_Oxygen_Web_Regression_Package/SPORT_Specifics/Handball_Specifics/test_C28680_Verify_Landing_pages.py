...
@pytest.mark.sports
@vtest
class Test_C28680_Verify_Landing_pages(Common):
    """
    TR_ID: C28680
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Handball=20)
    ...
    def test_002_taphandball_icon_on_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Handball' icon on the Sports Menu Ribbon
        EXPECTED: *   Handball Landing Page is opened
