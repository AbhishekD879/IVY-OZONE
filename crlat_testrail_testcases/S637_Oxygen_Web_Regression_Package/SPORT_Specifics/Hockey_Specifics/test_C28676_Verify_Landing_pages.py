...
@pytest.mark.sports
@vtest
class Test_C28676_Verify_Landing_pages(Common):
    """
    TR_ID: C28676
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Hockey=54)
    ...
    PRECONDITIONS: *   XXX - the event ID (Hockey=54)
    PRECONDITIONS: *   X.XX - current supported version of OpenBet release
    PRECONDITIONS: *   LL - language (e.g. en, ukr)
    """
    ...
    def test_002_taphockey_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_003_verify_section_headers_titles(self):
        ...
        EXPECTED: **categoryName** + ""** -** "" + t**ypeName**
        """
        pass
    ...
    def test_006_tap_tomorrow_tab_for_desktop(self):
        """
        DESCRIPTION: Tap '**Tomorrow**' tab (for desktop)
