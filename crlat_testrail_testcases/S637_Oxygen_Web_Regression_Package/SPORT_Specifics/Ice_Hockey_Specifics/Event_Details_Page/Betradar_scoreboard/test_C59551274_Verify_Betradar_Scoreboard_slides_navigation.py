...
@pytest.mark.sports
@vtest
class Test_C59551274_Verify_Betradar_Scoreboard_slides_navigation(Common):
    """
    TR_ID: C59551274
    ...
    PRECONDITIONS: Make sure you have Ice Hockey upcoming event which is subscribed to Betradar Scoreboards
    ...
    def test_001_navigate_to_event_details_page_of_in_play_ice_hockey_event_as_per_the_pre_conditions(self):
        """
        DESCRIPTION: Navigate to Event Details Page of In play Ice Hockey event as per the pre-conditions
        EXPECTED: Event Details Page should be opened with event visualization and scoreboards
        """
        pass

    def test_002_verify_display_of_slides_in_ice_hockey_court(self):
        """
        DESCRIPTION: Verify display of slides in Ice Hockey court
    ...
    def test_006_from_ice_hockey_court_widgetswipe_to_the_left(self):
        """
        DESCRIPTION: From Ice Hockey court widget
