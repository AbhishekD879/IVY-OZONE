...
@pytest.mark.sports
@vtest
class Test_C59551280_Verify_Betradar_Scoreboard_Statistics_tab(Common):
    """
    TR_ID: C59551280
    NAME: Verify Betradar Scoreboard- Statistics tab
    DESCRIPTION: This test case verifies inplay statistics tab for an event with betradar visualization
