...
@pytest.mark.sports
@vtest
class Test_C60004636_Verify_MS_on_Matches_Tab_for_Ice_Hockey_SLP(Common):
    """
    TR_ID: C60004636
    ...
    def test_006_repeat_steps_3_5_for_the_following_markets_puck_line_60_minute_betting_total_goals_2_way(self):
        """
