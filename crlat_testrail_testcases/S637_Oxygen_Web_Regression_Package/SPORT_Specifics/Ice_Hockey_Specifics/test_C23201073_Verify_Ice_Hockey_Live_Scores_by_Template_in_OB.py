...
@pytest.mark.sports
@vtest
class Test_C23201073_Verify_Ice_Hockey_Live_Scores_by_Template_in_OB(Common):
    """
    TR_ID: C23201073
    ...
    DESCRIPTION: AUTO TEST MOBILE: [C36827331]
    DESCRIPTION: DESKTOP: [C36893181]
    ...
    def test_005_go_to_ice_hockey_landing_page__in_play_tab(self):
        """
