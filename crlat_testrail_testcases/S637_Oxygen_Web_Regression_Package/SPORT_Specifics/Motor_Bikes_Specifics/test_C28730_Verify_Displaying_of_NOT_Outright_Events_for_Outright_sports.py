...
@pytest.mark.sports
@vtest
class Test_C28730_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28730
    ...
    def test_002_tap_motor_bikes_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Motor Bikes' icon from the Sports Menu Ribbon
        EXPECTED: **Desktop:**
    ...
    def test_011_tap_in_play_tab_desktopnote_for_mobile_view_in_play_events_are_displayed_in_in_play_module_at_the_top_of_the_page_if_available(self):
        """
        DESCRIPTION: Tap **'In-Play' **tab (Desktop)
        DESCRIPTION: Note: for Mobile view in-play events are displayed in In-Play module at the top of the page (if available)
