...
@pytest.mark.sports
@vtest
class Test_C28732_Verify_Landing_pages(Common):
    """
    TR_ID: C28732
    ...
    def test_006_tap_tomorrow_tab_desktop(self):
        ...
        EXPECTED: *   First **three **sections are expanded by default
        EXPECTED: *   The rest of sections are collapsed by default
    ...
    def test_010_tap_outrights_tab_desktopnote_for_mobile_view_outright_events_are_displayed_in_outrights_section_if_available(self):
        """
