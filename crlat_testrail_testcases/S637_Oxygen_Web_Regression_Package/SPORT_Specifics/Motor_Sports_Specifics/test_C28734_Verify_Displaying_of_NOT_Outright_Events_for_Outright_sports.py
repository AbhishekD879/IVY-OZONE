...
@pytest.mark.sports
@vtest
class Test_C28734_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28734
    ...
    def test_002_tap_motor_sports_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Motor Sports' icon from the Sports Menu Ribbon
        EXPECTED: **Desktop:**
    ...
    def test_011_tap_in_play_tab_desktopnote_for_mobile_in_play_events_are_displayed_in_in_play_module(self):
        """
