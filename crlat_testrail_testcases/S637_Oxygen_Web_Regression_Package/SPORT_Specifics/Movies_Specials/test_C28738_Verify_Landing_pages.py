...
@pytest.mark.sports
@vtest
class Test_C28738_Verify_Landing_pages(Common):
    """
    TR_ID: C28738
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Movies=42)
    ...
    def test_002_tapmovies_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_010_tap_outrights_tab_desktopnote_outrights_for_mobile_view_are_in_separate_outrights_section(self):
        """
