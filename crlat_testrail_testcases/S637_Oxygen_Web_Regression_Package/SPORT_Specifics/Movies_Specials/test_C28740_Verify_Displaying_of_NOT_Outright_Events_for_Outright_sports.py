...
@pytest.mark.sports
@vtest
class Test_C28740_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28740
    ...
    def test_002_tap_movies_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Movies' icon from the Sports Menu Ribbon
        EXPECTED: **Desktop:**
    ...
    def test_011_tap_in_play_tab_desktopall_in_play_events_for_mobile_view_are_in_top_module_on_landing_page(self):
        """
        DESCRIPTION: Tap **'In-Play' **tab (Desktop)
        DESCRIPTION: All in-play events for Mobile view are in top module on landing page
