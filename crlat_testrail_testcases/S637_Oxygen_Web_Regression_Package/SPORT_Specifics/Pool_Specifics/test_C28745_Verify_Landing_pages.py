...
@pytest.mark.sports
@vtest
class Test_C28745_Verify_Landing_pages(Common):
    """
    TR_ID: C28745
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Pool=28)
    ...
    def test_002_tappool_icon_on_the_sports_menu_ribbon(self):
        """
    ...
    def test_003_verify_section_header_titles(self):
        """
        DESCRIPTION: Verify section header titles
    ...
    def test_010_tap_outrights_tab_desktopnote_for_mobile_view_outrights_events_are_displayed_in_outrights_section_on_landing_page(self):
        """
        DESCRIPTION: Tap 'Outrights' tab (Desktop)
        DESCRIPTION: Note: for Mobile view Outrights events are displayed in Outrights section on landing page.
