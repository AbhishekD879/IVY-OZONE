...
@pytest.mark.sports
@vtest
class Test_C60004619_Verify_MS_on_Matches_Tab_for_Rugby_League_SLP(Common):
    """
    TR_ID: C60004619
    ...
    def test_006_repeat_steps_3_5_for_the_following_markets_handicap_2_way_total_points(self):
        """
