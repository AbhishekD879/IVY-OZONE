...
@pytest.mark.sports
@vtest
class Test_C59953613_Verify_Handicap_WW_MT_in_Competitions_Tab_for_Rugby_Union(Common):
    """
    TR_ID: C59953613
    NAME: Verify ‘Handicap WW’ MT in Competitions Tab for Rugby Union
    ...
    def test_007_verify_ga_tracking_for_the_handicap_2_wayhandicap_2_way_handicap_in_coral_and_handicap_2_way_in_lads(self):
        """
