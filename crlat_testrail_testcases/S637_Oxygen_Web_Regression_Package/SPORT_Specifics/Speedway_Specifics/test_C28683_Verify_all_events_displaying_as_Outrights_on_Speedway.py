...
@pytest.mark.sports
@vtest
class Test_C28683_Verify_all_events_displaying_as_Outrights_on_Speedway(Common):
    """
    TR_ID: C28683
    NAME: Verify all events displaying as Outrights on Speedway
    ...
    def test_001_tapspeedway_icon_on_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Speedway' icon on the Sports Menu Ribbon
        EXPECTED: **Desktop:**
        EXPECTED: * Speedway Landing Page is opened
        ...
        EXPECTED: **Mobile:**
        EXPECTED: * Speedway Landing Page (single view) is opened
