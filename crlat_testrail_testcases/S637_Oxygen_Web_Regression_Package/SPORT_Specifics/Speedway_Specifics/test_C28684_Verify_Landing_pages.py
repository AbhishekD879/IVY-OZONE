...
@pytest.mark.sports
@vtest
class Test_C28684_Verify_Landing_pages(Common):
    """
    TR_ID: C28684
    ...
    PRECONDITIONS: *   XX - sports **Category **ID (Speedway=25)
    ...
    def test_002_tapspeedway_icon_on_the_sports_menu_ribbon(self):
        """
