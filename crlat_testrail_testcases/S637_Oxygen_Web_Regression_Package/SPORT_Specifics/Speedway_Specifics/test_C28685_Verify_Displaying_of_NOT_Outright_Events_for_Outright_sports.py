...
@pytest.mark.sports
@vtest
class Test_C28685_Verify_Displaying_of_NOT_Outright_Events_for_Outright_sports(Common):
    """
    TR_ID: C28685
    ...
    def test_002_tap_formula_1_icon_from_the_sports_menu_ribbon(self):
        """
        DESCRIPTION: Tap 'Formula 1' icon from the Sports Menu Ribbon
