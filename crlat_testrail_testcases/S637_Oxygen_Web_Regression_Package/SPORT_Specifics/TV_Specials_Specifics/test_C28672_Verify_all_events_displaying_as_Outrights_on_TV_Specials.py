...
@pytest.mark.sports
@vtest
class Test_C28672_Verify_all_events_displaying_as_Outrights_on_TV_Specials(Common):
    """
    TR_ID: C28672
    NAME: Verify all events displaying as Outrights on TV Specials
    ...
    def test_001_taptv_specials_icon_on_the_sports_menu_ribbon(self):
        """
