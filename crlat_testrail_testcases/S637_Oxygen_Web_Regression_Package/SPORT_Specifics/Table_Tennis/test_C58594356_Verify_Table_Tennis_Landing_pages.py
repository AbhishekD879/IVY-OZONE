...
@pytest.mark.sports
@vtest
class Test_C58594356_Verify_Table_Tennis_Landing_pages(Common):
    """
    TR_ID: C58594356
    NAME: Verify Table Tennis Landing pages
    DESCRIPTION: This test case verifies Table Tennis Landing pages
    PRECONDITIONS: **Note:**
    ...
    def test_001_navigate_to_table_tennis_landing_page(self):
        """
        DESCRIPTION: Navigate to Table Tennis Landing page
        EXPECTED: **Desktop:**
