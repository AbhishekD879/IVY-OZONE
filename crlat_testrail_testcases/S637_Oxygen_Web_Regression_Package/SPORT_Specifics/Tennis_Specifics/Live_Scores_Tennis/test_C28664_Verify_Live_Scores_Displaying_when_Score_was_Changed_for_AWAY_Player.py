...
@pytest.mark.sports
@vtest
class Test_C28664_Verify_Live_Scores_Displaying_when_Score_was_Changed_for_AWAY_Player(Common):
    """
    TR_ID: C28664
    NAME: Verify Live Scores Displaying when Score was Changed for AWAY Player
    DESCRIPTION: This test case verifies live scores displaying when score was changed for AWAY player.
    ...
    def test_005_trigger_the_following_situationfactis_changed_for_away_player_rolecodeplayer_2_on_higherperiodindexlevelandfactis_changed_for_away_player_on_periodcodegame_level_of_the_highestperiodindex(self):
        """
        ...
        EXPECTED: Score immediately starts displaying new value for Away player on Game Score and highest Set Score
        """
        pass

    def test_006_find_event_from_step_4_on_today_tab_for_desktop_matches_tab_for_mobile_and_repeat_step_5(self):
        """
    ...
    def test_017_verify_gameset_score_change_for_away_team_for_sections_in_a_collapsed_state(self):
        """
        DESCRIPTION: Verify Game/Set Score change for AWAY team for sections in a collapsed state
    ...
    def test_018_verify_gameset_score_change_before_application_is_opened(self):
        ...
        EXPECTED: If application was not started/opened and Score was changed for AWAY player, after opening application and verified event - updated Game/Set Score will be shown there
        """
        pass
    ...
    def test_019_verify_gameset_score_change_when_details_page_of_verified_event_is_opened(self):
        ...
        EXPECTED: After tapping Back button updated Game/Set Score will be shown on Landing page
        """
        pass
