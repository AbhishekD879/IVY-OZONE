...
@pytest.mark.sports
@vtest
class Test_C28660_Verify_Primary_Market_for_Tennis(Common):
    """
    TR_ID: C28660
    NAME: Verify Primary Market for Tennis
    DESCRIPTION: This test case verifies Primary Market for 'Tennis' Sport
    ...
    PRECONDITIONS: * Go to Tennis landing page
    """
