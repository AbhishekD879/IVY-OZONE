...
@pytest.mark.sports
@vtest
class Test_C59551070_Verify_Volleyball_Inplay_event_End_of_the_Set(Common):
    """
    TR_ID: C59551070
    NAME: Verify Volleyball Inplay event: End of the Set
    DESCRIPTION: This test case verifies END of the SET of an inplay event with betradar visualization
    ...
    def test_002_wait_for_the_end_of_set(self):
        """
        DESCRIPTION: Wait for the end of set
    ...
    def test_003_verify_starting_of_next_set(self):
        """
        DESCRIPTION: Verify Starting of Next SET
        EXPECTED: + Next SET name should be displayed in square box with a timer icon on Volleyball widget
