...
@pytest.mark.sports
@vtest
class Test_C59551080_Verify_the_display_of_Betradar_scoreboard_for_In_play_Volleyball_event_when_User_is_logged_into_the_application(Common):
    """
    TR_ID: C59551080
    NAME: Verify the display of Betradar scoreboard for In play Volleyball event when User is logged into the application.
