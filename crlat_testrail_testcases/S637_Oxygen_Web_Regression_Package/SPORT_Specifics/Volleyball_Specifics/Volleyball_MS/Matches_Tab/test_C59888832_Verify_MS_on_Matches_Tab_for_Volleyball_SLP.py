...
@pytest.mark.sports
@vtest
class Test_C59888832_Verify_MS_on_Matches_Tab_for_Volleyball_SLP(Common):
    """
    TR_ID: C59888832
    ...
    def test_006_repeat_steps_3_6_for_the_following_markets_set_handicap_total_points(self):
        """
        DESCRIPTION: Repeat steps 3-6 for the following markets:
    ...
    def test_007_verify_bet_placement_for_single_multiple_and_quick_bet_for_the_below_markets_match_result_set_handicap_total_points(self):
        """
