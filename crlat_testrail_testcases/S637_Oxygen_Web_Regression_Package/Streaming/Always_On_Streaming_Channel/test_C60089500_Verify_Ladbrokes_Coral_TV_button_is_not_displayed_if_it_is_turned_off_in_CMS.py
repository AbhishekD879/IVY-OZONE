...
@vtest
class Test_C60089500_Verify_Ladbrokes_Coral_TV_button_is_not_displayed_if_it_is_turned_off_in_CMS(Common):
    """
    TR_ID: C60089500
    NAME: Verify Ladbrokes/Coral TV button is not displayed if it is turned off in CMS
    DESCRIPTION: This test case verifies that Ladbrokes/Coral TV button can be turned OFF in CMS for Horse Racing and Greyhounds
    ...
    PRECONDITIONS: In CMS: System Configuration > Structure > Racing TV-> Set linkShownForSportIds = false for Greyhounds/Horse Racing, disabling each sport by sport id:
