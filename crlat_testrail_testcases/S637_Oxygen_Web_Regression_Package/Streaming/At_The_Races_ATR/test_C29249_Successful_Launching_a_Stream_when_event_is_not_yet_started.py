...
@vtest
class Test_C29249_Successful_Launching_a_Stream_when_event_is_not_yet_started(Common):
    """
    TR_ID: C29249
    ...
    PRECONDITIONS: 2. User is logged into the Oxygen app and placed a minimum sum of £1 on one or many Selections within tested event
