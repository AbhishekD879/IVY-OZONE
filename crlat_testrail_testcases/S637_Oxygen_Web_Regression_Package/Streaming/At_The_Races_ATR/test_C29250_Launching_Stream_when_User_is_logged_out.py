...
@vtest
class Test_C29250_Launching_Stream_when_User_is_logged_out(Common):
    """
    TR_ID: C29250
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support ATR streaming (**'drilldownTagNames'**='EVFLAG_AVA' flag should be set)
