...
@vtest
class Test_C29251_Launching_Stream_when_Event_is_not_started(Common):
    """
    TR_ID: C29251
    ...
    DESCRIPTION: NOTE: Event countdown is not implemented on Native (https://jira.egalacoral.com/browse/BMA-44813)
    ...
    def test_002_all_devicestapclick_on_watchlive_stream_button(self):
        ...
        EXPECTED: * [ **Coral** desktop,tablet,mobile / **Ladbrokes** desktop]: Message is displayed: "This stream has not yet started. Please try again soon"
