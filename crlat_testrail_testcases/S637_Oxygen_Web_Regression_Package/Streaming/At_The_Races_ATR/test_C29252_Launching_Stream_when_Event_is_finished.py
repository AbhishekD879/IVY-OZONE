...
@vtest
class Test_C29252_Launching_Stream_when_Event_is_finished(Common):
    """
    TR_ID: C29252
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support ATR streaming (**'drilldownTagNames'**='EVFLAG_AVA') and should be mapped to ATR stream event
