...
@vtest
class Test_C58216484_Launching_ATR_Stream_for_inactive_users_on_Horse_Racing_EDP(Common):
    """
    TR_ID: C58216484
    NAME: Launching ATR Stream for inactive users on Horse Racing EDP
    DESCRIPTION: This test case verifies proper front-end handling of a response from opt-in micro service in regard to a specific 'failureCode', triggered by inactive user who tries to view ATR stream on Horse Racing Event Details Page.
