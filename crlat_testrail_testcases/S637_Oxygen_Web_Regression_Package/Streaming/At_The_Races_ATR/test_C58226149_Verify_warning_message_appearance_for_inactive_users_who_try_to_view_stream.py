...
@vtest
class Test_C58226149_Verify_warning_message_appearance_for_inactive_users_who_try_to_view_stream(Common):
    """
    TR_ID: C58226149
    NAME: Verify warning message appearance for inactive users who try to view stream
    DESCRIPTION: This test case verifies warning message appearance, triggered by inactive user who tries to view ATR stream on Horse Racing Event Details Page.
    ...
    PRECONDITIONS: 4. It should be 5 or more minutes left before event Start Time
