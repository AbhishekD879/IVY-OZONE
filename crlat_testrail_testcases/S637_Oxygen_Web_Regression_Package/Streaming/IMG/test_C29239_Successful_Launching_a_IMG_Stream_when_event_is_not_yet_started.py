...
@vtest
class Test_C29239_Successful_Launching_a_IMG_Stream_when_event_is_not_yet_started(Common):
    """
    TR_ID: C29239
    NAME: Successful Launching a IMG Stream when event is not yet started
    ...
    PRECONDITIONS: 2. Event should have following attributes: isMarketBetInRun = "true"
    PRECONDITIONS: 3. It should be less than 2 minutes left before event Start Time, event should not be started
    PRECONDITIONS: 4. User is logged into the Oxygen app and has a positive balance.
