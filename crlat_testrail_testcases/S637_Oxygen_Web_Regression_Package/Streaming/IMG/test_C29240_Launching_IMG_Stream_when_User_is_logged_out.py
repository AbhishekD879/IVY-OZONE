...
@vtest
class Test_C29240_Launching_IMG_Stream_when_User_is_logged_out(Common):
    """
    TR_ID: C29240
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support IMG streaming (**'typeFlagCodes'**='IVA , ... ' AND **'drilldownTagNames'**='EVFLAG_IVM' flags should be set)
