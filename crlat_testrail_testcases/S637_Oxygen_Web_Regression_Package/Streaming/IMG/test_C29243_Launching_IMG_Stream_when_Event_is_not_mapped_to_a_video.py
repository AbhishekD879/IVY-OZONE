...
@vtest
class Test_C29243_Launching_IMG_Stream_when_Event_is_not_mapped_to_a_video(Common):
    """
    TR_ID: C29243
    ...
    PRECONDITIONS: 1. Attribute **'drilldownTagNames'**='EVFLAG_IVM' should be set for event, however NO real stream should be mapped through BACKOFFICE -> ADMIN
