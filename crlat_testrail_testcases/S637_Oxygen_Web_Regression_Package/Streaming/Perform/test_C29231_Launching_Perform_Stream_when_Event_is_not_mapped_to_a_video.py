...
@vtest
class Test_C29231_Launching_Perform_Stream_when_Event_is_not_mapped_to_a_video(Common):
    """
    TR_ID: C29231
    NAME: Launching Perform Stream when Event is not mapped to a video
    ...
    PRECONDITIONS: 1. Attribute **'drilldownTagNames'**='EVFLAG_PVM' should be set for event, however NO real stream should be mapped through BACKOFFICE -> ADMIN
    PRECONDITIONS: 2. Event should be started.
