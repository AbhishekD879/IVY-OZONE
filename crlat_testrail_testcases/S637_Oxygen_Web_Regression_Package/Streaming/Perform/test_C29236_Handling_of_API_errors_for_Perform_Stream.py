...
@vtest
class Test_C29236_Handling_of_API_errors_for_Perform_Stream(Common):
    """
    TR_ID: C29236
    NAME: Handling of API errors for Perform Stream
    ...
    PRECONDITIONS: 5. API should return an error(case of a broken/missing token)
    ...
    def test_002_use_the_delete_authinvalidatesession_command_through_postmanie_httpsbpp_tst0coralsportsnonprodcloudladbrokescoralcomproxyauthinvalidatesessionheaders_2token_6994aa6ae06d0926601282a284449d4939a7c1bf5010c349ca92a67d363c56d0username_james_pond(self):
        ...
        EXPECTED: Use the DELETE '/auth/invalidateSession' command through POSTMAN:
        EXPECTED: (i.e. https://bpp-tst0.coralsports.nonprod.cloud.ladbrokescoral.com/Proxy/auth/invalidateSession
        EXPECTED: Headers (2)
        EXPECTED: token: 6994aa6ae06d0926601282a284449d4939a7c1bf5010c349ca92a67d363c56d0
        EXPECTED: username: james_pond)
        """
        pass
