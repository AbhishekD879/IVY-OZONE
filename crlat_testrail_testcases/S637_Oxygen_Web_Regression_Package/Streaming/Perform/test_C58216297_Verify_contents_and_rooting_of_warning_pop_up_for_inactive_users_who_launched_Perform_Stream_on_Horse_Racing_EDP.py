...
@vtest
class Test_C58216297_Verify_contents_and_rooting_of_warning_pop_up_for_inactive_users_who_launched_Perform_Stream_on_Horse_Racing_EDP(Common):
    """
    TR_ID: C58216297
    NAME: Verify contents and rooting of warning pop-up for inactive users who launched Perform Stream on Horse Racing EDP
    DESCRIPTION: This test case verifies contents and button functions of the warning pop-up shown to inactive user who tries to view Perform stream on Horse Racing Event Details Page.
    ...
    PRECONDITIONS: 5. It should be 2 minutes or less left before event Start Time
