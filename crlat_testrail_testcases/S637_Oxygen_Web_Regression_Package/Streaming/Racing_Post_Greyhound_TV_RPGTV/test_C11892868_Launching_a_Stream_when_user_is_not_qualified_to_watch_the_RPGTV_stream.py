...
@vtest
class Test_C11892868_Launching_a_Stream_when_user_is_not_qualified_to_watch_the_RPGTV_stream(Common):
    """
    TR_ID: C11892868
    NAME: Launching a Stream when user is not qualified to watch the RPGTV stream
    ...
    PRECONDITIONS: 2. SiteServer event should be configured to support RPGTV/Perform streaming (**'drilldownTagNames'**='EVFLAG_RPM' flag should be set) and should be mapped to RPGTV/Perform stream event
