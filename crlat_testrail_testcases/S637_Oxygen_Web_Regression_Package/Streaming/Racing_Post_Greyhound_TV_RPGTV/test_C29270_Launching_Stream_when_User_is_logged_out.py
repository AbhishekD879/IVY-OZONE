...
@vtest
class Test_C29270_Launching_Stream_when_User_is_logged_out(Common):
    """
    TR_ID: C29270
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support RPGTV/Perform streaming (**'typeFlagCodes'**='RPG, ... ' AND **'drilldownTagNames'**='EVFLAG_RPM' flags should be set)
