...
@vtest
class Test_C29272_Launching_Stream_when_Event_is_finished(Common):
    """
    TR_ID: C29272
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support RPGTV/Perform streaming (**'typeFlagCodes'**='RPG) and should be mapped to RPGTV/Perform stream event
