...
@vtest
class Test_C29273_Launching_Stream_when_Event_is_not_mapped_to_a_video(Common):
    """
    TR_ID: C29273
    ...
    PRECONDITIONS: 1. Attribute **'drilldownTagNames'**='EVFLAG_RPM' should be set for event, however NO real stream should be mapped through BACKOFFICE -> ADMIN
