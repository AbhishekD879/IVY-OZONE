...
@vtest
class Test_C29275_API_error(Common):
    """
    TR_ID: C29275
    NAME: API error
    ...
    PRECONDITIONS: 1. SiteServer event should be configured to support RPGTV/Perform streaming (**'drilldownTagNames'**='EVFLAG_RPM' flag should be set) and should be mapped to RPGTV/Perform stream event
