...
@vtest
class Test_C29259_Successful_Launching_a_RUK_Perform_Stream_when_event_is_started(Common):
    """
    TR_ID: C29259
    NAME: Successful Launching a RUK/Perform Stream when event is started
