...
@vtest
class Test_C29260_Successful_Launching_a_Stream_when_event_is_not_yet_started(Common):
    """
    TR_ID: C29260
    NAME: Successful Launching a Stream when event is not yet started
    ...
    PRECONDITIONS: 2. It should be less than 2 minutes left before event Start Time, event should not be started
    PRECONDITIONS: 3. User is logged into the Oxygen app and placed a minimum sum of £1 on one or many Selections within tested event
