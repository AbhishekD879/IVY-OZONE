...
@vtest
class Test_C29264_Launching_Stream_when_Event_is_not_mapped_to_a_video(Common):
    """
    TR_ID: C29264
    ...
    PRECONDITIONS: 1. Attribute **'drilldownTagNames'**='EVFLAG_RVA' should be set for event, however NO real stream should be mapped through BACKOFFICE -> ADMIN
