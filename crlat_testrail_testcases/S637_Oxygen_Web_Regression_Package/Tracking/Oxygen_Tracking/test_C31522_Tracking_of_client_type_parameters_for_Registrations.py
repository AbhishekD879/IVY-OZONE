...
@pytest.mark.other
@vtest
class Test_C31522_Tracking_of_client_type_parameters_for_Registrations(Common):
    """
    TR_ID: C31522
    NAME: Tracking of client type parameters for Registrations
    DESCRIPTION: This test case verifies tracking of new parameters for Registrations.
    DESCRIPTION: Jira tickets:
    DESCRIPTION: BMA-14429 BI Reporting - New parameters for Registrations
    ...
    def test_002_tap_join_button(self):
        ...
        EXPECTED: 'Join Us - Step 1 of 3' is shown
        """
        pass

    def test_003_fill_in_all_required_fields_with_valid_data_in_the_step_1_3_and_tap_complete_registration_button(self):
        """
        DESCRIPTION: Fill in all required fields with valid data in the 'Step 1-3' and tap 'Complete Registration' button
        EXPECTED: User is successful registered
        """
        pass
    ...
    def test_006_search_for_request_with_id31007(self):
        """
    ...
    def test_010_scroll_to_general_player_information(self):
        """
    ...
    def test_011_verify_data_correctness_in_ims_sign_up_client_type_sign_up_platform_sign_up_device_delivery_platform_sign_up_operating_system_name(self):
        """
        DESCRIPTION: Verify data correctness in IMS:
        DESCRIPTION: -Sign up client type
        DESCRIPTION: -Sign up platform
        DESCRIPTION: -Sign up device delivery platform
        DESCRIPTION: -Sign up operating system name
        EXPECTED: - **Sign up client type** is 'Sportsbook'
        EXPECTED: - **Sign up platform** is 'Mobile'
        EXPECTED: - **Sign up device delivery platform**
        EXPECTED: *   **HTML5** (in case of HTML)
        EXPECTED: *   **Wrapper** (in case of Wrapper app)
        EXPECTED: - **Sign up operating system name**
    ...
    def test_012_logged_out_from_oxygen_application(self):
        """
    ...
    def test_013_navigate_to_the_gaming_page(self):
        """
    ...
    def test_014_tap_join_button(self):
        """
        DESCRIPTION: Tap 'Join' button
        EXPECTED: 'Join Us - Step 1 of 3' is shown
        """
    ...
    def test_015_fill_in_all_required_fields_with_valid_data_in_the_step_1_3_and_tap_complete_registration_button(self):
        """
        DESCRIPTION: Fill in all required fields with valid data in the 'Step 1-3' and tap 'Complete Registration' button
        EXPECTED: User is successful registered
        """
    ...
    def test_016_repeat_steps_8_10(self):
        """
    ...
    def test_017_verify_sign_up_client_type_parameter_in_ims(self):
        """
        DESCRIPTION: Verify 'Sign up client type' parameter in IMS
        EXPECTED: 'Sign up client type' parameter is Casino
        """
        pass
