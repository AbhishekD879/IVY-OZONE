...
@pytest.mark.other
@vtest
class Test_C2024019_Tracking_of_League_Table_widget_collapsing_on_the_Football_Competitions_page(Common):
    """
    TR_ID: C2024019
    NAME: Tracking of 'League Table' widget collapsing on the Football Competitions page
    DESCRIPTION: This test case verifies tracking in the Google Analytic's data Layer when collapsing the 'League Table' widget on the Football Competitions page.
    ...
    def test_003_click_on_league_table_widgets_header_to_collapse_it(self):
        """
        DESCRIPTION: Click on 'League Table' widget's Header to collapse it
    ...
    def test_005_click_on_league_table_widgets_header_to_expand_it(self):
        """
        DESCRIPTION: Click on 'League Table' widget's Header to expand it
    ...
    def test_006_type_in_browser_console_datalayer_and_tap_enter(self):
        ...
        EXPECTED: * There are no data related to 'League Table' widget in 'dataLayer' after expanding of it
        """
        pass
    ...
    def test_007_repeat_steps_3_4_one_more_time(self):
        ...
        EXPECTED: * There are no data related to 'League Table' widget in 'dataLayer' after the second/third/etc. click on 'Show More' button
        """
        pass
