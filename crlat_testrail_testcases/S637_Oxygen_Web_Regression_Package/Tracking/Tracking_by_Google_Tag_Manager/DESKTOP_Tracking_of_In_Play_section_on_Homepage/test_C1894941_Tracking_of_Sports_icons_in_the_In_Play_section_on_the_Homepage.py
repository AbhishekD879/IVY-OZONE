...
@pytest.mark.other
@vtest
class Test_C1894941_Tracking_of_Sports_icons_in_the_In_Play_section_on_the_Homepage(Common):
    """
    TR_ID: C1894941
    NAME: Tracking of 'Sports' icons in the 'In-Play' section on the Homepage
    DESCRIPTION: This test case verifies tracking in the Google Analytic's data Layer when clicking on 'Sports' icons in the 'In-Play' section on the Homepage.
    ...
    def test_002_scroll_the_page_down_to_in_play__live_stream_section_and_select_in_play_switcher(self):
        ...
        EXPECTED: The 'Sports' icons are visible on the 'Sports Ribbon' menu at the 'In-Play' section
        """
        pass
    ...
    def test_003_click_on_some_sports_icon(self):
        ...
        EXPECTED: * The list of live events of that particular sport is displayed
        """
        pass
