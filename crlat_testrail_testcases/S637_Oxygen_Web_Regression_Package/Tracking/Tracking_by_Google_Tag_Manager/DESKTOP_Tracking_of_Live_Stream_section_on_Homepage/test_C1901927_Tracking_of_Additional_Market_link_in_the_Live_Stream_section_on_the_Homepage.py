...
@pytest.mark.other
@vtest
class Test_C1901927_Tracking_of_Additional_Market_link_in_the_Live_Stream_section_on_the_Homepage(Common):
    """
    TR_ID: C1901927
    NAME: Tracking of 'Additional Market' link in the 'Live Stream' section on the Homepage
    DESCRIPTION: This test case verifies tracking in the Google Analytic's data Layer when clicking on 'Additional Market' link in the 'Live Stream' section on the Homepage.
    ...
    def test_002_scroll_the_page_down_to_in_play__live_stream_section_and_select_live_stream_switcher(self):
        ...
        EXPECTED: * The 'Additional Market' links are visible on the event cards at 'Live Stream' section
        """
        pass
