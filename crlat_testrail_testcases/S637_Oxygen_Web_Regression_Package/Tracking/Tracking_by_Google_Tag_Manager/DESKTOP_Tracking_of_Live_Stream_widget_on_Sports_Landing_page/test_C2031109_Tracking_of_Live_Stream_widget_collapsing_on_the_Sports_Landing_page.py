...
@pytest.mark.other
@vtest
class Test_C2031109_Tracking_of_Live_Stream_widget_collapsing_on_the_Sports_Landing_page(Common):
    """
    TR_ID: C2031109
    NAME: Tracking of 'Live Stream' widget collapsing on the Sports Landing page
    DESCRIPTION: This test case verifies tracking in the Google Analytic's data Layer when collapsing the 'Live Stream' widget on Sports Landing page.
    ...
    def test_003_click_on_live_stream_widgets_header_to_collapse_it(self):
        """
        DESCRIPTION: Click on 'Live Stream' widget's Header to collapse it
    ...
    def test_005_click_on_live_stream_widgets_header_to_expand_it(self):
        """
        DESCRIPTION: Click on 'Live Stream' widget's Header to expand it
    ...
    def test_006_type_in_browser_console_datalayer_and_tap_enter(self):
        ...
        EXPECTED: * There are no data related to 'Live Stream' widget in 'dataLayer' after expanding of it
        """
        pass
    ...
    def test_007_repeat_steps_3_4_one_more_time(self):
        ...
        EXPECTED: * There are no data related to 'Live Stream' widget in 'dataLayer' after the second/third/etc. click on widget's header for collapsing it
        """
        pass
    ...
    def test_009_repeat_steps_2_8_but_for_logged_in_user(self):
        """
        DESCRIPTION: Repeat steps 2-8 but for Logged In user
        EXPECTED: 
        """
        pass
