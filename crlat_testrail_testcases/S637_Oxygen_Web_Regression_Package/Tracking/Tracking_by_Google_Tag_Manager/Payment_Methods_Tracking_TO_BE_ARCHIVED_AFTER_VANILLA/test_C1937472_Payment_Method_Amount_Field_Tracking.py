...
@pytest.mark.other
@vtest
class Test_C1937472_Payment_Method_Amount_Field_Tracking(Common):
    """
    TR_ID: C1937472
    NAME: Payment Method Amount Field Tracking
    DESCRIPTION: This test case verifies tracking of Payment Method Field in GA
    DESCRIPTION: AUTOTEST for Skrill: [C2089467]
    ...
    def test_003_tap_add_paysafecard_tab_or_select_paysafecard_from_dropdown_on_my_payments_tab_if_successful_transaction_was_conducted_via_paysafecard_before(self):
        """
        DESCRIPTION: Tap **Add Paysafecard** tab or select Paysafecard from dropdown on **My Payments** tab (if successful transaction was conducted via Paysafecard before)
        EXPECTED: 
        """
        pass

    def test_004_enter_valid_amount_manually(self):
        """
