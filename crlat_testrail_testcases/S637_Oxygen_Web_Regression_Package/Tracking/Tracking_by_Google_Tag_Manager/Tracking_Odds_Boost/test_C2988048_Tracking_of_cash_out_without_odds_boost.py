...
@pytest.mark.other
@vtest
class Test_C2988048_Tracking_of_cash_out_without_odds_boost(Common):
    """
    TR_ID: C2988048
    NAME: Tracking of cash out without odds boost
    ...
    PRECONDITIONS: Place SINGLE and DOUBLE bet without odds boost (where cash out available)
    PRECONDITIONS: To view response open Dev tools -> Network -> WS -> choose the last request
    """
    keep_browser_open = True

    def test_001_navigate_to_by_betscash_outverify_that_placed_single_bet_in_preconditions_is_shown_without_odds_bost_title(self):
        """
        DESCRIPTION: Navigate to By Bets>Cash Out
        DESCRIPTION: Verify that placed SINGLE bet in preconditions is shown without odds bost title
        EXPECTED: - Odds Boost title is NOT shown for SINGLE bet
        EXPECTED: - SINGLE Bet is shown with 'Cash Out' and 'Partial Cash Out' buttons
        """
        pass

    def test_002_tap_partial_cash_outcash_out_buttontap_partial_confirm_cash_outverify_that_successful_cash_out_button_is_shown(self):
        """
    ...
    def test_004_navigate_to_by_betscash_out_one_more_timeverify_that_placed_single_bet_in_preconditions_is_shown_without_odds_boost_title(self):
        """
        DESCRIPTION: Navigate to By Bets>Cash Out one more time
        DESCRIPTION: Verify that placed SINGLE bet in preconditions is shown without odds boost title
        EXPECTED: - Odds Boost title is NOT shown for SINGLE bet
        EXPECTED: - SINGLE Bet is shown with 'Cash Out' and 'Partial Cash Out' buttons
        """
        pass
