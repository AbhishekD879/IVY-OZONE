...
@pytest.mark.betslip
@vtest
class Test_C10644013_Surface_Bet_tracking_of_adding_selection_from_Surface_bet_on_home_page(Common):
    """
    TR_ID: C10644013
    NAME: Surface Bet: tracking of adding selection from Surface bet on home page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Surface bet on home page to Betslip
    ...
    PRECONDITIONS: - You should have 2 Surface bets on home page
