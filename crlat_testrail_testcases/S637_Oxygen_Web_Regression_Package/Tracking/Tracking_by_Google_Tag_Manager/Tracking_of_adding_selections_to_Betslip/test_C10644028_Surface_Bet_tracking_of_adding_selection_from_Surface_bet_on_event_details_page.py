...
@pytest.mark.betslip
@vtest
class Test_C10644028_Surface_Bet_tracking_of_adding_selection_from_Surface_bet_on_event_details_page(Common):
    """
    TR_ID: C10644028
    NAME: Surface Bet: tracking of adding selection from Surface bet on event details page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Surface bet on event details page to Betslip
    ...
    PRECONDITIONS: - You should have 2 Surface bets on event details page
    PRECONDITIONS: - You should be on event details page in application
    """
    keep_browser_open = True

    def test_001_mobile__tap_odds_button_on_surface_bet__tap_add_to_betslip_button__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        """
        DESCRIPTION: **Mobile**
        DESCRIPTION: - Tap ODDS button on Surface Bet > tap 'ADD TO BETSLIP' button
