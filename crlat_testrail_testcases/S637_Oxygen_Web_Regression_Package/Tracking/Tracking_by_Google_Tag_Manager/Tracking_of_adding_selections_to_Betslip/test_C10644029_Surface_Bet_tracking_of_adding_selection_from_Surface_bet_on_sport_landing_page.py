...
@pytest.mark.betslip
@vtest
class Test_C10644029_Surface_Bet_tracking_of_adding_selection_from_Surface_bet_on_sport_landing_page(Common):
    """
    TR_ID: C10644029
    NAME: Surface Bet: tracking of adding selection from Surface bet on <sport> landing page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Surface bet on <sport> landing page to Betslip
    ...
    PRECONDITIONS: - You should have 2 Surface bet on <sport> landing page
