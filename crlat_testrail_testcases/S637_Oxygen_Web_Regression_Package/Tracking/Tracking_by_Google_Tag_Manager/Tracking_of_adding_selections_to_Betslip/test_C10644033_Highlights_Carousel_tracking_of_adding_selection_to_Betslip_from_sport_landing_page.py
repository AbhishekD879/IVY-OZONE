...
@pytest.mark.betslip
@vtest
class Test_C10644033_Highlights_Carousel_tracking_of_adding_selection_to_Betslip_from_sport_landing_page(Common):
    """
    TR_ID: C10644033
    NAME: Highlights Carousel: tracking of adding selection to Betslip from <sport> landing page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Highlights Carousel on <sport> landing page to Betslip
