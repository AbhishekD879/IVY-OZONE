...
@pytest.mark.betslip
@vtest
class Test_C10669033_Next_Race_tracking_of_adding_selection_to_Betslip_from_Next_Race_tab_on_home_page(Common):
    """
    TR_ID: C10669033
    NAME: Next Race: tracking of adding selection to Betslip from Next Race tab on home page
    DESCRIPTION: This test case verifies GA tracking of adding selection from 'Next Races' tab on home page to Betslip
    ...
    PRECONDITIONS: - You should have at least 2 events in 'Next Races' tab on home page
