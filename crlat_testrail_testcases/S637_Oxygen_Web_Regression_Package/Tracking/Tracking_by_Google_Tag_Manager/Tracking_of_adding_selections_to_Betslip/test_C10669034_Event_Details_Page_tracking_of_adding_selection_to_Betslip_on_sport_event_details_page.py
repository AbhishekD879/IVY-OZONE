...
@pytest.mark.betslip
@vtest
class Test_C10669034_Event_Details_Page_tracking_of_adding_selection_to_Betslip_on_sport_event_details_page(Common):
    """
    TR_ID: C10669034
    ...
    PRECONDITIONS: - You should be on <sport> event details page in application
    """
