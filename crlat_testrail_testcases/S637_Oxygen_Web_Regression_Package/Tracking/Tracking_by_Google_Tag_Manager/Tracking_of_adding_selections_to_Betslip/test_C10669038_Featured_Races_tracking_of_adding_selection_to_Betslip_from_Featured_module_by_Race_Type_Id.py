...
@pytest.mark.betslip
@vtest
class Test_C10669038_Featured_Races_tracking_of_adding_selection_to_Betslip_from_Featured_module_by_Race_Type_Id(Common):
    """
    TR_ID: C10669038
    ...
    PRECONDITIONS: - You should have a Featured module by Race Type Id
    PRECONDITIONS: - You should be on Home page > Featured tab in application
    PRECONDITIONS: Note: This test case should also check Virtual Horses/Greyhounds within Featured module.
    """
    ...
    def test_003_mobile_tablet_and_desktop__login_and_go_to_right_menu__settings__disabled_allow_quick_bet_or_go_to_cms__system_configuration__structure__quickbet_disable_quick_bet_functionality__remove_all_selections_from_betslip__tap_odds_button_within_featured_module_by_race_type_id__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        """
