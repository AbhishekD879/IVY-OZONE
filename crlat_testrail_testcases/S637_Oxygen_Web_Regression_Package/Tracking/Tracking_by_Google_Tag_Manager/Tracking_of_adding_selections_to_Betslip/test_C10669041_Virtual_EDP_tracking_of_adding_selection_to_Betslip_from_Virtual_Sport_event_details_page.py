...
@pytest.mark.betslip
@vtest
class Test_C10669041_Virtual_EDP_tracking_of_adding_selection_to_Betslip_from_Virtual_Sport_event_details_page(Common):
    """
    TR_ID: C10669041
    NAME: Virtual EDP: tracking of adding selection to Betslip from Virtual Sport event details page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Virtual Sport event details page to Betslip
    ...
    PRECONDITIONS: - You should be on Virtual Sport event details page in application
    """
