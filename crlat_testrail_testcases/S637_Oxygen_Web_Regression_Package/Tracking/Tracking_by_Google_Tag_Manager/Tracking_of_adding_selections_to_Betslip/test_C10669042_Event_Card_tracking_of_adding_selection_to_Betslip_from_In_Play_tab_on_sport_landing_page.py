...
@pytest.mark.betslip
@vtest
class Test_C10669042_Event_Card_tracking_of_adding_selection_to_Betslip_from_In_Play_tab_on_sport_landing_page(Common):
    """
    TR_ID: C10669042
    NAME: Event Card: tracking of adding selection to Betslip from In-Play tab on <sport> landing page
    DESCRIPTION: This test case verifies GA tracking of adding selection from event card on <sport> landing page > In-Play tab to Betslip
    ...
    PRECONDITIONS: - You should have at least 2 event cards in In-Play tab on <sport> landing page (events should have attribute drilldownTagNames="EVFLAG_BL")
