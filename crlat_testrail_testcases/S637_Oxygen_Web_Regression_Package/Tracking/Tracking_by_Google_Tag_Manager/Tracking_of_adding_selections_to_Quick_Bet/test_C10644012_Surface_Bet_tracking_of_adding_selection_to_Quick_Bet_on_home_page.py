...
@vtest
class Test_C10644012_Surface_Bet_tracking_of_adding_selection_to_Quick_Bet_on_home_page(Common):
    """
    TR_ID: C10644012
    NAME: Surface Bet: tracking of adding selection to Quick Bet on home page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Surface bet on home page
    ...
    PRECONDITIONS: - You should have a Surface bet on home page
    PRECONDITIONS: - You should be on Home page > Featured tab in application
    """
    keep_browser_open = True

    def test_001___tap_odds_button_on_surface_bet__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        """
