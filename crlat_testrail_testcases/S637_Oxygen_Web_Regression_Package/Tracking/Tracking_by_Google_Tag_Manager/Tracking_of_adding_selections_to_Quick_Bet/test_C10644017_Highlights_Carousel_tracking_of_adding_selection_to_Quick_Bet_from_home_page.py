...
@vtest
class Test_C10644017_Highlights_Carousel_tracking_of_adding_selection_to_Quick_Bet_from_home_page(Common):
    """
    TR_ID: C10644017
    NAME: Highlights Carousel: tracking of adding selection to Quick Bet from home page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Highlights Carousel on home page to Quick bet
