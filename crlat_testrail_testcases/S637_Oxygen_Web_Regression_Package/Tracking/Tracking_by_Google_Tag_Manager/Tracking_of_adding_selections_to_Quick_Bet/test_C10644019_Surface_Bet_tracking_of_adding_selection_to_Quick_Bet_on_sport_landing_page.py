...
@vtest
class Test_C10644019_Surface_Bet_tracking_of_adding_selection_to_Quick_Bet_on_sport_landing_page(Common):
    """
    TR_ID: C10644019
    NAME: Surface Bet: tracking of adding selection to Quick Bet on <sport> landing page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Surface bet on <sport> landing page
    ...
    PRECONDITIONS: - You should have a Surface bet on <sport> landing page
    PRECONDITIONS: - You should be on <sport> landing page in application
    """
    keep_browser_open = True

    def test_001___go_to_sport_landing_page_and_tap_odds_button_on_surface_bet__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        """
        DESCRIPTION: - Go to <Sport> landing page and tap ODDS button on Surface Bet
