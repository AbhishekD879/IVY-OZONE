...
@vtest
class Test_C10644024_Featured_Bet_tracking_of_adding_selection_to_Quick_Bet_from_Featured_module_by_Type_Id(Common):
    """
    TR_ID: C10644024
    NAME: Featured Bet: tracking of adding selection to Quick Bet from Featured module by Type Id
    DESCRIPTION: This test case verifies GA tracking of adding selection from Featured module by TypeID on home page to Quick bet
    ...
    PRECONDITIONS: - You should have a Featured module created by TypeID
    PRECONDITIONS: - You should be on Home page > Featured tab in application
    """
    keep_browser_open = True

    def test_001___tap_odds_button_in_featured_module_by_typeid__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        """
        DESCRIPTION: - Tap ODDS button in Featured module by TypeID
