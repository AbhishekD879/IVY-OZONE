...
@vtest
class Test_C10644026_Virtual_EDP_tracking_of_adding_selection_to_Quick_Bet_from_Virtual_Sport_event_details_page(Common):
    """
    TR_ID: C10644026
    NAME: Virtual EDP: tracking of adding selection to Quick Bet from Virtual Sport event details page
    DESCRIPTION: This test case verifies GA tracking of adding selection from Virtual Sport event details page to Quick bet
    ...
    PRECONDITIONS: - You should have some virtual sports
    PRECONDITIONS: - You should be on Virtual sports landing page in application
    """
    ...
    def test_001___tap_odds_button_on_any_selection__type_datalayer_in_browsers_console_and_verify_ga_tracking_record(self):
        ...
        EXPECTED: dimension65: "virtual edp"
