...
@vtest
class Test_C10644030_Race_Card_tracking_of_adding_selection_to_Quick_Bet_on_race_details_page(Common):
    """
    TR_ID: C10644030
    NAME: Race Card: tracking of adding selection to Quick Bet on race details page
    DESCRIPTION: This test case verifies GA tracking of adding selection from <Race> event details page to Quick bet
    ...
    PRECONDITIONS: - You should be on <Race> landing page > event details page in application
    """
