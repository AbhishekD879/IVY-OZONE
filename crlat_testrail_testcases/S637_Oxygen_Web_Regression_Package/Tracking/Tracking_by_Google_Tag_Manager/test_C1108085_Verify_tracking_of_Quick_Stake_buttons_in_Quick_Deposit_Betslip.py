...
@pytest.mark.other
@vtest
class Test_C1108085_Verify_tracking_of_Quick_Stake_buttons_in_Quick_Deposit_Betslip(Common):
    """
    TR_ID: C1108085
    NAME: Verify tracking of Quick Stake buttons in Quick Deposit (Betslip)
    DESCRIPTION: is test case verifies Quick Stake buttons tracking in Betslip for 'Amount' field ('Quick Deposit' section)
    ...
    def test_005_tap_on_quick_deposit_link_in_the_betslip_header(self):
        """
    ...
    def test_006_tap_on_amount_field(self):
        """
    ...
    def test_007_tap_on_any_quick_stake_button_eg_pluscurrency_symbol5_10_50_100pluskr50_100_500_1000(self):
        """
        DESCRIPTION: Tap on any 'Quick Stake' button (e.g. +<currency symbol>5, 10, 50, 100/+kr50, 100, 500, 1000)
        EXPECTED: Quick Stake amount is shown in 'Amount' field
        """
        pass

    def test_008_type_datalayer_in_browser_console__press_enter(self):
        """
