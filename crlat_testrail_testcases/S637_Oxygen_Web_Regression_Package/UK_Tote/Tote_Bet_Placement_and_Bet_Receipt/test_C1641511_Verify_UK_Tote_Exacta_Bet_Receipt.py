...
@pytest.mark.races
@vtest
class Test_C1641511_Verify_UK_Tote_Exacta_Bet_Receipt(Common):
    """
    TR_ID: C1641511
    ...
    def test_001_verify_exacta_tote_bet_receipt_header(self):
        """
        DESCRIPTION: Verify Exacta Tote Bet Receipt header
    ...
    def test_002_verify_exacta_tote_bet_receipt_subheader(self):
        """
        DESCRIPTION: Verify Exacta Tote Bet Receipt subheader
    ...
    def test_003_verify_exacta_tote_bet_receipt_card_for_1_exacta_bet_in_the_betslip(self):
        """
        DESCRIPTION: Verify Exacta Tote bet receipt card for **1 Exacta Bet** in the betslip
        ...
        EXPECTED: 5. Kingston
        EXPECTED: Exacta Totepool / 11:45 Chantilly (FR)
    ...
    def test_004__place_a_combination_exacta_tote_bet_verify_exacta_tote_bet_receipt_card_for_combination_exacta_in_the_betslip(self):
        """
        DESCRIPTION: * Place a **Combination Exacta** tote bet
        DESCRIPTION: * Verify Exacta Tote bet receipt card for **Combination Exacta** in the betslip
    ...
    def test_010_place_a_exacta_bet_again(self):
        """
