...
@pytest.mark.races
@vtest
class Test_C1743726_Verify_UK_Tote_Placepot_Bet_Receipt(Common):
    """
    TR_ID: C1743726
    ...
    def test_001_verify_placepot_tote_bet_receipt_header(self):
        """
        DESCRIPTION: Verify Placepot Tote Bet Receipt header
    ...
    def test_002_verify_placepot_tote_bet_receipt_subheader(self):
        """
        DESCRIPTION: Verify Placepot Tote Bet Receipt subheader
    ...
    def test_003_verify_placepot_tote_bet_receipt_in_the_betslip(self):
        """
        ...
        EXPECTED: Placepot Totepool / 1 Line at £2 per line
        EXPECTED: Stake: £2
    ...
    def test_007_place_a_placepot_bet_again(self):
        """
