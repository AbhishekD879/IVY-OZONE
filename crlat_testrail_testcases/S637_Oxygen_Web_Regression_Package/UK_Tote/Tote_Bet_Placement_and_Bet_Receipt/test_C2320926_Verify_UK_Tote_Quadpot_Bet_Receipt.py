...
@pytest.mark.races
@vtest
class Test_C2320926_Verify_UK_Tote_Quadpot_Bet_Receipt(Common):
    """
    TR_ID: C2320926
    NAME: Verify UK Tote Quadpot Bet Receipt
    DESCRIPTION: This test case verifies Quadpot Bet Receipt, which appears in betslip after the user has placed an Quadpot Tote bet
    ...
    def test_001_verify_quadpot_bet_receipt_header(self):
        """
        DESCRIPTION: Verify Quadpot Bet Receipt header
    ...
    def test_002_verify_quadpot_bet_receipt_subheader(self):
        """
        DESCRIPTION: Verify Quadpot Bet Receipt subheader
    ...
    def test_003_verify_quadpot_tote_bet_receipt_in_the_betslipindexphpattachmentsget31322(self):
        """
        DESCRIPTION: Verify Quadpot Tote bet receipt in the betslip
        DESCRIPTION: ![](index.php?/attachments/get/31322)
        ...
        EXPECTED: Quadpot Totepool / 1 Line at £2 per line
        EXPECTED: Stake: £2
    ...
    def test_005_verify_est_returnspotential_returns(self):
        """
    ...
    def test_007_place_a_quadpot_bet_again(self):
        """
