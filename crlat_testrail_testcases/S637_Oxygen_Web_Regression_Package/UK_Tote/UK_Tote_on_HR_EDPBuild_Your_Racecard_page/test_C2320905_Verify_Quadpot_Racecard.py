...
@pytest.mark.races
@vtest
class Test_C2320905_Verify_Quadpot_Racecard(Common):
    """
    TR_ID: C2320905
    NAME: Verify Quadpot Racecard
    DESCRIPTION: This test case verifies the content of the UK Tote Quadpot racecard
    ...
    def test_001_tap_on_quadpot_subtab(self):
        """
        DESCRIPTION: Tap on Quadpot subtab
        EXPECTED: * Quadpot subtab content is loaded
        EXPECTED: * First leg should be loaded by default
        """
        pass

    def test_002_verify_quadpot_racecard_for_an_active_event(self):
        """
        DESCRIPTION: Verify Quadpot racecard for an active event
        EXPECTED: Quadpot racecard consists of:
    ...
    def test_003_tap_on_each_leg_header_button(self):
        ...
        EXPECTED: * Content of racecard is the same as in step 3
        """
        pass
    ...
    def test_005_verify_quadpot_racecard_with_a_suspended_selection(self):
        """
        DESCRIPTION: Verify Quadpot racecard with a suspended selection
