...
@pytest.mark.races
@vtest
class Test_C2320906_Verify_Jackpot_Racecard(Common):
    """
    TR_ID: C2320906
    NAME: Verify Jackpot Racecard
    DESCRIPTION: This test case verifies the content of the UK Tote Jackpot racecard
    ...
    def test_001_tap_on_jackpot_subtab(self):
        """
        DESCRIPTION: Tap on Jackpot subtab
        EXPECTED: * Jackpot subtab content is loaded
        EXPECTED: * First leg should be loaded by default
        """
        pass

    def test_002_verify_jackpot_racecard_for_an_active_event(self):
        """
        DESCRIPTION: Verify Jackpot racecard for an active event
        EXPECTED: Jackpot racecard consists of:
    ...
    def test_005_verify_jackpot_racecard_with_a_suspended_selection(self):
        """
        DESCRIPTION: Verify Jackpot racecard with a suspended selection
