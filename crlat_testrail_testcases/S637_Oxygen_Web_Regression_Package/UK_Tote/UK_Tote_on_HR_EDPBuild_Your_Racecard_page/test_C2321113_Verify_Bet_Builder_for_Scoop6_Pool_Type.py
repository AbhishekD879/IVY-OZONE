...
@pytest.mark.races
@vtest
class Test_C2321113_Verify_Bet_Builder_for_Scoop6_Pool_Type(Common):
    """
    TR_ID: C2321113
    NAME: Verify Bet Builder for Scoop6 Pool Type
    DESCRIPTION: This test case verifies UK Tote Bet Builder for Scoop6 Pool Type
    DESCRIPTION: **Jira Tickets:**
    DESCRIPTION: [BMA-28452 UK Tote: Implement HR Scoop6 pool type] [1]
    DESCRIPTION: [1]: https://jira.egalacoral.com/browse/BMA-28452
    ...
    PRECONDITIONS: * Scoop6 pool type is available for HR Event
    ...
    def test_001_navigate_to_the_scoop6_pool_type_tab(self):
        """
        DESCRIPTION: Navigate to the Scoop6 pool type tab
        EXPECTED: * Scoop6 pool type is opened and underlined
    ...
    def test_009_click_on_currency_symbol_stake_amount_total_stake_button(self):
        ...
        EXPECTED: * Scoop6 bet is added to the BetSlip
        EXPECTED: * All Scoop6 checkboxes are cleared (for each Leg)
        EXPECTED: * Scoop6 Bet Builder disappears
        """
        pass
