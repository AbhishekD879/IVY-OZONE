...
@pytest.mark.races
@vtest
class Test_C2912274_Verify_Bet_Builder_for_Place_Pool_Type(Common):
    """
    TR_ID: C2912274
    NAME: Verify Bet Builder for Place Pool Type
    DESCRIPTION: This test case verifies UK Tote Bet Builder for Place Pool Type
    ...
    def test_001_navigate_to_the_place_pool_type_in_hr_event_with_uk_tote_pools_available(self):
        """
        DESCRIPTION: Navigate to the Place pool type in HR Event with UK Tote pools available
