...
@vtest
class Test_C62162654_Verify_desktop_mini_games_removal_based_on_user_risk_level_at_medium_high_very_high(Common):
    """
    TR_ID: C62162654
    NAME: Verify desktop mini games removal based on user risk level at medium ,high, very high
    DESCRIPTION: The Test case verifies Mini games removal for risk level Users
    ...
    def test_003_verify_desktop_mini_games_are_appear(self):
        """
        DESCRIPTION: Verify desktop mini games are appear
    ...
    def test_007_verify_desktop_mini_games_are_appear(self):
        """
        DESCRIPTION: Verify desktop mini games are appear
        EXPECTED: Minigames removed for all sports
        """
    ...
    def test_011_verify_desktop_mini_games_are_appear(self):
        """
        DESCRIPTION: Verify desktop mini games are appear
        EXPECTED: Minigames removed for all sports
        """
