...
@vtest
class Test_C62167432_Verify_recently_played_games_removal_based_on_user_risk_level_when_level_changes_from_LOW_to_Medium(Common):
    """
    TR_ID: C62167432
    NAME: Verify recently played games removal based on user risk level when level changes from LOW to Medium
    ...
    def test_003_verify_recently_played_games_are_appear(self):
        """
        DESCRIPTION: Verify recently played games are appear
        EXPECTED: recently played games appeared for all sports
        """
        pass
    ...
    def test_006_login_again_into_oxygen_application_as_high_risk_user__gtgt_check_recently_played_games_removed_for_all_sports_on_new_session(self):
        """
        DESCRIPTION: Login again into Oxygen application as HIGH risk user -&gt;&gt; check recently played games removed for all Sports on new session
