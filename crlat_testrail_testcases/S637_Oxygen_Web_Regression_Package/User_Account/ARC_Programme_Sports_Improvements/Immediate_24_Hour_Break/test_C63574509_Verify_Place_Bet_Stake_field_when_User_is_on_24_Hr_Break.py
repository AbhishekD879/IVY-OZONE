...
@vtest
class Test_C63574509_Verify_Place_Bet_Stake_field_when_User_is_on_24_Hr_Break(Common):
    """
    TR_ID: C63574509
    NAME: Verify Place Bet & Stake field when User is on 24 Hr Break
    DESCRIPTION: This test case verifies the display of Place Bet and Stake field when user is on Immediate 24 Hr Break
    PRECONDITIONS: 
    """
