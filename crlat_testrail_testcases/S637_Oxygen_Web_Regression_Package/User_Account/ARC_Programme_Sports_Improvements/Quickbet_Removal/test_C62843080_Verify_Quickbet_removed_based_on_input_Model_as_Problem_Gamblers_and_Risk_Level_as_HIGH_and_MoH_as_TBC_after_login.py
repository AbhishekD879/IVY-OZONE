...
@vtest
class Test_C62843080_Verify_Quickbet_removed_based_on_input_Model_as_Problem_Gamblers_and_Risk_Level_as_HIGH_and_MoH_as_TBC_after_login(Common):
    """
    TR_ID: C62843080
    NAME: Verify Quickbet removed based on input Model as Problem Gamblers and Risk Level as HIGH and MoH as TBC after login
