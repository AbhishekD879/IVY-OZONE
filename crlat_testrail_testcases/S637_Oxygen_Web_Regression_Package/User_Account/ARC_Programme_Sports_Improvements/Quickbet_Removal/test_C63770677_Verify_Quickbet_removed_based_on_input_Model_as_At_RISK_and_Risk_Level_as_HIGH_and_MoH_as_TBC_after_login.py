...
@vtest
class Test_C63770677_Verify_Quickbet_removed_based_on_input_Model_as_At_RISK_and_Risk_Level_as_HIGH_and_MoH_as_TBC_after_login(Common):
    """
    TR_ID: C63770677
    NAME: Verify Quickbet removed based on input Model as At RISK and Risk Level as HIGH and MoH as TBC after login
    DESCRIPTION: The test case verifies the quickbet feature get removed for risk level users
    PRECONDITIONS: Configure in CMS like input Model as AT RISK and Risk Level as High AND MoH as TBC
    """
    keep_browser_open = True

    def test_001_login_into_oxygen_application_as_high_risk_user_gt_add_one_selection(self):
        """
