...
@vtest
class Test_C63770684_Verify_Quickbet_not_removed_for_LOW_Risk_Level_user_AT_RISK_MoH_as_TBC_after_login(Common):
    """
    TR_ID: C63770684
    NAME: Verify Quickbet not removed for LOW Risk Level user-AT RISK-MoH as TBC after login
