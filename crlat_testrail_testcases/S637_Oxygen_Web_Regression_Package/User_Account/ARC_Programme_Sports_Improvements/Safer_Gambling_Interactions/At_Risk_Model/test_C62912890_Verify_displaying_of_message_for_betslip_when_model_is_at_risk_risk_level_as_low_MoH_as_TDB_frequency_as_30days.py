...
@vtest
class Test_C62912890_Verify_displaying_of_message_for_betslip_when_model_is_at_risk_risk_level_as_low_MoH_as_TDB_frequency_as_30days(Common):
    """
    TR_ID: C62912890
    NAME: Verify displaying of message for betslip when model is 'at risk' risk level as low & MoH as TDB & frequency as 30days
    ...
    def test_003_in_cms_populate_all_fields_with_valid_data_model_at_riskrisk_level_lowmoh_tbd_and_frequency__30_days(self):
        """
