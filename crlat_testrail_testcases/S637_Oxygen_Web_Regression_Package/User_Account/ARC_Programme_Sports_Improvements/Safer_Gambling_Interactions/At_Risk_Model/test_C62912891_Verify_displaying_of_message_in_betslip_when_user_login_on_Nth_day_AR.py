...
@vtest
class Test_C62912891_Verify_displaying_of_message_in_betslip_when_user_login_on_Nth_day_AR(Common):
    """
    TR_ID: C62912891
    NAME: Verify displaying of message in betslip when user login on Nth day_AR
