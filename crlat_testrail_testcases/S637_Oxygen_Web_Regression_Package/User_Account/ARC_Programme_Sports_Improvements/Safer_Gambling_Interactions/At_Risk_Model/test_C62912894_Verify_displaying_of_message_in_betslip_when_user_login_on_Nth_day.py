...
@vtest
class Test_C62912894_Verify_displaying_of_message_in_betslip_when_user_login_on_Nth_day(Common):
    """
    TR_ID: C62912894
    NAME: Verify displaying of message in betslip when user login on Nth day
