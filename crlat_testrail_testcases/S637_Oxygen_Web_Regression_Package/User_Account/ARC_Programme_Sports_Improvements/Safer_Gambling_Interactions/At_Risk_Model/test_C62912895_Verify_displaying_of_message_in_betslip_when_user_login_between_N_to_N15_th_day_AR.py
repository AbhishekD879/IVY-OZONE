...
@vtest
class Test_C62912895_Verify_displaying_of_message_in_betslip_when_user_login_between_N_to_N15_th_day_AR(Common):
    """
    TR_ID: C62912895
    NAME: Verify displaying of message in betslip  when user login between N to N+15 th day_AR
    DESCRIPTION: This test cases verifies message display when user login on N to N+15 th day
    ...
    def test_002_user_login_on_n_to_nplus15_th_day(self):
        """
        DESCRIPTION: User login on N to N+15 th day
