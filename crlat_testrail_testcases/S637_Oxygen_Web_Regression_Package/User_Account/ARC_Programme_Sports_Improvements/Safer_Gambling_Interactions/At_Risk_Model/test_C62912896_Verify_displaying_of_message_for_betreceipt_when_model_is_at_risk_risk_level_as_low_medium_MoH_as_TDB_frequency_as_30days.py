...
@vtest
class Test_C62912896_Verify_displaying_of_message_for_betreceipt_when_model_is_at_risk_risk_level_as_low_medium_MoH_as_TDB_frequency_as_30days(Common):
    """
    TR_ID: C62912896
    NAME: Verify displaying of message for betreceipt when model is 'at risk' risk level as low, medium & MoH as TDB & frequency as 30days
    DESCRIPTION: This test case verifies Betreceipt when model as PG and risk level as Low,Medium
    ...
    def test_003_in_cms_populate_all_fields_with_valid_data_model_at_riskrisk_level_lowmoh_tbd_and_frequency_30_days_(self):
        """
        DESCRIPTION: In CMS populate all fields with valid data (Model-at risk,Risk Level-Low,MoH TBD and Frequency-30 days )
    ...
    def test_010_repeat_the_above_steps__formodel_at_risk_risk_level_as_medium(self):
        """
