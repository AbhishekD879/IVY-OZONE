...
@vtest
class Test_C62912897_Verify_displaying_of_message_in_betreceipt_when_user_login_on_Nth_day_AR(Common):
    """
    TR_ID: C62912897
    NAME: Verify displaying of message in betreceipt when user login on Nth day_AR
    DESCRIPTION: This test cases verifies message display bet receipt when user login on Nth day
