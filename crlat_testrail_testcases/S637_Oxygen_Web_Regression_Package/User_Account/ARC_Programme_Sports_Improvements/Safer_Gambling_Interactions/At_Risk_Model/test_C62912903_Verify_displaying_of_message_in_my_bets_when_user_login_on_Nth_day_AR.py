...
@vtest
class Test_C62912903_Verify_displaying_of_message_in_my_bets_when_user_login_on_Nth_day_AR(Common):
    """
    TR_ID: C62912903
    NAME: Verify displaying of message in my bets when user login on Nth day_AR
    ...
    def test_006_navigate_to_my_bets__open_bets_tab(self):
        """
    ...
    def test_007_check_the_messaging_in__my_bets_on_nth_day(self):
        """
    ...
    def test_008_user_click_on_minimize_for_message_component(self):
        """
    ...
    def test_009_user_click_on_close_icon_for_message_component_in_my_bets(self):
        """
