...
@vtest
class Test_C62912904_Verify_displaying_of_message_in_my_bets_when_user_login_between_N_to_N30th_day_AR(Common):
    """
    TR_ID: C62912904
    NAME: Verify displaying of message in my bets when user login between N to N+30th day_AR
    DESCRIPTION: This test cases verifies message display  in my bets when user login on N to N+30 th day
    ...
    def test_006_navigate_to_my_bets__open_bets_check_the_messaging_component_in_my_bets(self):
        """
