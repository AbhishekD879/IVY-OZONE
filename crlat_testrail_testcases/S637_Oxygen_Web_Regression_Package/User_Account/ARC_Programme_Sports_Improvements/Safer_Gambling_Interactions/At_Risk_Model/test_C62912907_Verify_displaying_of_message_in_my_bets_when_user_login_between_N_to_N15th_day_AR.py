...
@vtest
class Test_C62912907_Verify_displaying_of_message_in_my_bets_when_user_login_between_N_to_N15th_day_AR(Common):
    """
    TR_ID: C62912907
    NAME: Verify displaying of message in my bets when user login between N to N+15th day_AR
