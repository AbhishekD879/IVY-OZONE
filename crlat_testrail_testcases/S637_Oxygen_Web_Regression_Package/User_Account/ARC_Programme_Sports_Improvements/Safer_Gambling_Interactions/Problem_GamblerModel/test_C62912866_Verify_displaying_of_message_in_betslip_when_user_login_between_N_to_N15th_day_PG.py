...
@vtest
class Test_C62912866_Verify_displaying_of_message_in_betslip_when_user_login_between_N_to_N15th_day_PG(Common):
    """
    TR_ID: C62912866
    NAME: Verify displaying of message in betslip when user login between N to N+15th day_PG
    DESCRIPTION: This test cases verifies message display in betslip when user login on N to N+15 th day
    PRECONDITIONS: 
    """
