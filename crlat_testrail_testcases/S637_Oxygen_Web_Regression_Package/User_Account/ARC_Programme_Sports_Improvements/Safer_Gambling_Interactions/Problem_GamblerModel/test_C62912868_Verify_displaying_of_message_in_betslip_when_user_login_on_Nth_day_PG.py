...
@vtest
class Test_C62912868_Verify_displaying_of_message_in_betslip_when_user_login_on_Nth_day_PG(Common):
    """
    TR_ID: C62912868
    NAME: Verify displaying of message in betslip when user login on Nth day_PG
    DESCRIPTION: This test cases verifies message display when user login on Nth day
