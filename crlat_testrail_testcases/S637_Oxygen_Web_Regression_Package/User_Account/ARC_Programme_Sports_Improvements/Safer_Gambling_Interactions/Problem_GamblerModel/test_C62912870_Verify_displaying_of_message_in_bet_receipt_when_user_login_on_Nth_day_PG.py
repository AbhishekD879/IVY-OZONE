...
@vtest
class Test_C62912870_Verify_displaying_of_message_in_bet_receipt_when_user_login_on_Nth_day_PG(Common):
    """
    TR_ID: C62912870
    NAME: Verify displaying of message in bet receipt when user login on Nth day_PG
    DESCRIPTION: This test cases verifies message display in bet receipt when user login on Nth day
    ...
    def test_005_check_the_messaging_in__bet_receipt_on_nth_day(self):
        """
        DESCRIPTION: Check the Messaging in  bet receipt on Nth day
    ...
    def test_007_user_click_on_close_icon_for_message_component_in_betreceipt(self):
        """
        DESCRIPTION: User click on close icon for message component in betreceipt
