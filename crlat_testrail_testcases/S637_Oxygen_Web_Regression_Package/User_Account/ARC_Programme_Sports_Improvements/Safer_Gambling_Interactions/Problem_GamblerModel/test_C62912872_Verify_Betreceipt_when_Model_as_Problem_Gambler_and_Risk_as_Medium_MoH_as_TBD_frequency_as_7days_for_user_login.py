...
@vtest
class Test_C62912872_Verify_Betreceipt_when_Model_as_Problem_Gambler_and_Risk_as_Medium_MoH_as_TBD_frequency_as_7days_for_user_login(Common):
    """
    TR_ID: C62912872
    NAME: Verify Betreceipt when Model as Problem Gambler and Risk as Medium & MoH as TBD &frequency as 7days for user login
    DESCRIPTION: This test case verifies bet receipt when model as PG and risk level as Medium
    PRECONDITIONS: User Risk level should be medium
