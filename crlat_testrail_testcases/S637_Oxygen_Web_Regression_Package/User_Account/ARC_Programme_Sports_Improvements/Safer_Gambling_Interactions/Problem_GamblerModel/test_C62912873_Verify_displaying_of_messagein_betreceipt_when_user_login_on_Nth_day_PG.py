...
@vtest
class Test_C62912873_Verify_displaying_of_messagein_betreceipt_when_user_login_on_Nth_day_PG(Common):
    """
    TR_ID: C62912873
    NAME: Verify displaying of messagein betreceipt  when user login on Nth day_PG
    ...
    def test_007_user_click_on_close_icon_for_message_component_in_betslip(self):
        """
