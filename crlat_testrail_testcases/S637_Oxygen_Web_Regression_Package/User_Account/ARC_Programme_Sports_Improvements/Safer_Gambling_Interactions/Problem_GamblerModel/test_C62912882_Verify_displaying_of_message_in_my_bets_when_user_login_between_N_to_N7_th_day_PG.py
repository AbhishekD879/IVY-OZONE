...
@vtest
class Test_C62912882_Verify_displaying_of_message_in_my_bets_when_user_login_between_N_to_N7_th_day_PG(Common):
    """
    TR_ID: C62912882
    NAME: Verify displaying of message in my bets when user login between N to N+7 th day_PG
    DESCRIPTION: This test cases verifies message display  in my bets when user login on N to N+7 th day
    ...
    def test_004_go_to_any_sport_add_multiple_selection_to_betslip_and_place_any_doubletripleacca_etc_and_tab_on_place_bet_button(self):
        """
        DESCRIPTION: Go to any sport Add multiple selection to betslip and place any double/triple/Acca etc and tab on place bet button
