...
@vtest
class Test_C62799663_Verify_Place_Bet_and_Stake_fields_are_in_disable_state_during_self_exclusion_quick_bet(Common):
    """
    TR_ID: C62799663
    NAME: Verify Place Bet and Stake fields are in disable state during self-exclusion quick bet
    DESCRIPTION: This test case verifies disable  of place bet and stake field
    PRECONDITIONS: User should be logged in to view 'Self Exclusion' message and the buttons
    """
    ...
    def test_002_add_selection_to_quick_bet(self):
        ...
        EXPECTED: Quick Bet is displayed at the bottom of the page Added selection and all data are displayed in Quick Bet
        """
        pass
    ...
    def test_005_enter_valid_credentials_of_users_account_which_is_self_excluded(self):
        ...
        EXPECTED: User should be logged in and clear the stake amount on place bet and stake textbox disable, User will see a message on quickbet
        """
        pass
