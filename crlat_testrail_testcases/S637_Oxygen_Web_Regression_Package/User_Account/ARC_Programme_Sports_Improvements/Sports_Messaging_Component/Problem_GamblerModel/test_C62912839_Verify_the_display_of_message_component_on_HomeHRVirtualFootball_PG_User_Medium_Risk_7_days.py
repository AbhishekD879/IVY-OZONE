...
@vtest
class Test_C62912839_Verify_the_display_of_message_component_on_HomeHRVirtualFootball_PG_User_Medium_Risk_7_days(Common):
    """
    TR_ID: C62912839
    NAME: Verify the display of message component on Home,HR,Virtual,Football_PG User-Medium Risk_7 days
    ...
    PRECONDITIONS: Frequency : 7 Days
    """
