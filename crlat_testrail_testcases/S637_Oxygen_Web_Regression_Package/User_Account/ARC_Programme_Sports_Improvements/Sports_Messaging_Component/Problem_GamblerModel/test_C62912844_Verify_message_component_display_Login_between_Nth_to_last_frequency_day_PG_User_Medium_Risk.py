...
@vtest
class Test_C62912844_Verify_message_component_display_Login_between_Nth_to_last_frequency_day_PG_User_Medium_Risk(Common):
    """
    TR_ID: C62912844
    NAME: Verify message component display -Login between Nth to last frequency day-PG User -Medium Risk
    ...
    def test_005_login_in_again_with_same_user_and_verify_message_component_display(self):
        ...
        EXPECTED: User should not get any Messaging component until next frequency. [after 7 days for Medium risk User]
        """
        pass
