...
@vtest
class Test_C2064594_Verify_Callback_to_Casino_app_after_happy_path_of_depositing_via_Skrill(Common):
    """
    TR_ID: C2064594
    NAME: Verify Callback to Casino app after happy path of depositing via Skrill
    DESCRIPTION: This test case verifies the functionality of a callback to Casino app after successful completion of the Oxygen depositing via Skrill
    PRECONDITIONS: 1) User is logged in
    PRECONDITIONS: 2) User has a valid Skrill account from which he/her can deposit funds
    ...
    def test_003_select_skrill_method_from_payments_dropdown_list(self):
        ...
        EXPECTED: **Skrill method** is selected in payments dropdown list in the format: Skrill (Account ID)
        """
        pass
    ...
    def test_005_click_deposit_button(self):
        ...
        EXPECTED: Skrill iframe page is opened where the user is able to submit Skrill form
        """
        pass

    def test_006_submit_skrill_form(self):
        """
