...
@vtest
class Test_C832555_Verify_Callback_to_Casino_app_after_happy_path_of_depositing_via_new_added_credit_debit_card(Common):
    """
    TR_ID: C832555
    NAME: Verify Callback to Casino app after happy path of depositing via new added credit/debit card
    DESCRIPTION: This test case verifies the functionality of a callback to Casino app after adding new credit/debit card and happy path depositing via this card
    ...
    def test_003_enter_validcard_number_expiration_date_and_tap_continue_button(self):
        """
    ...
    def test_004_enter_valid_amount_manually_or_using_quick_deposit_buttons_and_tap_deposit_button(self):
        """
