...
@vtest
class Test_C832558_Verify_Callback_to_Casino_app_after_unhappy_path_of_depositing_via_credit_debit_card(Common):
    """
    TR_ID: C832558
    NAME: Verify Callback to Casino app after unhappy path of depositing via credit/debit card
    DESCRIPTION: This test case verifies the functionality of a callback to Casino app after unhappy path of the BMA depositing via credit/debit card
    ...
    def test_004_tap_deposit_button(self):
        ...
        EXPECTED: *   **User is NOT redirected to Casino application (e.g. http://mcasino-tst2.coral.co.uk)**
        EXPECTED: *   User Balance is NOT increased
        """
        pass
