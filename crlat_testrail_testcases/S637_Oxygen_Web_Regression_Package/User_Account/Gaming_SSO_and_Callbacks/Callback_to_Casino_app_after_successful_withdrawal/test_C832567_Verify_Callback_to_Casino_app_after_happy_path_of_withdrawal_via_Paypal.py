...
@vtest
class Test_C832567_Verify_Callback_to_Casino_app_after_happy_path_of_withdrawal_via_Paypal(Common):
    """
    TR_ID: C832567
    NAME: Verify Callback to Casino app after happy path of withdrawal via Paypal
    DESCRIPTION: This test case verifies the functionality of a callback to Casino app after successful completion of the BMA withdrawal via Paypal
    PRECONDITIONS: 1.  User is logged in
    PRECONDITIONS: 2.  User has a valid registered PayPal account from which his/her can withdraw funds
