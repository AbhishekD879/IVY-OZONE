...
@vtest
class Test_C28244_Verify_happy_NetVerify_path_for_Suspended_user(Common):
    """
    TR_ID: C28244
    NAME: Verify happy NetVerify path for Suspended user
    DESCRIPTION: This test case verifies happy NetVerify path for Suspended user.
    ...
    PRECONDITIONS: **"suspended":"true" **and **"ageVerificationStatus":"inprocess"**
    PRECONDITIONS: 3. Make sure KYC is turned off in CMS > System congigurations
    PRECONDITIONS: Test users:
    PRECONDITIONS: *   TST2: username102/123456
    PRECONDITIONS: *   STG: newstage/123456
    PRECONDITIONS: *   PROD: testjumio1/123456
    ...
    def test_004_verify_verify_your_account_pop_up(self):
        ...
        EXPECTED: *   body '**We just need a few details Due to our licensing commitments and for the safety of all our customers we are required to verify all players on our system. Unfortunately we have not been able to verify your details and therefore your account has been temporarily suspended. Using your device you can quickly and safely upload a photo of your driving lisence or ID document(s) through our secure service so that we can complete your verification and reactivate your account.**'
    ...
    def test_006_verify_your_document_eg_passportdriving_licence_using_netverify_system(self):
        ...
        EXPECTED: *   User is presented with Coral Successful page
        """
        pass
    ...
    def test_008_verify_verify_your_account_pop_up_appearing(self):
        ...
        EXPECTED: 'Verify Your Account' pop-up is not shown anymore if user navigated from Coral Successfull page
        """
        pass
