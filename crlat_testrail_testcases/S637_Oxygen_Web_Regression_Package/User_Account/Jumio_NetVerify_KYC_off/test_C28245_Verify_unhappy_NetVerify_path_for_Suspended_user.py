...
@vtest
class Test_C28245_Verify_unhappy_NetVerify_path_for_Suspended_user(Common):
    """
    TR_ID: C28245
    NAME: Verify unhappy NetVerify path for Suspended user
    DESCRIPTION: This test case verifies unhappy NetVerify path for Suspended user.
