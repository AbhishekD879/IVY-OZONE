...
@vtest
class Test_C11263564_KYC_journeys_are_not_started_after_login_KYC_is_off_in_CMS(Common):
    """
    TR_ID: C11263564
    NAME: KYC journeys are not started after login (KYC is off in CMS)
    ...
    def test_001_login_with_a_user_from_step_3_in_preconditions(self):
        ...
        EXPECTED: 'Pending Verification' KYC journey is NOT started:
    ...
    def test_003_in_app_refresh_the_page(self):
        ...
        EXPECTED: 'Failed Verification' KYC journey is NOT started:
        EXPECTED: - No 'Verification Needed' page
    ...
    def test_005_in_app_refresh_the_page(self):
        """
        DESCRIPTION: In app: Refresh the page
        EXPECTED: - 'Happy' KYC journey is NOT started
