...
@vtest
class Test_C10877974_Verify_displaying_the_overlay_to_upload_the_document_without_verify_my_address_CTA_after_editing_address_and_with_AgeVerificationResultunknown(Common):
    """
    TR_ID: C10877974
    NAME: Verify displaying the overlay to upload the document without verify my address CTA after editing address and with AgeVerificationResult="unknown"
    DESCRIPTION: This test case verifies displaying the overlay to upload the document without verify my address CTA after editing address and changing Age verification status to Unknown
    ...
    def test_001_before_a_user_clicks_update_address_button_on_review_details_pop_upin_ims__find_a_just_registered_user__change_age_verification_result_to_unknown__tap_update_info(self):
        """
        ...
        EXPECTED: - Age Verification Result is 'Unknown'
        """
        pass
    ...
    def test_003_after_a_user_clicks_update_address_button_on_review_details_pop_upin_app_devtools__verify_response_in_openapi_websocket(self):
        ...
        EXPECTED: - 'ageVerificationStatus' = **"unknown"** (in response with "ID":31083) AND/OR "Player tag"= "POA_required" is received  (in response with "ID":35548)
        """
        pass
