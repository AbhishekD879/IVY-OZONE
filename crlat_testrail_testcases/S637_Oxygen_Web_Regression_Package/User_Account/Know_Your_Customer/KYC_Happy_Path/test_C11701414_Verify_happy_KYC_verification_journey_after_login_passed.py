...
@vtest
class Test_C11701414_Verify_happy_KYC_verification_journey_after_login_passed(Common):
    """
    TR_ID: C11701414
    NAME: Verify happy KYC verification journey after login ("passed")
    ...
    PRECONDITIONS: 4. In IMS: 'Age verification result' is set to 'Passed' for a user
    PRECONDITIONS: NOTE:
    ...
    def test_001_log_into_an_app(self):
        ...
        EXPECTED: - 'ageVerificationStatus' = "passed" is received (in response with "ID":31083)
        """
        pass
