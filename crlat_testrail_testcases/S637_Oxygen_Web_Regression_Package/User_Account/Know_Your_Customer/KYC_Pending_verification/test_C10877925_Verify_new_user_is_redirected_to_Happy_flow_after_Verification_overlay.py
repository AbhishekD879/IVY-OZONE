...
@vtest
class Test_C10877925_Verify_new_user_is_redirected_to_Happy_flow_after_Verification_overlay(Common):
    """
    TR_ID: C10877925
    NAME: Verify new user is redirected to Happy flow after Verification overlay
    DESCRIPTION: This test case verifies redirection to Happy Flow when new user's Age Verification Result is updated from 'unknown' to 'Pending verification' during Verification Spinner overlay displayed
    DESCRIPTION: Note: cannot automate as we are not able to set statuses for users in IMS
    ...
    def test_006_return_to_oxygen_app__wait_until_verification_spinner_display_time_is_ended(self):
        """
