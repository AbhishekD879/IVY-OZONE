...
@pytest.mark.other
@vtest
class Test_C16408295_Verify_My_Bets_counter_after_Race_Bet_Placement(Common):
    """
    TR_ID: C16408295
    NAME: Verify My Bets counter after Race Bet Placement
    DESCRIPTION: AUTOTEST [C58628668]
    ...
    def test_001_add_race_selection__eg_horse_racing_to_quickbetbetslip_and_place_bet(self):
        """
    ...
    def test_002__close_quickbetbetslip_verify_my_bets_counter_on_the_footer_panel(self):
        """
    ...
    def test_004_repeat_steps_1_2_for_forecasttricast(self):
        """
