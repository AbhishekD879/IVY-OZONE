...
@vtest
class Test_C60471270_Verify_Bet_tracker_of_Red_Card_related_markets_after_player_receives_second_yellow_card(Common):
    """
    TR_ID: C60471270
    NAME: Verify Bet tracker of "Red Card" related markets after player receives second yellow card.
    ...
    def test_001_when_there_is_a_red_card_allotted_2_yellow_cards_in_the_match_for_participant_121build_your_bet_red_card_participant_1_placed_on_yes_selection2build_your_bet_red_card_participant_1_placed_on_no_selection(self):
        """
        DESCRIPTION: When there is a Red card allotted (2 yellow cards) in the match for Participant-1/2.
        ...
        EXPECTED: 1. Bet wins (Green Tick)
        EXPECTED: 2. Bet is loosing (Red Down arrow)
        """
        pass

    def test_002_when_there_is_a_red_card_allotted_2_yellow_cards_in_the_match_for_participant_121build_your_bet_red_card_in_match_placed_on_yes_selection2build_your_bet_red_card_in_match_placed_on_no_selection(self):
        """
        DESCRIPTION: When there is a Red card allotted (2 yellow cards) in the match for Participant-1/2.
    ...
    def test_003_when_there_is_a_red_card_allotted_2_yellow_cards_in_the_match_for_participant_12_in_1st_half1build_your_bet_red_card_in_1st_half_placed_on_yes_selection2build_your_bet_red_card_in_1st_half_placed_on_no_selection(self):
        """
        DESCRIPTION: When there is a Red card allotted (2 yellow cards) in the match for Participant-1/2 in 1st Half
    ...
    def test_004_when_there_is_a_red_card_allotted_2_yellow_cards_in_the_match_for_participant_12_in_2nd_half1build_your_bet_red_card_in_2nd_half_placed_on_yes_selection2build_your_bet_red_card_in_2nd_half_placed_on_no_selection(self):
        """
        DESCRIPTION: When there is a Red card allotted (2 yellow cards) in the match for Participant-1/2 in 2nd Half
