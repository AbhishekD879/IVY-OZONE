...
@vtest
class Test_C62162266_Verify_the_Cash_Out_Messaging_When_Events_are_not_traded_In_Play(Common):
    """
    TR_ID: C62162266
    NAME: Verify the Cash Out Messaging- When Events are not traded In Play
