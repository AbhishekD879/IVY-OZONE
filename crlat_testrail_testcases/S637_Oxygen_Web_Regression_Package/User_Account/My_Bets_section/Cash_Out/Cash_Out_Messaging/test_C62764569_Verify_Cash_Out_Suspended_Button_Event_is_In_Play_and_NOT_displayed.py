...
@vtest
class Test_C62764569_Verify_Cash_Out_Suspended_Button_Event_is_In_Play_and_NOT_displayed(Common):
    """
    TR_ID: C62764569
    NAME: Verify Cash Out Suspended Button- Event is In-Play and NOT displayed
    ...
    def test_003__in_ob_make_the_changes_as_mentioned_in_the_pre_condition_display_status_is_n_active_status_is_s_is_off_flag_is_y_cash_out_flag_is_yevent_has_started(self):
        """
