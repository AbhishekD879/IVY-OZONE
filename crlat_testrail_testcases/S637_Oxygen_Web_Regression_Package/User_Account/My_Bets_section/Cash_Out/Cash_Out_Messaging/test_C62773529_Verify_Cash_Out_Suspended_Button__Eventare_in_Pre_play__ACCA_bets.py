...
@vtest
class Test_C62773529_Verify_Cash_Out_Suspended_Button__Eventare_in_Pre_play__ACCA_bets(Common):
    """
    TR_ID: C62773529
    NAME: Verify Cash Out Suspended Button - Eventare in Pre-play - ACCA bets
    ...
    def test_003__in_ob_make_the_changes_as_mentioned_in_the_pre_conditions_for_any_one_of_the_selection_display_status_is_y_active_status_is_s_is_off_flag_is_n_cash_out_flag_is_y(self):
        """
