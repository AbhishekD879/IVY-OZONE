...
@vtest
class Test_C62773533_Verify_Cash_Out_Suspended_Button_Event_are_In_Play_ACCA_bets(Common):
    """
    TR_ID: C62773533
    NAME: Verify Cash Out Suspended Button- Event are In-Play_ACCA bets
    ...
    def test_003__in_ob_make_the_changes_as_mentioned_in_the_pre_condition_for_any_one_of_the_selection_display_status_is_y_active_status_is_s_is_off_flag_is_y_cash_out_flag_is_yevent_has_started(self):
        """
