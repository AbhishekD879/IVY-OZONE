...
@vtest
class Test_C62782216_Verify_Cash_Out_Messaging_Market_is_not_traded_for_In_Play_ACCA_bet(Common):
    """
    TR_ID: C62782216
    NAME: Verify Cash Out Messaging-Market is not traded for In-Play_ACCA bet
    ...
    def test_003_in_ob_make_the_changes_as_mentioned_in_the_pre_conditions_for_any_one_of_the_selectionevent_levelevent___display_status_is_y_active_status_is_a_is_off_flag_is_y_and_cash_out_flag_is_ymarket_levelmarket__display_status_is_n_active_status_is_s_and_cash_out_flag_is_y(self):
        """
        DESCRIPTION: In OB make the changes as mentioned in the Pre-Conditions for ANY ONE of the selection
    ...
    def test_007_in_ob_make_the_changes_as_mentioned_in_the_pre_conditions_for_all_of_the_selectionevent_levelevent___display_status_is_y_active_status_is_a_is_off_flag_is_y_and_cash_out_flag_is_ymarket_levelmarket__display_status_is_n_active_status_is_s_and_cash_out_flag_is_y(self):
        """
        DESCRIPTION: In OB make the changes as mentioned in the Pre-Conditions for ALL  of the selection
        DESCRIPTION: **Event Level**
        DESCRIPTION: Event - Display status is **Y**, Active status is **A**, Is OFF Flag is **Y** and cash out Flag is **Y**
        DESCRIPTION: **Market Level**
        DESCRIPTION: Market -Display status is **N**, Active status is **S** and Cash out Flag is **Y**
    ...
    def test_008_in_fe_navigate_to_my_bets_gt_open_bets(self):
        """
        DESCRIPTION: In FE navigate to My Bets &gt; Open Bets
        EXPECTED: * Cash Out Button should not be displayed
        EXPECTED: * Cash Out Messaging should be displayed as configured in CMS
        EXPECTED: * Find Out More Link should be displayed
        EXPECTED: **On clicking Find Out More**
        EXPECTED: * Message Pop-up should be displayed
        EXPECTED: * Message pop up with events (which causing cash out button removed) and Got it button
        """
        pass
