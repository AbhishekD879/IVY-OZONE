...
@vtest
class Test_C62912732_Verify_GA_tracking_on_clicking_Find_Out_More_Link_GOT_IT_button_Market_is_not_traded_for_In_Play(Common):
    """
    TR_ID: C62912732
    NAME: Verify GA tracking on clicking Find Out More Link & GOT IT button-Market is not traded for In-Play
