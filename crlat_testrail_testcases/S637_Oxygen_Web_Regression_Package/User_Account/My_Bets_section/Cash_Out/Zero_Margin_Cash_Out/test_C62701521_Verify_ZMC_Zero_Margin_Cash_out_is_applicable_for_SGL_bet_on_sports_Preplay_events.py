...
@vtest
class Test_C62701521_Verify_ZMC_Zero_Margin_Cash_out_is_applicable_for_SGL_bet_on_sports_Preplay_events(Common):
    """
    TR_ID: C62701521
    NAME: Verify ZMC (Zero Margin Cash out) is applicable for SGL bet on sports Preplay events
    DESCRIPTION: This test case verifies Zero margin cash Out is applicable for full cash out with Single bet on Tier 1 and 2 sports of Preplay events when there are no price changes in Cash Out tab
