...
@vtest
class Test_C62736558_Verify_ZMC_is_applicable_for_Partial_Cash_Out_with_SGL_bet_on_Racing_Preplay_events(Common):
    """
    TR_ID: C62736558
    NAME: Verify ZMC is applicable for Partial Cash Out with SGL bet on Racing Preplay events
    DESCRIPTION: This test case verifies Zero margin cash Out is applicable for partial cash out with Single bet on Racing(Horse Racing and Grey Hounds) Preplay events when there are no price changes in Cash Out tab
