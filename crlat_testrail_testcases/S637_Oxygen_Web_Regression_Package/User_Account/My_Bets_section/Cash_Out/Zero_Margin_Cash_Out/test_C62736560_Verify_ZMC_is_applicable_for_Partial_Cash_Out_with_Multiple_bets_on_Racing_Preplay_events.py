...
@vtest
class Test_C62736560_Verify_ZMC_is_applicable_for_Partial_Cash_Out_with_Multiple_bets_on_Racing_Preplay_events(Common):
    """
    TR_ID: C62736560
    NAME: Verify ZMC is applicable for Partial Cash Out with Multiple bets on Racing Preplay events
    DESCRIPTION: This test case verifies Zero margin cash Out is applicable for partial cash out with Multiple bets on Racing(Horse Racing and grey Hounds) of Preplay events when there are no price changes in Cash Out tab
