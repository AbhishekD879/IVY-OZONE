...
@vtest
class Test_C62755634_Verify_ZMC_is_applicable_for_Partial_Cash_Out_with_QB_on_sports_Preplay_events(Common):
    """
    TR_ID: C62755634
    NAME: Verify ZMC is applicable for Partial Cash Out with QB on sports Preplay events
    DESCRIPTION: This test case verifies Zero margin cash Out is applicable for partial cash out with QB on Tier 1 and 2 sports of Preplay events when there are no price changes in Cash Out tab
