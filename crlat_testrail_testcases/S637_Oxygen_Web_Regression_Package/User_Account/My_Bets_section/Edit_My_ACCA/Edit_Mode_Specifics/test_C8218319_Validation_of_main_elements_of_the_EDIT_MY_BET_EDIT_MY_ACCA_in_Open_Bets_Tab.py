...
@pytest.mark.betslip
@vtest
class Test_C8218319_Validation_of_main_elements_of_the_EDIT_MY_BET_EDIT_MY_ACCA_in_Open_Bets_Tab(Common):
    """
    TR_ID: C8218319
    NAME: Validation of main elements of the 'EDIT MY BET'/'EDIT MY ACCA'  in 'Open Bets' Tab
    ...
    DESCRIPTION: AUTOTEST [C12695499]
    ...
    PRECONDITIONS: 5. Go to 'Open Bets' Tab -> verify that 'EDIT MY BET'/'EDIT MY ACCA' button is available
    PRECONDITIONS: NOTE: ''EDIT MY BET'/'EDIT MY ACCA'' button is shown only for the bets which placed on an ACCA - Single line Accumulators (it can be DOUBLE, TREBLE, ACCA4 and more)
    """
    ...
    def test_003_verify_that_new_stake_and_new_est_returnscoral_new_potential_returns_ladbrokes_are_updated(self):
        """
        DESCRIPTION: Verify that 'New Stake' and 'New Est. Returns'(Coral) 'New Potential Returns' (Ladbrokes) are updated
        EXPECTED: New 'New Stake' and 'New Est. Returns'(Coral) 'New Potential Returns' (Ladbrokes) is displayed
        """
        pass
