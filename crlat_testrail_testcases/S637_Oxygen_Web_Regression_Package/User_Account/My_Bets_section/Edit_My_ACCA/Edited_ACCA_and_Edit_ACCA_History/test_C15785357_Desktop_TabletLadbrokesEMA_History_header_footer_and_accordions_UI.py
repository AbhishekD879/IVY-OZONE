...
@vtest
class Test_C15785357_Desktop_TabletLadbrokesEMA_History_header_footer_and_accordions_UI(Common):
    """
    TR_ID: C15785357
    NAME: [Desktop/Tablet][Ladbrokes]EMA History: header, footer and accordions UI
    DESCRIPTION: This test case verifies UI of the header, footer and accordions within EMA history pop up for Desktop application
    ...
    def test_001___load_the_application_and_open_open_bets_tab_within_betslip_widget__tap_edit_acca_history_button_under_the_edited_bet__verify_accordions_state_and_ui_elements_of_the_header_footer_and_accordion(self):
        """
        DESCRIPTION: - Load the application and open 'Open Bets' tab within 'Betslip' widget
        ...
        EXPECTED: Edit Acca history is opened in a pop up window
        EXPECTED: **Header UI:**
    ...
    def test_002___close_the_ema_history_pop_up_and_settled_bets_tab_within_betslip_widget__tap_edit_acca_history_button_under_the_bet_with_selections_from_resulted_events__verify_accordions_state_and_ui_elements_of_the_header_footer_and_accordion(self):
        """
        DESCRIPTION: - Close the EMA history pop up and 'Settled Bets' tab within 'Betslip' widget
