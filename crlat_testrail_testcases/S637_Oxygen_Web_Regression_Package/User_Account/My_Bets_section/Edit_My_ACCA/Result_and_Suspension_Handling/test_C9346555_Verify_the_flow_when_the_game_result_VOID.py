...
@pytest.mark.betslip
@vtest
class Test_C9346555_Verify_the_flow_when_the_game_result_VOID(Common):
    """
    TR_ID: C9346555
    ...
    def test_001_go_to_ti_and_set_void_result_for_any_event_in_the_placed_betverify_that_selection_removal_button_is_not_shown_for_resulted_event(self):
        """
