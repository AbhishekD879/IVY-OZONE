...
@vtest
class Test_C64378749_Verify_My_bets_widget_for_Pre_leaderboard_in_Open_bets_when_contest_is_removed_in_CMS(Common):
    """
    TR_ID: C64378749
    NAME: Verify My bets widget for Pre-leaderboard in (Open bets) when contest is removed in CMS
    ...
    def test_002_navigate_to_the_pre_leaderboard_contest_and_login_with_a_user_which_has_bet_placed(self):
        """
        DESCRIPTION: Navigate to the Pre leaderboard contest and login with a user which has bet placed.
        EXPECTED: user should able to see Pre leaderboard which is configured in CMS.
        """
        pass
