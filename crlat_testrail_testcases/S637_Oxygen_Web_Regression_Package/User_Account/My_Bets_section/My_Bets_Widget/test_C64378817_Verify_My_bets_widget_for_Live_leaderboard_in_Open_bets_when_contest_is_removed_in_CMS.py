...
@vtest
class Test_C64378817_Verify_My_bets_widget_for_Live_leaderboard_in_Open_bets_when_contest_is_removed_in_CMS(Common):
    """
    TR_ID: C64378817
    NAME: Verify My bets widget for Live-leaderboard in (Open bets) when contest is removed in CMS
    ...
    def test_002_navigate_to_the_live_leaderboard_contest_and_login_with_a_user_which_has_bet_placed(self):
        """
        DESCRIPTION: Navigate to the Live leaderboard contest and login with a user which has bet placed.
        EXPECTED: User should able to see Live leaderboard which is configured in CMS.
        """
        pass
    ...
    def test_003_click_on_remove_button_and_save_the_contest_in_cms(self):
        ...
        EXPECTED: User should not see 5-a-side leaderboard widget in My bets (open bets) section, for the contest which is removed in CMS.
        """
        pass
