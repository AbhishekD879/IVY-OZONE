...
@vtest
class Test_C12834229_Verify_Trifecta_bet_is_displayed_on_Settled_Bets_tab(Common):
    """
    TR_ID: C12834229
    NAME: Verify Trifecta bet is displayed on Settled Bets tab
    DESCRIPTION: This test case verifies the displayed contents of a Trifecta tote bet in the Settled Bets tab
    PRECONDITIONS: User is logged in
    PRECONDITIONS: User has placed tote Trifecta Bet(s) on UK Tote events
    PRECONDITIONS: User has placed tote Trifecta Bet(s) on UK Tote events and the bet is already settled
    """
    ...
    def test_001_navigate_to_settled_bets_tabtap_on_the_pools_sub_section(self):
        ...
        EXPECTED: Trifecta tote bet information corresponds to settled bet:
