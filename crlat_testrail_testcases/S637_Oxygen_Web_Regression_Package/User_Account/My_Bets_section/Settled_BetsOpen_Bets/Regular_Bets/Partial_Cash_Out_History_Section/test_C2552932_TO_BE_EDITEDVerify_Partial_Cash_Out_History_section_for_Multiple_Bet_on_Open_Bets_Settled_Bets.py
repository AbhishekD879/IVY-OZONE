...
@vtest
class Test_C2552932_TO_BE_EDITEDVerify_Partial_Cash_Out_History_section_for_Multiple_Bet_on_Open_Bets_Settled_Bets(Common):
    """
    TR_ID: C2552932
    NAME: [TO BE EDITED]Verify 'Partial Cash Out History' section for Multiple Bet on Open Bets/Settled Bets
    DESCRIPTION: This test case verifies 'Partial Cash Out History' section of 'Regular' bets.
    DESCRIPTION: This scenario should also be checked on cashout tab + should be edited according to the latest changes including Vanilla
    DESCRIPTION: AUTOTEST [C1503139]
    ...
    def test_001_tap_open_bets_tabverifypartial_cash_out_history_section_presence_for_multiple_bet(self):
        """
        DESCRIPTION: Tap 'Open Bets' tab
        DESCRIPTION: Verify 'Partial Cash Out History' section presence for Multiple bet
        EXPECTED: *   'Partial Cash Out History' section is displayed below Multiple bets section
    ...
    def test_007_make_partial_cash_out_of_the_verified_betverify_that_the_partial_cash_out_history_sectionis_increased_by_one_row(self):
        """
        DESCRIPTION: Make Partial Cash out of the verified bet
        DESCRIPTION: Verify that the 'Partial Cash Out History' section is increased by one row
