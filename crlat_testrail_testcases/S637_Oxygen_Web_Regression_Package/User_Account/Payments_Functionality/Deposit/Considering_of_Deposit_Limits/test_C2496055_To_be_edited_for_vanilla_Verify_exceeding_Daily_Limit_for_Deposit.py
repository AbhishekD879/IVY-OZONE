...
@vtest
class Test_C2496055_To_be_edited_for_vanilla_Verify_exceeding_Daily_Limit_for_Deposit(Common):
    """
    TR_ID: C2496055
    NAME: [To be edited for vanilla] Verify exceeding Daily Limit for Deposit
    DESCRIPTION: This test case verifies considering of Daily Limit for Deposit functionality
    DESCRIPTION: AUTOTEST Desktop: [C2515192]
    DESCRIPTION: AUTOTEST Mobile: [C2493539]
    ...
    PRECONDITIONS: 7.  User has Daily Limit set
    ...
    def test_002_selectdebitcredit_card_payment_methodfrom_drop_down(self):
        """
    ...
    def test_008_selectpaypal_payment_methodfrom_drop_down(self):
        """
    ...
    def test_009_enter_amount_thatexceeds_daily_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Daily Limit
        EXPECTED: 
        """
    ...
    def test_013_selectneteller_payment_methodfrom_drop_down(self):
        """
    ...
    def test_015_enter_amount_thatexceeds_daily_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Daily Limit
        EXPECTED: 
        """
    ...
    def test_019_selectskrill_payment_methodfrom_drop_down(self):
        """
    ...
    def test_020_enter_amount_thatexceeds_daily_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Daily Limit
        EXPECTED: 
        """
    ...
    def test_024_selectpaysafecard_payment_methodfrom_drop_down(self):
        """
    ...
    def test_025_enter_amount_thatexceeds_daily_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Daily Limit
        EXPECTED: 
        """
