...
@vtest
class Test_C28288_Verify_exceeding_Weekly_Limit_for_Deposit(Common):
    """
    TR_ID: C28288
    NAME: Verify exceeding Weekly Limit for Deposit
    DESCRIPTION: This test case verifies considering of Weekly Limit for Deposit functionality
    DESCRIPTION: AUTOTEST Desktop [C2515190]
    DESCRIPTION: AUTOTEST Mobile [C2493277]
    ...
    PRECONDITIONS: 7.  User has Weekly Limit set
    ...
    PRECONDITIONS: **For testing exceeding of the Weekly limit, the Daily limit should be exceeded on the previous day.**
    PRECONDITIONS: **NOTE:**
    ...
    def test_004_enter_amount_that_exceeds_weekly_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Weekly Limit
        EXPECTED: 
        """
        pass
    ...
    def test_009_enter_amount_that_exceeds_weekly_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Weekly Limit
        EXPECTED: 
        """
    ...
    def test_015_enter_amount_that_exceeds_weekly_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Weekly Limit
        EXPECTED: 
        """
    ...
    def test_020_enter_amount_that_exceeds_weekly_limit(self):
        """
        DESCRIPTION: Enter amount that exceeds Weekly Limit
        EXPECTED: 
        """
    ...
    def test_025_enter_amount_that_exceeds_daily_limit(self):
        """
