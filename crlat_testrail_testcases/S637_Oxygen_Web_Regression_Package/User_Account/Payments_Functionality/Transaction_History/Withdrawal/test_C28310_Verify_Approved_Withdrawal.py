...
@vtest
class Test_C28310_Verify_Approved_Withdrawal(Common):
    """
    TR_ID: C28310
    NAME: Verify Approved Withdrawal
    DESCRIPTION: This test case verifies Approved Withdrawal.
    ...
    def test_009_go_to_ims_and_approve_this_transaction(self):
        """
        DESCRIPTION: Go to IMS and **approve **this transaction
        EXPECTED: Transaction is approved
        """
        pass
    ...
    def test_010_tap_refresh_button_on_the_pending_tab(self):
        ...
        EXPECTED: Verified withdrawal transaction dissapears
        """
        pass

    def test_011_tap_approved_tab(self):
        """
        DESCRIPTION: Tap 'Approved' tab
        EXPECTED: Withdrawal transaction from step №7 appears on the 'Approved' tab
        """
        pass

    def test_012_verify_approved_transaction_info(self):
        """
