...
@vtest
class Test_C1649164_Withdraw_to_expired_card_WITH_deposits_on_record(Common):
    """
    TR_ID: C1649164
    NAME: Withdraw to expired card WITH deposits on record
    DESCRIPTION: This test case verifies ability to withdraw to an expired card and user had deposited from this card.
    PRECONDITIONS: User is logged in
    PRECONDITIONS: User has a card that expired
    PRECONDITIONS: User has deposited from this card
    ...
    def test_004_go_back_to_withdraw_page_and_select_the_card_from_preconditions_click_edit_expiry_date(self):
        """
