...
@pytest.mark.other
@vtest
class Test_C17354960_Vanilla__Verify_successful_Withdraw_for_Visa(Common):
    """
    TR_ID: C17354960
    NAME: [Vanilla] - Verify successful Withdraw for Visa
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Visa
