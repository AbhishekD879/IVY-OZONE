...
@pytest.mark.other
@vtest
class Test_C17354963_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Visa(Common):
    """
    TR_ID: C17354963
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Visa
    ...
    PRECONDITIONS: 3. Visa Payment method added;
    """
    ...
    def test_002_select_the_visa_payment_method(self):
        """
        DESCRIPTION: Select the Visa payment method;
