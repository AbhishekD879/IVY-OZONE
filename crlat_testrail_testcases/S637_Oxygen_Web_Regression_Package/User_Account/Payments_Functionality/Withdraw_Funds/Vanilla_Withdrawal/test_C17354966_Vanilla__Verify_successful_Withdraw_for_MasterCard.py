...
@pytest.mark.other
@vtest
class Test_C17354966_Vanilla__Verify_successful_Withdraw_for_MasterCard(Common):
    """
    TR_ID: C17354966
    NAME: [Vanilla] - Verify successful Withdraw for MasterCard
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - MasterCard;
    ...
    def test_004_select_mastercard_payment_method__mastercard_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select MasterCard payment method;
        DESCRIPTION: - MasterCard should be added before deposit.
        EXPECTED: Withdrawal page for MasterCard is opened;
        """
        pass
