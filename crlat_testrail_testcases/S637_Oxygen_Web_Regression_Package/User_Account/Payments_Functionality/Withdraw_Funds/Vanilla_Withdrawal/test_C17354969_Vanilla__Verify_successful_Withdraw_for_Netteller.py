...
@pytest.mark.other
@vtest
class Test_C17354969_Vanilla__Verify_successful_Withdraw_for_Netteller(Common):
    """
    TR_ID: C17354969
    NAME: [Vanilla] - Verify successful Withdraw for Netteller
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Netteller;
    ...
    def test_004_select_netteller_payment_method__netteller_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Netteller payment method;
        DESCRIPTION: - Netteller should be added before deposit.
        EXPECTED: Withdrawal page for Netteller is opened;
        """
        pass
