...
@pytest.mark.other
@vtest
class Test_C17354970_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Netteller(Common):
    """
    TR_ID: C17354970
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Netteller
    ...
    PRECONDITIONS: 3. Netteller Payment method is added;
    """
    ...
    def test_002_select_the_netteller_payment_method(self):
        """
        DESCRIPTION: Select the Netteller payment method;
