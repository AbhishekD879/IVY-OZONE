...
@pytest.mark.other
@vtest
class Test_C17354971_Vanilla__Verify_successful_Withdraw_for_PayPal(Common):
    """
    TR_ID: C17354971
    NAME: [Vanilla] - Verify successful Withdraw for PayPal
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method (e.g PayPal);
    ...
    def test_004_select_paypal_payment_method__paypal_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select PayPal payment method;
        DESCRIPTION: - PayPal should be added before deposit.
        EXPECTED: Withdrawal page for PayPal is opened;
        """
        pass
