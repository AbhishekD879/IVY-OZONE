...
@pytest.mark.other
@vtest
class Test_C17354972_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__PayPal(Common):
    """
    TR_ID: C17354972
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - PayPal
    ...
    PRECONDITIONS: 3. PayPal Payment method added;
    """
    ...
    def test_002_select_the_paypal_payment_method(self):
        """
        DESCRIPTION: Select the PayPal payment method;
