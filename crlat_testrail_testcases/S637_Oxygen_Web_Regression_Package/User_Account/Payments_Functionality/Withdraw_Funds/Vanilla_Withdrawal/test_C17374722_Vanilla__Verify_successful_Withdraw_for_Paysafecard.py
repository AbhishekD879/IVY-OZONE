...
@pytest.mark.other
@vtest
class Test_C17374722_Vanilla__Verify_successful_Withdraw_for_Paysafecard(Common):
    """
    TR_ID: C17374722
    NAME: [Vanilla] - Verify successful Withdraw for Paysafecard
    ...
    def test_004_select_paysafecard_payment_method__paysafecard_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Paysafecard payment method;
        DESCRIPTION: - Paysafecard should be added before deposit.
        EXPECTED: Withdrawal page for Paysafecard is opened;
        """
        pass
