...
@pytest.mark.other
@vtest
class Test_C17374723_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Paysafecard(Common):
    """
    TR_ID: C17374723
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Paysafecard
    ...
    PRECONDITIONS: 3. Paysafecard Payment method added;
    """
    ...
    def test_002_select_the_paysafecard_payment_method(self):
        """
        DESCRIPTION: Select the Paysafecard payment method;
