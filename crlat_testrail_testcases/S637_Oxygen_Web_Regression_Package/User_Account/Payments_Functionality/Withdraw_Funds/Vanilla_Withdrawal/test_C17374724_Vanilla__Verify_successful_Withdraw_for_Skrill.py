...
@pytest.mark.other
@vtest
class Test_C17374724_Vanilla__Verify_successful_Withdraw_for_Skrill(Common):
    """
    TR_ID: C17374724
    NAME: [Vanilla] - Verify successful Withdraw for Skrill
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Skrill;
    ...
    def test_004_select_skrill_payment_method__skrill_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Skrill payment method;
        DESCRIPTION: - Skrill should be added before deposit.
        EXPECTED: Withdrawal page for Skrill is opened;
        """
        pass
