...
@pytest.mark.other
@vtest
class Test_C17374725_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Skrill(Common):
    """
    TR_ID: C17374725
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Skrill
    ...
    PRECONDITIONS: 3. Skrill Payment method added;
    """
    ...
    def test_002_select_the_skrill_payment_method(self):
        """
        DESCRIPTION: Select the Skrill payment method;
