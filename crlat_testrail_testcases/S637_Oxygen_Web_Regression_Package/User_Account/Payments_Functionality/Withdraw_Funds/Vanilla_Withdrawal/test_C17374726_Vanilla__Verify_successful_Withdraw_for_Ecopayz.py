...
@pytest.mark.other
@vtest
class Test_C17374726_Vanilla__Verify_successful_Withdraw_for_Ecopayz(Common):
    """
    TR_ID: C17374726
    NAME: [Vanilla] - Verify successful Withdraw for Ecopayz
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Ecopayz;
    ...
    def test_004_select_ecopayz_payment_method__ecopayz_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Ecopayz payment method;
        DESCRIPTION: - Ecopayz should be added before deposit.
        EXPECTED: Withdrawal page for Ecopayz is opened;
        """
        pass
