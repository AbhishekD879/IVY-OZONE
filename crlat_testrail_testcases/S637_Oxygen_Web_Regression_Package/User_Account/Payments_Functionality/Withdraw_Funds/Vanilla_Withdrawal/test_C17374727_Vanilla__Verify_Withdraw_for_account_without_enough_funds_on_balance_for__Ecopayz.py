...
@pytest.mark.other
@vtest
class Test_C17374727_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Ecopayz(Common):
    """
    TR_ID: C17374727
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Ecopayz
    ...
    PRECONDITIONS: 3. Ecopayz Payment method added;
    """
    ...
    def test_002_select_the_ecopayz_payment_method(self):
        """
        DESCRIPTION: Select the Ecopayz payment method;
