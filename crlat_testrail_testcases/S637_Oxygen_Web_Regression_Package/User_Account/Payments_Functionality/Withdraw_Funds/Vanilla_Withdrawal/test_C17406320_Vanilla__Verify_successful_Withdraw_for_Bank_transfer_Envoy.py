...
@pytest.mark.other
@vtest
class Test_C17406320_Vanilla__Verify_successful_Withdraw_for_Bank_transfer_Envoy(Common):
    """
    TR_ID: C17406320
    NAME: [Vanilla] - Verify successful Withdraw for Bank transfer (Envoy)
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Bank transfer (Envoy);
    ...
    def test_004_select_bank_transfer_envoy_payment_method__bank_transfer_envoy_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Bank transfer (Envoy) payment method;
        DESCRIPTION: - Bank transfer (Envoy) should be added before deposit.
        EXPECTED: Withdrawal page for Bank transfer (Envoy) is opened;
        """
        pass
