...
@pytest.mark.other
@vtest
class Test_C17406321_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Bank_transfer_Envoy(Common):
    """
    TR_ID: C17406321
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Bank transfer (Envoy)
    ...
    PRECONDITIONS: 3. Bank transfer (Envoy) Payment method added;
    """
    ...
    def test_002_select_the_bank_transfer_envoy_payment_method(self):
        """
        DESCRIPTION: Select the Bank transfer (Envoy) payment method;
