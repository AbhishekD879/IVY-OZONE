...
@pytest.mark.other
@vtest
class Test_C17406323_Vanilla__Verify_successful_Withdraw_for_Safecharge(Common):
    """
    TR_ID: C17406323
    NAME: [Vanilla] - Verify successful Withdraw for Safecharge
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Safecharge;
    ...
    def test_004_select_safecharge_payment_method__safecharge_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Safecharge payment method;
        DESCRIPTION: - Safecharge should be added before deposit.
