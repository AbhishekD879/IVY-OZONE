...
@pytest.mark.other
@vtest
class Test_C17406324_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Safecharge(Common):
    """
    TR_ID: C17406324
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Safecharge
    ...
    PRECONDITIONS: 3. Safecharge Payment method added;
    """
    ...
    def test_002_select_the_safecharge_payment_method(self):
        """
        DESCRIPTION: Select the Safecharge payment method;
