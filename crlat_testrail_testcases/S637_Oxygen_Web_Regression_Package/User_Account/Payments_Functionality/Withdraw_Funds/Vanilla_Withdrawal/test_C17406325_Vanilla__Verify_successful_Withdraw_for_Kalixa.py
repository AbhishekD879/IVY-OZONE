...
@pytest.mark.other
@vtest
class Test_C17406325_Vanilla__Verify_successful_Withdraw_for_Kalixa(Common):
    """
    TR_ID: C17406325
    NAME: [Vanilla] - Verify successful Withdraw for Kalixa
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - ***Kalixa***;
    ...
    def test_004_select_kalixa_payment_method__kalixa_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select ***Kalixa*** payment method;
        DESCRIPTION: - ***Kalixa*** should be added before deposit.
        EXPECTED: Withdrawal page for ***Kalixa*** is opened;
        """
        pass
