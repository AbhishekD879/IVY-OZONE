...
@pytest.mark.other
@vtest
class Test_C17406326_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Kalixa(Common):
    """
    TR_ID: C17406326
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Kalixa
    ...
    PRECONDITIONS: 3. ***Kalixa*** Payment method added;
    """
    ...
    def test_002_select_the_kalixa_payment_method(self):
        """
        DESCRIPTION: Select the ***Kalixa*** payment method;
