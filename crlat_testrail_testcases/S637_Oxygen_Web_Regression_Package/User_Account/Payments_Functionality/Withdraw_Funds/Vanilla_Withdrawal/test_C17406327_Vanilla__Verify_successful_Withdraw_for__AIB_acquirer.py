...
@pytest.mark.other
@vtest
class Test_C17406327_Vanilla__Verify_successful_Withdraw_for__AIB_acquirer(Common):
    """
    TR_ID: C17406327
    NAME: [Vanilla] - Verify successful Withdraw for - AIB (acquirer)
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - AIB (acquirer);
    ...
    def test_004_select_aib_acquirer_payment_method__aib_acquirer_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select AIB (acquirer) payment method;
        DESCRIPTION: - AIB (acquirer) should be added before deposit.
        EXPECTED: Withdrawal page for AIB (acquirer) is opened;
        """
        pass
