...
@pytest.mark.other
@vtest
class Test_C17406329_Vanilla__Verify_successful_Withdraw_for_Worldpay(Common):
    """
    TR_ID: C17406329
    NAME: [Vanilla] - Verify successful Withdraw for Worldpay
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Worldpay;
    ...
    def test_004_select_worldpay_payment_method__worldpay_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Worldpay payment method;
        DESCRIPTION: - Worldpay should be added before deposit.
        EXPECTED: Withdrawal page for Worldpay is opened;
        """
        pass
