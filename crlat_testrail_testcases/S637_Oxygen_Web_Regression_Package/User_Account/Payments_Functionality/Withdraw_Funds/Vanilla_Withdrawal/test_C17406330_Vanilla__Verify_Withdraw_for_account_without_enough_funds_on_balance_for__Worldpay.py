...
@pytest.mark.other
@vtest
class Test_C17406330_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Worldpay(Common):
    """
    TR_ID: C17406330
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Worldpay
    ...
    PRECONDITIONS: 3. Worldpay Payment method added;
    """
    ...
    def test_002_select_the_worldpay_payment_method(self):
        """
        DESCRIPTION: Select the Worldpay payment method;
