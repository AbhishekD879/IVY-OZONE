...
@pytest.mark.other
@vtest
class Test_C17406331_Vanilla__Verify_successful_Withdraw_for_Citadel(Common):
    """
    TR_ID: C17406331
    NAME: [Vanilla] - Verify successful Withdraw for Citadel
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Citadel;
    ...
    def test_004_select_citadel_payment_method__citadel_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Citadel payment method;
        DESCRIPTION: - Citadel should be added before deposit.
        EXPECTED: Withdrawal page for Citadel is opened;
        """
        pass
