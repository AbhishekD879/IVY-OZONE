...
@pytest.mark.other
@vtest
class Test_C17406332_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Citadel(Common):
    """
    TR_ID: C17406332
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Citadel
    ...
    PRECONDITIONS: 3. Citadel Payment method added;
    """
    ...
    def test_002_select_the_citadel_payment_method(self):
        """
        DESCRIPTION: Select the Citadel payment method;
