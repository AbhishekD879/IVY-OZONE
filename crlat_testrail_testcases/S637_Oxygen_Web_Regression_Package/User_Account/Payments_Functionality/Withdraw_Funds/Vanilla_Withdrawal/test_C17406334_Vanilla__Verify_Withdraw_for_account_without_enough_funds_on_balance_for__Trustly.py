...
@pytest.mark.other
@vtest
class Test_C17406334_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Trustly(Common):
    """
    TR_ID: C17406334
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Trustly
    ...
    PRECONDITIONS: 3. Trustly Payment method added;
    """
    ...
    def test_002_select_the_trustly_payment_method(self):
        """
        DESCRIPTION: Select the Trustly payment method;
