...
@pytest.mark.other
@vtest
class Test_C17406335_Vanilla__Verify_successful_Withdraw_for_MuchBetter(Common):
    """
    TR_ID: C17406335
    NAME: [Vanilla] - Verify successful Withdraw for MuchBetter
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - ***MuchBetter***;
    ...
    def test_004_select_muchbetter_payment_method__muchbetter_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select ***MuchBetter*** payment method;
        DESCRIPTION: - ***MuchBetter*** should be added before deposit.
        EXPECTED: Withdrawal page for ***MuchBetter*** is opened;
        """
        pass
