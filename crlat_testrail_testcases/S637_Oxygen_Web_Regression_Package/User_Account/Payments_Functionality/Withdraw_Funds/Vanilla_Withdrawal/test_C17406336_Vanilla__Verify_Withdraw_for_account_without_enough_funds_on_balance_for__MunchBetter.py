...
@pytest.mark.other
@vtest
class Test_C17406336_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__MunchBetter(Common):
    """
    TR_ID: C17406336
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - MunchBetter
    ...
    PRECONDITIONS: 3. ***MuchBetter*** Payment method added;
    """
    ...
    def test_002_select_the_muchbetter_payment_method(self):
        """
        DESCRIPTION: Select the ***MuchBetter*** payment method;
