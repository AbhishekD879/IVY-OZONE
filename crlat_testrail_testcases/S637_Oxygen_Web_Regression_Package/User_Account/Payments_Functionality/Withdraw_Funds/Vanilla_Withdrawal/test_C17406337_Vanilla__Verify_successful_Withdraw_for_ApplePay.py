...
@pytest.mark.other
@vtest
class Test_C17406337_Vanilla__Verify_successful_Withdraw_for_ApplePay(Common):
    """
    TR_ID: C17406337
    NAME: [Vanilla] - Verify successful Withdraw for ApplePay
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - ApplePay;
    ...
    def test_004_select_applepay_payment_method__applepay_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select ApplePay payment method;
        DESCRIPTION: - ApplePay should be added before deposit.
        EXPECTED: Withdrawal page for ApplePay is opened;
        """
        pass
