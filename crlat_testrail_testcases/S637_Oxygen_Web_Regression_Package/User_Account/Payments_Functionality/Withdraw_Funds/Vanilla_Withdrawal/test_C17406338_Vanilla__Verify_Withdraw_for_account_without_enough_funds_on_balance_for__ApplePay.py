...
@pytest.mark.other
@vtest
class Test_C17406338_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__ApplePay(Common):
    """
    TR_ID: C17406338
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - ApplePay
    ...
    PRECONDITIONS: 3. ApplePay Payment method added;
    """
    ...
    def test_002_select_the_applepay_payment_method(self):
        """
        DESCRIPTION: Select the ApplePay payment method;
