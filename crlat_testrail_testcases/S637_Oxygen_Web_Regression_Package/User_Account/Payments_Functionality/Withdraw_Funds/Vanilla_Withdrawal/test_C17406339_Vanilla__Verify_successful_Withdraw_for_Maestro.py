...
@pytest.mark.other
@vtest
class Test_C17406339_Vanilla__Verify_successful_Withdraw_for_Maestro(Common):
    """
    TR_ID: C17406339
    NAME: [Vanilla] - Verify successful Withdraw for Maestro
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Maestro;
    ...
    def test_004_select_maestro_payment_method__maestro_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Maestro payment method;
        DESCRIPTION: - Maestro should be added before deposit.
        EXPECTED: Withdrawal page for Maestro is opened;
        """
        pass
