...
@pytest.mark.other
@vtest
class Test_C17406340_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Maestro(Common):
    """
    TR_ID: C17406340
    NAME: [Vanilla] - Verify Withdraw for account without enough funds on balance for - Maestro
    ...
    PRECONDITIONS: 3. Maestro Payment method added;
    """
    ...
    def test_002_select_the_maestro_payment_method(self):
        """
        DESCRIPTION: Select the Maestro payment method;
