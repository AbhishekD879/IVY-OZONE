...
@pytest.mark.other
@vtest
class Test_C17406342_Vanilla__Verify_Withdraw_for_account_without_enough_funds_on_balance_for__Skrill1tap(Common):
    """
    TR_ID: C17406342
    ...
    PRECONDITIONS: 3. Skrill1tap Payment method added;
    """
    ...
    def test_002_select_the_skrill1tap_payment_method(self):
        """
        DESCRIPTION: Select the Skrill1tap payment method;
