...
@pytest.mark.other
@vtest
class Test_C17410294_Vanilla__Verify_successful_Withdraw_for_Visa_direct_Through_Safecharge(Common):
    """
    TR_ID: C17410294
    NAME: [Vanilla] - Verify successful Withdraw for Visa direct (Through Safecharge)
    DESCRIPTION: This test case verifies Withdraw of Funds for registered Payment Methods.
    PRECONDITIONS: 1. User should register at least 1 payment method - Visa direct (Through Safecharge);
    ...
    def test_004_select_visa_direct_through_safecharge_payment_method__visa_direct_through_safecharge_should_be_added_before_deposit(self):
        """
        DESCRIPTION: Select Visa direct (Through Safecharge) payment method;
        DESCRIPTION: - Visa direct (Through Safecharge) should be added before deposit.
