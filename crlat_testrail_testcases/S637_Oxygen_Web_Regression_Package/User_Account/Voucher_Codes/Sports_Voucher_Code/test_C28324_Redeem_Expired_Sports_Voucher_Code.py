...
@vtest
class Test_C28324_Redeem_Expired_Sports_Voucher_Code(Common):
    """
    TR_ID: C28324
    NAME: Redeem Expired Sports Voucher Code
    DESCRIPTION: This test case verifies redemption of an expired Voucher Code, if the Voucher Code or the offer related to it is expired
