...
@vtest
class Test_C869676_Verify_Order_of_Selections_for_Total_Number_of_Goals_market(Common):
    """
    TR_ID: C869676
    NAME: Verify Order of Selections for Total Number of Goals market
    DESCRIPTION: This test case verifies that selections are ordered in Price/Odds order (lowest price first) in Total Number of Goals section.
    ...
    def test_002_go_to_total_number_of_goals_section(self):
        """
        DESCRIPTION: Go to 'Total Number of Goals' section
        EXPECTED: 
        """
        pass
