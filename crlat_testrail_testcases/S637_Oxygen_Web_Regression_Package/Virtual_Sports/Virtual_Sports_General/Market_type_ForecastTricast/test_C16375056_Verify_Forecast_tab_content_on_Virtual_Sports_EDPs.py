...
@vtest
class Test_C16375056_Verify_Forecast_tab_content_on_Virtual_Sports_EDPs(Common):
    """
    TR_ID: C16375056
    ...
    DESCRIPTION: AUTOTEST MOBILE:[C27288908]
    DESCRIPTION: DESKTOP: [C30777412]
    ...
    def test_001_navigate_to_virtual_sport_page_and_tap_on_some_sport_from_preconditions_where_forecast_tab_should_be_displayednote_this_test_cases_should_be_run_for_all_virtual_sports_where_forecast_tab_should_be_displayed(self):
        """
