...
@pytest.mark.other
@vtest
class Test_C14253854_Event_Hub_Verify_Event_Hub_tab_scheduling(Common):
    """
    TR_ID: C14253854
    NAME: Event Hub: Verify Event Hub tab scheduling
    DESCRIPTION: This test case verifies Event Hub tab scheduling
    PRECONDITIONS: 1. Event hub is created in CMS > Sport Pages > Event Hubs (Max 6 Event Hubs could be created in CMS). You should create at least 1 module for Event Hub (e.g. 'Featured events')
    PRECONDITIONS: 2. Event Hub Module ribbon tab is created in CMS > Module ribbon tabs. It is scheduled to be displayed in current time. You should select created Event Hub in step 1 in the 'Event Hub Name' field
    """
