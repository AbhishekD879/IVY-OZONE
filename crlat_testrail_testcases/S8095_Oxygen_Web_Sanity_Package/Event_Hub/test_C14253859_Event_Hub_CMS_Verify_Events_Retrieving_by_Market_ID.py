...
@pytest.mark.other
@vtest
class Test_C14253859_Event_Hub_CMS_Verify_Events_Retrieving_by_Market_ID(Common):
    """
    TR_ID: C14253859
    NAME: Event Hub: CMS. Verify Events Retrieving by Market ID
    ...
    PRECONDITIONS: 2. Module Ribbon Tab is created for Event Hub
