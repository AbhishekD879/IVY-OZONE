...
@vtest
class Test_C10687851_Verify_In_Play_page_main_user_journeys_under_high_load(Common):
    """
    TR_ID: C10687851
    ...
    def test_003_verify_possibility_to_expand_all_available_modules_in_following_areas__in_play_tab_on_the_homepage_homein_play__in_play_in_sport_landing_page__in_play_section_with_all_sports_available_in_play(self):
        ...
        DESCRIPTION: - In-Play in sport landing page
        DESCRIPTION: - In-Play section with all sports available (in-play)
        EXPECTED: All modules are successfully expanded and module content is loaded with any delays
        """
        pass

    def test_004_verify_in_play_data_retrieving_after_connection_is_lost_app_was_inactive_during_the_high_load_for_following_areas__in_play_tab_on_the_homepage_homein_play__in_play_in_sport_landing_page__in_play_section_with_all_sports_available_in_play(self):
        """
