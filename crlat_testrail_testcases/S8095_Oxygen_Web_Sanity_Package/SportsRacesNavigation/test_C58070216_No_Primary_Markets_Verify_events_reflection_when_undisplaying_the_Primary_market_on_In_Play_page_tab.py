...
@pytest.mark.sports
@vtest
class Test_C58070216_No_Primary_Markets_Verify_events_reflection_when_undisplaying_the_Primary_market_on_In_Play_page_tab(Common):
    """
    TR_ID: C58070216
    NAME: [No Primary Markets]  Verify events reflection when undisplaying the  Primary market on 'In-Play' page/tab
