...
@vtest
class Test_C874344_Streaming_Greyhounds__RPGTV(Common):
    """
    TR_ID: C874344
    NAME: Streaming Greyhounds - RPGTV
    DESCRIPTION: Video Streaming - Verify that the customer can see an Perform(RPGTV) Greyhounds video stream for the Live <Race> event
    ...
    PRECONDITIONS: 3. Check that a Perform stream is available and mapped to a race (**'typeFlagCodes'**='RPG', 'PVA' ... AND **'drilldownTagNames'**='EVFLAG_RPM','EVFLAG_PVM' flags should be set)
    ...
    PRECONDITIONS: ![](index.php?/attachments/get/63405660)
    """
