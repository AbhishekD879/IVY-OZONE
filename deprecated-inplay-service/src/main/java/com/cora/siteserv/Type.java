 ...
 *       &lt;attribute name="regionIds" type="{http://schema.openbet.com/SiteServer/2.15/SSResponse.xsd}obSetOfStrings" />
 *       &lt;attribute name="regionNames" type="{http://schema.openbet.com/SiteServer/2.15/SSResponse.xsd}obSetOfStrings" />
...
public class Type {
    ...
    @XmlAttribute(name = "typeStatusCode")
    ...
    @XmlAttribute(name = "regionIds")
    protected String regionIds;
    @XmlAttribute(name = "regionNames")
