...
@pytest.mark.login
@vtest
class Test_C49291_Verify_multiple_log_in_from_different_devices_at_the_same_time(BaseUserAccountTest):
    """
    TR_ID: C49291
    NAME: Verify multiple log in from different devices at the same time
