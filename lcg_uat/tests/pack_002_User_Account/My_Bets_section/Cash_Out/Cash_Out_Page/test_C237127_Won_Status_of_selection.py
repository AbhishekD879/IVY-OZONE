...
@pytest.mark.login
@vtest
class Test_C237127_Won_Status_of_selection(BaseCashOutTest):
    """
    TR_ID: C237127
    NAME: Won status of selection
    DESCRIPTION: This test case verifies displaying 'Won' status on the Cash Out page
    """
    ...
    def test_002_in_ob_backoffice_set_win_result_for_selection_of_event_with_placed_single_bet(self):
        """
        DESCRIPTION: In OB Backoffice set **Win** result settle for selection of event
        """
    ...
    def test_003_check_badge_for_single_bet(self):
        ...
        EXPECTED: Bet is shown with status badge of "Won"
        """
