...
@pytest.mark.desktop
@vtest
class Test_C10284444_TO_UPDATE_Verify_Potential_return_increase_during_bet_placement_of_the_new_Acca_for_Cash_Out_Tab(BaseCashOutTest):
    """
    TR_ID: C10284444
    ...
    def test_000_preconditions(self):
        ...
        self.site.wait_content_state('cashout')
    ...
    def test_002_tap_confirm_button_and_verify_that_the_new_acca_is_successfully_placed_at_the_higher_potential_returns(self):
        ...
        result = wait_for_result(
            lambda: list(self.site.cashout.tab_content.accordions_list.items_as_ordered_dict.values())[0].cash_out_successful_message == vec.ema.EDIT_SUCCESS.caption,
