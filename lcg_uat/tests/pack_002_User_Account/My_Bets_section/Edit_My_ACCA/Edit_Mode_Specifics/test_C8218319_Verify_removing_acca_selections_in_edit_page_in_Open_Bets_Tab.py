...
@pytest.mark.login
@vtest
class Test_C8218319_Verify_removing_acca_selections_in_edit_page_in_Open_Bets_Tab(BaseCashOutTest):
    """
    TR_ID: C8218319
    NAME: Verify removing acca selection(s) in edit page in 'Open Bets' Tab
    ...
    PRECONDITIONS: 5. Go to 'Open Bets' Tab -> verify that Edit My Bet button is available
    ...
    def test_002_click_on_selections_removal_button_to_remove_selections_from_their_original_acca(self):
        ...
        selection = self.edited_bet.items_as_ordered_dict.get(self.event_name)
