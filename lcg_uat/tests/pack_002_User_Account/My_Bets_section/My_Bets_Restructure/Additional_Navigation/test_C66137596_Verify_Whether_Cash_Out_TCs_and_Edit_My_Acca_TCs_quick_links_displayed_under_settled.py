...
@vtest
class Test_C66137596_Verify_Whether_Cash_Out_TCs_and_Edit_My_Acca_TCs_quick_links_displayed_under_settled(Common):
    """
    TR_ID: C66137596
    NAME: Verify Whether Cash Out T&Cs and Edit My Acca T&Cs quick links displayed under settled
    DESCRIPTION: This test case is to Verify Whether Cash Out T&Cs and Edit My Acca T&Cs quick links displayed under settled
    ...
    def test_000_verify_the__cash_out_tampcs_and_edit_my_acca_tampcs_quick_links_by_scrolling_down_under_settled_by_navigating_from_open(self):
        """
        DESCRIPTION: Verify the  Cash Out T&amp;Cs and Edit My Acca T&amp;Cs quick links by scrolling down under Settled by navigating from open
        EXPECTED: Should be able to see Quick links of Cash Out T&amp;Cs and Edit My Acca T&amp;Cs under under Settled
        """
        pass
    ...
    def test_000_verify_the_location_of__cash_out_tampcs_and_edit_my_acca_tampcs(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/f2b317a5-2a97-4055-b1d0-7d7063c1d07a)
        """
        pass
