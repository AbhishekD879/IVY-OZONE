...
@vtest
# This test is covering C66111692
class Test_C66111686_Verify_content_information_displaying_based_on_the_bet_type(BaseBetSlipTest):
    """
    TR_ID: C66111686
    NAME: Verify content  information displaying based on the bet type
    DESCRIPTION: This test case verify content  information displaying based on the bet type
    ...
    def test_007_click_on_expand_to_to_see_the_bet_details_in_open_tab(self):
        """
        DESCRIPTION: Click on expand to to see the bet details in open tab
        EXPECTED: Bet details information should be based on the bets placed .It should be as per Figma deign
        EXPECTED: SS:
        EXPECTED: ![](index.php?/attachments/get/99fce416-c976-4a68-a475-34f0ce204bb7)  ![](index.php?/attachments/get/27abdd96-cae9-4a98-8fd8-303cb72ca571)
        """
