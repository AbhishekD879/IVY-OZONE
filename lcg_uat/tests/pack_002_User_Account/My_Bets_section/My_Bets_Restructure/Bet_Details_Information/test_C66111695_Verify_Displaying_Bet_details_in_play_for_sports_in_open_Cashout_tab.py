...
@vtest
class Test_C66111695_Verify_Displaying_Bet_details_in_play_for_sports_in_open_Cashout_tab(BaseBetSlipTest):
    """
    TR_ID: C66111695
    NAME: Verify Displaying Bet details in-play for sports in open/Cashout tab
    DESCRIPTION: This test case verify Displaying Bet details in-play for sports in open/Cashout tab
    ...
    def test_000_preconditions(self):
        ...
        event = self.get_active_events_for_category(category_id=self.ob_config.tennis_config.category_id,
                                                    in_play_event=True,
    ...
    def test_008_check_the_bet_detail_information_for_sports_singlesmultiples_for__bets_placed_for_pre_play_events(self):
        ...
        EXPECTED: SS:
        EXPECTED: ![](index.php?/attachments/get/c679b533-b6c1-46ed-ad92-6083473d3174)  ![](index.php?/attachments/get/2e449540-216c-407f-b2ab-6b77b5c4958c)
        """
