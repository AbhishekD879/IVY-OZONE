...
@vtest
class Test_C66111696_Verify_Displaying_Bet_details_in_play_for_Races_in_open_cashout_tab(BaseBetSlipTest):
    """
    TR_ID: C66111696
    NAME: Verify Displaying Bet details  in-play  for Races in open/cashout tab
    DESCRIPTION: This test case verify Displaying Bet details  in-play  for Races in open/cashout tab
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.num_of_selections = 0
    ...
    def test_003_navigate_any_racing_page(self):
        """
    ...
    def test_004_place_singlemutiple_bets__from_races__for_in_play_events(self):
        """
        DESCRIPTION: Place single/Mutiple bets  from races  for In-play events
        ...
        if len(parts) > 1 and len(parts[1]) == 1:
            self.expected_bet_potential_returns = f"{parts[0]}.{parts[1]}0"
    ...
    def test_007_check_new_setion_with_bet_detail_area_available(self):
        """
    ...
    def test_008_check_the_bet_detail_information_for_sports_singlesmultiples_for__bets_placed_for_pre_play_events(self):
        """
        DESCRIPTION: Check the bet detail information for sports singles/multiples for  bets placed for pre play events
        EXPECTED: Bet detail information should be as per Figma for In-play events
        EXPECTED: SS:
        EXPECTED: ![](index.php?/attachments/get/a2aae3e8-97a8-49f9-8098-dfcab63dac77)
        EXPECTED: ![](index.php?/attachments/get/c0a258d9-d7f8-4c8a-b548-781e6c5ec892)
        """
    ...
    def test_009_repeat_the_above_steps_for_cashout_tab(self):
        """
