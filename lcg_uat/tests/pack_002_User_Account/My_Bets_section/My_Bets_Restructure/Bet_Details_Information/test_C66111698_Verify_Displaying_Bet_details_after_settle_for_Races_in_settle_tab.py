...
@vtest
class Test_C66111698_Verify_Displaying_Bet_details_after_settle_for_Races_in_settle_tab(BaseBetSlipTest):
    """
    TR_ID: C66111698
    NAME: Verify Displaying Bet details after settle for Races in settle tab
    DESCRIPTION: This test case verify Displaying Bet details after settle for Races in settle tab
    ...
    def verify_bet_details_section_content(self, bet=None, tab_name=None):
        ...
        self.assertEqual(f'NO. OF WINNING LINES:  {expected_bet_number_of_winning_lines}', actual_bet_number_of_winning_lines) # 1 is coming for Lad
    ...
    def test_000_preconditions(self):
        ...
        hr_events = self.get_active_events_for_category(category_id=self.ob_config.horseracing_config.category_id,
                                                        ...
                                                        umber_of_events=self.number_of_events)
    ...
    def test_003_navigate_to_racing_page(self):
        """
        DESCRIPTION: Navigate to Racing page
    ...
    def test_010_check_the_bet_detail_information_for_races_singlesmultiples_in_settle_tab(self):
        """
        DESCRIPTION: Check the bet detail information for races singles/multiples in settle tab
        EXPECTED: Bet detail information should be as per Figma
        EXPECTED: SS:
        EXPECTED: ![](index.php?/attachments/get/3e20cb73-ee29-4543-bb45-7910d7492125)
        """
