...
@vtest
class Test_C66111705_Verify_CSS_elementsFont_size_font_colorof_Event_name_in_My_bets(Common):
    """
    TR_ID: C66111705
    NAME: Verify CSS elements(Font size, font color)of Event name in My bets
    DESCRIPTION: This testcase verifies CSS elements(Font size, color) of Event name in my bets
    ...
    def test_003_verify_event_name_of_bets_displayed_in_open_tab(self):
        """
        DESCRIPTION: Verify Event name of bets displayed in Open tab
        EXPECTED: Font size ,font colour should be as per figma
        EXPECTED: ![](index.php?/attachments/get/7e9e7b45-4a6a-4e4b-ab78-dafad99e86e2)
        """
        pass

    def test_004_verify_event_name_of_bets_displayed_in_cashout_tab(self):
        """
        DESCRIPTION: Verify Event name of bets displayed in Cashout tab
        EXPECTED: Font size,font color should be as per figma
        """
        pass

    def test_005_verify_event_name_of_bets_displayed_in_settled_tab(self):
        """
        DESCRIPTION: Verify Event name of bets displayed in Settled tab
        EXPECTED: Font size,font color should be as per figma
        """
        pass
