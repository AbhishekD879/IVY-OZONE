...
@vtest
class Test_C66113517_Verify_2UP_signposting_for_Won_bets_at_selection_level_when_has_a_bet_on_2up_market_in_settled_tab(Common):
    """
    TR_ID: C66113517
    NAME: Verify 2UP signposting for Won bets at selection level when has a bet on 2up market in settled tab
    DESCRIPTION: This testcase verifies 2UP signposting for Won bets in Settled tab at selection level when user has bet on 2up market
    ...
    def test_005_verify_the_2up_signposting(self):
        ...
        EXPECTED: 2UP signposting should be displayed in green color
        EXPECTED: ![](index.php?/attachments/get/5342bf63-8b45-47a2-8b0b-18dd15a55520)
        """
        pass
