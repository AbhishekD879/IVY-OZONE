...
@vtest
class Test_C66114011_Verify_Location_of_Bet_level_signpostings_displayed_for_the_bets_showing_in_my_bets_area(Common):
    """
    TR_ID: C66114011
    NAME: Verify Location of Bet level signpostings displayed for the bets showing in my bets area
    DESCRIPTION: This test case is to Verify Location of Bet level signpostings displayed for the bets showing in my bets area
    ...
    def test_003_verify_the_bet_level_sign_postings_for_single_and_multiple_bets_beside_event_name(self):
        """
        DESCRIPTION: Verify the Bet level sign postings for single and multiple bets beside event name
        EXPECTED: Bet level Sign postings should be displayed next to the event name (ex: 2UP&amp;WIN)
        """
        pass
