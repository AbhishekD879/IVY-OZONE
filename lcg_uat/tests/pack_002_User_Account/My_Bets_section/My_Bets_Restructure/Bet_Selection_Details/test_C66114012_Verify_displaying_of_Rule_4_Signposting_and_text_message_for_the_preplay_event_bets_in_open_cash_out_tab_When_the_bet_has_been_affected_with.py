...
@vtest
class Test_C66114012_Verify_displaying_of_Rule_4_Signposting_and_text_message_for_the_preplay_event_bets_in_open_cash_out_tab_When_the_bet_has_been_affected_with_Rule_4(Common):
    """
    TR_ID: C66114012
    NAME: Verify displaying of Rule 4 Signposting and text message for the preplay event bets in open/cash out tab When the bet has been affected with Rule 4
    ...
    def test_007_check_for_bets_with_rule4_signposting_and_message(self):
        """
    ...
    def test_009_check_for_bets_with_rule4_signposting_and_message(self):
        """
        DESCRIPTION: Check for bets with Rule4 signposting and message
        EXPECTED: Rule 4 signposting and text should be displayed as per Figma
        EXPECTED: SS:
        EXPECTED: ![](index.php?/attachments/get/b2ab6f14-fb50-4765-ab73-37ef8f7f0fb0)
        """
        pass
