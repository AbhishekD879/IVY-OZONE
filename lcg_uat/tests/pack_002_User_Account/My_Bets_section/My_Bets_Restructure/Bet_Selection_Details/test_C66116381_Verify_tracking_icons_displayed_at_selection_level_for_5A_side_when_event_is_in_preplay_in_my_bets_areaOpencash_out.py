...
@vtest
class Test_C66116381_Verify_tracking_icons_displayed_at_selection_level_for_5A_side_when_event_is_in_preplay_in_my_bets_areaOpencash_out(Common):
    """
    TR_ID: C66116381
    NAME: Verify  tracking icons displayed at selection level for 5A side when event is in preplay in my bets area(Open,cash out)
    DESCRIPTION: This testcase verifies tracking icons displayed at selection level for 5A side when event is in preplay in my bets area(Open,cash out)
    PRECONDITIONS: 5A side bet preplay event should be available in Open,Cashout tab
    """
