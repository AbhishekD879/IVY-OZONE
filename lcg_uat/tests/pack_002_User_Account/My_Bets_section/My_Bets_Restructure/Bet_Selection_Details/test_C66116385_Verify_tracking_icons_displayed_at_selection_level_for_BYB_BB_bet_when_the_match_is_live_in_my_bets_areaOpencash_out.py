...
@vtest
class Test_C66116385_Verify_tracking_icons_displayed_at_selection_level_for_BYB_BB_bet_when_the_match_is_live_in_my_bets_areaOpencash_out(Common):
    """
    TR_ID: C66116385
    NAME: Verify  tracking icons displayed at selection level for BYB/BB bet when the match is live in my bets area(Open,cash out)
    DESCRIPTION: This testcase verifies tracking icons displayed at selection level for BYB/BB when the match is live in my bets area(Open,cash out)
    PRECONDITIONS: BYB/BB bet on inplay event should be available in Open,Cashout tab
    """
