...
@vtest
class Test_C66132232_Verify_no_GO_TO_5_A_Side_CTA_button_display_for_void_bets_in_settle_tab_for_kickoff_event(Common):
    """
    TR_ID: C66132232
    NAME: Verify no  GO TO 5-A-Side CTA  button display for void bets in settle tab for kickoff event
    DESCRIPTION: This test case verify no  GO TO 5-A-Side CTA  button display for void bets in settle tab for kickoff event
    ...
    def test_000_check_go_to_5_a_side_cta__button__for_void_bets_after__the_event_gets_kickoff(self):
        """
        DESCRIPTION: Check GO TO 5-A-Side CTA  button  for void bets after  the event gets kickoff
        EXPECTED: In settle No GO TO 5-A-Side CTA  button  should be displayed for void bets after the event starts
        """
        pass
