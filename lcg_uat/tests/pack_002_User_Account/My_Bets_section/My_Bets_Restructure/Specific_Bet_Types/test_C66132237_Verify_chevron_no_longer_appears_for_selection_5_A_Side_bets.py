...
@vtest
class Test_C66132237_Verify_chevron_no_longer_appears_for_selection_5_A_Side_bets(Common):
    """
    TR_ID: C66132237
    NAME: Verify chevron no longer appears for selection 5-A-Side bets
    DESCRIPTION: This test case verify chevron no longer appears for selection 5-A-Side bets
    ...
    def test_000_check_the_event_location_for_5_a_side_bet(self):
        ...
        EXPECTED: Event name should be  show above the  leags  below the header
        """
        pass

    def test_000_check_chevron__display_at_the_beside_the_selection_name(self):
        """
        DESCRIPTION: Check chevron  Display at the beside the selection name
        EXPECTED: Chevron no longer appears to the right of each selection
        """
        pass
