...
@vtest
class Test_C66132238_Verify_on_clicking_on_anywhere_on_the_selection_area(Common):
    """
    TR_ID: C66132238
    NAME: Verify on clicking on anywhere on the selection area
    DESCRIPTION: This test case verify on clicking on anywhere on the selection area
    ...
    def test_000_click_anywhere_on_the_selection_area__full_selection_area_is_click_able(self):
        """
        DESCRIPTION: Click anywhere on the selection area  (Full selection area is click able)
