...
@vtest
class Test_C66132240_Verify_displaying_of_the_odd_location_and_font_for_5_A_Side_bets(Common):
    """
    TR_ID: C66132240
    NAME: Verify displaying of the odd location and  font for 5-A Side bets
    DESCRIPTION: This test case verify displaying of the odd location and  font for 5-A Side bets
    ...
    def test_000_check_the_odd_location(self):
        """
        DESCRIPTION: Check the odd location
        EXPECTED: Odd location should be above the potentaial returns
        """
        pass
