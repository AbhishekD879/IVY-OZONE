...
@vtest
class Test_C66132261_Verify_Event_location_and_score_location_for_BYB_BB_in_all_the_tabs(Common):
    """
    TR_ID: C66132261
    NAME: Verify Event location and score location for BYB/BB in  all the tabs
    ...
    def test_000_check_the_event_name_and_scores_position__for_bybbb_bet__in_settle_bets(self):
        """
        DESCRIPTION: Check the event name and scores position  for BYB/BB bet  in settle bets
        EXPECTED: Event name should be  show above the  legs  below the bet header
