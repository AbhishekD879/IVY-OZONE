...
@vtest
class Test_C66132263_Verify_chevron_no_longer_appears_for_selection_BYB_BB(Common):
    """
    TR_ID: C66132263
    NAME: Verify chevron no longer appears for selection  BYB/BB
    DESCRIPTION: This test case  verify chevron no longer appears for selection  BYB/BB
