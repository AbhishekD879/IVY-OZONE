...
@vtest
class Test_C66132278_Verify_Bet_SHARE_location_for_lotto_bets_in_bet_details(Common):
    """
    TR_ID: C66132278
    NAME: Verify Bet SHARE location for lotto bets in bet details
    DESCRIPTION: This test case verify Bet SHARE location for lotto bets in bet details
    ...
    def test_000_check_the_location_of_the_hare_icon(self):
        """
        DESCRIPTION: Check the location of the hare icon
        EXPECTED: Share icon location should be as pr Figma deign
        """
        pass
    ...
    def test_000_lotto_bets_should_be_available_in_settle_tab(self):
        """
        DESCRIPTION: Lotto bets should be available in settle tab
        EXPECTED: Share icon location should be as pr Figma deign  in settle tab
        """
        pass

    def test_000_check_the_share_icon_location(self):
        """
        DESCRIPTION: Check the Share icon location
        EXPECTED: 
        """
        pass
