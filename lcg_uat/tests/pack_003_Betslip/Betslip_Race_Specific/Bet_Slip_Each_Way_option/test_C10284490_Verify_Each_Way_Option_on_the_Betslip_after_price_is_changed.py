...
@pytest.mark.betslip
@vtest
class Test_C10284490_Verify_Each_Way_Option_on_the_Betslip_after_price_is_changed(BaseRacing, BaseBetSlipTest):
    """
    TR_ID: C10284490
    ...
    PRECONDITIONS: TST2 - 127.0.0.1 liveserve-publisher-dev0.coralsports.dev.cloud.ladbrokescoral.com
