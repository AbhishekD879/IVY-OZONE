...
@pytest.mark.betslip
@vtest
class Test_C10375629_Added_for_OX98_Verify_displaying_Betslip_with_Tricast(BaseRacing, BaseBetSlipTest):
    """
    TR_ID: C10375629
    ...
    def test_004_add_a_selection_from_win_or_each_way_tab_on_horse_racegrayhound_edpverify_that_additional_single_selection_is_shown_in_betslip(self):
        ...
        self.assertEqual(stake1.market_name, 'Tricast',
                         msg=f'Actual Market name "{stake2.market_name}" is not the same as expected "{"Tricast"}"')
