...
# @pytest.mark.prod # This functionality is no longer applicable from release 108
# @pytest.mark.hl
# @pytest.mark.tst2
# @pytest.mark.stg2
# @pytest.mark.medium
...
@pytest.mark.na
@vtest
class Test_C28117_Betslip_Widget_Display_on_Tablet(BaseBetSlipTest):
    """
    TR_ID: C28117
    VOL_ID: C9698171
    NAME: Betslip Widget Display on Tablet
    ...
    def test_001_load_oxygen_app_on_tablet_device(self):
        ...
        actual_tab_menu = self.site.betslip.betslip_tabs.items_names
    ...
    def test_002_tap_my_bets_tab(self):
        ...
        if self.is_cashout_tab_enabled:
            self.assertTrue(
                self.site.betslip.tabs_menu.items_as_ordered_dict.get(vec.bet_history.CASH_OUT_TAB_NAME).is_selected(),
