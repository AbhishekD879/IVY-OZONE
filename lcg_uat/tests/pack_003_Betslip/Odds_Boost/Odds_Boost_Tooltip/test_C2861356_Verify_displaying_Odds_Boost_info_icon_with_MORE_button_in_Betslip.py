...
@pytest.mark.desktop
@vtest
class Test_C2861356_Verify_displaying_Odds_Boost_info_icon_with_MORE_button_in_Betslip(BaseBetSlipTest):
    """
    TR_ID: C2861356
    ...
    def test_004_tap_i_icon_one_more_time(self):
        ...
        EXPECTED: - 'More' button
        """
        self.test_002_tap_i_iconverify_that_the_tooltip_style_popup_is_displayed()
    ...
    def test_005_tap_more_buttonverify_that_user_is_redirected_to_appropriate_page(self):
        ...
        """
        # More button functionality is no more applicable
