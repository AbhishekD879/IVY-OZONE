...
@pytest.mark.login
@vtest
class Test_C29147_Verify_Overask_triggering_with_higher_than_max_Free_Bet_and_stake_value(BaseBetSlipTest):
    """
    TR_ID: C29147
    ...
    def test_000_preconditions(self):
        ...
        """
        event_params = self.ob_config.add_autotest_premier_league_football_event(max_bet=0.05)
    ...
    def test_002_enter_stake_value_which_is_higher_then_maximum(self):
        """
        ...
        self.place_single_bet(freebet=True, number_of_stakes=1)
    ...
    def test_004_trigger_stake_modification_by_trader_and_verify_betslip_displaying(self):
        ...
        self.bet_intercept.offer_stake(account_id=account_id, bet_id=bet_id, betslip_id=betslip_id, max_bet=0.05)
        ...
        self.assertTrue(self.get_betslip_content().wait_for_overask_warning(),
                        msg='Overask warning message did not appear on betslip')
        ...
        self.assertFalse(betnow_btn.is_enabled(expected_result=False), msg='Bet Now button is enabled')
    ...
    def test_007_repeat_steps_2_5(self):
        ...
        """
        self.test_002_enter_stake_value_which_is_higher_then_maximum()
