...
@pytest.mark.desktop
@vtest
class Test_C58694683_Verify_Betslip_is_cleared_after_logged_out_during_Overask_is_pending(BaseBetSlipTest):
    """
    TR_ID: C58694683
    NAME: Verify Betslip is cleared after logged out during Overask is pending
    DESCRIPTION: This test case verifies that  Betslip is cleared after tapping logging out during OA
    ...
    def test_000_preconditions(self):
        ...
        """
        self.__class__.selection_id = list(self.ob_config.add_autotest_premier_league_football_event(max_bet=self.max_bet).selection_ids.values())[0]
    ...
    def test_001_tap_place_bet_button(self):
        ...
        EXPECTED: - OA bet trigger is sent to TI (Go to TI tap on Bet tab>BI Request>Search)
        """
    ...
    def test_004_check_local_storage(self):
        """
        ...
        """
        key_value1 = self.get_local_storage_cookie_value_as_dict('OX.overaskPlaceBetsData')
        self.assertTrue(key_value1 is None, msg=f'Value of cookie "OX.overaskPlaceBetsData" is not blank')
        key_value2 = self.get_local_storage_cookie_value_as_dict('OX.overaskIsInProcess')
    ...
    def test_005_tap_login_buttonlogin_with_user1_from_preconditions(self):
        """
