...
@pytest.mark.overask
@vtest
class Test_C16379442_Accepting_split_double_bets__only_one_bet_placed(BaseBetSlipTest):
    """
    TR_ID: C16379442
    NAME: Accepting split double bets  - only one bet placed
    DESCRIPTION: This test case verifies accepting split double bets without linked parts - only one bet placed
