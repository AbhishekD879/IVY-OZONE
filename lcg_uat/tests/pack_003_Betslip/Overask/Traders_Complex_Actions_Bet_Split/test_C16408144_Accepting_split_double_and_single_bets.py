...
@pytest.mark.desktop
@vtest
class Test_C16408144_Accepting_split_double_and_single_bets(BaseBetSlipTest):
    """
    TR_ID: C16408144
    ...
    def test_002__enter_stakes_into_double_field_and_into_singles_fields_value_which_is_higher_than_the_maximum_limit_for_added_selections_tap_button_place_bet(
            self):
        """
        ...
        stake.amount_form.input.value = self.max_bet + 0.10
        self.__class__.est_returns_before = self.site.betslip.total_estimate_returns
