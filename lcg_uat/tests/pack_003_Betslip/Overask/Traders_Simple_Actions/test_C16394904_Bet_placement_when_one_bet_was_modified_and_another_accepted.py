...
@pytest.mark.desktop
@vtest
class Test_C16394904_Bet_placement_when_one_bet_was_modified_and_another_accepted(BaseBetSlipTest):
    """
    TR_ID: C16394904
    ...
    def test_002__enter_stake_value_which_is_higher_than_maximum_limit_for_one_added_selection_enter_stake_value_which_is_higher_than_maximum_limit_for_another_added_selection(
            self):
        """
    ...
    def test_003_tap_place_bet_button(self):
        """
        DESCRIPTION: Tap 'Place bet' buttonh
        EXPECTED: *   Overask is triggered for the User
        EXPECTED: *   The bet review notification is shown to the User
        """
        # Covered in Step #1

    def test_004__trigger_any_modification_by_trader_for_the_first_bet_trigger_accepting_the_bet_by_a_trader_in_openbet_system_for_the_second_bet(
            self):
        """
        ...
        self.assertNotEqual(stake.offered_stake.background_color_value, vec.colors.OVERASK_MODIFIED_PRICE_COLOR,
