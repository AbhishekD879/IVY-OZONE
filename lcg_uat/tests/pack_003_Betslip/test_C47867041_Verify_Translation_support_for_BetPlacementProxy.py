...
@pytest.mark.betslip
@vtest
class Test_C47867041_Verify_Translation_support_for_BetPlacementProxy(BaseDataLayerTest):
    """
    TR_ID: C47867041
    ...
    def test_006_expand_outcomedetails_branch(self):
        ...
        EXPECTED: name: "Draw"
        """
        ss_request = self.ss_req.ss_event_to_outcome_for_event(event_id=self.outcome_details['eventId'],
