...
@pytest.mark.other
@vtest
class Test_C66133020_Verify_if_updated_record_is_displayed_under_Active_Cards_Table(Common):
    """
    TR_ID: C66133020
    NAME: Verify if updated record is displayed under 'Active Cards Table'
    DESCRIPTION: This test case is to verify if updated record is displayed under 'Active Cards Table'
    ...
    def test_000_verify_if_updated_record_is_displayed_under_active_cards_table(self):
        """
        DESCRIPTION: Verify if updated record is displayed under 'Active Cards Table'
        EXPECTED: Updated record should be displayed under 'Active Cards Table' upon page refresh
        """
        pass
