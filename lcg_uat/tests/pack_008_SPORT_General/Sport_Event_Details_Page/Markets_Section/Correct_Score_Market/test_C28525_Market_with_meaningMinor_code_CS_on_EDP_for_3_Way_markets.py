...
@pytest.mark.sports
@vtest
class Test_C28525_Market_with_meaningMinor_code_CS_on_EDP_for_3_Way_markets(BaseSportTest, BaseBetSlipTest):
    """
    TR_ID: C28525
    NAME: Market with  meaningMinor code 'CS' on  EDP for 3-Way markets.
