...
@pytest.mark.sports
@vtest
class Test_C60092719_Market_with_meaningMinor_code_CS_on_EDP_for_2_Way_markets_Players(BaseSportTest, BaseBetSlipTest):
    """
    TR_ID: C60092719
    NAME: Market with  meaningMinor code 'CS' on EDP for 2-Way markets (Players).
