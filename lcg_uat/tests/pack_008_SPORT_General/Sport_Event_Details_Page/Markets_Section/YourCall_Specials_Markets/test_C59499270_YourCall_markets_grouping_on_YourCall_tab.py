...
@pytest.mark.desktop
@vtest
class Test_C59499270_YourCall_markets_grouping_on_YourCall_tab(BaseSportTest):
    """
    TR_ID: C59499270
    ...
    def test_002_go_to_yourcall_tab_and_review_the_market_grouping(self):
        ...
        actual_market_count = len(list(self.markets_sections.keys()))
        expected_market_count = len(self.yourcall_markets)
        self.assertEqual(actual_market_count, expected_market_count,
                         msg='Only YourCall markets are not present on "#YourCall" tab')
