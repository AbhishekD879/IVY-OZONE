...
@pytest.mark.sports
@vtest
class Test_C28482_Verify_Market_with_Handicap_Values(BaseSportTest):
    """
    TR_ID: C28482
    NAME: Verify Market with Handicap Values
    DESCRIPTION: This test case verifies makets which selections have handicap values available on SS response.
