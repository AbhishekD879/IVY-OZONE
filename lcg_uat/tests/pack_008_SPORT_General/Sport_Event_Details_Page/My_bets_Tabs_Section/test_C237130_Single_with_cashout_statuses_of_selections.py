...
@pytest.mark.login
@vtest
class Test_C237130_Single_with_cashout_statuses_of_selections(BaseCashOutTest, BaseSportTest):
    """
    TR_ID: C237130
    NAME: Single with cashout statuses of selections
    DESCRIPTION: This test case verifies displaying status of single selection with cashout on 'My Bets' tab on the Event Details page
    PRECONDITIONS: * User is logged in;
    PRECONDITIONS: * User has placed single bet on events with Cash Out offer available
    ...
    def test_001_navigate_to_my_bets_tab_on_event_details_page_of_event_with_placed_single_bet_with_available_cash_out(
            self):
        """
    ...
    def test_003_navigate_to_my_bets_tab_on_event_details_page_of_event_with_placed_single_bet_with_available_cash_out(
            self):
        """
        DESCRIPTION: Navigate to 'My bets' tab on Event Details page of event with placed **Single** bet with available cash out
        EXPECTED: * 'My bets' tab is opened
    ...
    def test_005_navigate_to_my_bets_tab_on_event_details_page_of_event_with_placed_single_bet_with_available_cash_out(
            self):
        """
        DESCRIPTION: Navigate to 'My bets' tab on Event Details page of event with placed **Single** bet with available cash out
        EXPECTED: * 'My bets' tab is opened
