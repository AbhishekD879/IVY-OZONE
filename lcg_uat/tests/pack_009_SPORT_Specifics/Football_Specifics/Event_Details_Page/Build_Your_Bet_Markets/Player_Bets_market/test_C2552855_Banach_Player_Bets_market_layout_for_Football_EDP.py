...
@pytest.mark.sports
@vtest
class Test_C2552855_Banach_Player_Bets_market_layout_for_Football_EDP(BaseBanachTest):
    """
    TR_ID: C2552855
    ...
    PRECONDITIONS: 4. Click/Tap on 'Build Your Bet' tab
    """
    ...
    def test_003_select_some_player_name(self):
        ...
        EXPECTED: * Empty second dropdown is displayed on the right  - Note: cannot automate as a
        """
    ...
    def test_005_select_some_statistic(self):
        ...
        EXPECTED: * Next dropdown box is prepopulated with statistic value
