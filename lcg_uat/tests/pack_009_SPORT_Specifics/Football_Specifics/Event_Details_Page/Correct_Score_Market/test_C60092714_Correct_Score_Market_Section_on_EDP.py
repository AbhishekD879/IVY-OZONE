...
@pytest.mark.medium
@vtest
class Test_C60092714_Correct_Score_market_section_on_EDP(BaseSportTest):
    """
    TR_ID: C28525
    NAME: Correct Score market section on EDP
    DESCRIPTION: Test verifies appearance of Correct Score market on EDP
    """
    ...
    def test_002_go_to_correct_score_market_section(self):
        ...
        self.assertTrue(self.correct_score, msg=f'"{self.market_name}" section is not found in "{self.markets_list.keys()}"')
    ...
    def test_008_verify_selections_sortening(self):
        """
    ...
    def test_009_clicktap_on_show_less_button(self):
        """
