...
@pytest.mark.banach
@vtest
class test_C65043454_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Goals_Inside_The_Box_1_Shots_1_To_Be_Carded_Yes_Assists_1(BaseFiveASide):
    """
    TR_ID: C65043454
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Goals Inside The Box-1 Shots-1 To Be Carded-Yes Assists-1
