...
@pytest.mark.banach
@vtest
class test_C65043476_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Passes_35_Goals_OutsideTheBox_1_Goals_1_Shots_1(BaseFiveASide):
    """
    TR_ID: C65043476
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Goals Outside The Box-1 Goals-1 Shots-1
