...
@pytest.mark.banach
@vtest
class Test_C65043478_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede1_Passes35_Goals_Outside_The_Box1_Goals1_Shots_Outside_the_Box1(BaseFiveASide):
    """
    TR_ID: C65043478
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Goals Outside The Box-1 Goals-1 Goals Outside the Box-1
