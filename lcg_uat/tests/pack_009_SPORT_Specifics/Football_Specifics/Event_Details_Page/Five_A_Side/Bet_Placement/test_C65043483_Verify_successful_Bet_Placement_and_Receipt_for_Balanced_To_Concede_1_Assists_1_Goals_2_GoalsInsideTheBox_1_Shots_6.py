...
@pytest.mark.banach
@vtest
class Test_C65043483_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Assists_1_Goals_2_GoalsInsideTheBox_1_Shots_6(BaseFiveASide):
    """
    TR_ID: C65043483
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Assists-1 Goals-2 Goals Inside The Box-1 Shots-6
