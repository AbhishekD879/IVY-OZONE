...
@pytest.mark.banach
@vtest
class Test_C65043531_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Goals_inside_the_box_1_Shots_1_To_be_carder_Yes_Assists_1(BaseFiveASide):
    """
    TR_ID: C65043531
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Goals Inside The Box-1 Shots-2 To Be Carded-Yes Assists-1
