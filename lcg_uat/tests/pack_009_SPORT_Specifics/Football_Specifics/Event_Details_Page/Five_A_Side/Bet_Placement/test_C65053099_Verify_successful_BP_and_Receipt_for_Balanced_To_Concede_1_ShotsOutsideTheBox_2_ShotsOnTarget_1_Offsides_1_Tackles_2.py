...
@pytest.mark.banach
@vtest
class Test_C65053099_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_ShotsOutsideTheBox_2_ShotsOnTarget_1_Offsides_1_Tackles_2(BaseFiveASide):
    """
    TR_ID: C65053099
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Shots Outside The Box-2 Shots On Target-1 Offsides-1Tackles-2
