...
@pytest.mark.banach
@vtest
class Test_C65063093_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Tackles_2_Shots_Outside_The_Box_3_Passes_60_Passes_15(BaseFiveASide):
    """
    TR_ID: C65063093
    NAME: 	Test case verifies successful Bet Placement and Receipt for Balanced -   To Concede-1 Tackles-2 Shots Outside The Box-3 Passes-60 Passes-15
