...
@pytest.mark.banach
@vtest
class Test_C65065151_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Passes_35_GoalsOutsideTheBox_1_GoalsInsideTheBox_1_Tackles_1(BaseFiveASide):
    """
    TR_ID: C65065151
    NAME: 	Verify successful Bet Placement and Receipt for Balanced -  To Concede-1 Passes-35 Goals Outside The Box-1 Goals Inside The Box-1 Tackles-1
