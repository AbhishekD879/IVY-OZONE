...
@pytest.mark.banach
@vtest
class test_C65157818_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Passes_35_Goals_Outside_The_Box_1_Offsides_1_Shots_3(BaseFiveASide):
    """
    TR_ID: C65157818
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-1 Goals Outside The Box-1 Offsides-1 Shots-3
