...
@pytest.mark.cms
@vtest
class Test_C65177176_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Goals_Outside_The_Box_1_Tackles_1_Shots_3_Offsides_1(BaseFiveASide):
    """
    TR_ID: C65177176
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Goals Outside The Box-1 Tackles-1 Shots-3 Offsides-1
