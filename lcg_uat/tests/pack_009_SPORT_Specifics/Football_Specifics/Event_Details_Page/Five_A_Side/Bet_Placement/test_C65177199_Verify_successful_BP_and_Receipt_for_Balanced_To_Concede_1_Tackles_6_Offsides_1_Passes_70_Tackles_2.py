...
@pytest.mark.banach
@vtest
class Test_C65177199_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Tackles_6_Offsides_Passes_70_Tackles_2(BaseFiveASide):
    """
    TR_ID: C65177199
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Tackles-6 Offsides-1 Passes-70 Tackles-2
