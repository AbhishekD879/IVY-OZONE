...
@pytest.mark.banach
@vtest
class Test_C65177200_Verify_successful_BP_Receipt_for_Balanced_To_Concede_1_Passes_35_GoalsOTB1_Passes_20_ShotsOTB1(BaseFiveASide):
    """
    TR_ID: C65177200
    NAME: Verify successful Bet Placement and Receipt for Balanced To Concede-1 Passes-35 Goals Outside The Box-1 Passes-20 Shots Outside The Box-1
