...
@pytest.mark.banach
@vtest
class Test_C65177238_Verify_successful_BP_and_Receipt_for_Balanced_To_Concede_1_Passes_35_Goals_Outside_The_Box_25_Passes_20_Tackles_1(BaseFiveASide):
    """
    TR_ID: C65177238
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Goals Outside The Box-1 Passes-20 Tackles-1
