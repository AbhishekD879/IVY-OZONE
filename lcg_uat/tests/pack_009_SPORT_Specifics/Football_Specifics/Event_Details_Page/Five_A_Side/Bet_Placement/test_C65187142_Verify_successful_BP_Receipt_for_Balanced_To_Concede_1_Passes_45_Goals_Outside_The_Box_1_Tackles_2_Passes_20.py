...
@pytest.mark.banach
@vtest
class Test_C65187142_Verify_successful_BP_Receipt_for_Balanced_To_Concede_1_Passes_45_Goals_Outside_The_Box_1_Tackles_2_Passes_20(BaseFiveASide):
    """
    TR_ID: C65187142
    NAME: Verify successful Bet Placement and Receipt for Balanced To Concede-1 Passes-45 Goals Outside The Box-1 Tackles-2 Passes-20
