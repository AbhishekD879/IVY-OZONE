...
@pytest.mark.banach
@vtest
class Test_C65187147_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede1_Passes35_Offsides1_GoalsInsideTheBox1_Tackles1(BaseFiveASide):
    """
    TR_ID: C65187147
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Offsides-1 Goals Inside The Box-1 Tackles-1
