...
@pytest.mark.banach
@vtest
class test_C65192237_Verify_successfulBPandReceipt_for_Balanced_ToConcede_1_Passed_35_Offside_1_GoalsOutsideBox_1_GoalsOutsideBox_1(BaseFiveASide):
    """
    TR_ID: C65192237
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Offsides-1 Goals Outside The Box-1 Goals Outside The Box-1
