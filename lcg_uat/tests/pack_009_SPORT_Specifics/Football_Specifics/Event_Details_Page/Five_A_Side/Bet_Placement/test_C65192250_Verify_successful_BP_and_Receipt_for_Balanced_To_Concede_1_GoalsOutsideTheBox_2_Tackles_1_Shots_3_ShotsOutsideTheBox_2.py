...
@pytest.mark.banach
@vtest
class Test_C65192250_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Goals_Outside_The_Box_2_Tackles_1_Shots_3_Shots_Outside_The_Box_2(BaseFiveASide):
    """
    TR_ID: C65192250
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-0 Tackles-1 Passes-25 Assists-1 Shots-1
