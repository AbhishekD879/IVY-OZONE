...
@pytest.mark.banach
@vtest
class Test_C65221680_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_5_Goals_Inside_The_Box_1_Shots_3_To_Be_Carded_Yes_Assists_1(BaseFiveASide):
    """
    TR_ID: C65221680
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-5 Goals Inside The Box-1 Shots-3 To Be Carded-Yes Assists-1
