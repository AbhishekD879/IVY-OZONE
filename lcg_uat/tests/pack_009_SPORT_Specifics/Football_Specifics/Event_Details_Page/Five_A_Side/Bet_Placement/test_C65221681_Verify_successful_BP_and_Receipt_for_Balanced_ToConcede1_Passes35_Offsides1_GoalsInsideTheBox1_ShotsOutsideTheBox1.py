...
@pytest.mark.banach
@vtest
class test_C65221681_Verify_successful_BP_and_Receipt_for_Balanced_ToConcede1_Passes35_Offsides1_GoalsInsideTheBox1_ShotsOutsideTheBox1(BaseFiveASide):
    """
    TR_ID: C65221681
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Offsides-1 Goals Inside The Box-1 Shots Outside The Box-1
