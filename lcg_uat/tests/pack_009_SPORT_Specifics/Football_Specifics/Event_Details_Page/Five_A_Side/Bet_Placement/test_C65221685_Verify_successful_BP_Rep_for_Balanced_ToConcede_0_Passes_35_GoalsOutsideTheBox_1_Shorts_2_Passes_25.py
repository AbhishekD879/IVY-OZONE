...
@pytest.mark.banach
@vtest
class Test_C65221685_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_ToConcede_0_Passes_35_GoalsOutsideTheBox_1_Shorts_2_Passes_25(BaseFiveASide):
    """
    TR_ID: C65221685
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-0 Passes-35 Goals Outside The Box-1 Shorts-2 Passes-25
