...
@pytest.mark.cms
@vtest
class Test_C65221697_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_Passes_35_Goals_Outside_The_Box_1_Passes_20_Goals_1(BaseFiveASide):
    """
    TR_ID: C65221697
    NAME: 	Verify successful Bet Placement and Receipt for Balanced-To Concede-1 Passes-35 Goals Outside The Box-1 Passes-20 Goals-1
