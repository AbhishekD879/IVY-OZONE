...
@pytest.mark.banach
@vtest
class Test_C65221782_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_1_ShotsOutsideTheBox_3_Passes_30_Tackles_2_Shots_3(BaseFiveASide):
    """
    TR_ID: C65221782
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Shots Outside The Box-3 Passes-30 Tackles-2 Shots-3
