...
@pytest.mark.banach
@vtest
class Test_C65221786_Verify_BP_Receipt_for_Balanced_To_Concede_1_Goals_Outside_The_Box_2_Tackles_4_Shots_Outside_The_Box_2_Offsides_1(BaseFiveASide):
    """
    TR_ID: C65221786
    NAME: Verify successful Bet Placement and Receipt for Balanced To Concede-1 Goals Outside The Box-2 Tackles-4 Shots Outside The Box-2 Offsides-1
