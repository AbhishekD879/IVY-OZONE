...
@pytest.mark.banach
@vtest
class Test_C65221821_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_ToConcede2_Passes40_Goaloutsidebox1_ShotsonTarget2_Passes25(BaseFiveASide):
    """
    TR_ID: C65221821
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-2 Passes-40 Goals Outside The Box-1 Shots On Target-2 Passes-25
