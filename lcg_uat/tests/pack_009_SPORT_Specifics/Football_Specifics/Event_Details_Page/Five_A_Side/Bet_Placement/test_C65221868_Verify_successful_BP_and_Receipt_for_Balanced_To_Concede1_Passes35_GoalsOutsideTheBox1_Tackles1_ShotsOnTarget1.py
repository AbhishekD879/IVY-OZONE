...
@pytest.mark.banach
@vtest
class Test_C65221868_Verify_successful_BP_and_Receipt_for_Balanced_To_Concede1_Passes35_GoalsOutsideTheBox1_Tackles1_ShotsOnTarget1(BaseFiveASide):
    """
    TR_ID: C65221868
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Goals Outside The Box-1 Tackles-1 Shots On Target-1
