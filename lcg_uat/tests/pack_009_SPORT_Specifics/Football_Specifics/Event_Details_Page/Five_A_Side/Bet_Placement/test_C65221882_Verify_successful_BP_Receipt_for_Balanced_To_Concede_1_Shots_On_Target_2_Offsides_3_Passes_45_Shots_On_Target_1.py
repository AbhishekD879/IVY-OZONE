...
@pytest.mark.banach
@vtest
class Test_C65221882_Verify_successful_BP_Receipt_for_Balanced_To_Concede_1_Shots_On_Target_2_Offsides_3_Passes_45_Shots_On_Target_1(BaseFiveASide):
    """
    TR_ID: C65221882
    NAME: Verify successful Bet Placement and Receipt for Balanced To Concede-1 Shots On Target-2 Offsides-3 Passes-45 Shots On Target-1
