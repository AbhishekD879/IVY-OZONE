...
@pytest.mark.banach
@vtest
class Test_C65221883_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_ToConcede1_Passes35_GoalsOutsideBox1_ShotsonTraget2_ShotsonTarget1(BaseFiveASide):
    """
    TR_ID: C65221883
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-1 Passes-35 Goals Outside The Box-1 Shots On Target-2 Shots On Target-1
