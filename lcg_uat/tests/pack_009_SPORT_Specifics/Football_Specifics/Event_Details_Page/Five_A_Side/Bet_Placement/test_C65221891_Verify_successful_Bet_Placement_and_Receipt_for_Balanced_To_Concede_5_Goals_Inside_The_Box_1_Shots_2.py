...
@pytest.mark.banach
@vtest
class Test_C65221891_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_To_Concede_5_Goals_Inside_The_Box_1_Shots_2_Tackles_2_Assists_1(BaseFiveASide):
    """
    TR_ID: C65221891
    NAME: 	Verify successful Bet Placement and Receipt for Balanced - To Concede-5 Goals Inside The Box-1 Shots -2 Tackles-2 Assists-1
