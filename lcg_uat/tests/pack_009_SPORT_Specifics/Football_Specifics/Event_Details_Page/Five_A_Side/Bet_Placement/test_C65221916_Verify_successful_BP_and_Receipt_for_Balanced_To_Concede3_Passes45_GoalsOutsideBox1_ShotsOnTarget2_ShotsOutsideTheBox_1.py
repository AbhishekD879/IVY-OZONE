...
@pytest.mark.banach
@vtest
class Test_C65221916_Verify_successful_BP_and_Receipt_for_Balanced_To_Concede3_Passes45_GoalsOutsideBox1_ShotsOnTarget2_ShotsOutsideTheBox_1(BaseFiveASide):
    """
    TR_ID: C65221916
    NAME: 	Verify successful Bet Placement and Receipt for Balanced -To Concede-3 Passes-45 Goals Outside The Box -1 Shots On Target-2 Shots Outside The Box-1
