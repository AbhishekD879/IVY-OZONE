...
@pytest.mark.banach
@vtest
class Test_C65221967_Verify_successful_Bet_Placement_and_Receipt_for_Balanced_ToConcede_2_Passes_45_GoalsOutsideTheBox_1_Shots_3_Shots_3(BaseFiveASide):
    """
    TR_ID: C65221967
    NAME: Verify successful Bet Placement and Receipt for Balanced - To Concede-2 Paases-45 Goals Outside The Box -1 Shots Outside The Box-3 Assists-1
