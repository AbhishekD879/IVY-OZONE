...
@pytest.mark.banach
@vtest
class Test_C65268811_Verify_the_contest_is_not_displayed_if_less_than_5_legs_are_selected_for_bet_placement_Private_Contest(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65268811
    NAME: Verify the contest is not displayed if less than 5 legs (players) are selected for bet placement-Private Contest
    DESCRIPTION: Verify the contest is not displayed if less than 5 legs (players) are selected for bet placement-Private Contest
    ...
    def test_000_preconditions(self):
        ...
        contest_name = f"INV_Auto test " + event_name + "_" + str(event_id) + "_" + 'C65268811'
