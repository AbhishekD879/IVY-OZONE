...
@pytest.mark.banach
@vtest
class Test_C65268843_Verify_User_Cant_See_Contest_In_Lobby_If_Contest_Inactive_In_CMS_Contest(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65268843
    NAME: Verify user can't see the contest in lobby if contest is made inactive in CMS-Private Contest
    DESCRIPTION: Test case Verify user can't see the contest in lobby if contest is made inactive in CMS-Private Contest
