...
@pytest.mark.banach
@vtest
class Test_C65271549_Verify_Maximum_Total_Entries_text_on_Leaderboard_is_not_displayed_if_Size_entry_is_empty_in_CMS_Private_Contest(BaseFiveASide):
    """
    TR_ID: C65271549
    ...
    def test_004_click_on_view_entry(self):
        """
