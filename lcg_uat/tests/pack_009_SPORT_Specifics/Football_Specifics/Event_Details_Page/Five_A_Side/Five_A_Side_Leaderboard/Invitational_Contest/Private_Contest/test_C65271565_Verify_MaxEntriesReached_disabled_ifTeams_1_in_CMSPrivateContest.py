...
@pytest.mark.banach
@vtest
class Test_C65271565_Verify_MaxEntriesReached_isDisabled_for_singleContest_if_Teams_1_in_CMSPrivateContest(BaseFiveASide, BaseFeaturedTest):
    """
     TR_ID: C65271565
     NAME: Verify MAX ENTRIES REACHED is disabled on Leaderboard for a single contest and Teams entry as 1 in CMS-Private Contest
     DESCRIPTION: This testcase verifies MAX ENTRIES REACHED is disabled on Leaderboard for a single contest and Teams entry as 1 in CMS-Private Contest
    ...
    def test_000_preconditions(self):
        ...
        contest_id = self.cms_config.create_five_a_side_show_down(contest_name=self.contest_name,
                                                                  ...
                                                                  isInvitationalContest=True, isPrivateContest=True)['id']
