...
@pytest.mark.banach
@vtest
class Test_C65272214_Verify_bet_placement_without_selecting_contest_on_Betslip_for_a_single_contest_Private_Contest(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65272214
    ...
    def test_001_Select_all_players_for_5_A_Side_formation(self):
        ...
        self.assertIn(self.contest_name, contests.keys(), msg=f'{self.contest_name} is not in leaderboard keys {contests.keys()} ')
