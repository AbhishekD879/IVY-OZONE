...
@pytest.mark.banach
@vtest
class Test_C65271575_Verify_UI_elements_on_Leaderboard_for_a_single_contest_Public_contest_via_lobby(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65271575
    ...
    def test_000_preconditions(self):
        ...
        DESCRIPTION: Destination: https://beta2-sports.ladbrokes.com/5-a-side/lobby
        ...
        quick_link_title = 'Autotest Beta2 Lobby ' + '71575'
        ...
        self.__class__.contest = self.cms_config.create_five_a_side_show_down(contest_name=self.contest_name,
    ...
    def test_005_verify_leaderboard_ui_elements(self):
        ...
        self.assertEqual(actual_message, vec.five_a_side.MAX_ENTRIES_REACHED.format(n=1),
                         msg=f'Actual message: "{actual_message}" is not same as '
                             f'Expected message: "{vec.five_a_side.MAX_ENTRIES_REACHED.format(n=1)}"')
