...
@vtest
class Test_C65272386_Verify_if_Contest_Id_in_LB_URL_same_as_CMS_Single_Contest_Public_Contest_vie_lobby(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65272386
    NAME: Verify if Contest Id in Leaderboard URL is same as in CMS for Single Contest - Public contest via lobby
    DESCRIPTION: Verify if Contest Id in Leaderboard URL is same as in CMS for Single Contest - Public contest via lobby
    ...
    def test_000_preconditions(self):
        ...
        if self.device_type != 'desktop':
            ...
            quick_link_title = 'Autotest Beta2 Lobby_' + 'C65272386'
        ...
        contest_name = f"Auto test " + event_name + "_" + str(event_id) + "_" + 'C65272386'
    ...
    def test_004_Verify_Contest_Id_in_the_URL(self):
        """
         ...
         """
        self.assertIn(self.response_id['id'], unquote(self.device.get_current_url()),
