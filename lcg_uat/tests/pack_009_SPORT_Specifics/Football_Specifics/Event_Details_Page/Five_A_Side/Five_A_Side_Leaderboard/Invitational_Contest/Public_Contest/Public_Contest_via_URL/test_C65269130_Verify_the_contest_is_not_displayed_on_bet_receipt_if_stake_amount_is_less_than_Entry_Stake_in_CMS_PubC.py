...
@pytest.mark.banach
@vtest
class Test_C65269130_Verify_the_contest_is_not_displayed_on_bet_receipt_if_stake_amount_is_less_than_Entry_Stake_in_CMS_PubC(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65269130
    NAME: Verify the contest is not displayed on bet receipt if stake amount is less than Entry Stake in CMS - Public Contest
    DESCRIPTION: Verify the contest is not displayed on bet receipt if stake amount is less than Entry Stake in CMS - Public Contest
