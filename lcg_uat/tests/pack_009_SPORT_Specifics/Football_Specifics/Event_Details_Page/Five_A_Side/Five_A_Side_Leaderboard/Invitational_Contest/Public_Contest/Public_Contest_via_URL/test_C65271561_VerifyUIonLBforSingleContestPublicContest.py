...
@pytest.mark.banach
@vtest
class Test_C65271561_Verify_UI_elements_on_Leaderboard_for_a_single_contest_Public_Contest(BaseFiveASide):
    """
    TR_ID: C65271561
    NAME: Verify UI elements on Leaderboard for a single contest - Public Contest
    DESCRIPTION: Verify UI elements on Leaderboard for a single contest - Public Contest
