...
@pytest.mark.banach
@vtest
class test_C65271581_Verify_CONTEST_FULL_button_on_Leaderboard_for_a_single_contest_and_Size_entry_as_1_in_CMS_public_contest(
    BaseFiveASide):
    """
    TR_ID: C65271581
    NAME: Verify CONTEST FULL button on Leaderboard for a single contest and Size entry as 1 in CMS - Public Contest
