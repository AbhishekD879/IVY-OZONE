...
@pytest.mark.banach
@vtest
class Test_C65271584_Verify_user_cannot_see_the_contest_in_lobby_if_contest_is_made_Inactive_in_CMS_Public_Contest(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65271584
    NAME: Verify user cann't see the contest in lobby if contest is made inactive in CMS - Public Contest
    DESCRIPTION: Verify user cann't see the contest in lobby if contest is made inactive in CMS - Public Contest
    ...
    def test_000_preconditions(self):
        ...
        self.cms_config.create_five_a_side_show_down(contest_name=self.contest_name,
                                                     ...
                                                     event_id=event_id, display=False,
