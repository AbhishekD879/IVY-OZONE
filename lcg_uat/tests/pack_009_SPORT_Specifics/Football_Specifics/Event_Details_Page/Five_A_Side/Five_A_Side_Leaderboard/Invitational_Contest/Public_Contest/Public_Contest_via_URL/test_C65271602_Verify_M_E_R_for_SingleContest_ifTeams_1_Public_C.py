...
@vtest
class Test_C65271602_Verify_MaxEntriesReached_for_aSingle_contest_if_Teams_entry_1_in_CMS_Public_Contest(BaseFiveASide):
    """
    TR_ID: C65271602
    NAME: Verify MAX ENTRIES REACHED on Leaderboard for a single contest and Teams entry as 1 in CMS - Public Contest
    DESCRIPTION: Verify MAX ENTRIES REACHED on Leaderboard for a single contest and Teams entry as 1 in CMS - Public Contest
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.response_id = contest_response["id"]
