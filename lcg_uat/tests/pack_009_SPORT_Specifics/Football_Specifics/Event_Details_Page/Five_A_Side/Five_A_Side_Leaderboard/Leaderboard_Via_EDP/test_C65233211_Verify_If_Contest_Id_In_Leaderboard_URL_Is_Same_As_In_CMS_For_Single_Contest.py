...
@pytest.mark.banach
@vtest
class Test_C65233211_Verify_If_Contest_Id_In_Leaderboard_URL_Is_Same_As_In_CMS_For_Single_Contest(BaseFiveASide):
    """
    TR_ID: C65233211
    NAME: Verify if Contest Id in Leaderboard URL is same as in CMS for Single Contest
    DESCRIPTION: Test case Verify if Contest Id in Leaderboard URL is same as in CMS for Single Contest
