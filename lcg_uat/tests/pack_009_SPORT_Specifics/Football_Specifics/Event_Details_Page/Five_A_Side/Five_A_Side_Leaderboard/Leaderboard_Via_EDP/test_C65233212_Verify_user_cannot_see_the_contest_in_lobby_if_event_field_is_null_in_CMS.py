...
@pytest.mark.banach
@vtest
class Test_C65233212_Verify_user_cant_see_the_contest_in_lobby_if_event_field_is_null_in_CMS(BaseFiveASide):
    """
    TR_ID: C65233212
    NAME:  Verify user can't see the contest in lobby if event field is null in CMS
    DESCRIPTION: Verify user can't see the contest in lobby if event field is null in CMS
    ...
    def test_000_preconditions(self):
        ...
        DESCRIPTION: User's Allowed: Test Accounts
        ...
        self.__class__.contest_name = f"Auto test " + event_name + " " + "(" + str(event_id) + ")_33212"
