...
@pytest.mark.banach
@vtest
class test_C65233216_Verify_CONTEST_FULL_button_on_Leaderboard_for_a_single_contest_and_Size_entry_as_1_in_CMS(BaseFiveASide):
    """
    TR_ID: C65233216
    NAME: Verify CONTEST FULL button on Leaderboard for a single contest and Size entry as 1 in CMS
    ...
    def test_004_Verify_button_CONTEST_FULL_and_is_disabled(self):
        ...
        self.assertEqual(context_full, 'CONTEST FULL', msg=f'actual text {context_full} is not same as Expected text "CONTEST FULL"')
