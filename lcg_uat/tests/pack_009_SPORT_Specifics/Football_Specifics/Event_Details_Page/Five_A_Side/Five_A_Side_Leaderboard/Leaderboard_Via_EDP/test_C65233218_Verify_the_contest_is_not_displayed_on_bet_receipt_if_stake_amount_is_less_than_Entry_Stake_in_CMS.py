...
@pytest.mark.banach
@vtest
class Test_C65233218_Verify_the_contest_is_not_displayed_on_bet_receipt_if_stake_amount_is_less_than_Entry_Stake_in_CMS(BaseFiveASide):
    """
    TR_ID: C65233218
    NAME: Verify the contest is not displayed on bet receipt if stake amount is less than Entry Stake in CMS
