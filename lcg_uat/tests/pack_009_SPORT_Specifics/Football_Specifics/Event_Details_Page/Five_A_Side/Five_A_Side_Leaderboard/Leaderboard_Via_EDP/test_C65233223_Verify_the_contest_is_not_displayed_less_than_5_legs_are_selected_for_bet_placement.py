...
@pytest.mark.banach
@vtest
class test_C65233223_Verify_the_contest_is_not_displayed_less_than_5_legs_are_selected_for_bet_placement(BaseFiveASide):
    """
    TR_ID: C65233223
    NAME: Verify the contest is not displayed if less than 5 legs (players) are selected for bet placement
    DESCRIPTION: Verify the contest is not displayed if less than 5 legs (players) are selected for bet placement
    ...
    def test_000_preconditions(self):
        ...
        contest_name = f"Auto test " + event_name + " " + "(" + str(event_id) + ")" + "C65233218"
