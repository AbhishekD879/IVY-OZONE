...
@pytest.mark.banach
@vtest
class Test_C65233254_Verify_MAX_ENTRIES_REACHED_on_Leaderboard_for_a_single_contest_and_Teams_entry_as_1_in_CMS(BaseFiveASide):
    """
    TR_ID: C65233254
    NAME: Verify MAX ENTRIES REACHED on Leaderboard for a single contest and Teams entry as 1 in CMS
    DESCRIPTION: Verify MAX ENTRIES REACHED on Leaderboard for a single contest and Teams entry as 1 in CMS
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.contest_name = f"Auto test " + event_name + "_" + str(event_id) + "_" + str(33254)
    ...
    def test_003_click_on_button_VIEW_ENTRY(self):
        ...
        self.assertIn(self.response_id, urllib.parse.unquote(self.device.get_current_url()),
