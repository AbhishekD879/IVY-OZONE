...
@pytest.mark.banach
@vtest
class Test_C65233256_Verify_UI_elements_on_Leaderboard_for_a_single_contest(BaseFiveASide):
    """
    TR_ID: C65233256
    NAME: Verify UI elements on Leaderboard for a single contest
    DESCRIPTION: VVerify UI elements on Leaderboard for a single contest
