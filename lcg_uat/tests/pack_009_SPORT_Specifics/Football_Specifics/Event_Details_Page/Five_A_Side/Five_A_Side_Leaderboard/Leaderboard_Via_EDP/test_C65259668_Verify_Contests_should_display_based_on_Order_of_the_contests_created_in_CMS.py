...
@vtest
class Test_C65259668_Verify_Contests_should_display_based_on_Order_of_the_contests_created_in_CMS(BaseFiveASide):
    """
    TR_ID: C65259668
    NAME: Verify Contests should display based on Order of the contests created in CMS
    DESCRIPTION: Verify Contests should display based on Order of the contests created in CMS
    """
    ...
    def test_001_select_all_players_for_5_A_Side_formation(self):
        ...
        EXPECTED: On Betslip page (Before placing bet): Both the contests should be available along with contest names
                  Contests display should be based on Order of the contests created in CMS. (this journey is applicable, when user is placing bet via EDP page)
        """
