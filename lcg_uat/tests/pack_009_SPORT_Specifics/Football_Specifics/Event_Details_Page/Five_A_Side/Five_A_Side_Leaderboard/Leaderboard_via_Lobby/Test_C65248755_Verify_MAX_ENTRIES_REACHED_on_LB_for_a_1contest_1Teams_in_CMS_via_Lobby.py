...
@pytest.mark.banach
@vtest
class Test_C65248755_Verify_MAX_ENTRIES_REACHED_on_Leaderboard_for_a_single_contest_and_Teams_entry_as_1_in_CMS_navigation_via_lobby(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65248755
    NAME: Verify MAX ENTRIES REACHED on Leaderboard for a single contest and Teams entry as 1 in CMS - navigation via lobby
    ...
    def test_000_preconditions(self):
        ...
        quick_link_title = 'Autotest Beta2 Lobby_' + 'C65248755'
