...
@pytest.mark.banach
@vtest
class Test_C65248868_Verify_user_cannt_see_the_contest_in_lobby_if_contest_is_made_inactive_in_CMS_navigation_via_lobby(BaseFiveASide, BaseFeaturedTest):
    """
    TR_ID: C65248868
    NAME: Verify user cann't see the contest in lobby if contest is made inactive in CMS - navigation via lobby
    DESCRIPTION: Verify user cann't see the contest in lobby if contest is made inactive in CMS - navigation via lobby
    """
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.contest_id = self.cms_config.create_five_a_side_show_down(contest_name=self.contest_name,
                                                                                 ...
                                                                                 teams="1",
                                                                                 event_id=event_id, display=False)['id']
