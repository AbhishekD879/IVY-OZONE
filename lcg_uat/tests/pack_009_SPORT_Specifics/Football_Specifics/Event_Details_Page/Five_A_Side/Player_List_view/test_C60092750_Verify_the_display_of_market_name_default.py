...
@vtest
class Test_C60092750_Verify_the_display_of_market_name_default(BaseFiveASide, BaseSportTest, BaseCashOutTest):
    """
    TR_ID: C60092750
    ...
    def test_006_click_on_plus_icon_from_any_player_position(self):
        ...
        default_market = self.site.sport_event_details.tab_content.players_overlay.sub_title
        self.assertTrue(default_market, msg=f'"{default_market}" is not displayed ')
