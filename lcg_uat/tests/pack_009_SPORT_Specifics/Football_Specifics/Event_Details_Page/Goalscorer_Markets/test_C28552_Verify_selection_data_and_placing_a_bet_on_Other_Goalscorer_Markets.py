...
@pytest.mark.tst2
@pytest.mark.stg2
# @pytest.mark.prod // cannot create events for other goalscorer markets
# @pytest.mark.hl
@pytest.mark.medium
@pytest.mark.sports
@pytest.mark.desktop
@vtest
class Test_C28552_Verify_selection_data_and_placing_a_bet_on_Other_Goalscorer_Markets(BaseSportTest, BaseBetSlipTest):
    """
    TR_ID: C28552
    ...
    def test_000_preconditions(self):
        ...
        for market in event.ss_response['event']['children']:
            self.__class__.market_names = ['Hat trick', 'Last Goalscorer']
            if market['market']['templateMarketName'] == self.market_names[0]:
                self.__class__.hatrick_market = market['market']['children']
    ...
    def test_004_verify_selection_section(self):
        ...
        for name, switcher in self.market_grouping_buttons.items():
            switcher.click()
            sleep(3)
            selections_list = self.other_goalscorer_section.outcome_table.items
    ...
    def test_006_verify_priceodds_buttons_correspondence_to_goalscorer_markets(self):
        ...
        for i in self.last_goalscorere_market:
    ...
    def test_008_verify_data_of_priceodds_buttons_in_decimal_format(self):
        ...
        self.test_003_go_to_other_goalscorer_markets_section()
