...
@pytest.mark.desktop
@vtest
class Test_C65304897_Verify_Now_and_Next_tab_will_populate_both_IN_PLAY_and_Pre_Play_matches(Common):
    """
    TR_ID: C65304897
    NAME: Verify Now and Next tab will populate both IN-PLAY and Pre-Play matches
    DESCRIPTION: Verify Now and Next tab will populate both IN-PLAY and Pre-Play matches
    ...
    def test_004_verify_user_is_able_to_see_events_for_both_in_play_and_upcoming_events(self):
        """
        DESCRIPTION: Verify user is able to see events for both In-play and Upcoming events
        EXPECTED: User should be able to see both In-play and Upcoming Events in Highlight carousel format
        """
        expected_date_list = []
