...
@pytest.mark.other
@vtest
class Test_C65305128_Top_GoalScorer_markets_are_shown_in_Now_and_Next_tab(Common):
    """
    TR_ID: C65305128
    NAME: Top GoalScorer markets are shown in Now and Next tab
    DESCRIPTION: To verify created Top GoalScorer market is shown in Now and Next tab under (Teams)Bet in Fanzone page
    ...
    new_market_name = "Top GoalScorer"
    ...
    def test_004_verify_is_user_is_able_to_see_top_goalscorer_market_in_now_and_next_tab(self):
        """
        DESCRIPTION: Verify is user is able to see Top Goalscorer Market in Now and next Tab
        EXPECTED: User should be able to see Top GoalScorer market under (Team)bet label in Now and Next tab
        """
