...
@pytest.mark.fanzone
@vtest
class Test_C65305129_Top_outright_markets_are_shown_in_Now_and_Next_tab(Common):
    """
    TR_ID: C65305129
    NAME: Top outright markets are shown in Now and Next tab
    DESCRIPTION: To verify Outright market is shown in Now and Next tab under (Teams)Bet in Fanzone page
    ...
    def test_000_preconditions(self):
        ...
        self.cms_config.update_fanzone(self.teamname.title(), str(type_id))
    ...
    def test_004_verify_is_user_is_able_to_see_top_outright_market_in_now_and_next_tab(self):
        """
        DESCRIPTION: Verify is user is able to see Top outright Market in Now and next Tab
        EXPECTED: User should be able to see Top outright market under (Team)bet label in Now and Next tab
        """
