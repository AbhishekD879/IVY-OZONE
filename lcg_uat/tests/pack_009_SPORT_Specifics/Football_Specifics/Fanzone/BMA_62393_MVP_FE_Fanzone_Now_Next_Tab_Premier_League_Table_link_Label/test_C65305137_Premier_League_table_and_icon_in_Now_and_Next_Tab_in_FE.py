...
@vtest
class Test_C65305137_Premier_League_table_and_icon_in_Now_and_Next_Tab_in_FE(Common):
    """
    TR_ID: C65305137
    NAME: Premier League table and icon in Now and Next Tab in FE
    DESCRIPTION: To verify user is able to see Premier League table and icon in Now and Next Tab in FE with Team bet Header as Link
    ...
    def test_002_click_on_the_teams_bets_header_link(self):
        ...
        EXPECTED: User should be able to see the league table is opened as pop up overlay with close option(X)
        """
        ...
        self.device.driver.execute_script("return arguments[0].click();", self.site.fanzone.premier_leauge.close_button)
