...
@pytest.mark.fanzone
@vtest
class Test_C65305139_Overlay_will_be_closed_when_close_optionX_is_clicked(Common):
    """
    TR_ID: C65305139
    NAME: Overlay will be closed when close option(X) is clicked
    DESCRIPTION: To verify user can close the Overlay by clicking on Close option(X) in the overlay
