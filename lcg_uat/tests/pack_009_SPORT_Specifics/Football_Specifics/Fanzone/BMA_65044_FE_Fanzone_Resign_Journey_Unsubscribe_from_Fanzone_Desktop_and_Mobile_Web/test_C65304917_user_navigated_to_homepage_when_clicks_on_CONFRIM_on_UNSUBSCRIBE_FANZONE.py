...
@pytest.mark.desktop
@vtest
class Test_C65304917_To_verify_the_UI_of_UNSUBSCRIBE_FROM_FANZONE_popup(Common):
    """
    TR_ID: C65304917
    NAME: To verify the UI of UNSUBSCRIBE FROM FANZONE popup
    DESCRIPTION: To verify the UI of UNSUBSCRIBE FROM FANZONE popup
    ...
    def test_000_preconditions(self):
        ...
        if tests.settings.device_type == "mobile":
            self.site.home.module_selection_ribbon.tab_menu.items_as_ordered_dict.get(vec.racing.RACING_HIGHLIGHTS_TAB_NAME)
    ...
    def test_007_click_on_confirm(self):
        """
        DESCRIPTION: Click on CONFIRM CTA
        EXPECTED: User should be navigated to Lads home page
        """
