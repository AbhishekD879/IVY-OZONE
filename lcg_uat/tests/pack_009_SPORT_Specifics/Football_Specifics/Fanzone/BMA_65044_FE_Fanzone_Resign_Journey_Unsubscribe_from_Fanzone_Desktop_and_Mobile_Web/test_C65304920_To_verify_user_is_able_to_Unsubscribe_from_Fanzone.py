...
@pytest.mark.desktop
@vtest
class Test_C65304920_To_verify_user_is_able_to_Unsubscribe_from_Fanzone(Common):
    """
    TR_ID: C65304920
    NAME: To verify user is able to Unsubscribe from Fanzone.
    DESCRIPTION: To verify user is able to Unsubscribe from Fanzone.
