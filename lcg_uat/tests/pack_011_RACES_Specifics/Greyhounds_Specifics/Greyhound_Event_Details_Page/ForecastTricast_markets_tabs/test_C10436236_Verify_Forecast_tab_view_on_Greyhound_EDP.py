...
@pytest.mark.desktop
@vtest
class Test_C10436236_Verify_Forecast_tab_view_on_Greyhound_EDP(BaseRacing):
    """
    TR_ID: C10436236
    ...
    def test_000_preconditions(self):
        ...
        if tests.settings.backend_env == 'prod':
            additional_filter = exists_filter(LEVELS.EVENT, simple_filter(LEVELS.MARKET, ATTRIBUTES.NCAST_TYPE_CODES, OPERATORS.INTERSECTS, 'CF')), \
