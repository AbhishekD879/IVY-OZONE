...
@pytest.mark.tst2
@pytest.mark.stg2
# @pytest.mark.hl  can't modify event details
# @pytest.mark.prod
@pytest.mark.high
@pytest.mark.races
...
@pytest.mark.safari
@vtest
class Test_C10474867_Verify_Forecast___Tricast_tabs_displaying_on_Greyhound_EDP_depending_on_checkboxes_in_Openbet_TI(BaseRacing):
    """
    TR_ID: C10474867
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.market_template_id = self.ob_config.backend.ti.greyhound_racing.greyhounds_live.autotest.market_template_id
    ...
    def test_001_verify_forecasttricast_tabs_on_edp(self):
        ...
        typeCodes = self.get_market_for_event_from_ss(event_id=self.eventID)['ncastTypeCodes']
    ...
    def test_002_in_ti_uncheck_forecast_tabrefresh_app(self):
        ...
        self.ob_config.change_racing_market_forecast_tricast_status(event_id=self.eventID,
                                                                    ...
                                                                    tricast_status=True)
        result = wait_for_result(lambda: self.get_market_for_event_from_ss(event_id=self.eventID)['ncastTypeCodes'] == 'CT,TC,',
    ...
    def test_004_in_ti_check_only_forecast_checkboxrefresh_app(self):
        ...
        wait_for_result(lambda: 'ncastTypeCodes' in self.get_market_for_event_from_ss(event_id=self.eventID).keys(),
                        ...
                        expected_result=True,
                        timeout=3)
        result = wait_for_result(lambda: self.get_market_for_event_from_ss(event_id=self.eventID)['ncastTypeCodes'] == 'SF,CF,RF,',
