...
@pytest.mark.desktop
@vtest
class Test_C59899928_Verify_Next_Races_Events_Number_CMS_configuration(BaseRacing):
    """
    TR_ID: C59899928
    ...
    def test_004_in__numberofevents_drop_down_choose_some_number_from_1_12___press_submit(self):
        ...
        """
        greyhound_next_races_toggle = self.cms_config.get_initial_data(device_type=self.device_type)['systemConfiguration']['GreyhoundNextRacesToggle']['nextRacesTabEnabled']
        if not greyhound_next_races_toggle:
            self.cms_config.update_system_configuration_structure(config_item='GreyhoundNextRacesToggle', field_name='nextRacesTabEnabled', field_value=True)
    ...
    def test_007_open_next_races_tabverify__events_number(self, first=True):
        """
        ...
        EXPECTED: - If number of events is less than was set in CMS -> display the remaining events
    ...
    def test_009_repeat_steps_5_7(self):
        ...
        self.test_007_open_next_races_tabverify__events_number(first=False)
