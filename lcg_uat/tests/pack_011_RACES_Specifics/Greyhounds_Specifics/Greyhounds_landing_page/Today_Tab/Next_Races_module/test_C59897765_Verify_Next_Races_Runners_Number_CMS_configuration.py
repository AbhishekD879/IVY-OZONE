...
@pytest.mark.desktop
@vtest
class Test_C59897765_Verify_Next_Races_Runners_Number_CMS_configuration(BaseRacing):
    """
    TR_ID: C59897765
    ...
    def test_008_verify_next_races_selectionsrunners_number(self, first=True):
        """
    ...
    def test_010_repeat_steps_5_7(self):
        ...
        self.test_008_verify_next_races_selectionsrunners_number(first=False)
