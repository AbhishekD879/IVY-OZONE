...
@pytest.mark.login
@vtest
class Test_C11366888_Verify_selections_ordering_on_To_Finish_market(BaseRacing, BaseBetSlipTest):
    """
    TR_ID: C11366888
    ...
    def test_002_verify_to_finish_market_headers(self):
        ...
        self.softAssert(self.assertListEqual, list(market_headers.keys()), vec.racing.TO_FINISH_FIXTURE_HEADERS,
                        msg=f'Market headers "{list(market_headers.keys())}" are not the same '
                        f'as expected "{vec.racing.TO_FINISH_FIXTURE_HEADERS}"')
    ...
    def test_005_change_price_format_to_decimal_in_my_account__settings_and_repeat_steps_1___4(self):
        ...
        self.test_002_verify_to_finish_market_headers()
