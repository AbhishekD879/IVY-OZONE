...
@pytest.mark.login
@vtest
class Test_C11353994_Verify_liveserve_updates_on_Top_Finish_market(BaseRacing):
    """
    TR_ID: C11353994
    ...
    def test_000_preconditions(self, login=True):
        ...
        self.__class__.marketID = self.ob_config.market_ids['top_2_finish']
    ...
    def test_001_navigate_to_edp_and_open_top_finish_market_tab(self):
        ...
        """
        self.__class__.tab_name = vec.racing.TOP_FINISH_MARKET_NAME
    ...
    def test_002_in_ti_change_price_for_one_of_the_selections_with_enabled_liveserve_updates_see_preconditions(self, decimal=False):
        ...
        """
        self.__class__.selection_name_1, self.__class__.selection_id_1 = list(self.selection_ids['top_2_finish'].items())[2]
        self.__class__.selection_name_2, self.__class__.selection_id_2 = list(self.selection_ids['top_2_finish'].items())[0]
    ...
    def test_003_in_application_observe_changes_on_the_top_finish_market_tab(self, decimal=False):
        """
    ...
    def test_008_in_ti_undisplay_all_top_finish_markets(self):
        ...
        self.ob_config.change_market_state(event_id=self.eventID,
                                           market_id=self.ob_config.market_ids['top_2_finish'], active=True)
        self.ob_config.change_market_state(event_id=self.eventID,
                                           market_id=self.ob_config.market_ids['top_3_finish'], active=True)
        self.ob_config.change_market_state(event_id=self.eventID,
                                           market_id=self.ob_config.market_ids['top_4_finish'], active=True)
    ...
    def test_010_refresh_the_page(self):
        ...
        self.site.racing_event_details.tab_content._wait_active(timeout=30)
        event_markets_list = self.site.racing_event_details.tab_content.event_markets_list.items_as_ordered_dict
        self.assertTrue(event_markets_list, msg='No markets found')
        self.assertNotIn(self.tab_name, event_markets_list.keys(),
                         msg=f'"{self.tab_name}" market was found among "{event_markets_list.keys()}"')
    ...
    def test_011_change_price_format_to_decimal_in_my_account_settings_and_repeat_steps_1_10(self):
        ...
        self.test_003_in_application_observe_changes_on_the_top_finish_market_tab(decimal=True)
        self.test_004_in_ti_suspend_market()
        self.test_005_in_application_observe_changes_on_the_top_finish_market_tab()
        self.test_006_in_ti_suspend_one_of_the_selections_with_enabled_liveserve_updates_see_preconditions()
        self.test_007_in_application_observe_changes_on_the_top_finish_market_tab()
        self.test_008_in_ti_undisplay_all_top_finish_markets()
        self.test_009_in_application_observe_changes_on_the_top_finish_market_tab()
