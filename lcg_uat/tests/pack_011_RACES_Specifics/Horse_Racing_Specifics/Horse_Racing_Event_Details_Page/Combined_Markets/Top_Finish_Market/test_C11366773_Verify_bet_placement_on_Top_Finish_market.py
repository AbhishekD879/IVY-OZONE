...
@pytest.mark.login
@vtest
class Test_C11366773_Verify_bet_placement_on_Top_Finish_market(BaseRacing, BaseBetSlipTest):
    """
    TR_ID: C11366773
    ...
    def test_003_for_mobileclick_on_a_bet_button_of_one_of_the_selections(self, fractional=True):
        """
    ...
    def test_008_change_price_format_to_decimal_in_my_account__settings_and_repeat_steps_2_7(self):
        ...
        self.test_002_navigate_to_edp_and_open_top_finish_market_tab()
        self.test_003_for_mobileclick_on_a_bet_button_of_one_of_the_selections(fractional=False)
