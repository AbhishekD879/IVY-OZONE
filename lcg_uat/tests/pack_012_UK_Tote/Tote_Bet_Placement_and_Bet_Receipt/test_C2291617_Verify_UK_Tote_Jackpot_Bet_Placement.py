...
@pytest.mark.login
@vtest
class Test_C2291617_Verify_UK_Tote_Jackpot_Bet_Placement(BaseUKTote, BaseBetSlipTest):
    """
    TR_ID: C2291617
    NAME: Verify UK Tote Jackpot Bet Placement
    """
    keep_browser_open = True
    selection_name = f'{vec.uk_tote.UJKP} {vec.uk_tote.TOTEPOOL.title()}'
    ...
    def test_001_select_jackpot_sub_tab_under_tote_tab(self):
        ...
        self.assertTrue(jackpot_opened, msg='"%s" tab is not opened' % vec.uk_tote.UK_TOTE_TABS.jackpot)
    ...
    def test_005_open_betslip_and_verify_the_jackpot_tote_bet(self):
        """
    ...
    def test_006_verify_bet_details_for_jackpot_tote_bet(self):
        ...
        EXPECTED:  There are the following details on Jackpot tote bet:
        ...
        EXPECTED:    448 Lines
        """
        self.assertEqual(self.stake.outcome_name, self.selection_name, msg='Actual outcome name "%s", expected "%s"' %
                                                                           (self.stake.outcome_name,
                                                                            self.selection_name))
    ...
    def test_009_verify_odds_and_estimated_returns(self):
        ...
        self.assertEqual(self.stake.est_returns, 'N/A',
                         msg='Est returns is "%s" not "N/A"' % self.stake.est_returns)
    ...
    def test_010_verify_total_est_returns(self):
        ...
        self.assertEqual(self.get_betslip_content().total_estimate_returns, 'N/A',
                         msg='Total Est returns is "%s" not "N/A"' %
    ...
    def test_012_repeat_step_2_5_tap_on_remove_button(self):
        ...
        self.test_005_open_betslip_and_verify_the_jackpot_tote_bet()
