...
@pytest.mark.races
@vtest
class Test_C1641243_Verify_Bet_Builder_for_Placepot_Pool_Type(BaseUKTote, BaseBetSlipTest):
    """
    TR_ID: C1641243
    NAME: Verify Bet Builder for Placepot Pool Type
    DESCRIPTION: This test case verifies UK Tote Bet Builder for Placepot Pool Type
    ...
    def test_001_navigate_to_the_placepot_pool_type_tab(self):
        """
        DESCRIPTION: Navigate to the Placepot pool type tab
        EXPECTED: * Placepot pool type is opened and underlined
    ...
    def test_009_click_on_currency_symbol_stake_amount_total_stake_button(self):
        ...
        EXPECTED: * Placepot bet is added to the BetSlip
        EXPECTED: * All Placepot checkboxes are cleared (for each Leg)
        EXPECTED: * Placepot Bet Builder disappears
        """
