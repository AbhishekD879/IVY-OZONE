...
@pytest.mark.races
@vtest
class Test_C2320909_Verify_Bet_Builder_for_Quadpot_Pool_Type(BaseUKTote, BaseBetSlipTest):
    """
    TR_ID: C2320909
    ...
    def test_005_click_on_remove_icon_near_some_selection(self):
        ...
        self.assertNotIn(selection_1_name, selection_names,
                         msg=f'Selection name : "{selection_1_name}" is in "{selection_names}"')
        self.bet_builder.summary.open.click()
        outcomes = self.pool.items_as_ordered_dict
