...
@pytest.mark.tst2
@pytest.mark.stg2
# @pytest.mark.prod # cannot configure Event Hub in prod
# @pytest.mark.hl
@pytest.mark.mobile_only
@pytest.mark.medium
@pytest.mark.homepage_featured
@vtest
class Test_C11418326_Featured_module_by_Sport_Event_ID_Event_without_primary_market(Common):
    """
    TR_ID: C11418326
    ...
    def test_000_preconditions(self):
        ...
        module_data = self.cms_config.add_featured_tab_module(select_event_by='Event',
                                                              id=eventID,
                                                              page_type='eventhub',
                                                              page_id=index_number, events_time_from_hours_delta=-10,
