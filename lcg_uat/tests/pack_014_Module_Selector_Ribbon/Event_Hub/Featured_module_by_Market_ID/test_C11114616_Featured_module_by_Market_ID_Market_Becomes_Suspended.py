...
@vtest
class Test_C11114616_Featured_module_by_Market_ID_Market_Becomes_Suspended(BaseFeaturedTest):
    """
    TR_ID: C11114616
    ...
    PRECONDITIONS: **NOTE:**
    PRECONDITIONS: For creating modules use CMS (https://coral-cms-<endpoint>.symphony-solutions.eu) > Sports Pages > EventHub > Featured events > 'Create Featured Tab Module'
    ...
    def test_010_change_attribute_in_ti_for_this_eventmarketstatuscodea(self):
        ...
        EXPECTED:
        """
        self.test_004_change_attribute_for_this_event_in_timarketstatuscodea()
    ...
    def test_011_expand_module_and_verify_outcomes_for_the_market(self):
        ...
        self.module.expand()
        self.assertTrue(self.module.is_expanded(), msg=f'"{self.module_name}" module is not expanded')
        self.test_005_verify_outcomes_for_the_market()
