...
@vtest
class Test_C2987446_Highlights_Carousel_live_price_updates(BaseHighlightsCarouselTest):
    """
    TR_ID: C2987446
    VOL_ID: C9698715
    ...
    def test_001_increase_price_for_selection_verify_live_updates_in_highlights_carousel(self):
        """
        ...
        self.assertTrue(self.highlight_carousel and self.highlight_carousel.is_displayed(),
                        msg=f'Failed to display Highlights Carousel named "{self.highlights_carousel_name}"')

        highlight_carousel_events = self.highlight_carousel.items_as_ordered_dict
        ...
        self.assertTrue(result, msg=f'Price updates are not received for event "{self.event_name}", event id "{self.event_id}"')
    ...
    def test_002_decrease_the_price_for_selection_verify_live_updates_in_highlights_carousel(self):
        """
