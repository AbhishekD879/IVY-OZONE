...
@vtest
class Test_C29388_Featured_Price_is_Changed_for_One_Boosted_Race_SP_Selection(BaseFeaturedTest, BaseRacing):
    """
    TR_ID: C29388
    ...
    def test_003_trigger_price_change_for_the_outcome_of_the_boosted_selection(self):
        ...
        self.assertTrue(bet_button,
                        msg=f'selection bet button is not found within module "{self.section.name}"')
        bet_button.scroll_to()
        self.assertFalse(bet_button.is_price_changed(expected_price=self.new_price_1, timeout=10), msg='Price was changed')
    ...
    def test_006_expand_the_module(self):
        ...
        self.assertNotEqual(bet_button.name, self.new_price_2)
