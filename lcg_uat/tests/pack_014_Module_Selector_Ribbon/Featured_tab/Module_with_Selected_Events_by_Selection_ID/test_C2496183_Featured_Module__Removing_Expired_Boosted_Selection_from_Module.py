...
@vtest
class Test_C2496183_Featured_Module__Removing_Expired_Boosted_Selection_from_Module(BaseFeaturedTest, BaseRacing):
    """
    TR_ID: C2496183
    ...
    def test_003_trigger_completionexpiration_one_of_the_event_that_include_the_selection(self):
        ...
        bet_buttons1 = self.section.get_available_prices()
        self.assertFalse(bet_buttons1,
                         msg=f'selection  is not removed from the front end')
