...
@pytest.mark.tst2
@pytest.mark.stg2
# @pytest.mark.prod   # cannot create featured tab module in beta/prod
@pytest.mark.mobile_only
@pytest.mark.medium
@pytest.mark.homepage_featured
@vtest
class Test_C11061810_Featured_module_by_Market_ID_Event_Becomes_Suspended(BaseFeaturedTest):
    """
    TR_ID: C11061810
