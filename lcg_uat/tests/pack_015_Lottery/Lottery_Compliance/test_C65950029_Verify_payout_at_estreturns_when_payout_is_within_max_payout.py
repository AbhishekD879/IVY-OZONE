...
@pytest.mark.other
@vtest
class Test_C65950029_Verify_payout_at_estreturns_when_payout_is_within_max_payout(Common):
    """
    TR_ID: C65950029
    NAME: Verify payout at est.returns when payout is within max payout
    DESCRIPTION: This test case is to verify payout at est.returns when payout is  within max payout
