...
@pytest.mark.other
@vtest
class Test_C65950030_Verify_payout_at_estreturns_when_payout_exceeds_max_payout(Common):
    """
    TR_ID: C65950030
    NAME: Verify payout at est.returns when payout exceeds max payout
    DESCRIPTION: This test case is to verify payout at est.returns when payout exceeds max payout
    ...
    def test_010_verify_payout_at_estreturns_when_payout_is_exceeds_max_payout(self):
        """
