...
@pytest.mark.other
@vtest
class Test_C65950035_Verify_payout_for_different_stakes_exceeds_max_payout(Common):
    """
    TR_ID: C65950035
    NAME: Verify payout for different stakes exceeds max payout
    DESCRIPTION: This testcase verifies payout for different stakes exceeds max payout
    ...
    def test_010_try_to_enter_different_stakes_and_observe_potential_returns(self):
        """
        DESCRIPTION: Try to enter different stakes and observe potential returns
        EXPECTED: Once the potential returns reaches the max payout, even if we try to enter bigger stakes, the totel potential returns remains the same
        """
        pass

    def test_011_verify_payout_at_estreturns_when_payout_exceeds_max_payout(self):
        """
    ...
    def test_012_verify_the_max_payout_information_area_to_be_displayed_above_the_total_stake_and_returns_area_near_placebet_button(self):
        """
