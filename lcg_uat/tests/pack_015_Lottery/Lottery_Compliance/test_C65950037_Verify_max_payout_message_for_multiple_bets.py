...
@pytest.mark.other
@vtest
class Test_C65950037_Verify_max_payout_message_for_multiple_bets(Common):
    """
    TR_ID: C65950037
    NAME: Verify max payout message for multiple bets
    DESCRIPTION: This testcase verifies max payout message for multiple bets
    ...
    def test_009_enter_the_stake_and_verify_the_potential_returns_for_multiple_bets(self):
        """
