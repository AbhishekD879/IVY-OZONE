...
@pytest.mark.other
@vtest
class Test_C65950038_Verify_max_payout_message_for_single_draw_and_Single_week(Common):
    """
    TR_ID: C65950038
    NAME: Verify max payout message for single draw and Single week
    DESCRIPTION: This testcase verifies max payout message for single draw and Single week
    ...
    def test_005_choose_single_draw_and_single_week(self):
        """
        DESCRIPTION: Choose single draw and single week
        EXPECTED: Able to select single draw and single week
        """
        # covered in step 4
    ...
    def test_007_enter_the_stake_and_verify_the_potential_returns_for_multiple_bets(self):
        ...
        """
        self.verify_betslip(self.draw_name, self.expected_day_and_time)
