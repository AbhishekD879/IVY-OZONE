...
@vtest
class Test_C884423_Verify_Double_Your_Winnings_Overlay_on_Race_event(BaseSportTest, BaseRacing, BasePromotionTest):
    """
    TR_ID: C884423
    NAME: Verify 'Double Your Winnings' Promotional Overlay on Race_event
    ...
    promo_name = 'Double Your Winnings'
    ...
    def test_001_navigate_to_any_page_with_promo_signposting_and_tap_on_promo_icon(self):
        ...
        self.__class__.dialog = self.site.wait_for_dialog(dialog_name=vec.dialogs.DIALOG_MANAGER_DOUBLE_YOUR_WINNINGS, timeout=2)
