...
@pytest.mark.issue('https://jira.egalacoral.com/browse/BMA-56151')
@vtest
class Test_C884423_Verify_Extra_Place_Race_Promotional_Overlay_on_Race_event(BaseRacing, BasePromotionTest):
    """
    TR_ID: C884423
    NAME: Verify 'Extra Place Race' Promotional Overlay on Race_event
    ...
    def test_000_preconditions(self):
        ...
        event = self.ob_config.add_UK_racing_event(extra_place_race=True, number_of_runners=2)
    ...
    def test_001_navigate_to_any_page_with_promo_signposting_and_tap_on_promo_icon(self):
        ...
        self.__class__.dialog = self.site.wait_for_dialog(dialog_name=vec.dialogs.DIALOG_MANAGER_EXTRA_PLACE_RACE, timeout=2)
    ...
    def test_003_scroll_the_page(self):
        ...
        self.assertTrue(self.promotion_overlay.header.is_displayed(),
    ...
    def test_006_verify_main_content(self):
        ...
        self.assertEqual(actual_promo_description.lower(), expected_promo_description.lower(),
