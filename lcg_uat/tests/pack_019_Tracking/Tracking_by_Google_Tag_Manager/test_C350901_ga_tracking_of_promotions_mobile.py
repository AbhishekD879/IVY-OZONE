...
@vtest
class Test_C350901_GA_Tracking_Of_Promotion_Mobile_Mode(BaseDataLayerTest):
    """
    TR_ID: C350901
    VOL_ID: C30777414
    NAME: Verify tracking on 'Promotion' page mobile mode
    ...
    def test_002_click_on_banner_image(self):
        ...
        self.assertTrue(promotions, msg='No promotions found')
