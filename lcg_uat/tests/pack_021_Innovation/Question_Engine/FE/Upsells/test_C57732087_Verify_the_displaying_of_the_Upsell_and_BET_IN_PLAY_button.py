...
@vtest
class Test_C57732087_Verify_the_displaying_of_the_Upsell_and_BET_IN_PLAY_button(BaseBetSlipTest):
    """
    TR_ID: C57732087
    ...
    def test_000_preconditions(self):
        ...
        """
        event = self.get_active_events_for_category(in_play_event=True)[0]
