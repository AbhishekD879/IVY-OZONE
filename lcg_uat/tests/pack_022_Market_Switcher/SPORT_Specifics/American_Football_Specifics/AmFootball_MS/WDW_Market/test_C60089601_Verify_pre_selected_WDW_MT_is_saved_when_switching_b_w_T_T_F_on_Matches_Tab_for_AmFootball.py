...
@vtest
class Test_C60089601_Verify_pre_selected_WDW_MT_is_saved_when_switching_b_w_T_T_F_on_Matches_Tab_for_AmFootball(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089601
    NAME: Verify pre selected ‘WDW’ MT is saved when switching b/w T/T/F on Matches Tab for Am.Football
    ...
    def verify_market_template_labels_text(self, event_id=None):
        ...
        self.assertTrue(self.event, msg='Event for the "60 minute betting" market not shown')
    ...
    def test_000_preconditions(self):
        ...
        event_tomorrow = self.ob_config.add_american_football_event_to_autotest_league(markets=self.event_markets,
                                                                                       is_tomorrow=True)
        self.__class__.eventID_tomorrow = event_tomorrow.event_id

        event_future = self.ob_config.add_american_football_event_to_autotest_league(markets=self.event_markets,
    ...
    def test_001_verify_displaying_of_the_market_selector(self):
        ...
        options.get('60 Minute Betting').click()
    ...
    def test_005_switch_to_the_tomorrow_tab(self):
        ...
        self.test_002_verify_displaying_of_preplay_events_for_60_minute_betting()
        self.verify_market_template_labels_text(event_id=self.eventID_tomorrow)
        self.test_004_verify_ga_tracking_for_the_60_minute_betting()
    ...
    def test_008_switch_back_to_today_tab(self):
        ...
        self.test_003_verify_text_of_the_labels_for_60_minute_betting()
        self.test_004_verify_ga_tracking_for_the_60_minute_betting()
