...
@pytest.mark.sports
@vtest
class Test_C60089532_Verify_WW_MT_on_Competitions_Tab_for_AmFootball(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089532
    ...
    def verify_fixture_header_and_qty_of_bet_buttons(self, bet_button_qty, header1, header3):
    ...
    def test_004_verify_text_of_the_labels_for_money_line(self):
        ...
        self.site.competition_league.tab_content.dropdown_market_selector.items_as_ordered_dict.get(
            vec.siteserve.EXPECTED_MARKETS_NAMES.money_line).click()
