...
@vtest
class Test_C60089617_Verify_Handicap_WW_MT_in_Competitions_Tab_for_Baseball(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089617
    NAME: Verify ‘Handicap WW’ MT in Competitions Tab for Baseball
    ...
    PRECONDITIONS: 2. Go to the Baseball Landing Page -> Click on  Competition Tab
    PRECONDITIONS: Note:
    ...
    def test_004_verify_displaying_of_preplayinplay_or_both_events(self):
        ...
        EXPECTED: • Run Line (Preplay and Inplay market)
        EXPECTED: • Total PRuns (Preplay and Inplay market)
        EXPECTED: Note:
    ...
    def test_005_verify_text_of_the_labels_for_run_line(self, label1="1", label2="2"):
        """
    ...
    def test_008_repeat_steps_3_7_for_the_below_markettotal_runsexcept_step_5(self):
        """
        DESCRIPTION: Repeat steps 3-7 for the below market:
        DESCRIPTION: Total Runs(Except step 5)
        """
    ...
    def test_009_verify_text_of_the_labels_for_total_runs(self):
        """
        DESCRIPTION: Verify text of the labels for Total Runs
        ...
        """
        self.test_005_verify_text_of_the_labels_for_run_line(label1="OVER", label2="UNDER")
