...
@pytest.mark.desktop
@vtest
class Test_C60089587_Verify_MS_behavior_on_Matches_Tab_for_Baseball(Common):
    """
    TR_ID: C60089587
    NAME: Verify MS behavior on Matches Tab for Baseball
    ...
    def test_000_preconditions(self):
        ...
        PRECONDITIONS: 2. Go to the Baseball Landing page -> 'Matches' tab
        """
    ...
    def test_002_tap_on_the_change_button_in_market_selector_dropdown_list(self):
        ...
        """
        self.__class__.list_of_drop_down = self.site.sports_page.tab_content.dropdown_market_selector.\
            items_as_ordered_dict
    ...
    def test_004_click_on__market_which_is_highlighted(self):
        """
