...
@pytest.mark.sports
@vtest
class Test_C60089593_Verify_WW_MT_on_Competitions_Tab_for_Baseball(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089593
    NAME: Verify 'WW’ MT on Competitions Tab for Baseball
    ...
    def test_000_preconditions(self):
        ...
        PRECONDITIONS: Go to the Baseball Landing Page -> 'Click on Competition Tab'
        """
