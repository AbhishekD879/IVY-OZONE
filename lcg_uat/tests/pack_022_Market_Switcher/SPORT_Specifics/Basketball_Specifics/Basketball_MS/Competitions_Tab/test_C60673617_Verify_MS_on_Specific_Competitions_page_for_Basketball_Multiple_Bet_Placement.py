...
@pytest.mark.desktop
@vtest
class Test_C60673617_Verify_MS_on_Specific_Competitions_page_for_Basketball_Multiple_Bet_Placement(BaseBetSlipTest):
    """
    TR_ID: C60673617
    NAME: Verify MS on Specific Competitions page for Basketball Multiple Bet Placement
    ...
    def verify_fixture_header_and_qty_of_bet_buttons(self, bet_button_qty, header1=None, header3=None, header2=None,
        ...
        current_page = self.site.competition_league
        items = current_page.tab_content.accordions_list.first_item[1]
    ...
    def test_000_preconditions(self):
        ...
        self.expected_tab_name = self.get_sport_tab_name(
    ...
    def test_005_verify_bet_placement_for__multiple_bet_for_the_below_markets_money_line_total_points_handicap_handicap_in_lads_and_spread_in_coral_home_team_total_points_away_team_total_points_current_half_total_points_current_quarter_total_points(self):
        """
