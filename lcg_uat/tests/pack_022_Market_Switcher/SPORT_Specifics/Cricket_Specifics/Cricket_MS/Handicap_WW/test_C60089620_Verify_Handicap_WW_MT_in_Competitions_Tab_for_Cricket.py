...
@vtest
class Test_C60089620_Verify_Handicap_WW_MT_in_Competitions_Tab_for_Cricket(BaseDataLayerTest):
    """
    TR_ID: C60089620
    NAME: Verify ‘Handicap WW’ MT in Competitions Tab for Cricket
    ...
    PRECONDITIONS: 2. Go to the Cricket Landing Page -> Click on 'Competition Page'
    PRECONDITIONS: **Note:**
    ...
    def test_001_verify_displaying_of_the_market_selector(self):
        ...
        try:
            ...
            self.site.competition_league.tab_content.dropdown_market_selector.items_as_ordered_dict.get(vec.siteserve.EXPECTED_MARKETS_NAMES.total_sixes).click()
    ...
    def test_002_clicktap_on_market_selector(self):
        ...
        """
        list_of_drop_down = self.site.competition_league.tab_content.dropdown_market_selector.items_as_ordered_dict
    ...
    def test_004_verify_displaying_of_preplayinplay_or_both_events(self):
        ...
        EXPECTED: • Total Sixes (Preplay and Inplay)
        EXPECTED: • Next Over Runs (Inplay)
        EXPECTED: • Team Runs (Inplay)
        EXPECTED: • Runs At Fall Of Next Wicket (Inplay)
        EXPECTED: Note:
    ...
    def test_005_verify_text_of_the_labels_for_total_sixes(self):
        """
