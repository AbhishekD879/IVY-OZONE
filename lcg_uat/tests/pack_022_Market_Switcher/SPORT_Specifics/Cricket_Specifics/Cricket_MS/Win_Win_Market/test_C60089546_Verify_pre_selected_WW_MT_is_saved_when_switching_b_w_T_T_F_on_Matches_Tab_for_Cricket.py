...
@pytest.mark.desktop
@vtest
class Test_C60089546_Verify_pre_selected_WW_MT_is_saved_when_switching_b_w_T_T_F_on_Matches_Tab_for_Cricket(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089546
    ...
    def verify_pre_selected_option_and_labels_and_GA_tracking_functionality_for_tab(self, tab):
        if self.device_type == 'desktop':
            ...
            self.test_002_verify_displaying_for_preplay_events_for_match_result()
    ...
    def test_000_preconditions(self):
        ...
        self.ob_config.add_autotest_cricket_event_for_WW_type(start_time=tomorrow)
        # Future event
        future = self.get_date_time_formatted_string(days=7)
        self.ob_config.add_autotest_cricket_event_for_WW_type(start_time=future)
    ...
    def test_002_verify_displaying_for_preplay_events_for_match_result(self):
        ...
        """
        self.site.sports_page.tab_content.accordions_list.items_as_ordered_dict
