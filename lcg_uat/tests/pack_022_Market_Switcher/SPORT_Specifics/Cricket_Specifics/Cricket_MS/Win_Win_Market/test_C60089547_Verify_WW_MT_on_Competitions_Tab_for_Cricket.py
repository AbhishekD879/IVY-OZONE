...
@vtest
class Test_C60089547_Verify_WW_MT_on_Competitions_Tab_for_Cricket(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089547
    NAME: Verify 'WW’ MT on Competitions Tab for Cricket
    DESCRIPTION: This test case verifies displaying of ‘WW market’ Template is displaying by default for Cricket Competition page under Market Selector Dropdown
    ...
    def test_000_preconditions(self):
        """
        PRECONDITIONS: 1. Load the app
        PRECONDITIONS: 2. Go to the Cricket Landing page -> 'Click on Competition Tab'
        ...
        self.ob_config.add_autotest_cricket_event_for_WW_type()
    ...
    def test_004_verify_text_of_the_labels_for_match_result(self):
        ...
        """
        items = list(self.site.competition_league.tab_content.accordions_list.items)[0]
