...
@pytest.mark.sports
@vtest
class Test_C60089570_Verify_MS_sticky_behavior_on_Competitions_Tab_for_Darts(BaseSportTest):
    """
    TR_ID: C60089570
    NAME: Verify MS sticky behavior on Competitions Tab for Darts
    ...
    def test_000_precondition(self):
        ...
        self.site.darts.tabs_menu.click_button(self.expected_sport_tabs.competitions)
        ...
        self.assertEqual(current_tab_name, self.expected_sport_tabs.competitions,
                         msg=f'Actual Tab: "{current_tab_name}" is not same as the'
                             f'Expected Tab: "{self.expected_sport_tabs.competitions}"')
        self.__class__.darts_tab_content = self.site.competition_league.tab_content
    ...
    def test_001_verify_that_market_selector_is_sticky_when_scrolling_the_page_down(self):
        ...
        """
        self.site.competition_league.scroll_to_bottom()
    ...
    def test_002_verify_that_market_selector_is_sticky_when_scrolling_the_page_up(self):
        ...
        EXPECTED: For the Desktop 'Market Selector' is NOT sticky. It becomes hidden together with Date Selector panel
        """
        self.site.competition_league.scroll_to_top()
