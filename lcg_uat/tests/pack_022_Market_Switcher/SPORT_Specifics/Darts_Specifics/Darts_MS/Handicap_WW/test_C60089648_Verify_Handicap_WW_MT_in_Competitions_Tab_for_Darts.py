...
@vtest
class Test_C60089648_Verify_Handicap_WW_MT_in_Competitions_Tab_for_Darts(BaseDataLayerTest):
    """
    TR_ID: C60089648
    NAME: Verify ‘Handicap WW’ MT in Competitions Tab for Darts
    ...
    expected_list = [vec.siteserve.EXPECTED_MARKETS_NAMES.handicap,
    ...
    def test_000_preconditions(self):
        ...
        self.cms_config.verify_and_update_sport_config(sport_category_id=self.ob_config.rugby_union_config.category_id,
                                                       ...
                                                       primary_markets='|Match Betting|,|Handicap 2-way|,'
                                                                       '|Total Match Points|')
        created_event = self.ob_config.add_autotest_darts_event_for_handicap(markets=self.event_markets)
    ...
    def test_001_verify_displaying_of_the_market_selector(self):
        ...
        EXPECTED: • ‘Market Selector’ is displayed on upcoming module header (with 1st option selected by defaultco)
    ...
    def test_002_clicktap_on_market_selector(self):
        ...
        for market in self.expected_list:
            self.assertIn(market, actual_list,
                          msg=f'Actual List: "{market} is not same as'
                              f'Expected List: "{actual_list}"')

    def test_003_select_total_180s_in_the_market_selector_dropdown_list(self, handicap_value=expected_same_sort_handicap):
        """
    ...
    def test_005_verify_text_of_the_labels_for_total_180s(self, label1=vec.sb.OVER.upper(), label2=vec.sb.UNDER.upper()):
        """
    ...
    def test_007_verify_ga_tracking_for_the_total_180s(self, market=expected_list[1]):
        """
    ...
    def test_008_repeat_3_7_steps_for_the_below_markets_handicap_expect_step_5(self):
        ...
        self.test_003_select_total_180s_in_the_market_selector_dropdown_list(handicap_value=self.expected_low_sort_handicap)
        self.test_004_verify_displaying_of_preplayinplay_or_both_events()
        self.test_007_verify_ga_tracking_for_the_total_180s(market=self.expected_list[0])
    ...
    def test_009_verify_text_of_the_labels_for_handicap(self):
        ...
        """
        self.test_005_verify_text_of_the_labels_for_total_180s(label1="1", label2="2")
