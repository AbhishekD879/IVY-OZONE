...
@pytest.mark.desktop
@pytest.mark.low
class Test_C60089598_Verify_pre_selected_WW_MT_is_saved_when_switching_b_w_T_T_F_on_Matches_Tab_for_Ice_Hockey(BaseSportTest):
    """
    TR_ID: C60089598
    NAME: Verify pre selected ‘WW’ MT is saved when switching b/w T/T/F on Matches Tab for Ice Hockey
    ...
    event_markets = [('total_goals_2_way',)]
