...
@pytest.mark.desktop
class Test_C60089599_Verify_WW_MT_on_Competitions_Tab_for_Ice_Hockey(BaseSportTest, BaseDataLayerTest):
    """
    TR_ID: C60089599
    NAME: Verify 'WW’ MT on Competitions Tab for Ice Hockey
    DESCRIPTION: This test case verifies displaying of ‘WW market’ Template is displaying by default for Ice Hockey Competition page under Market Selector Dropdown
    ...
    preplay_list = []
    inplay_list = []
    event_market = [('total_goals_2_way',),
                    ('puck_line',)]
    ...
    def test_000_preconditions(self):
        ...
        self.ob_config.add_ice_hockey_event_to_ice_hockey_usa(markets=self.event_market)
