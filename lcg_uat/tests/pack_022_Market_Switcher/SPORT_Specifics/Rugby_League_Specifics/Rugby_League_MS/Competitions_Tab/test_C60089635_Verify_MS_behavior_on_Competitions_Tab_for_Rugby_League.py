...
@pytest.mark.desktop
@vtest
class Test_C60089635_Verify_MS_behavior_on_Competitions_Tab_for_Rugby_League(Common):
    """
    TR_ID: C60089635
    NAME: Verify MS behavior on Competitions Tab for Rugby League
    ...
    def test_004_click_on_market_which_is_higlighted(self):
        ...
        EXPECTED: Selected market will be displayed
        """
