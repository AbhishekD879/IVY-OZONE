...
@pytest.mark.sports
@vtest
class Test_C60089641_Verify_pre_selected_Handicap_WW_MT_is_saved_when_switching_b_w_T_T_F_on_Matches_Tab_for_Rugby_League(Common):
    """
    TR_ID: C60089641
    NAME: Verify pre selected ‘Handicap WW’ MT is saved when switching b/w T/T/F on Matches Tab for Rugby League
