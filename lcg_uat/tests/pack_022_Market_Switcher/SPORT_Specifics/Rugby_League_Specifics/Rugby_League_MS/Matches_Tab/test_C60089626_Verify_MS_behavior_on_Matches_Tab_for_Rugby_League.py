...
@vtest
class Test_C60089626_Verify_MS_behavior_on_Matches_Tab_for_Rugby_League(Common):
    """
    TR_ID: C60089626
    NAME: Verify MS behavior on Matches Tab for Rugby League
    ...
    def test_001_verify_displaying_of_the_market_selector_dropdown_list(self):
        ...
        self.assertTrue(has_market_selector, msg=' "Market selector" is not available for Rugby League')
