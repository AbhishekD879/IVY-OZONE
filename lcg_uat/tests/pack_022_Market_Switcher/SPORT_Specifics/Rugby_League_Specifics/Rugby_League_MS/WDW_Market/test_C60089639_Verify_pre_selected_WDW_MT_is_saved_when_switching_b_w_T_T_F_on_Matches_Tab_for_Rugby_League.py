...
@vtest
class Test_C60089639_Verify_pre_selected_WDW_MT_is_saved_when_switching_b_w_T_T_F_on_Matches_Tab_for_Rugby_League(BaseDataLayerTest):
    """
    TR_ID: C60089639
    NAME: Verify pre selected ‘WDW’ MT is saved when switching b/w T/T/F on Matches Tab for Rugby League
    ...
    def test_000_preconditions(self):
        ...
        self.cms_config.verify_and_update_sport_config(sport_category_id=self.ob_config.rugby_league_config.category_id,
                                                       ...
                                                       primary_markets='|Match Betting|,|Handicap 2-way|,'
                                                                       '|Total Match Points|')
        self.ob_config.add_rugby_league_event_to_rugby_league_all_rugby_league()
