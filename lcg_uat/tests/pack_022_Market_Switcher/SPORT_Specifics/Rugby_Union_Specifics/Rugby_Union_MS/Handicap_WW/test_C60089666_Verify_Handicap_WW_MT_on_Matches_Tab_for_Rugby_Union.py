...
@pytest.mark.sports
@vtest
class Test_C60089666_Verify_Handicap_WW_MT_on_Matches_Tab_for_Rugby_Union(Common):
    """
    TR_ID: C60089666
    NAME: Verify 'Handicap WW’ MT on Matches Tab for Rugby Union
    ...
    def test_004_verify_text_of_the_labels_for_handicap_2_way(self):
        """
    ...
    def test_007_verify_ga_tracking_for_the_handicaphandicap_in_coral_and_handicap_2_way_in_lads(self):
        """
    ...
    def test_008_repeat_steps_3_7_for_the_below_market_total_points_except_step4(self):
        """
        DESCRIPTION: Repeat steps 3-7 for the below market:
        DESCRIPTION: • Total Points (except step4)
        EXPECTED: 
        """
        pass
