...
@vtest
class Test_C60089533_Verify_MS_on_Matches_Tab_for_Rugby_Union_SLP(BaseBetSlipTest, BaseSportTest):
    """
    TR_ID: C60089533
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.matches_tab_enabled = self.cms_config.get_sport_tab_status(
        ...
        is_market_switcher_enabled = self.cms_config.get_system_configuration_item('MarketSwitcher').get('rugbyunion')

        if not is_market_switcher_enabled:
            raise CmsClientException('Market Switcher is Not Enabled for rugby union')
        ...
        if expected_tab_name not in tabs and not self.matches_tab_enabled:
    ...
    def test_006_repeat_steps_2_to_5_for_the_following_markets_handicap_2_wayhandicap_total_points(self):
        """
        DESCRIPTION: Repeat steps 2 to 5 for the following markets:
