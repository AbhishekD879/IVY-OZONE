...
@pytest.mark.sports
@vtest
class Test_C60089621_Verify_Handicap_WW_MT_on_Matches_Tab_for_Snooker(BaseDataLayerTest):
    """
    TR_ID: C60089621
    NAME: Verify 'Handicap WW’ MT on Matches Tab for Snooker
    ...
    PRECONDITIONS: |Total Frames Over/Under (Over/Under)|-"Total Frame"
    ...
    def test_002_clicktap_on_market_selector(self):
        ...
        actual_markets_list = list(
            self.site.snooker.tab_content.dropdown_market_selector.items_as_ordered_dict.keys())
    ...
    def test_008_repeat_steps_3_7_for_the_below_market_total_framesexcept_step4(self):
        """
        DESCRIPTION: Repeat steps 3-7 for the below market:
        DESCRIPTION: • Total Frames(except step4)
        ...
        self.test_007_verify_ga_tracking_for_the_handicap(market=self.expected_market_selector_options[2])
