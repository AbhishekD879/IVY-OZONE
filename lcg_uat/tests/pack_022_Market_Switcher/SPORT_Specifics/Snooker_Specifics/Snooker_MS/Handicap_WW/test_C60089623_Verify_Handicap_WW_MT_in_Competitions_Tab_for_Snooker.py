...
@pytest.mark.sports
@vtest
class Test_C60089623_Verify_Handicap_WW_MT_in_Competitions_Tab_for_Snooker(BaseDataLayerTest):
    """
    TR_ID: C60089623
    NAME: Verify ‘Handicap WW’ MT in Competitions Tab for Snooker
    ...
    PRECONDITIONS: eg: |Handicap|,|Total Frames|
    ...
    expected_market_selector_options = [vec.siteserve.EXPECTED_MARKET_SECTIONS.match_result.title(),
    ...
    def test_000_preconditions(self):
        ...
        expected_tab_name = self.get_sport_tab_name(
    ...
    def test_001_verify_displaying_of_the_market_selector(self):
        ...
        """
        self.__class__.snooker_tab_content = self.site.competition_league.tab_content
    ...
    def test_002_clicktap_on_market_selector(self):
        ...
        self.assertTrue(actual_markets_list, msg=f'"Market Selector" dropdown list not opened')
        self.assertListEqual(actual_markets_list, self.expected_market_selector_options,
    ...
    def test_005_verify_text_of_the_labels_for_handicap(self):
        ...
        """
        self.snooker_tab_content.dropdown_market_selector.items_as_ordered_dict.get(
    ...
    def test_008_repeat_3_7_steps_for_the_below_markets_total_frames_expect_step_5(self):
        """
        DESCRIPTION: Repeat 3-7 steps for the below markets
        DESCRIPTION: • Total Frames (Expect step 5)
        EXPECTED: As per steps
        """
        self.test_003_select_handicap_in_the_market_selector_dropdown_list(
            market=self.expected_market_selector_options[2])
        self.test_004_verify_displaying_of_preplayinplay_or_both_events()
        self.test_007_verify_ga_tracking_for_the_handicap(market_name=self.expected_market_selector_options[2])

    def test_009_verify_text_of_the_labels_for_total_frames(self):
        """
        DESCRIPTION: Verify text of the labels for 'Total Frames'
        ...
        """
        self.site.competition_league.tab_content.dropdown_market_selector.items_as_ordered_dict.get(
            self.expected_market_selector_options[2]).click()
        self.verify_fixture_header_and_qty_of_bet_buttons(bet_button_qty=2, header1='OVER', header3='UNDER')

    def test_010_verify_ga_tracking_for_the_total_frames(self):
        """
