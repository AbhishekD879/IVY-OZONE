...
@vtest
class Test_C60089552_Verify_MS_sticky_behavior_on_Competitions_Tab_for_Volleyball(Common):
    """
    TR_ID: C60089552
    NAME: Verify MS sticky behavior on Competitions Tab for Volleyball
    ...
    def test_000_preconditions(self):
        ...
        expected_tab_name = self.get_sport_tab_name(self.cms_config.constants.SPORT_TABS_INTERNAL_NAMES.competitions, self.ob_config.volleyball_config.category_id)
    ...
    def test_001_verify_that_market_selector_is_sticky_when_scrolling_the_page_down(self):
        ...
        """
        markets = list(self.site.competition_league.tab_content.dropdown_market_selector.items_as_ordered_dict.keys())
