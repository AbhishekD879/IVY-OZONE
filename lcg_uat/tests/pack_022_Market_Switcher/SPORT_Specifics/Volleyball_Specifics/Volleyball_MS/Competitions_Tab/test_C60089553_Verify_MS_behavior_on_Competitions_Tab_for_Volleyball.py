...
@vtest
class Test_C60089553_Verify_MS_behavior_on_Competitions_Tab_for_Volleyball(Common):
    """
    TR_ID: C60089553
    NAME: Verify MS behavior on Competitions Tab for Volleyball
    ...
    def test_000_preconditions(self):
        ...
        DESCRIPTION: Navigate volleybal competitons tab
