...
@vtest
class Test_C60089627_Verify_Handicap_WW_MT_on_Matches_Tab_for_Volleyball(BaseDataLayerTest):
    """
    TR_ID: C60089627
    ...
    def test_002_clicktap_on_market_selector(self):
        ...
        """
        actual_list = list(self.site.sports_page.tab_content.dropdown_market_selector.items_as_ordered_dict.keys())
    ...
    def test_004_verify_text_of_the_labels_for_total_points(self, header_1=vec.sb.FIXTURE_HEADER.over, header_2=vec.sb.FIXTURE_HEADER.under):
        """
    ...
    def test_008_repeat_steps_3_7_for_the_below_market_set_handicap_except_step4(self):
        ...
        self.site.sports_page.tab_content.dropdown_market_selector.items_as_ordered_dict.\
            get(self.expected_list[1]).click()
    ...
    def test_009_verify_text_of_the_labels_for_set_handicap(self):
        ...
        """
        self.test_004_verify_text_of_the_labels_for_total_points(header_1='1', header_2='2')
