...
@pytest.mark.other
@vtest
class Test_C66072429_Verify_the_Accumulator_4_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072429
    NAME: Verify the Accumulator (4) bet placement
    DESCRIPTION: Verify the Accumulator (4) bet placement
    ...
    def test_003_verify_by_adding__four_selections_from_different_events_to__betslipenter_the_stake_amount_against_the_4_fold_acca_accumulator_4_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding  four selections from different events to  betslip,enter the stake amount against the 4 Fold Acca (Accumulator (4)) bet type and click on place bet option.
        EXPECTED: The 4 Fold Acca (Accumulator (4)) bet should be placed successfully.
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/0272c45b-dd4b-456c-bd69-38cfd615d854) ![](index.php?/attachments/get/9b11e1f7-ebe8-44bc-bc8c-5d9f1fb96af9)
        """
        pass
