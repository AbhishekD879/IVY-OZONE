...
@pytest.mark.other
@vtest
class Test_C66072435_Verify_the_Accumulator_9_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072435
    NAME: Verify the Accumulator (9) bet placement
    DESCRIPTION: Verify the Accumulator (9) bet placement
    ...
    def test_003_verify_by_adding__nine_selections_from_different_events_to__betslipenter_the_stake_amount_against_the_9_fold_acca_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding  nine selections from different events to  betslip,enter the stake amount against the 9 Fold Acca bet type and click on place bet option.
        EXPECTED: The 9 Fold Acca bet should be placed successfully.
        ...
        self.assertIn(vec.betslip.ACC9, sections.keys(),
                      msg=f'No "{vec.betslip.ACC9}" stake was found in "{sections.keys()}"')
        ...
        self.place_multiple_bet(stake_name=vec.betslip.ACC9)
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/4f8057e3-1b48-4f3a-b097-ae357aae34ac) ![](index.php?/attachments/get/db6b31a4-1c11-4f27-9466-ac5290ecfd70)
        """
        pass
