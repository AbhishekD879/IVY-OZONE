...
@pytest.mark.other
@vtest
class Test_C66072436_Verify_the_Accumulator_10_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072436
    NAME: Verify the Accumulator (10) bet placement
    DESCRIPTION: Verify the Accumulator (10) bet placement
    ...
    def test_003_verify_by_adding__ten_selections_from_different_events_to__betslipenter_the_stake_amount_against_the_10_fold_acca_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding  ten selections from different events to  betslip,enter the stake amount against the 10 Fold Acca bet type and click on place bet option
        EXPECTED: The 10 Fold Acca bet should be placed successfully.
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/8b90842e-e587-4006-b874-6bab4cde9481) ![](index.php?/attachments/get/2944decb-9dfa-427f-8472-f5604fa573a7)
        """
        sections = self.get_betslip_sections(multiples=True).Multiples
        self.assertIn(vec.betslip.AC10, sections.keys(),
                      msg=f'No "{vec.betslip.AC10}" stake was found in "{sections.keys()}"')
        ...
        self.place_multiple_bet(stake_name=vec.betslip.AC10)
