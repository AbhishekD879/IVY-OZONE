...
@pytest.mark.other
@vtest
class Test_C66072438_Verify_the_Accumulator_12_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072438
    NAME: Verify the Accumulator (12) bet placement
    DESCRIPTION: Verify the Accumulator (12) bet placement
    ...
    def test_003_verify_by_adding_12_selections_from_different_events_to__betslipenter_the_stake_amount_against_the_12_fold_acca_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding 12 selections from different events to  betslip,enter the stake amount against the 12 Fold Acca bet type and click on place bet option.
        EXPECTED: The 12 Fold Acca bet should be placed successfully.
        ...
        self.assertIn(vec.betslip.AC12, sections.keys(),
                      msg=f'No "{vec.betslip.AC12}" stake was found in "{sections.keys()}"')
        ...
        self.place_multiple_bet(stake_name=vec.betslip.AC12)
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/e1bd8ed4-1908-48f1-9990-d3f69a70d7fd) ![](index.php?/attachments/get/cbeebe42-e5ad-41f3-a3e2-15a40ea606bb)
        """
