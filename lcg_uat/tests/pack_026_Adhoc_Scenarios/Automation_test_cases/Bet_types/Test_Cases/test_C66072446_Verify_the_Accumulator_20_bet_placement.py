...
@pytest.mark.other
@vtest
class Test_C66072446_Verify_the_Accumulator_20_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072446
    NAME: Verify the Accumulator (20) bet placement
    DESCRIPTION: Verify the Accumulator (20) bet placement
    ...
    def test_003_verify_by_adding_20_selections_from_different_events_to__betslipenter_the_stake_amount_against_the_20_fold_acca_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding 20 selections from different events to  betslip,enter the stake amount against the 20 Fold Acca bet type and click on place bet option.
        EXPECTED: The 20 Fold Acca bet should be placed successfully.
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/5683a97f-f455-430e-bf0e-fbb5d70f61b7) ![](index.php?/attachments/get/3a3ce77b-625e-4c05-af26-52020aa1b906)
        """
        sections = self.get_betslip_sections(multiples=True).Multiples
        self.assertIn(vec.betslip.AC20, sections.keys(),
                      msg=f'No "{vec.betslip.AC20}" stake was found in "{sections.keys()}"')
        ...
        self.place_multiple_bet(stake_name=vec.betslip.AC20)
