...
@pytest.mark.other
@vtest
class Test_C66072457_Verify_Ninefolds_from_13_bet_placement(BaseBetSlipTest):
    """
    TR_ID: C66072457
    NAME: Verify Ninefolds from 13 bet placement.
    DESCRIPTION: Verify Ninefolds from 13 bet placement.
    ...
    def test_003_verify_by_adding_13_selections_from_different_horse_racing_events_to__betslipenter_the_stake_amount_against_the_ninefolds_from_13_bet_type_and_click_on_place_bet_option(self):
        """
        DESCRIPTION: Verify by adding 13 selections from different Horse racing events to  betslip,enter the stake amount against the Ninefolds from 13 bet type and click on place bet option.
        EXPECTED: The Ninefolds from 13 bet should be placed successfully.
    ...
    def test_004_verify_the_calls_in_the_network_tab(self):
        ...
        EXPECTED: ![](index.php?/attachments/get/c8af7574-4e97-4964-ba92-456849aa3aea) ![](index.php?/attachments/get/fe6687de-a17c-4b2f-a9fd-7f5ca8f94565)
        """
        sections = self.get_betslip_sections(multiples=True).Multiples
        self.assertIn(vec.betslip.P913, sections.keys(),
                      msg=f'No "{vec.betslip.P913}" stake was found in "{sections.keys()}"')
        ...
        self.place_multiple_bet(stake_name=vec.betslip.P913)
