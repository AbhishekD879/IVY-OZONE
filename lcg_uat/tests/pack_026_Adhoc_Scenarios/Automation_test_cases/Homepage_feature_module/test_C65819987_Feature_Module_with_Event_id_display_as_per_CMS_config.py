...
@vtest
class Test_C65819987_Feature_Module_with_Event_id_display_as_per_CMS_config(Common):
    """
    TR_ID: C65819987
    NAME: Feature Module with Event id display as per CMS config
    DESCRIPTION: Feature Module with Event id display as per CMS config
    ...
    def test_010_under_events_loading_module__choose_select_events_by_as_event_id_from_the_drop_down(self):
        """
        DESCRIPTION: Under events loading module , choose select events by as "Event id from the drop down"
        EXPECTED: Enter Event id of the sport
        EXPECTED: Ex : Foot ball event id -
        EXPECTED: Tennis event id -
        """
        # Covered in above pre-condition step
    ...
    def test_017_launch_front_end_application___lads_or_coral(self):
        ...
        EXPECTED: Example :
        EXPECTED: ![](index.php?/attachments/get/a4acbb0c-d29e-4f86-9273-1679095e38fe)
        """
