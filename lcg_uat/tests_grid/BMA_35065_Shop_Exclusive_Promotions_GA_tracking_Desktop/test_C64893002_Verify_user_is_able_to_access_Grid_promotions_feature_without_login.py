...
@pytest.mark.grid
@vtest
class Test_C64893002_Verify_user_is_able_to_access_Grid_promotions_feature_without_login(Common):
    """
    TR_ID: C64893002
    NAME: Verify user is able to access "Grid promotions" feature without login.
    DESCRIPTION:
    PRECONDITIONS: 1.User should have valid Ladbrokes sports URL.
    """
    keep_browser_open = True

    def test_001_launch_ladbrokes_sports_url2click_on_grid_tab3click_on_shop_exclusive_promos_from_the_listexpected_result1sports_url_should_be_launched_successfully2user_should_be_able_to_open_grid_tab3user_should_be_able_to_click_on_shop_exclusive_promos_and_promotions_page_is_accessed_successfully(self):
        """
        ...
        DESCRIPTION: 3.User should be able to click on "Shop Exclusive Promos" and promotions page is accessed successfully.
