...
@pytest.mark.desktop
@vtest
class Test_C64893027_Verify_the_following_tabs_are_displayed_in_football_bet_filter_page_by_clicking_go_betting_buttonSelect_bet_online_option_on_the_pop_up1_Create_Coupons2_Your_Team3_The_Opposition4_Saved_Filter(Common):
    """
    TR_ID: C64893027
    NAME: Verify the following tabs are displayed in football bet filter page by clicking go betting button(Select bet online option on the pop up)
    1. Create Coupons
    2. Your Team
    3. The Opposition
    4. Saved Filter
    ...
    def test_001_1_1launch_ladbrokes_sports_web_application_and_login_with_valid_user_credentials2click_on_grid_tab_from_main_header3click_on_football_bet_filter_from_the_grid_hub_menu_items4click_on_bet_online_from_the_fcb_opening_pop_up_and__click_on_go_bettingexpected_result1sports_web_application_should_be_launch_2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_football_bet_filter_and_successfully_open_football_bet_filter_page4_user_should_be_able_to_select_bet_online_and_click_on_go_betting_button_navigate_to_football_bet_filter_page_and_should_see_all_the_below_tabs1_create_coupons2_your_team3_the_opposition4_saved_filter(self):
        """
        ...
        DESCRIPTION: 4.Click on bet online from the FCB opening pop up and  click on 'Go betting'
        ...
        DESCRIPTION: 4. User should be able to select "Bet online" and click on "Go betting" button ,navigate to football bet filter page and should see all the below tabs:
        ...
        EXPECTED: 4. User should be able to select "Bet online" and click on "Go betting" button ,navigate to football bet filter page and should see all the below tabs:
