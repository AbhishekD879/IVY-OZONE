...
@pytest.mark.desktop
@vtest
class Test_C64893038_Verify_if_the_user_is_able_to_see_Add_to_Bet_slip_button_is_highlighted_for_bet_online_from_FCB_popup(BaseCouponsTest, BaseFootballBetFilter):
    """
    TR_ID: C64893038
    NAME: Verify if the user is able to see "Add to Bet slip" button is highlighted for bet online from FCB popup.
    DESCRIPTION:
    PRECONDITIONS: 1.User should have valid Ladbrokes sports URL.
    """
    keep_browser_open = True

    def test_001_launch_ladbrokes_sports_web_application_and_login_with_valid_user_credentials2click_on_grid_tab_from_main_header3click_on_football_bet_filter_from_the_grid_hub_menu_items4click_on_bet_online_from_the_fcb_opening_pop_up5select_all_required_filters6click_on_find_bets_buttonexpected_result1sports_web_application_should_be_launch_2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_football_bet_filter_and_successfully_open_football_bet_filter_page4user_should_be_landed_on_football_bet_filter_page_by_clicking_go_betting_page5user_should_be_able_to_select_all_required_filter6some_of_filter_selections_should_be_auto_selected_and_add_to_bet_slip_button_should_be_active_(self):
        """
        ...
        DESCRIPTION: 6.Some of filter selections should be auto selected and add to bet slip button should be active .
        ...
        EXPECTED: 6.Some of filter selections should be auto selected and add to bet slip button should be active .
        """
