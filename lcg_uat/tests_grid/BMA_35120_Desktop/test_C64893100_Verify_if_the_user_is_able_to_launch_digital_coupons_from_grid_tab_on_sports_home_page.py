...
@pytest.mark.grid
@vtest
class Test_C64893100_Verify_if_the_user_is_able_to_launch_digital_coupons_from_grid_tab_on_sports_home_page(Common):
    """
    TR_ID: C64893100
    NAME: Verify if the user is able to launch digital coupons from grid tab on sports home page.
    PRECONDITIONS: 1.User should have valid Ladbrokes sports URL.
    PRECONDITIONS: 2.User should have valid online users.
    """
    keep_browser_open = True

    def test_001_launch_ladbrokes_sports_web_application_and_login_with_valid_user_credentials2click_on_grid_tab_from_main_header3click_on_digital_coupons_from_the_grid_hub_menu_itemsexpected_result1sports_web_application_should_be_launch_2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_digital_coupons_and__open_digital_coupons_page(self):
        """
