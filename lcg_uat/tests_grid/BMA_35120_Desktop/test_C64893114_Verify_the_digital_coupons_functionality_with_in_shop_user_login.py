...
@pytest.mark.grid
@vtest
class Test_C64893114_Verify_the_digital_coupons_functionality_with_in_shop_user_login(Common):
    """
    TR_ID: C64893114
    NAME: Verify the digital coupons functionality with  in shop user login.
    PRECONDITIONS: 1.User should have valid Ladbrokes sports URL.
    PRECONDITIONS: 2.User should have valid in shop user.
    """
