...
@pytest.mark.grid
@vtest
class Test_C64893115_Verify_the_digital_coupons_functionality_with_online_user_login(Common):
    """
    TR_ID: C64893115
    NAME: Verify the digital coupons functionality with online user login.
    PRECONDITIONS: 1.User should have valid Ladbrokes sports URL.
    PRECONDITIONS: 2.User should have valid online user.
    """
