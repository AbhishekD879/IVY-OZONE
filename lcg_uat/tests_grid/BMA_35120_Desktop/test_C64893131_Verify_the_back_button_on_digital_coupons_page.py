...
@pytest.mark.desktop
@vtest
class Test_C64893131_Verify_the_back_button_on_digital_coupons_page(Common):
    """
    TR_ID: C64893131
    NAME: Verify the back button(<) on digital coupons page.
    DESCRIPTION:
    ...
    def test_001_1_1launch_ladbrokes_sports_web_application_and_login_with_valid_user_credentials2click_on_grid_tab_from_main_header3click_on_digital_coupons_from_the_grid_hub_menu_items4click_on_back_button_from_header_menuexpected_result1sports_web_application_should_be_launch_2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_digital_coupons_and__open_digital_coupons_page4user_should_be_landed_on_grid_hub_page(self):
        """
        ...
        DESCRIPTION: 4.Click on back button(<) from header menu.
        ...
        DESCRIPTION: 4.User should be landed on grid hub page.
        ...
        EXPECTED: 4.User should be landed on grid hub page.
        """
        ...
        wait_for_result(lambda: self.site.in_shop_coupons.title.is_displayed(),
                        ...
                        timeout=20)
        self.assertTrue(self.site.in_shop_coupons.back_icon.is_displayed(), msg="Back button is not displayed on In-Shop Coupons screen")
        self.site.in_shop_coupons.back_icon.click()
        self.site.wait_content_state(state_name='thegrid')
