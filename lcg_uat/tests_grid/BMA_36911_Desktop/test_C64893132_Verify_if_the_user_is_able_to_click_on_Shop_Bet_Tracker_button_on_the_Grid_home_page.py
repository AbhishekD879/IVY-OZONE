...
@pytest.mark.desktop
@vtest
class Test_C64893132_Verify_if_the_user_is_able_to_click_on_Shop_Bet_Tracker_button_on_the_Grid_home_page(Common):
    """
    TR_ID: C64893132
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hubexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_shop_bet_tracker_and_should_be_navigated_to_shop_bet_tracker_page(self):
        """
