...
@pytest.mark.desktop
@vtest
class Test_C64893133_Verify_if_the_user_is_able_to_see_the_below_items_Track_Button_Open_In_Shop_Bets_Settled_In_Shop_Bets_Info_Icon_and_there_should_be_a_default_message_that_You_currently_have_no_open_In_Shop_betsafter_navigating_to_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893133
    NAME: Verify if the user is able to see the below items (Track Button, Open In Shop Bets, Settled In Shop Bets, Info Icon and there should be a default message that You currently have no open In-Shop bets)after navigating to "Shop Bet Tracker" page.
    DESCRIPTION:
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hubexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_see_all_the_below_items__track_button_open_in_shop_bets_settled_in_shop_bets_info_icon_and_there_should_be_a_default_message_that_you_currently_have_no_open_in_shop_bets(self):
        """
        ...
        DESCRIPTION: 4.User should be able to see all the below items:-
        ...
        EXPECTED: 4.User should be able to see all the below items:-
