...
@pytest.mark.desktop
@vtest
class test_C64893134_Verify_if_the_user_is_able_to_see_information_about_Bet_Receipt_Number_after_tapping_I_icon_present_below_the_Bet_Tracker_Cashout_title_in_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893134
    NAME: Verify if the user is able to see information about Bet Receipt Number after tapping I icon present below the Bet Tracker & Cashout title in Shop Bet Tracker page.
    DESCRIPTION:
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hub4click_on_i_icon_below_the_bet_tracker__cashout_titleexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_see_the_information_about_your_bet_receipt_number_bet_station_13_digit_bet_number_and_over_the_counter_14_digit_bet_number(self):
        """
        ...
        DESCRIPTION: 4.Click on (I) icon below the "Bet Tracker & Cashout" title.
        ...
        DESCRIPTION: 4.User should be able to see the information about Your bet receipt number (Bet Station 13 digit bet number) and (Over the counter 14 digit bet number).
        ...
        EXPECTED: 4.User should be able to see the information about Your bet receipt number (Bet Station 13 digit bet number) and (Over the counter 14 digit bet number).
        """
