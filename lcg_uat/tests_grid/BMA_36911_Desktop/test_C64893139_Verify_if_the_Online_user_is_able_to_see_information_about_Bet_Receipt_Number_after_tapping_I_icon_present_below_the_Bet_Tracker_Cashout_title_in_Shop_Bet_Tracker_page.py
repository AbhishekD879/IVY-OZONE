...
@pytest.mark.desktop
@vtest
class Test_C64893139_Verify_if_the_Online_user_is_able_to_see_information_about_Bet_Receipt_Number_after_tapping_I_icon_present_below_the_Bet_Tracker_Cashout_title_in_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893139
