...
@pytest.mark.desktop
@vtest
class Test_C64893140_Verify_if_the_Online_user_is_able_to_click_on_back_button_on_the_header_of_Shop_bet_tracker_page_and_navigate_back_to_the_Grid_home_page(Common):
    """
    TR_ID: C64893140
    NAME: Verify if the Online user is able to click on (<) back button on the header of "Shop bet tracker" page and navigate back to the Grid home page.
    DESCRIPTION:
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_shop_bet_tracker_from_the_grid_hub5click_on__back_buttonexpected_result1sports_application_should_be_launched_successfully2user_should_be_logged_in3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_navigated_to_shop_bet_tracker_page5user_should_come_back_to_the_grid_home_page(
            self):
        """
        ...
        DESCRIPTION: 5.User should come back to the Grid home page.
