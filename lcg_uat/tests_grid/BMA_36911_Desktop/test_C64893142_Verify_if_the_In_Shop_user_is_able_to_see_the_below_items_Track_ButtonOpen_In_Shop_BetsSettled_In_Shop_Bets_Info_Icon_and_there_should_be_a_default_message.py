...
@pytest.mark.desktop
@vtest
class Test_C64893142_Verify_if_the_In_Shop_user_is_able_to_see_the_below_items_Track_ButtonOpen_In_Shop_BetsSettled_In_Shop_Bets_Info_Icon_and_there_should_be_a_default_message_that_You_currently_have_no_open_In_Shop_betsafter_navigating_to_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893142
    NAME: Verify if the In-Shop user is able to see the below items (Track Button,Open In Shop Bets,Settled In Shop Bets, Info Icon and there should be a default message that You currently have no open In-Shop bets)after navigating to "Shop Bet Tracker" page
    DESCRIPTION:
