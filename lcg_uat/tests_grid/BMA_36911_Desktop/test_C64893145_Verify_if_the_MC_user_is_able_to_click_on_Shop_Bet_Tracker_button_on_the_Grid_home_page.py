...
@pytest.mark.grid
@vtest
class Test_C64893145_Verify_if_the_MC_user_is_able_to_click_on_Shop_Bet_Tracker_button_on_the_Grid_home_page(Common):
    """
    TR_ID: C64893145
    NAME: Verify if the MC user is able to click on "Shop Bet Tracker" button on the Grid home page.
    DESCRIPTION:
