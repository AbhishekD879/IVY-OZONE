...
@pytest.mark.grid
@vtest
class Test_C64893147_Verify_if_the_MC_user_is_able_to_see_information_about_Bet_Receipt_Number_after_tapping_I_icon_present_below_the_Bet_Tracker_Cashout_title_in_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893147
    NAME: Verify if the MC user is able to see information about Bet Receipt Number after tapping I icon present below the Bet Tracker & Cashout title in Shop Bet Tracker page.
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_shop_bet_tracker_from_the_grid_hub5click_on_i_icon_below_the_bet_tracker__cashout_titleexpected_result1sports_application_should_be_launched_successfully2user_should_be_logged_in3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_navigated_to_shop_bet_tracker_page5user_should_be_able_to_see_the_information_about_your_bet_receipt_number_bet_station_13_digit_bet_number_and_over_the_counter_14_digit_bet_number(self):
        """
        ...
        self.assertTrue(self.site.bet_tracker.receipt_number_info.bet_station_receipt.is_displayed(),
                        msg='Bet Station receipt info is not displayed')
