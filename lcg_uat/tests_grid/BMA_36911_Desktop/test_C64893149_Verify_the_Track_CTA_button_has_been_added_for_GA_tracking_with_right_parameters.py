...
@pytest.mark.grid
@vtest
class Test_C64893149_Verify_the_Track_CTA_button_has_been_added_for_GA_tracking_with_right_parameters(BaseDataLayerTest):
    """
    TR_ID: C64893149
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hub4click_on_track_cta_after_entering_the_bet_numberexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_enter_the_bet_number_and_click_on_track_button5the_next_push_is_sent_to_gadatalayerpush_event__trackeventeventcategory__shop_bet_trackereventaction__scan_your_bet_receipt__track_(self):
        """
