...
@pytest.mark.desktop
@vtest
class Test_C64893151_Verify_if_the_user_is_able_to_check_the_GA_tracking_of_Settled_In_Shop_Bets(BaseDataLayerTest):
    """
    TR_ID: C64893151
    ...
    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hub4click_on_settled_in_shop_betsexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_click_on_settled_in_shop_bets5the_next_push_is_sent_to_gadatalayerpush_event__trackeventeventcategory__shop_bet_trackereventaction___settled_in_shop_bets__(self):
        """
