...
@pytest.mark.desktop
@vtest
class Test_C64893154_Verify_if_the_user_is_able_to_click_on_Shop_Bet_Tracker_button_on_the_Grid_home_page(Common):
    """
    TR_ID: C64893154
    NAME: Verify if the user is able to click on "Shop Bet Tracker" button on the Grid home page.
    DESCRIPTION:
    ...
    def test_001_1_1launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hubexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_shop_bet_tracker_and_should_be_navigated_to_shop_bet_tracker_page(self):
        """
        ...
        DESCRIPTION: 3.User should be able to click on "Shop Bet Tracker" and should be navigated to "Shop Bet Tracker" page.
        ...
        EXPECTED: 3.User should be able to click on "Shop Bet Tracker" and should be navigated to "Shop Bet Tracker" page.
        """
