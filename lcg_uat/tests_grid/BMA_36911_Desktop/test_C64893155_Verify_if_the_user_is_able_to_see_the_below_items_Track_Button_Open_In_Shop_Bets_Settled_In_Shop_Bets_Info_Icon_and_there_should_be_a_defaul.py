...
@pytest.mark.desktop
@vtest
class Test_C64893155_Verify_if_the_user_is_able_to_see_the_below_items_Track_Button_Open_In_Shop_Bets_Settled_In_Shop_Bets_Info_Icon_and_there_should_be_a_default_message_that_You_currently_have_no_open_In_Shop_betsafter_navigating_to_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893155
    ...
    def test_001_1_1launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hubexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_see_all_the_below_items__track_button_open_in_shop_bets_settled_in_shop_bets_info_icon_and_there_should_be_a_default_message_that_you_currently_have_no_open_in_shop_bets(self):
        """
