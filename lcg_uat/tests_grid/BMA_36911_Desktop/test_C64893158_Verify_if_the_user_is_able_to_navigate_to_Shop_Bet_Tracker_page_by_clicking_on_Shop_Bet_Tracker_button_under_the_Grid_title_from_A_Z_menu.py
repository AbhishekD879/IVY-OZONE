...
@pytest.mark.grid
@vtest
class Test_C64893158_Verify_if_the_user_is_able_to_navigate_to_Shop_Bet_Tracker_page_by_clicking_on_Shop_Bet_Tracker_button_under_the_Grid_title_from_A_Z_menu(Common):
    """
    TR_ID: C64893158
    ...
    def test_001_1_1launch_ladbrokes_sports_application2click_on_a_z_menu3click_on_shop_bet_tracker_from_the_a_z_menu_under_the_gridexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_a_z_menu3user_should_be_navigated_to_shop_bet_tracker_page(self):
        """
