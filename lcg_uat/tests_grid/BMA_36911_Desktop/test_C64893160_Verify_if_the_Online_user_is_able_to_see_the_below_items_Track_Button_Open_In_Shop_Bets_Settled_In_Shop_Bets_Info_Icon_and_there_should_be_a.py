...
@pytest.mark.grid
@vtest
class Test_C64893160_Verify_if_the_Online_user_is_able_to_see_the_below_items_Track_Button_Open_In_Shop_Bets_Settled_In_Shop_Bets_Info_Icon_and_there_should_be_a_default_message_that_You_currently_have_no_open_In_Shop_betsafter_navigating_to_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893160
