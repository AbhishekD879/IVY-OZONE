...
@pytest.mark.grid
@vtest
class Test_C64893165_Verify_if_the_In_Shop_user_is_able_to_see_information_about_Bet_Receipt_Number_after_tapping_I_icon_present_below_the_Bet_Tracker_Cashout_title_in_Shop_Bet_Tracker_page(Common):
    """
    TR_ID: C64893165
    NAME: Verify if the In-Shop user is able to see information about Bet Receipt Number after tapping I icon present below the Bet Tracker & Cashout title in Shop Bet Tracker page.
