...
@pytest.mark.grid
@vtest
class Test_C64893166_Verify_if_the_In_Shop_user_is_able_to_click_on_back_button_on_the_Breadcrumb_in_Shop_bet_tracker_page_and_navigate_back_to_the_Grid_home_page(Common):
    """
    TR_ID: C64893166
