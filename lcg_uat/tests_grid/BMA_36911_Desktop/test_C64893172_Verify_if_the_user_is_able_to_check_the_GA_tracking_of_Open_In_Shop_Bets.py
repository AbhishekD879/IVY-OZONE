...
@pytest.mark.desktop
@vtest
class Test_C64893172_Verify_if_the_user_is_able_to_check_the_GA_tracking_of_Open_In_Shop_Bets(BaseDataLayerTest):
    """
    TR_ID: C64893172
    NAME: Verify if the user is able to check the GA tracking of "Open In Shop Bets".
    PRECONDITIONS: 1.User should have valid Ladbrokes sports web
    PRECONDITIONS: application URL.
    """
    keep_browser_open = True

    def test_001_launch_ladbrokes_sports_web_application2click_on_grid_tab_from_main_header3click_on_shop_bet_tracker_from_the_grid_hub4click_on_open_in_shop_betsexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_navigated_to_shop_bet_tracker_page4user_should_be_able_to_click_on_open_in_shop_bets5the_next_push_is_sent_to_gadatalayerpush_event__trackeventeventcategory__shop_bet_trackereventaction___open_in_shop_bets__(self):
        """
        ...
        DESCRIPTION: 4.Click on "Open In Shop Bets".
        ...
        DESCRIPTION: 4.User should be able to click on "Open In Shop Bets".
        ...
        DESCRIPTION: 'eventAction' : ' Open In Shop Bets ' }
        DESCRIPTION: );
        ...
        EXPECTED: 4.User should be able to click on "Open In Shop Bets".
        EXPECTED: 5.The next push is sent to GA:
        EXPECTED: dataLayer.push(
        EXPECTED: { 'event' : 'trackEvent',
        EXPECTED: 'eventCategory' : 'Shop Bet Tracker',
        EXPECTED: 'eventAction' : ' Open In Shop Bets ' }
        EXPECTED: );
        """
        ...
        expected_response = {'event': 'trackEvent',
                             'eventAction': 'Open In Shop Bets',
                             'eventCategory': 'Bet tracker',
                             }
        actual_response = self.get_data_layer_specific_object(object_key='eventAction', object_value='Open In Shop Bets')
