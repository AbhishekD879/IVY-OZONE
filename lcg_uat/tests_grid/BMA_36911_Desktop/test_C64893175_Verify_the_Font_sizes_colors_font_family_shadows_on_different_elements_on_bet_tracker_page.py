...
@pytest.mark.desktop
@vtest
class Test_C64893175_Verify_the_Font_sizes_colors_font_family_shadows_on_different_elements_on_bet_tracker_page(Common):
    """
    TR_ID: C64893175
    NAME: Verify the Font sizes, colors, font family, shadows on different elements on bet tracker page
