...
@pytest.mark.desktop
@vtest
class Test_C64893191_Verify_if_the_user_is_able_to_select_Bet_In_Shop_radio_button_and_on_clicking_Go_Betting_button_user_should_navigate_to_the_Football_Bet_Filter_page_without_login(Common):
    """
    TR_ID: C64893191
    NAME: Verify if the user is able to select "Bet In Shop" radio button and on clicking "Go Betting" button, user should navigate to the "Football Bet Filter" page without login.
    DESCRIPTION:
    PRECONDITIONS: 1.User should have valid ladbrokes sports web app.
    """
    keep_browser_open = True

    def test_001_1_1launch_ladbrokes_sports_web_app2click_on_grid_tab_from_main_header3click_on_football_bet_filter_from_the_grid_hub4select_bet_in_shop_and_click_on_go_betting_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_able_to_open_grid_tab_from_main_header3user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons4user_should_be_navigated_to_football_bet_filter_page(self):
        """
        ...
        DESCRIPTION: 4.Select "Bet In Shop" and click on "Go Betting" button.
