...
@pytest.mark.grid
@vtest
class Test_C64893193_Verify_if_the_user_is_able_to_see_a_popup_on_clicking_Football_Bet_Filter_which_consists_of_1Bet_In_Shop_and_2Bet_Online_Radio_buttons_with_Online_user_login(Common):
    """
    TR_ID: C64893193
    NAME: Verify if the user is able to see a popup on clicking "Football Bet Filter" which consists of 1.Bet In Shop
    and 2.Bet Online Radio buttons with "Online user" login.
    ...
    def test_001_launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hubexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_sucessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons(self):
        """
