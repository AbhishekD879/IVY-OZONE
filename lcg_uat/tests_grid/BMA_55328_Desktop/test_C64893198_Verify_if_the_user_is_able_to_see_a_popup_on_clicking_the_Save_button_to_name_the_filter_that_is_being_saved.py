...
@pytest.mark.grid
@vtest
class Test_C64893198_Verify_if_the_user_is_able_to_see_a_popup_on_clicking_the_Save_button_to_name_the_filter_that_is_being_saved(Common):
    """
    TR_ID: C64893198
    NAME: Verify if the user is able to see a popup on clicking the "Save" button to name the filter that is being saved.
    ...
    def test_001_launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hub5select_bet_in_shop_and_click_on_go_betting_button6select_the_filtering_options_of_coupons_leagues_date7check_whether_the_find_bets_and_save_button_are_active8click_on_save_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_secessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons5user_should_be_navigated_to_football_bet_filter_page6user_must_be_able_to_select_the_filtering_options7user_must_be_able_to_see_both_find_bets_and_save_buttons_in_active_state8user_must_be_able_to_see_a_popup_to_enter_the_name_for_saving_the_filter(self):
        """
        ...
        self.assertEqual(name, entered_value,
                         msg=f'Actual Filter entered value "{entered_value}" is not same as'
