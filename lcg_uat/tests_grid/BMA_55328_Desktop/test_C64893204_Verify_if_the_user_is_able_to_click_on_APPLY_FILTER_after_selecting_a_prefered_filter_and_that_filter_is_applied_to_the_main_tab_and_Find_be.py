...
@pytest.mark.grid
@vtest
class Test_C64893204_Verify_if_the_user_is_able_to_click_on_APPLY_FILTER_after_selecting_a_prefered_filter_and_that_filter_is_applied_to_the_main_tab_and_Find_bets_button_must_be_in_Active_state(Common):
    """
    TR_ID: C64893204
    NAME: Verify if the user is able to click on "APPLY FILTER" after selecting a prefered filter and that filter is applied to the main tab and "Find bets" button must be in Active state.
    ...
    def test_001_launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hub5select_bet_in_shop_and_click_on_go_betting_button6select_the_filtering_options_of_coupons_leagues_date7check_whether_the_find_bets_and_save_button_are_active8click_on_save_button9click_on_saved_filters_button_from_header10select_the_prefered_filter_from_the_saved_filters_page11click_on_apply_filter_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_secessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons5user_should_be_navigated_to_football_bet_filter_page6user_must_be_able_to_select_the_filtering_options7user_must_be_able_to_see_both_find_bets_and_save_buttons_in_active_state8user_must_be_able_to_see_a_popup_to_enter_the_name_for_saving_the_filter_and_save_it_by_giving_the_name9user_should_be_navigated_to_the_saved_filters_page10user_must_be_able_to_select_the_prefered_filter_sucessfully11bet_filter_is_applied_sucessfully_to_the_main_tab_and_find_bets_button_is_in_active_state(self):
        """
        ...
        DESCRIPTION: 10.Select the preferred filter from the "SAVED FILTERS" page.
        ...
        EXPECTED: 10.User must be able to select the prefered filter successfully.
        EXPECTED: 11.Bet filter is applied successfully to the main tab and "Find Bets" button is in active state.
        """
