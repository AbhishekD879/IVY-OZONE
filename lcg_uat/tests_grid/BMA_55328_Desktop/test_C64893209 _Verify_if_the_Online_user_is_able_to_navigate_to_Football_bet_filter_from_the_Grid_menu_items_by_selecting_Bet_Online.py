...
@pytest.mark.grid
@vtest
class Test_C64893209_Verify_if_the_Online_user_is_able_to_navigate_to_Football_bet_filter_from_the_Grid_menu_items_by_selecting_Bet_Online(Common):
    """
    TR_ID: C64893209
    NAME: Verify if the Online user is able to navigate to Football bet filter from the Grid menu items by selecting "Bet Online"
    DESCRIPTION:
    ...
    def test_001_1_1launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hub5select_bet_online_radio_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_sucessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons5user_should_be_navigated_to_the_football_bet_filter_page_sucessfully(self):
        """
