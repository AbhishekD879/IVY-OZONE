...
@pytest.mark.grid
@vtest
class Test_C64893210_Verify_if_the_Online_user_is_able_to_see_find_bets_button_getting_active_after_saving_a_filter_and_applying_it(Common):
    """
    TR_ID: C64893210
    NAME: Verify if the Online user is able to see find bets button getting active after saving a filter and applying it
    DESCRIPTION:
    ...
    def test_001_launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hub5select_bet_online_and_click_on_go_betting_button6select_the_filtering_options_of_coupons_leagues_date7check_whether_the_find_bets_and_save_button_are_active8click_on_save_button9click_on_saved_filters_button_from_header10select_the_prefered_filter_from_the_saved_filters_page11click_on_apply_filter_button12check_the_selections_in_filtering_page_and_count_in_find_bets_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_secessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons5user_should_be_navigated_to_football_bet_filter_page6user_must_be_able_to_select_the_filtering_options7user_must_be_able_to_see_both_find_bets_and_save_buttons_in_active_state8user_must_be_able_to_see_a_popup_to_enter_the_name_for_saving_the_filter_and_save_it_by_giving_the_name9user_should_be_navigated_to_the_saved_filters_page10user_must_be_able_to_select_the_prefered_filter_sucessfully11bet_filter_is_applied_sucessfully_and_removed_from_the_saved_filters12user_must_be_able_to_see_change_in_selections_and_change_in_the_count_in_find_bets_button(self):
        """
        ...
        DESCRIPTION: 11.Bet filter is applied sucessfully
        DESCRIPTION: 12.User must be able to see change count in "FIND BETS" button.
        ...
        EXPECTED: 11.Bet filter is applied sucessfully
        EXPECTED: 12.User must be able to see change count in "FIND BETS" button.
        """
        self.site.login()
