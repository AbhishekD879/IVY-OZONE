...
@pytest.mark.grid
@vtest
class Test_C64893211_Verify_the_inshop_user_is_able_to_navigate_to_football_bet_filter_page_by_selecting_bet_inshop_from_FCB_pop_up(Common):
    """
    TR_ID: C64893211
    NAME: Verify the inshop user is able to navigate to football bet filter page by selecting bet inshop from FCB pop up
    DESCRIPTION:
    ...
    def test_001_launch_ladbrokes_sports_web_app2click_on_login_button_and_enter_valid_user_details3click_on_grid_tab_from_main_header4click_on_football_bet_filter_from_the_grid_hub5select_bet_in_shop_radio_buttonexpected_result1sports_application_should_be_launch_successfully2user_should_be_logged_in_sucessfully3user_should_be_able_to_open_grid_tab_from_main_header4user_should_be_able_to_click_on_football_bet_filter_successfully_and_a_popup_is_shown_with1bet_in_shop_and_2bet_online_radio_buttons5user_should_be_navigated_to_the_football_bet_filter_page_sucessfully(self):
        """
        ...
        DESCRIPTION: 5.Select "Bet In-shop" radio button.
