...
@pytest.mark.grid
@vtest
class Test_C64893214_verify_if_the_inshop_user_is_able_to_save_and_apply_the_bet_filters(Common):
    """
    TR_ID: C64893214
    NAME: verify if the inshop user is able to save and apply the bet filters
    DESCRIPTION:
