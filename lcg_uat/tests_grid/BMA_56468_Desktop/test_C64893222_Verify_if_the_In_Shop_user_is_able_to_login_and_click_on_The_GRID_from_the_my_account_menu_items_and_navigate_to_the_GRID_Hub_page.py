...
@pytest.mark.grid
@vtest
class Test_C64893222_Verify_if_the_In_Shop_user_is_able_to_login_and_click_on_The_GRID_from_the_my_account_menu_items_and_navigate_to_the_GRID_Hub_page(Common):
    """
    TR_ID: C64893222
    NAME: Verify if the In-Shop user is able to login and click on The GRID from the my account menu items and navigate to the GRID Hub page.
    ...
    def test_001_1_1_launch_ladbrokes_sports_url2_click_on_login_and_login_with_valid_in_shop_user_credentials3_click_on_my_account4_click_on_the_grid_from_the_my_account_menu_items5_click_on_the_grid_home_from_the_grid_menu_itemsexpected_result1sports_application_should_be_launched_successfully2user_should_be_able_to_click_on_login_and_should_be_able_to_login_as_in_shop_user3user_should_be_able_to_see_my_account_menu_items4user_should_be_able_to_click_on_the_grid_and_able_to_see_the_grid_menu_items5user_should_be_navigated_to_the_grid_hub_page(self):
        """
