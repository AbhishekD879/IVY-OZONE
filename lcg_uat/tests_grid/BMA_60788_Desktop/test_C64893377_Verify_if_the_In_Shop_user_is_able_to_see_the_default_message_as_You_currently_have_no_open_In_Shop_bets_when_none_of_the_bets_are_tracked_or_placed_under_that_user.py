...
@pytest.mark.desktop
@vtest
class Test_C64893377_Verify_if_the_In_Shop_user_is_able_to_see_the_default_message_as_You_currently_have_no_open_In_Shop_bets_when_none_of_the_bets_are_tracked_or_placed_under_that_user(Common):
    """
    TR_ID: C64893377
    NAME: Verify if the In-Shop user is able to see the default message as "You currently have no open In-Shop bets" when none of the bets are tracked or placed under that user.
    ...
    def test_001_launch_ladbrokes_sports_url2_login_with_in_shop_user3_click_on_grid_tab_from_a_z_menu__carousel__my_account_menu_items4click_on_shop_bet_tracker_from_home_page_menu_items5check_both_settled_bets_tab_and_open_bets_tabsexpected_result1sports_application_should_be_launched_successfully2logged_in_as_in_shop_user3user_should_be_able_to_navigate_to_the_grid_home_page4user_should_be_navigated_to_the_shop_bet_tracker_page5user_must_be_able_to_see_the_default_message_as_you_currently_have_no_open_in_shop_bets_and_same_for_settled_bets_tab_to_as__you_currently_have_no_settled_in_shop_bets(self):
        """
        DESCRIPTION: 1.Launch Ladbrokes sports URL.
        DESCRIPTION: 2. Login with In-Shop user.
