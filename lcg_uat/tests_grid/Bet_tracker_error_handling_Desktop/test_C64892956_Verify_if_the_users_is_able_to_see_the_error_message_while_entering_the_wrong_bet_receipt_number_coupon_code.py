...
@pytest.mark.grid
@vtest
class Test_C64892956_Verify_if_the_users_is_able_to_see_the_error_message_while_entering_the_wrong_bet_receipt_number_coupon_code(Common):
    """
    TR_ID: C64892956
    NAME: Verify if the users is able to see the error message while entering the wrong bet receipt number/coupon code.
    ...
    def test_001_1_1launch_ladbrokes_sports_application_and_login_with_valid_onlinein_shop_user2click_on_grid_tab_from_header_menu3click_on_bet_tracker_from_grid_hub_menu_items_list4enter_invalid_bet_receipt_numberexpected_result1sports_web_application_should_be_launched2user_should_be_able_to_click_on_grid_tab_and_should_be_landed_on_grid_hub_menu3user_should_be_able_to_click_on_bet_tracker_from_grid_hub_menu_items_and_should_be_landed_on_bet_tracker_page4user_should_see_the_following_error_message_after_clicking_on_track_bet_buttonreceipt_code_not_recognized(self):
        """
        ...
        DESCRIPTION: 4.User should see the following error message after clicking on track bet button.{"Receipt code not recognized"}
        ...
        EXPECTED: 4.User should see the following error message after clicking on track bet button.{"Receipt code not recognized"}
        """
        self.site.login()
        ...
        wait_for_result(lambda: self.site.bet_tracker.track_button.is_enabled() is True, timeout=20)
