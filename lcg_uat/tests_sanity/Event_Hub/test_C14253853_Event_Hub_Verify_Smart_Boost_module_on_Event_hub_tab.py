...
@pytest.mark.other
@vtest
class Test_C14253853_Event_Hub_Verify_Smart_Boost_module_on_Event_hub_tab(BaseSportTest):
    """
    TR_ID: C14253853
    ...
    def test_001_verify_selections_within_the_module(self):
        ...
        while not event_hub:
            try:
                self.site.wait_content_state_changed()
                self.__class__.surface_bets = self.site.home.tab_content.surface_bets.items_as_ordered_dict.get(self.surface_bet['title'].upper())
                event_hub = True
    ...
    def test_003_switch_to_fractional_format_top_right_menu__settings__odds_format(self):
        ...
        surface_bets = self.site.home.tab_content.surface_bets.items_as_ordered_dict.get(self.surface_bet['title'].upper())
