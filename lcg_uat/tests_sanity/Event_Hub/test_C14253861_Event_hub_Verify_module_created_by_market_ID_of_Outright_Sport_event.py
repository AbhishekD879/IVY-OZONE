...
@pytest.mark.other
@vtest
class Test_C14253861_Event_hub_Verify_module_created_by_market_ID_of_Outright_Sport_event(Common):
    """
    TR_ID: C14253861
    ...
    def test_000_preconditions(self):
        ...
        self.__class__.event_name, event_time = event.ss_response['event']['name'], event.ss_response['event']['startTime']
