...
@pytest.mark.safari
@vtest
class Test_C9138222_Verify_user_navigation_from_Featured_tab_to_CMS_configured_hardcoded_pages_in_the_application(BaseFeaturedTest):
    """
    TR_ID: C9138222
    NAME: Verify user navigation from 'Featured' tab to CMS configured/hardcoded pages in the application
    DESCRIPTION: This test case verifies user navigation from 'Featured' tab to CMS configured page in an application
    """
    ...
    def test_001_verify_the_users_navigation_to_the_appropriate_page_configured_in_cms_for_the_selected_module(self):
        """
        DESCRIPTION: Select the 'Featured' module by 'Type ID'.
        DESCRIPTION: Click/Tap the CMS configurable link at the bottom of the module.
        DESCRIPTION: Verify the user's navigation to the appropriate page configured in CMS for the selected module.
    ...
    def test_002_verify_that_user_navigates_to_the_selected_event_details_page(self):
        """
        DESCRIPTION: Select the 'Featured' module by 'Type ID'.
        DESCRIPTION: Click/Tap hardcoded link with the number of available markets for the selected event within the module.
        DESCRIPTION: Verify that user navigates to the selected event details page.
    ...
    def test_003_verify_the_users_navigation_to_the_appropriate_page_configured_in_cms_for_the_selected_module(self):
        """
        DESCRIPTION: Select the 'Featured' module by 'Race Type ID'.
        DESCRIPTION: Click/Tap CMS configurable link at the bottom of the module.
        DESCRIPTION: Verify the user's navigation to the appropriate page configured in CMS for the selected module.
        EXPECTED: User is navigated to the page configured in CMS for selected module
        """
        if tests.settings.backend_env == 'tst2' or self.is_safari:
    ...
    def test_004_verify_that_user_navigates_to_the_selected_event_details_page(self):
        """
        DESCRIPTION: Select the 'Featured' module by Race type ID.
        DESCRIPTION: Click/Tap hardcoded link 'More' with the number of available markets for the selected event within the module header.
        DESCRIPTION: Verify that user navigates to the selected event details page.
        EXPECTED: User is navigated to selected event details page
        """
        module = self.get_module(module_content_name=self.featured_tab_name, module_name=self.module_race_type_name)
