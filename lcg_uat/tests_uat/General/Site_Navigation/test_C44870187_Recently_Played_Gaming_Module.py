...
class Test_C44870187_Recently_Played_Gaming_Module(Common):
    ...
    def test_003_tap_on_one_of_the_recently_played_games(self):
        """
        DESCRIPTION: tap on one of the Recently Played Games
        EXPECTED: User should navigate to the corresponding Game info page with 'Play Now' button
        """
        pass

    def test_004_click_on_play_now_button(self):
        """
        DESCRIPTION: Click on 'Play Now' button
        EXPECTED: The Game should launch and User should be able to play the game.
        """
        pass

    def test_005_verify_rpg_carousel(self):
        """
