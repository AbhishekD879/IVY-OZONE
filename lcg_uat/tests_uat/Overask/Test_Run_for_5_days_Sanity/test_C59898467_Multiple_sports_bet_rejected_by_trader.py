...
@pytest.mark.betslip
@vtest
class Test_C59898467_Multiple_sports_bet_rejected_by_trader(BaseBetSlipTest):
    """
    TR_ID: C59898467
    ...
    def test_000_preconditions(self):
        ...
        """
        for i in range(2):
            event_params = self.ob_config.add_autotest_premier_league_football_event(lp_prices=self.prices[i],
