...
@pytest.mark.betslip
@vtest
class Test_C59898468_Single_HR_bet_rejected_by_the_trader(BaseBetSlipTest):
    """
    TR_ID: C59898468
    ...
    def test_000_preconditions(self):
        ...
        """
        event_params = self.ob_config.add_UK_racing_event(number_of_runners=1, lp_prices=self.prices[0],
