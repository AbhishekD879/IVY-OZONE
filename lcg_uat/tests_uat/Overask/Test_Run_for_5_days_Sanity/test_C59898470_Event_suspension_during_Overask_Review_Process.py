...
@pytest.mark.betslip
@vtest
class Test_C59898470_Event_suspension_during_Overask_Review_Process(BaseBetSlipTest):
    """
    TR_ID: C59898470
    ...
    def test_002_in_openbet_suspend_the_event(self):
        """
        DESCRIPTION: In Openbet, suspend the event
