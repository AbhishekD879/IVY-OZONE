...
@pytest.mark.other
@vtest
class Test_C44870277__Single_Tennis_Bet_Countered_by_Price(BaseBetSlipTest):
    """
    TR_ID: C44870277
    ...
    def test_000_preconditions(self):
        ...
        """
        event_params = self.ob_config.add_tennis_event_to_autotest_trophy(lp_prices=self.prices, max_bet=self.max_bet, max_mult_bet=self.max_mult_bet)
