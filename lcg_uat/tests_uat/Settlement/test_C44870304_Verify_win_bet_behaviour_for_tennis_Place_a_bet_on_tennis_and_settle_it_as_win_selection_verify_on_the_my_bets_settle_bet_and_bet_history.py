...
@pytest.mark.betslip
@vtest
class Test_C44870304_Verify_win_bet_behaviour_for_tennis_Place_a_bet_on_tennis_and_settle_it_as_win_selection_verify_on_the_my_bets_settle_bet_and_bet_history(BaseBetSlipTest):
    """
    TR_ID: C44870304
