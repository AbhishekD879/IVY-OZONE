from voltron.utils.dialog_action import DialogAction
...
def set_has_hostname_opened(val: bool):
    global _has_hostname_opened
    _has_hostname_opened = val


def get_has_hostname_opened():
    return _has_hostname_opened
