...
public class Message implements Serializable {
  ...
  private static final int TYPE_ID_START_INDEX = 1;

  private static final int TYPE_ID_END_INDEX = 7;
  ...
  public Message(
    ...
    this.body = body;
    this.type = messageCode.substring(TYPE_ID_START_INDEX, TYPE_ID_END_INDEX);
