...
public class StringUtilsTest {
  ...
  @Test
  public void testTrimChannelPrefix() {
    Assert.assertEquals("2113946413", StringUtils.tryTrimChannelPrefix("2113946413"));
    Assert.assertEquals("2113946413", StringUtils.tryTrimChannelPrefix("02113946413"));
    Assert.assertEquals("0013946413", StringUtils.tryTrimChannelPrefix("000013946413"));
    Assert.assertEquals("1013946413", StringUtils.tryTrimChannelPrefix("01013946413"));
  }

  @Test(expected = IllegalArgumentException.class)
  public void testTrimChannelPrefixNotZero() {
    StringUtils.tryTrimChannelPrefix("12113946413");
  }
}
