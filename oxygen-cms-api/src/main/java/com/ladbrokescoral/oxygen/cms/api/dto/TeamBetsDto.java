...
public class TeamBetsDto extends AbstractSegmentDto implements SportPageModuleDataItem {
  private String id;
  ...
  public SportPageId sportPageId() {
    return new SportPageId(getPageId(), getPageType(), SportModuleType.BETS_BASED_ON_YOUR_TEAM);
  }
}
