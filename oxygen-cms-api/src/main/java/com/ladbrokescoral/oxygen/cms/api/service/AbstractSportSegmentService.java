...
@Slf4j
public abstract class AbstractSportSegmentService<T extends AbstractSportSegmentEntity>
    extends AbstractSportService<T> implements SegmentedService<T> {
  ...
  protected AbstractSportSegmentService(
      CustomSegmentRepository<T> mongoRepository,
      CustomArchivalMongoRepository<? extends T> archivalRepository,
      SegmentService segmentService,
      EventHubService eventHubService) {
    super(mongoRepository, eventHubService);
