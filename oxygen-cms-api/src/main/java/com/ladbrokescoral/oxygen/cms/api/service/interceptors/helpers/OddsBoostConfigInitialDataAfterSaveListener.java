...
@Component
public class OddsBoostConfigInitialDataAfterSaveListener
    extends BasicInitialDataAfterSaveListener<OddsBoostConfigEntity> {
  public OddsBoostConfigInitialDataAfterSaveListener(
      InitialDataService service, DeliveryNetworkService context) {
    super(service, context);
  }

  @Override
  public void onAfterSave(AfterSaveEvent<OddsBoostConfigEntity> event) {
    upload(event);
  }
}
