...
public class GolfMatchesTabEventsChecker extends EventsChecker {

  private final SiteServeService siteServeService;
  private final String brand;

  public GolfMatchesTabEventsChecker(
  ...
  protected void doCheck() {
    List<SportTab> golfMatchesTabs =
        sportTabService.findAllForCheckingEvents(brand, SportTabNames.GOLF_MATCHES);
                ...
                (Integer sportId, SportCategory sport) -> {
                  boolean hasEvents =
                      ((SiteServeServiceImpl) siteServeService)
                          .anyUpcomingEventsExistsForMatchesTabGolf(sport);
