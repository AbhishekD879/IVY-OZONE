...
public class AssetManagementAfterSaveListenerLadsTest
  ...
  public static List<Object[]> data() {
    return Arrays.asList(new Object[][] {{"ladbrokes", "api/ladbrokes", "asset-management"}});
  }
  ...
  public void shouldAfterSaveEvent() throws Exception {
    ...
    if (null != getCollection()) {
      ...
      then(context).should().uploadCFContent(brand, "api/ladbrokes/cf", filename, collection);
      ReflectionTestUtils.setField(
          listener,
          brand.equalsIgnoreCase(Brand.LADBROKES)
              ? "coralAssetmanagementTopic"
              : "ladsAssetmanagementTopic",
          brand.equalsIgnoreCase(Brand.LADBROKES)
              ? "coral-cms-assetmanagement"
              : "cms-assetmanagement");
    }
  };;;;
}
