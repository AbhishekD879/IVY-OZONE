...
public class BetPackAfterSaveListener2Test extends AbstractAfterSaveListenerTest<BetPackEntity> {
  ...
  public static List<Object[]> data() throws IOException {
    return Arrays.asList(new Object[][] {{"bma", "api/bma/", "bet-pack"}});
  }

  @Before
  public void init() {
    ReflectionTestUtils.setField(listener, "coralBetPackTopic", "coral-active-bet-packs-topic");
    given(service.findAllBetPacksBetweenDate(anyString())).willReturn(this.getCollectionV2());
    given(service.getActiveBetPackByBrand(anyString())).willReturn(this.getCollectionV2());
  }
}
