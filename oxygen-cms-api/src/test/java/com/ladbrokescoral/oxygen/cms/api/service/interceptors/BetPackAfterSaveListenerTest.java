...
public class BetPackAfterSaveListenerTest extends AbstractAfterSaveListenerTest<BetPackEntity> {
  ...
  @Getter private List<BetPackEntity> collection = Arrays.asList(new BetPackEntity());;
  ...
  public void init() {
    ...
    given(service.findAllBetPacksBetweenDate(anyString())).willReturn(this.getCollection());
    given(service.getActiveBetPackByBrand(anyString())).willReturn(this.getCollection());
  }
}
