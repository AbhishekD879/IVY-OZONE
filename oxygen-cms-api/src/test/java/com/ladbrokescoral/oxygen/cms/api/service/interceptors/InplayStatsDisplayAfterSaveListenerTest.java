...
public class InplayStatsDisplayAfterSaveListenerTest
    extends AbstractAfterSaveListenerTest<InplayStatsDisplay> {
  ...
  @Getter @InjectMocks private InplayStatsDisplayAfterSaveListener listener;

  private final InitialDataDto data = new InitialDataDto();

  @Getter @Mock private InplayStatsDisplay entity;

  @Getter private final List<?> collection = null;
  ...
  public void shouldAfterSaveEvent() throws Exception {
    ...
    // when
    this.getListener().onAfterSave(new AfterSaveEvent<>(getEntity(), null, "inplay-stats-display"));
