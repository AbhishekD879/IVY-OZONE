...
public class InplayStatsSortingAfterSaveListenerTest
    extends AbstractAfterSaveListenerTest<InplayStatsSorting> {
  ...
  @Getter @InjectMocks private InplayStatsSortingAfterSaveListener listener;

  @Getter @Mock private InplayStatsSorting entity;
  ...
  public void shouldAfterSaveEvent() throws Exception {
    ...
    // when
    this.getListener().onAfterSave(new AfterSaveEvent<>(getEntity(), null, "inplay-stats-sorting"));
