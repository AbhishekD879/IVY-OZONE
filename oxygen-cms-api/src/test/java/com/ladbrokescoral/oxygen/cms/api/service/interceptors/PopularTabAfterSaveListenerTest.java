...
public class PopularTabAfterSaveListenerTest extends AbstractAfterSaveListenerTest<PopularTab> {
  ...
  @Getter @InjectMocks private PopularTabAfterSaveListener listener;

  @Getter @Spy private PopularTab entity;
