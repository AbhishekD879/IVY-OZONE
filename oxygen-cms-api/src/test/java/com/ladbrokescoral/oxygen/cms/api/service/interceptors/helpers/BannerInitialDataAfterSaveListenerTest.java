...
public class BannerInitialDataAfterSaveListenerTest extends AbstractAfterSaveListenerTest<Banner> {

  @Mock private InitialDataService service;
  @Mock private CustomExecutors customExecutors;

  @Getter @InjectMocks private BannerInitialDataAfterSaveListener listener;

  @Getter @Mock private Banner entity;
