...
public class FooterMenuInitialDataAfterSaveListenerTest
    extends AbstractAfterSaveListenerTest<FooterMenu> {

  @Mock private InitialDataService service;
  @Mock private CustomExecutors customExecutors;

  @Getter @InjectMocks private FooterMenuInitialDataAfterSaveListener listener;
  ...
  @Test
  public void shouldAfterSaveEventForCustomEVent() throws Exception {
    CustomEvent<FooterMenu> event = new CustomEvent<>(new FooterMenu(), "footermenus", "bma");
    // given
    // given(getEntity().getBrand()).willReturn(brand);
