...
public class HomeModuleInitialDataAfterSaveListenerTest
  ...
  @Getter @InjectMocks private HomeModuleInitialDataAfterSaveListener listener;
  ...
  @Before
  public void init() {
    when(entity.getPublishToChannels()).thenReturn(Arrays.asList("bma"));
