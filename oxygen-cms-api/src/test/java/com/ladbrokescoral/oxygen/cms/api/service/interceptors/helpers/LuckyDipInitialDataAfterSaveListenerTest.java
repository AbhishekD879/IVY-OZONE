...
public class LuckyDipInitialDataAfterSaveListenerTest
  ...
  @Getter @InjectMocks private LuckyDipInitialDataAfterSaveListener listener;
  ...
  public void shouldAfterSaveEvent() throws Exception {
    ...
    // when
    this.getListener()
        .onAfterSave(new AfterSaveEvent<LuckyDipV2Config>(getEntity(), null, "lucky-dip-config"));
