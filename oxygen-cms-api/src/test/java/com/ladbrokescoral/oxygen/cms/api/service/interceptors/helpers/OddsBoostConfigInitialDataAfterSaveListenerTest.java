...
public class OddsBoostConfigInitialDataAfterSaveListenerTest
    extends AbstractAfterSaveListenerTest<OddsBoostConfigEntity> {

  @Mock private InitialDataService service;
  @Mock private CustomExecutors customExecutors;

  @Getter @InjectMocks private OddsBoostConfigInitialDataAfterSaveListener listener;

  @Getter @Mock private OddsBoostConfigEntity entity;
