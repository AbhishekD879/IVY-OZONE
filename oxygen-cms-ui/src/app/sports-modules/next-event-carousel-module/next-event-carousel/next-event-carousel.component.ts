...
@Component({
  selector: 'app-next-event-carousel',
  templateUrl: './next-event-carousel.component.html',
  styleUrls: ['./next-event-carousel.component.scss']
})
export class NextEventCarouselComponent implements OnInit {
