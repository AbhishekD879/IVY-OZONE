...
@Component({
  selector: 'app-specials-module',
  templateUrl: './specials-module.component.html',
  styleUrls: ['./specials-module.component.scss']
})
export class SpecialsModuleComponent implements OnInit {
