...
class LeaderboardEntryInfoListenerTest {

  @Mock private LeaderboardReqPublisher showdownReqPublisher;
  @InjectMocks private LeaderboardEntryInfoListener listener;
  ...
  void onDataTest() throws Exception {
    ...
    verify(showdownReqPublisher, times(1)).publish(Mockito.any(), Mockito.any());
  }
}
