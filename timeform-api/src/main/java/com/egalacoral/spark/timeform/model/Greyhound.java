...
public class Greyhound extends Identity implements Serializable {
   ...
   * Remark: the Primary Key for the greyhound (PK)
   *
  ...
  /**
   * Gets the value of the damFullName property.
   * EntityColumn: dam_full_name | Standard (PA)
   * Summary: the full name of the greyhound's dam
   * Remark: an example: Giddyup Girl.
   * Dam will be 'Unknown Pedigree' in the event of the information being unavailable
   *
   * @return a String with Title Case value
   */
  ...
  /**
   * Gets the value of the sireFullName property.
   * EntityColumn: sire_full_name | Standard (PA)
   * Summary: the full name of the greyhound's sire
   * Remark: an example: Ballymac Maeve.
   * Sire will be 'Unknown Pedigree' in the event of the information being unavailable
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: colour | Standard (PA)
   * Summary: the colour of the greyhound
   * Remark: an example: bk indicates black fur, etc
   *
   ...
   * EntityColumn: birth_date | Standard (PA)
   * Summary: the date the greyhound was born
   * Remark: Date will be null in the event of the information being unavailable
   *
   ...
   * EntityColumn: gender | Standard (PA)
   * Summary: the gender of the greyhound
   * Remark: Dog - male dog; Bitch - female dog.
   * Gender will be 'Unknown' in the event of the information being unavailable
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: country_full_name | Standard (PA)
   * Summary: the country this greyhound was born in
   * Remark: an example: Great Britain
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn:
   * Summary: the season date of the bitch
   * Remark: an example: 14.De.11.
   * Date will be empty in the event of a male or the information being unavailable
   *
