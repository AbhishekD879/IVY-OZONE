 ...
 */
public class Meeting extends Identity implements Serializable {
  ...
  private List<Integer> obEventTypeIds;
   ...
   * EntityColumn: meeting_id | Standard
   * Summary: the unique identifier for the meeting
   * Remarks:the Primary Key for the meeting (PK)
   *
  ...
  /**
   * Gets the value of the obEventTypeId property.
   * EntityColumn: openbet_id
   * Summary: the unique identifier for the event type
   * Remark:
   *
   * @return an Integer value above 0
   */
  public List<Integer> getObEventTypeId() {
    return obEventTypeIds;
  }

  /**
   * Gets the value of the name property.
   * EntityColumn: name
   * Summary: mapped value from spreadsheet
   ...
   * Remarks: the PA Primary Key for the meeting (PK)
   *
   * @return an Integer with value above 0
   */
   ...
   * EntityColumn: track_id | Standard
   ...
   * EntityColumn: track_short_name | Standard (PA)
   * Summary: The short name of the track
   * Remark: An example: Wimbledon
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: meeting_date | Standard (PA)
   * Summary: The date the meeting is taking place
   * Remark: Date will never be null
   *
   * @return Date value
   */
   ...
   * EntityColumn: meeting_number | Standard
   * Summary: the meeting number
   * Remarks: Meetings can be held at the same track on the same day
   * (to differentiate between meetings held in the morning, afternoon or evening)
   *
  ...
  /**
   * Gets the value of the meetingStateName property.
   * EntityColumn: meeting_state_name | Standard (PA)
   * Summary: the state the meeting is currently at
   * Remarks: an example: Finished
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: meeting_type_name | Standard (PA)
   * Summary: the type of racing at this meeting
   * Remarks: Will be either Flat, Hurdles or Both
   *
   * @return a String with Title Case value
   *
   */
  ...
  /**
   * Gets the value of the meetingRaceTypeName property.
   * EntityColumn: meeting_race_type_name | Standard (PA)
   * Summary: the type of meeting
   * Remarks: Will be either Official Meeting or Trials Meeting
   *
   * @return a String with Title Case value
   *
   */
  ...
  /**
   * Gets the value of the meetingNap property.
   * EntityColumn: meeting_nap | Standard
   * Summary: Timeform's meeting NAP and next best
   * Remarks: an example: NAP: Mountainview Gal. NB: Murlough Bay. Will be empty in the event of trials,
   * or if it hasn't yet been calculated
   *
   * @return a String with Title Case value
   *
   */
   ...
   * EntityColumn: race
   * Summary: The representation of a race.
   * Remark: {@link Race }
   *
  ...
  public void setObEventTypeId(List<Integer> obEventTypeIds) {
    this.obEventTypeIds = obEventTypeIds;
  }
  ...
  public String toString() {
    ...
    sb.append(", obEventTypeId=").append(obEventTypeIds);
