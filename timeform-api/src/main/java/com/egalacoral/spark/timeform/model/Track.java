...
public class Track extends Identity implements Serializable {
   ...
   * Remarks: the Primary Key for the track (PK)
   *
  ...
  /**
   * Gets the value of the trackFullName property.
   * EntityColumn: track_full_name | Standard (PA)
   * Summary: the full name of the track
   * Remarks: an example: Wimbledon Stadium
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: country_full_name | Standard
   * Summary: the full name of the country this track is situated in
   * Remarks: an example: Great Brtain
   *
   * @return a String with Title Case value
   */
   ...
   * EntityColumn: meetings
   * Summary: the representation of a meeting.
   * Remark: {@link Meeting }
   *
