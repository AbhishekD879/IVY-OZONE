...
@Api(value = "greyhounds", description = " ", tags = "Greyhounds Greyhounds")
@FunctionalInterface
public interface GrayhoundRacesGreyhoundsApi extends GrayhoundRacesApiBase {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "List all greyhounds", response = Greyhound.class)
      })
  @RequestMapping(
      value = "/greyhounds",
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<List<Greyhound>> greyhoundsGet(
