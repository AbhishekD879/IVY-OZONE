...
@Api(value = "meetings", description = " ", tags = "Greyhounds Meetings")
@FunctionalInterface
public interface GrayhoundRacesMeetingsApi extends GrayhoundRacesApiBase {
  ...
  @ApiOperation(
      ...
      tags = {})
  @ApiResponses(
      value = {@ApiResponse(code = 200, message = "List all meetings", response = Meeting.class)})
  @RequestMapping(
      value = "/meetings",
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<List<Meeting>> meetingsGet(
