...
@Api(value = "tracks", description = " ", tags = "Greyhounds Tracks")
@FunctionalInterface
public interface GrayhoundRacesTracksApi extends GrayhoundRacesApiBase {
  ...
  @ApiOperation(
      ...
      tags = {})
  @ApiResponses(
      value = {@ApiResponse(code = 200, message = "List all tracks", response = Track.class)})
  @RequestMapping(
      value = "/tracks",
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<List<Track>> tracksGet(
