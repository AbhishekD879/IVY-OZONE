...
@Controller
public class HorseRacesMeetingsApiController implements HorseRacesMeetingsApi {

  @Autowired private HorseRacingStorageService service;

  public ResponseEntity<List<HRMeeting>> meetingsGet(
      ...
      @ApiParam(
          ...
          String filter) {
    List<HRMeeting> hrMeetings = service.getMeetings(top, skip, orderby, filter);
