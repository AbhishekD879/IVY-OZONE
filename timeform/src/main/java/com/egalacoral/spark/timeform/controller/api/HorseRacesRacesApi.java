...
@Api(value = "races", description = " ", tags = "Horses Races")
public interface HorseRacesRacesApi extends HorseRacesApiBase {
  ...
  @ApiOperation(
      ...
      tags = {})
  @ApiResponses(
      value = {@ApiResponse(code = 200, message = "List all races", response = HRMeeting.class)})
  @RequestMapping(
      value = "/races",
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<List<HRRace>> racesGet(
