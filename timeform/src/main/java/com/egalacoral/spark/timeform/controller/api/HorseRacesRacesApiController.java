...
@Controller
public class HorseRacesRacesApiController implements HorseRacesRacesApi {

  @Autowired private HorseRacingStorageService service;

  public ResponseEntity<List<HRRace>> racesGet(
      ...
      @ApiParam(
          ...
          String filter) {
    List<HRRace> hrRaces = service.getRaces(top, skip, orderby, filter);
