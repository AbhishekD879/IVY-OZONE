...
public class Entry extends OBRelatedEntity implements Serializable, TimeformEntry {

  private static final String EMPTY_STATUS_DESCRIPTION = "";
  ...
  /**
   * Gets the value of the entryId property. EntityColumn: entry_id | Standard Summary: the unique
   * identifier for the entry Remark: the Primary Key for the entry (PK)
   *
  ...
  /**
   * Gets the value of the fairOddsNum property. EntityColumn: fair_odds_num | Standard Summary:
   * Timeform's fair odds forecast inclusive of stake Remark: the numerator; get the denominator
   * from fair_odds_den
   *
   * @return a Double value above 0
   */
  ...
  /**
   * Gets the value of the fairOddsDen property. EntityColumn: fair_odds_den | Standard Summary:
   * Timeform's fair odds forecast inclusive of stake Remark: the denominator; get the numerator
   * from fair_odds_num
   *
   * @return a Double value above 0
   */
  ...
  /**
   * Gets the value of the fairOddsDec property. EntityColumn: fair_odds_dec | Standard Summary:
   * Timeform's fair odds forecast inclusive of stake Remark: the fair odds expressed as a decimal
   * inclusive of stake
   *
   * @return a Double value above 0
   */
  ...
  /**
   * Gets the value of the positionPrediction property. EntityColumn: position_prediction | Standard
   * Summary: Timeform's 1-2-3 position prediction for this race Remark: prediction will be 0 in the
   * event of the greyhound not qualifying for the 1-2-3
   *
  ...
  /**
   * Gets the value of the starRating property. EntityColumn: star_rating | Standard Summary:
   * Timeform's star rating Remark: an example: 3 indicates 3 out of 5 stars, etc
   *
  ...
  /**
   * Gets the value of the oneLineComment property. EntityColumn: one_line_comment | Standard
   * Summary: Timeform's comment summing up the prospect for each greyhound in this race Remark: an
   * example: Was running really well before its absence. Capable of being involved in the finish
   *
  ...
  /**
   * Gets the value of the bestRecentTime property. EntityColumn: best_recent_time | Standard
   * Summary: the best time the greyhound has recorded in the last 3 months or 15 runs; whichever is
   * most recent Remark: time is matched to this track and distance if not recorded here
   *
   * @return a Double value above 0
   */
  ...
  /**
   * Gets the value of the meetingEntryNap property. EntityColumn: meeting_entry_nap | Standard
   * Summary: Timeform's meeting NAP and next best Remark: Timeform's betting tips for this meeting;
   * 1 being the bet of the day and 2 the next best; a value of 0 will be used where this entry
   * didn't qualify for either of these
   *
  ...
  /**
   * Gets the value of the reserve property. EntityColumn: reserve | Standard (PA) Summary:
   * indicates if this greyhound was a reserve replacing another greyhound in the race Remark: if
   * true then greyhound was a reserve
   *
  ...
  /**
   * Gets the value of the statusName property. EntityColumn: status_name | Standard (PA) Summary:
   * the current status of the entry Remark: an example: Runner
   *
   * @return a String with Title Case value
   */
   ...
   * greyhound is set to run from Remark: an example: 2 indicates Trap 2, etc
   *
   ...
   * greyhound's seed for this race Remark: an example: Wide
   *
   * @return a String with Title Case value
   */
  ...
  /**
   * Gets the value of the greyhound property. EntityColumn: greyhound Summary: The representation
   * of a dog Remark: {@link Greyhound }
   *
   * @return Greyhound
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(entryId, entry.getEntryId());
  }
  ...
  public String getStatusDescription() {
    return EMPTY_STATUS_DESCRIPTION;
  }
}
