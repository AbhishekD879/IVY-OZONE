...
public class Race extends OBRelatedEntity implements Serializable, TimeformRace {
  ...
  private String scheduledRaceTimeLocal;

  @SerializedName(value = "scheduled_race_time_gmt")
  private String scheduledRaceTimeGmt;

  @SerializedName(value = "actual_race_time_local")
  private String actualRaceTimeLocal;
   ...
   * identifier for the race Remarks: the Primary Key for the race (PK)
   *
  ...
  /**
   * Gets the value of the trackId property. EntityColumn: track_id | Standard (PA) Summary: the
   * unique identifier for the track Remarks: the Primary Key for the track (FK)
   *
   * @return an Integer with value above 0
   */
  ...
  /**
   * Gets the value of the meetingId property. EntityColumn: meeting_id | Standard (PA) Summary: the
   * unique identifier for the meeting Remarks: the Primary Key for the meeting (FK)
   *
   * @return an Integer with value above 0
   */
  ...
  /**
   * Gets the value of the bigRace property. EntityColumn: big_race | Standard Summary: Indicates if
   * the race is classed as a 'big race' Remarks: an example: Coronation Cup
   *
  ...
  /**
   * Gets the value of the smartStats property. EntityColumn: smart_stats | Standard Summary: Some
   * noteworthy stats generated for this specific race Remarks: an example: B D O'sullivan has a
   * 33.33% winning strike rate in the last 7 days
   *
  ...
  /**
   * Gets the value of the verdict property. EntityColumn: verdict | Standard Summary: Timeform's
   * verdict on this specific race Remarks: an example: Severly Damaged has the best chance albeit
   * not by much but can't afford for much to go wrong. Knockmoy Jack can emerge second best
   *
   * @return a String with Sentence Case value
   */
  ...
  /**
   * Gets the value of the trackProfile property. EntityColumn: track_profile | Standard Summary:
   * Timeform's track profile written for this track and distance Remarks: Profile will be an empty
  ...
  /**
   * Gets the value of the trackShortName property. EntityColumn: track_short_name | Standard
  ...
  /**
   * Gets the value of the raceNumber property. EntityColumn: race_number | Standard (PA) Summary:
   * the race number at this meeting Remarks: Assigned by race time ascending
   *
   * @return an Integer with value above 0
   */
  ...
  /**
   * Gets the value of the raceTitle property. EntityColumn: race_title | Standard (PA) Summary: the
   * title of the race Remarks: Title will be an empty string in the event of us not knowing it
   *
  ...
  /**
   * Gets the value of the scheduledRaceTimeLocal property. EntityColumn: scheduled_race_time_local
   * | Standard (PA) Summary: the date and time the race is scheduled to start (local time) Remarks:
   * Date will be null in the event of us not knowing it yet
   *
   * @return a String value
   */
  public String getScheduledRaceTimeLocal() {
    return scheduledRaceTimeLocal;
  }

  /**
   * Gets the value of the scheduledRaceTimeGmt property. EntityColumn: scheduled_race_time_gmt |
   * Standard (PA) Summary: the date and time the race is scheduled to start (GMT time) Remarks:
   * Date will be null in the event of us not knowing it yet
   *
   * @return a String value
   */
  public String getScheduledRaceTimeGmt() {
    return scheduledRaceTimeGmt;
  }

  /**
   * Gets the value of the actualRaceTimeLocal property. EntityColumn: actual_race_time_local |
   * Standard (PA) Summary: the date and time the race actually started Remarks: Date will be null
   * until after the race has started
   *
   * @return a String value
   */
  public String getActualRaceTimeLocal() {
    return actualRaceTimeLocal;
  }

  /**
   * Gets the value of the raceStateName property. EntityColumn: race_state_name | Standard (PA)
   * Summary: the state the race is currently at Remarks: an example: Final Result
   *
   * @return a String with Title Case value
   */
  ...
  /**
   * Gets the value of the raceTypeName property. EntityColumn: race_type_name | Standard (PA)
   * Summary: the type of this race Remarks: Will be either Flat or Hurdles
   *
   * @return a String with Title Case value
   */
  ...
  /**
   * Gets the value of the raceGradeName property. EntityColumn: race_grade_name | Standard (PA)
   * Summary: the grade/class of this race Remarks: an example: A1
   *
  ...
  /**
   * Gets the value of the handicapRace property. EntityColumn: handicap_race | Standard (PA)
   * Summary: Indicates if the race is a handicap or not Remarks: If true then the race is a
   * handicap
   *
   * @return a Boolean with True or false value
   */
  ...
  /**
   * Gets the value of the raceDistance property. EntityColumn: race_distance | Standard (PA)
   * Summary: the distance of the race Remarks: Distance expressed in metres
   *
   * @return an Integer with value above 0
   */
  ...
  /**
   * Gets the value of the prizes property. EntityColumn: prizes | Standard (PA) Summary: Details
   * about the prizes of this race Remarks: an example: 1st £107, 2nd £34, Others £31 Race Total
   * £265
   *
   * @return a String with Title Case value
   */
  ...
  /**
   * Gets the value of the officialGoing property. EntityColumn: official_going | Standard (PA)
   * Summary: the official going given to this race Remarks: Official going
   *
  ...
  /**
   * Gets the value of the entries property. EntityColumn: entry Summary: The representation of a
   * dog in a race. Remark: {@link Entry }
   *
   * @return set of performance entities
   */
  ...
  public void setScheduledRaceTimeLocal(String scheduledRaceTimeLocal) {
    this.scheduledRaceTimeLocal = scheduledRaceTimeLocal;
  }

  public void setScheduledRaceTimeGmt(String scheduledRaceTimeGmt) {
    this.scheduledRaceTimeGmt = scheduledRaceTimeGmt;
  }

  public void setActualRaceTimeLocal(String actualRaceTimeLocal) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.raceId);
  }
