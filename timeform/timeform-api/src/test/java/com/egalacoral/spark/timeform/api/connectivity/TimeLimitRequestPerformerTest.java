...
public class TimeLimitRequestPerformerTest {
  ...
  public void testFollowRulesAsync() {
    ...
    Mockito.verify(delegate, Mockito.timeout(10000).times(iterations))
        .invokeAsync(call, dataCallback);
  }
  ...
  public void testWaitAsync() {
    ...
    Mockito.verify(delegate, Mockito.timeout((int) (delay + 500)).times(2))
        .invokeAsync(call, dataCallback);
  }
