...
public class PaginationTest {
  ...
  @Mock private Function createCallFunction;

  @Mock private RequestPerformer requestPerformer;
  ...
  public void testPagination() {
    ...
    Mockito.when(createCallFunction.apply(Mockito.any(Map.class)))
        .then(
            new Answer<Call>() {
              @Override
    ...
    Mockito.doAnswer(
        ...
        .when(requestPerformer)
        .invokeAsync(Mockito.eq(call1), Mockito.any());
    // page 2
    Mockito.doAnswer(
            new Answer() {
              @Override
        ...
        .when(requestPerformer)
        .invokeAsync(Mockito.eq(call2), Mockito.any());
    // page 3
    Mockito.doAnswer(
            new Answer() {
              @Override
        ...
        .when(requestPerformer)
        .invokeAsync(Mockito.eq(call3), Mockito.any());
