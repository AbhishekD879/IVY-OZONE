...
@ContextConfiguration(classes = {TrendingBetsSiteServImpl.class, ObjectMapper.class})
class TrendingBetsSiteServImplImplTest {

  @Autowired public TrendingBetsSiteServImpl trendingBetsSiteServImpl;
  ...
  @ParameterizedTest
  @CsvSource({
    "OutcomeForEvent.json,trending_bets_payload.json,trending_bet_response.json,false,MKTFLAG_FZ,EVFLAG_BL",
    "OutcomeForEvent_two_selections.json,trending_bets_payload.json,trending_bet_response.json,true,MKTFLAG_FZ,EVFLAG_BL",
  ...
  void testSiteServe(
      String siteServerResponse,
      String request,
      String response,
      boolean isContextReq,
      String marketTagName,
      String eventTagName)
      throws IOException {
    ...
    ReflectionTestUtils.setField(
        trendingBetsSiteServImpl, "marketDrillDownTagNames", marketTagName);
    ReflectionTestUtils.setField(trendingBetsSiteServImpl, "eventDrillDownTagNames", eventTagName);
    assertResponse(response, trendingBetsSiteServImpl.getEventToOutcomeForOutcome(trendingItems));
  }
